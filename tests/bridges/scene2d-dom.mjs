...
export const enableDomCssFilterSupport = compiled.flighthq.scene2dDom.Scene2dDom.enableDomCssFilterSupport;
...
export const setDomCssFilter = compiled.flighthq.scene2dDom.Scene2dDom.setDomCssFilter;
