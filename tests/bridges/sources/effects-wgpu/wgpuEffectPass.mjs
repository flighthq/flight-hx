...
const __bridgeImplementation_initializeWgpuDualSourceEffectPipeline = api.initializeWgpuDualSourceEffectPipeline;
export function initializeWgpuDualSourceEffectPipeline(...args) { __syncDependencies(); const result = __bridgeImplementation_initializeWgpuDualSourceEffectPipeline(...args); return result; }
api.initializeWgpuDualSourceEffectPipeline = initializeWgpuDualSourceEffectPipeline;
compiled.flight.EffectsWgpu.initializeWgpuDualSourceEffectPipeline = initializeWgpuDualSourceEffectPipeline;
const __bridgeImplementation_initializeWgpuEffectPipeline = api.initializeWgpuEffectPipeline;
export function initializeWgpuEffectPipeline(...args) { __syncDependencies(); const result = __bridgeImplementation_initializeWgpuEffectPipeline(...args); return result; }
api.initializeWgpuEffectPipeline = initializeWgpuEffectPipeline;
compiled.flight.EffectsWgpu.initializeWgpuEffectPipeline = initializeWgpuEffectPipeline;
