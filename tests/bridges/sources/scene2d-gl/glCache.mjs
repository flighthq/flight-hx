...
function __syncDependencies() {
  ...
  compiled.flight._RenderGl.destroyGlRenderState = __dependency0.destroyGlRenderState;
  ...
  compiled.flight._RenderGl.registerGlRenderStateTeardown = __dependency0.registerGlRenderStateTeardown;
