...
const __bridgeImplementation_initializeWebGlRenderSurfaceProvider = api.initializeWebGlRenderSurfaceProvider;
export function initializeWebGlRenderSurfaceProvider(...args) { __syncDependencies(); const result = __bridgeImplementation_initializeWebGlRenderSurfaceProvider(...args); return result; }
api.initializeWebGlRenderSurfaceProvider = initializeWebGlRenderSurfaceProvider;
compiled.flight.HostWeb.initializeWebGlRenderSurfaceProvider = initializeWebGlRenderSurfaceProvider;
