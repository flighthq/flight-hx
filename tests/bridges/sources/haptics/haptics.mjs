...
const api = compiled.flight._Haptics;
...
export const explainHapticsOperation = api.explainHapticsOperation;
export const getHapticsBackend = api.getHapticsBackend;
export const getHapticsCapabilities = api.getHapticsCapabilities;
export const hasHapticsOperation = api.hasHapticsOperation;
