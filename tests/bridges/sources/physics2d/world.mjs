...
export const initializePhysics2DCollider = api.initializePhysics2DCollider;
export const initializePhysics2DWorld = api.initializePhysics2DWorld;
export const initializeRigidBody2D = api.initializeRigidBody2D;
