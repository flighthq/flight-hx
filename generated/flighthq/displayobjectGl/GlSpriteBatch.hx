...
class GlSpriteBatch {
  ...
  public static function flushGlSpriteBatch(state:GlRenderState):Void {
    ...
    flighthq._internal.backend.WebGl2Backend.bufferSubData(gl, flighthq._internal.backend.WebGl2Backend.ARRAY_BUFFER, 0.0, _Runtime.field(runtime, 'spriteBatchInstanceData'), 0.0, (count * GlSpriteBatch.SPRITE_INSTANCE_FLOATS__glSpriteBatch));
    ...
    if (_Runtime.truthy(!_Runtime.truthy(ctHandled))) {
      if (_Runtime.truthy(_Runtime.compare(floats, 0.0, '>'))) {
        ...
        flighthq._internal.backend.WebGl2Backend.bufferSubData(gl, flighthq._internal.backend.WebGl2Backend.ARRAY_BUFFER, 0.0, _Runtime.field(runtime, 'spriteBatchMaterialData'), 0.0, (count * floats));
      }
