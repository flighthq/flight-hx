...
class GlTextInput {
  public static function drawGlTextInputOverlay(context:Dynamic, source:Dynamic, result:TextLayoutResult, fieldW:Float, fieldH:Float, _text:String):Void {
    ...
    if (_Runtime.truthy(_Runtime.andValue(_Runtime.field(input, 'focused'), function():Dynamic return cast _Runtime.strictEquals(_Runtime.callValue(getTextInputSelectionBeginIndex, cast ([source] : Array<Dynamic>)), _Runtime.callValue(getTextInputSelectionEndIndex, cast ([source] : Array<Dynamic>)))))) {
      ...
      _Runtime.setField(context, 'fillStyle', GlTextInput.CARET_COLOR__glTextInput);
      _Runtime.setField(context, 'globalAlpha', 1.0);
      _Runtime.callProperty(context, 'fillRect', cast ([(_Runtime.field(GlTextInput.caretRectangle__glTextInput, 'x') - scrollXOffset), (_Runtime.field(GlTextInput.caretRectangle__glTextInput, 'y') - scrollYOffset), GlTextInput.CARET_WIDTH__glTextInput, _Runtime.field(GlTextInput.caretRectangle__glTextInput, 'height')] : Array<Dynamic>));
    }
