...
class GlColorAdjustment {
  ...
  public static function bindGlSpriteBatchInstancedColorTransform__glColorAdjustment(state:GlRenderState):Void {
    ...
    flighthq._internal.backend.WebGl2Backend.vertexAttribPointer(gl, 7.0, 4.0, flighthq._internal.backend.WebGl2Backend.FLOAT, false, GlColorAdjustment.COLOR_TRANSFORM_STRIDE__glColorAdjustment, 0.0);
    ...
    flighthq._internal.backend.WebGl2Backend.vertexAttribPointer(gl, 8.0, 4.0, flighthq._internal.backend.WebGl2Backend.FLOAT, false, GlColorAdjustment.COLOR_TRANSFORM_STRIDE__glColorAdjustment, 16.0);
  ...
  public static function ensureGlColorTransformInstancedShader__glColorAdjustment(state:GlRenderState):GlColorTransformInstancedShader {
    ...
    _Runtime.setField(runtime, 'colorTransformInstancedShader', { program: program, locCorner: 0.0, locWorldMatrix: flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, program, 'u_world'), locTexture: flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, program, 'u_texture') });
  ...
  public static function ensureGlUniformColorTransformShader__glColorAdjustment(state:GlRenderState):GlUniformColorTransformShader {
    ...
    _Runtime.setField(runtime, 'uniformColorTransformShader', { program: program, locCorner: 0.0, locWorldMatrix: flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, program, 'u_world'), locTexture: flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, program, 'u_texture'), locColorMultiplier: flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, program, 'u_ctMult'), locColorOffset: flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, program, 'u_ctOff') });
  ...
  public static function ensureGlShapeMeshColorTransformShader__glColorAdjustment(state:GlRenderState):GlShapeMeshColorTransformShader {
    ...
    _Runtime.setField(runtime, 'shapeMeshColorTransformShader', { program: program, positionLocation: flighthq._internal.backend.WebGl2Backend.getAttribLocation(gl, program, 'a_position'), matrixLocation: flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, program, 'u_matrix'), colorLocation: flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, program, 'u_color'), colorMultiplierLocation: flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, program, 'u_ctMult'), colorOffsetLocation: flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, program, 'u_ctOff') });
