...
class GlParticleEmitter {
  ...
  public static function drawGlParticleEmitter(state:GlRenderState, renderProxy:RenderProxy2D):Void {
    ...
    flighthq._internal.backend.WebGl2Backend.vertexAttribPointer(gl, _Runtime.field(shader, 'locPos'), 2.0, flighthq._internal.backend.WebGl2Backend.FLOAT, false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 0.0);
    ...
    flighthq._internal.backend.WebGl2Backend.vertexAttribPointer(gl, _Runtime.field(shader, 'locCosScale'), 1.0, flighthq._internal.backend.WebGl2Backend.FLOAT, false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 8.0);
    ...
    flighthq._internal.backend.WebGl2Backend.vertexAttribPointer(gl, _Runtime.field(shader, 'locSinScale'), 1.0, flighthq._internal.backend.WebGl2Backend.FLOAT, false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 12.0);
    ...
    flighthq._internal.backend.WebGl2Backend.vertexAttribPointer(gl, _Runtime.field(shader, 'locColor'), 4.0, flighthq._internal.backend.WebGl2Backend.FLOAT, false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 16.0);
    ...
    flighthq._internal.backend.WebGl2Backend.vertexAttribPointer(gl, _Runtime.field(shader, 'locUvRect'), 4.0, flighthq._internal.backend.WebGl2Backend.FLOAT, false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 32.0);
    ...
    flighthq._internal.backend.WebGl2Backend.vertexAttribPointer(gl, _Runtime.field(shader, 'locSize'), 2.0, flighthq._internal.backend.WebGl2Backend.FLOAT, false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 48.0);
