...
@:expose("flighthq.displayobjectGl.GlParticleEmitter")
class GlParticleEmitter {
  public static final INSTANCE_FLOATS__glParticleEmitter:Dynamic = 14.0;

  public static final INSTANCE_STRIDE__glParticleEmitter:Dynamic = (GlParticleEmitter.INSTANCE_FLOATS__glParticleEmitter * 4.0);
  ...
  public static function compileParticleShader__glParticleEmitter(gl:Dynamic):GlParticleShader {
    ...
    program = _Runtime.callValue(createGlProgram, cast ([gl, GlParticleEmitter.PARTICLE_VS__glParticleEmitter, GlParticleEmitter.PARTICLE_FS__glParticleEmitter, 'Particle emitter'] : Array<Dynamic>));
  ...
  public static function ensureParticleShader__glParticleEmitter(state:GlRenderState):GlParticleShader {
    ...
    _Runtime.setField(runtime, 'particleShader', _Runtime.callValue(GlParticleEmitter.compileParticleShader__glParticleEmitter, cast ([gl] : Array<Dynamic>)));
  ...
  public static function drawGlParticleEmitter(state:GlRenderState, renderProxy:RenderProxy2D):Void {
    ...
    _Runtime.callProperty(gl, 'bindBuffer', cast ([_Runtime.field(gl, 'ARRAY_BUFFER'), _Runtime.field(runtime, 'particleInstanceBuffer')] : Array<Dynamic>));
    _Runtime.callProperty(gl, 'bufferSubData', cast ([_Runtime.field(gl, 'ARRAY_BUFFER'), 0.0, instanceData, 0.0, (drawCount * GlParticleEmitter.INSTANCE_FLOATS__glParticleEmitter)] : Array<Dynamic>));
    ...
    _Runtime.callProperty(gl, 'vertexAttribPointer', cast ([_Runtime.field(shader, 'locPos'), 2.0, _Runtime.field(gl, 'FLOAT'), false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 0.0] : Array<Dynamic>));
    ...
    _Runtime.callProperty(gl, 'vertexAttribPointer', cast ([_Runtime.field(shader, 'locCosScale'), 1.0, _Runtime.field(gl, 'FLOAT'), false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 8.0] : Array<Dynamic>));
    ...
    _Runtime.callProperty(gl, 'vertexAttribPointer', cast ([_Runtime.field(shader, 'locSinScale'), 1.0, _Runtime.field(gl, 'FLOAT'), false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 12.0] : Array<Dynamic>));
    ...
    _Runtime.callProperty(gl, 'vertexAttribPointer', cast ([_Runtime.field(shader, 'locColor'), 4.0, _Runtime.field(gl, 'FLOAT'), false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 16.0] : Array<Dynamic>));
    ...
    _Runtime.callProperty(gl, 'vertexAttribPointer', cast ([_Runtime.field(shader, 'locUvRect'), 4.0, _Runtime.field(gl, 'FLOAT'), false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 32.0] : Array<Dynamic>));
    ...
    _Runtime.callProperty(gl, 'vertexAttribPointer', cast ([_Runtime.field(shader, 'locSize'), 2.0, _Runtime.field(gl, 'FLOAT'), false, GlParticleEmitter.INSTANCE_STRIDE__glParticleEmitter, 48.0] : Array<Dynamic>));
