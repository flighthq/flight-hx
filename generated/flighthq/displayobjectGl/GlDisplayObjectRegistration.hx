...
import flighthq.displayobjectGl.GlParticleEmitter2D.defaultGlParticleEmitter2DRenderer;
...
class GlDisplayObjectRegistration {
  public static function registerGlDisplayObjectRenderers(state:GlRenderState):Void {
    ...
    _Runtime.callValue(registerRenderer, cast ([state, ParticleEmitter2DKind, defaultGlParticleEmitter2DRenderer] : Array<Dynamic>));
