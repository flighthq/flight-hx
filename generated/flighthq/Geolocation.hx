...
class Geolocation {
  ...
  try {
  return cast _Runtime.callProperty(geo, 'watchPosition', cast ([function(position:Dynamic) return _Runtime.callValue(listener, cast ([_Runtime.callValue(Geolocation.mapWebPosition__geolocation, cast ([position] : Array<Dynamic>))] : Array<Dynamic>)), _Runtime.select(!_Runtime.strictEquals(onError, _Runtime.UNDEFINED), function():Dynamic return cast function(error:Dynamic) return _Runtime.callValue(onError, cast ([_Runtime.callValue(Geolocation.mapWebPositionError__geolocation, cast ([error] : Array<Dynamic>))] : Array<Dynamic>)), function():Dynamic return cast function() {
