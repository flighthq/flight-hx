...
class CapacitorDevice {
  public static function createCapacitorDeviceBackend(capacitor:CapacitorApi):DeviceBackend {
    ...
    return cast { getCapabilities: function(out:DeviceCapabilities):DeviceCapabilities {
      ...
      (out.formFactor = cast ((cast CapacitorDevice.toFormFactor__capacitorDevice(({ final __callArgument0:Dynamic = info; __callArgument0; })) : String) : Dynamic));
      ...
      (out.isVirtual = cast (_Runtime.coalesce(({ final __structural1 = info; __structural1 == null ? _Runtime.UNDEFINED : (cast __structural1 : { var isVirtual:Bool; }).isVirtual; }), function():Dynamic return cast false) : Dynamic));
      (out.manufacturer = cast (_Runtime.coalesce(({ final __structural2 = info; __structural2 == null ? _Runtime.UNDEFINED : (cast __structural2 : { var manufacturer:String; }).manufacturer; }), function():Dynamic return cast '') : Dynamic));
      (out.marketingName = cast (_Runtime.coalesce(({ final __structural3 = info; __structural3 == null ? _Runtime.UNDEFINED : (cast __structural3 : { @:optional var name:Null<String>; }).name; }), function():Dynamic return cast '') : Dynamic));
      (out.model = cast (_Runtime.coalesce(({ final __structural4 = info; __structural4 == null ? _Runtime.UNDEFINED : (cast __structural4 : { var model:String; }).model; }), function():Dynamic return cast '') : Dynamic));
      (out.osBuild = cast ('' : Dynamic));
      (out.osName = cast (_Runtime.coalesce(({ final __structural5 = info; __structural5 == null ? _Runtime.UNDEFINED : (cast __structural5 : { var operatingSystem:String; }).operatingSystem; }), function():Dynamic return cast '') : Dynamic));
      (out.osVersion = cast (_Runtime.coalesce(({ final __structural6 = info; __structural6 == null ? _Runtime.UNDEFINED : (cast __structural6 : { var osVersion:String; }).osVersion; }), function():Dynamic return cast '') : Dynamic));
      (out.platformString = cast (_Runtime.coalesce(({ final __structural7 = info; __structural7 == null ? _Runtime.UNDEFINED : (cast __structural7 : { var platform:String; }).platform; }), function():Dynamic return cast '') : Dynamic));
      (out.productName = cast (_Runtime.coalesce(({ final __structural8 = info; __structural8 == null ? _Runtime.UNDEFINED : (cast __structural8 : { var model:String; }).model; }), function():Dynamic return cast '') : Dynamic));
      (out.supportedAbis = cast (cast ([] : Array<Dynamic>) : Dynamic));
      (out.totalMemory = cast (-1.0 : Dynamic));
      (out.webViewVersion = cast (_Runtime.coalesce(({ final __structural9 = info; __structural9 == null ? _Runtime.UNDEFINED : (cast __structural9 : { var webViewVersion:String; }).webViewVersion; }), function():Dynamic return cast '') : Dynamic));
      return cast out;
      return cast _Runtime.UNDEFINED;
