...
class SwfBitmap {
  ...
  public static function createSwfJpegAlphaBitmap(decoded:DecodedImage, payload:SwfJpegAlphaPayload):Null<Bitmap> {
    ...
    alpha = (cast decompress(_Runtime.field(payload, 'compressedAlphaBytes'), (cast pixelCount : Float), ({ final __callArgument2:Dynamic = (cast CompressionFramingValue : { var Raw:String; var Rfc1950:String; }).Rfc1950; __callArgument2; })) : Null<flighthq._internal._UInt8Array>);
  ...
  public static function createSwfLosslessBitmap(payload:flighthq._internal._UInt8Array, hasAlpha:Bool):Null<Bitmap> {
    ...
    if ((cast _Runtime.strictEquals(decompress, null) : Bool)) { return cast null; }
    pixels = (cast decompress(({ final __callArgument6:Dynamic = compressed; __callArgument6; }), (cast uncompressedLength : Float), ({ final __callArgument7:Dynamic = (cast CompressionFramingValue : { var Raw:String; var Rfc1950:String; }).Rfc1950; __callArgument7; })) : Null<flighthq._internal._UInt8Array>);
    ...
    unpacked = ((cast hasColorTable : Bool) ? (cast (cast SwfBitmap.unpackSwfColorMapped__swfBitmap(({ final __callArgument10:Dynamic = bitmap; __callArgument10; }), ({ final __callArgument11:Dynamic = pixels; __callArgument11; }), (cast width : Float), (cast height : Float), (cast colorCount : Float), (cast hasAlpha : Bool)) : Bool) : Dynamic) : (cast ((cast _Runtime.strictEquals(format, SwfBitmap.FORMAT_15_BIT__swfBitmap) : Bool) ? (cast (cast SwfBitmap.unpackSwf15Bit__swfBitmap(({ final __callArgument14:Dynamic = bitmap; __callArgument14; }), ({ final __callArgument15:Dynamic = pixels; __callArgument15; }), (cast width : Float), (cast height : Float)) : Bool) : Dynamic) : (cast (cast SwfBitmap.unpackSwf24Bit__swfBitmap(({ final __callArgument18:Dynamic = bitmap; __callArgument18; }), ({ final __callArgument19:Dynamic = pixels; __callArgument19; }), (cast width : Float), (cast height : Float), (cast hasAlpha : Bool)) : Bool) : Dynamic)) : Dynamic));
