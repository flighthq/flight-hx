...
class WgpuToonPrelude {
  public static function bindWgpuToonSurface(state:WgpuRenderState, pipeline:WgpuToonPipeline, materialKey:Dynamic, baseColor:Array<Float>, steps:Float, alphaCutoff:Float):Dynamic {
    ...
    if (_Runtime.truthy(_Runtime.strictEquals(binding, _Runtime.field(_Runtime, 'UNDEFINED')))) {
      ...
      var buffer:Dynamic = _Runtime.callProperty(_Runtime.field(state, 'device'), 'createBuffer', cast ([{ size: WgpuToonPrelude.TOON_UNIFORM_BYTES__wgpuToonPrelude, usage: (Std.int(_Runtime.field(_Runtime.globalValue('GPUBufferUsage'), 'UNIFORM')) | Std.int(_Runtime.field(_Runtime.globalValue('GPUBufferUsage'), 'COPY_DST'))) }] : Array<Dynamic>));
  ...
  public static final _scratch__wgpuToonPrelude:Dynamic = _Runtime.construct(_Runtime.globalValue('Float32Array'), [(WgpuToonPrelude.TOON_UNIFORM_BYTES__wgpuToonPrelude / 4.0)]);
}
