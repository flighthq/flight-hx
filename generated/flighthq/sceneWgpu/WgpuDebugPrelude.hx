...
class WgpuDebugPrelude {
  ...
  public static final _scratch__wgpuDebugPrelude:Dynamic = _Runtime.construct(_Runtime.globalValue('Float32Array'), [(WgpuDebugPrelude.DEBUG_UNIFORM_BYTES__wgpuDebugPrelude / 4.0)]);
}
