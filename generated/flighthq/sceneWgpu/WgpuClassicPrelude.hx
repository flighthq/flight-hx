...
class WgpuClassicPrelude {
  ...
  public static final _scratch__wgpuClassicPrelude:Dynamic = _Runtime.construct(_Runtime.globalValue('Float32Array'), [(WgpuClassicPrelude.CLASSIC_UNIFORM_BYTES__wgpuClassicPrelude / 4.0)]);
}
