...
class _WgpuMeshPipelineValues {
  ...
  public static function createWgpuMeshPipeline(state:WgpuRenderState, options:{ var doubleSided:Bool; var format:Dynamic; @:optional var iblBindGroupLayout:Dynamic; var materialBindGroupLayout:Dynamic; var module:Dynamic; @:optional var pbrSampleBindGroupLayout:Dynamic; @:optional var shadowBindGroupLayout:Dynamic; @:optional var topology:Dynamic; }):WgpuMeshPipeline {
    ...
    pipeline = _Runtime.callProperty(device, 'createRenderPipeline', cast ([{ layout: layout, vertex: { module: _Runtime.field(options, 'module'), entryPoint: 'vs_main', buffers: _WgpuMeshPipelineValues.VERTEX_BUFFER_LAYOUTS__wgpuMeshPipeline }, fragment: { module: _Runtime.field(options, 'module'), entryPoint: 'fs_main', targets: cast ([{ format: _Runtime.field(options, 'format') }] : Array<Dynamic>) }, primitive: { topology: _Runtime.coalesce(_Runtime.field(options, 'topology'), function():Dynamic return cast 'triangle-list'), frontFace: 'ccw', cullMode: _Runtime.select(_Runtime.field(options, 'doubleSided'), function():Dynamic return cast 'none', function():Dynamic return cast 'back') }, depthStencil: { format: _WgpuMeshPipelineValues.DEPTH_STENCIL_FORMAT__wgpuMeshPipeline, depthWriteEnabled: true, depthCompare: 'less' } }] : Array<Dynamic>));
  ...
  public static function ensureWgpuIblSampleBindGroup(state:WgpuRenderState):Dynamic {
    ...
    if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.field(scene, 'iblUniformBuffer'), null))) {
      _Runtime.setField(scene, 'iblUniformBuffer', _Runtime.callProperty(device, 'createBuffer', cast ([{ size: _WgpuMeshPipelineValues.IBL_SAMPLE_UNIFORM_BYTES__wgpuMeshPipeline, usage: (Std.int(_Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['GPUBufferUsage'] : Array<Dynamic>)), 'UNIFORM')) | Std.int(_Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['GPUBufferUsage'] : Array<Dynamic>)), 'COPY_DST'))) }] : Array<Dynamic>)));
    }
    ...
    if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.field(scene, 'iblDummyCubeView'), null))) {
      ...
      _Runtime.setField(scene, 'iblDummyLutTexture', _Runtime.callProperty(device, 'createTexture', cast ([{ size: cast ([1.0, 1.0, 1.0] : Array<Dynamic>), format: _WgpuMeshPipelineValues.IBL_DUMMY_FORMAT__wgpuMeshPipeline, usage: (Std.int(_Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['GPUTextureUsage'] : Array<Dynamic>)), 'TEXTURE_BINDING')) | Std.int(_Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['GPUTextureUsage'] : Array<Dynamic>)), 'COPY_DST'))) }] : Array<Dynamic>)));
    ...
    _Runtime.callProperty(_Runtime.field(device, 'queue'), 'writeBuffer', cast ([_Runtime.field(scene, 'iblUniformBuffer'), 0.0, _Runtime.field(u, 'buffer'), 0.0, _WgpuMeshPipelineValues.IBL_SAMPLE_UNIFORM_BYTES__wgpuMeshPipeline] : Array<Dynamic>));
  ...
  public static function ensureWgpuPbrSampleBindGroup(state:WgpuRenderState):Dynamic {
    ...
    _Runtime.callProperty(_Runtime.field(device, 'queue'), 'writeBuffer', cast ([_Runtime.field(scene, 'shadowUniformBuffer'), 0.0, _Runtime.field(s, 'buffer'), 0.0, _WgpuMeshPipelineValues.SHADOW_SAMPLE_UNIFORM_BYTES__wgpuMeshPipeline] : Array<Dynamic>));
    ibl = _Runtime.field(scene, 'ibl');
    u = _WgpuMeshPipelineValues._iblSampleScratch__wgpuMeshPipeline;
    if (_Runtime.truthy(!_Runtime.strictEquals(ibl, null))) {
      _Runtime.setIndex(u, 0.0, 1.0);
  ...
  public static function ensureWgpuPlaceholderTextureView(state:WgpuRenderState):Dynamic {
    ...
    if (_Runtime.truthy(_Runtime.strictEquals(view, null))) {
      ...
      _Runtime.callProperty(_Runtime.field(_Runtime.field(state, 'device'), 'queue'), 'writeTexture', cast ([{ texture: texture }, _WgpuMeshPipelineValues.WHITE_PIXEL__wgpuMeshPipeline, { bytesPerRow: 4.0 }, cast ([1.0, 1.0, 1.0] : Array<Dynamic>)] : Array<Dynamic>));
  ...
  public static function writeWgpuFrameUniform(state:WgpuRenderState, camera:Camera, lights:SceneLightBlock):Void {
    ...
    _Runtime.callProperty(_Runtime.field(_Runtime.field(state, 'device'), 'queue'), 'writeBuffer', cast ([_Runtime.field(scene, 'frameBuffer'), 0.0, _Runtime.field(f, 'buffer'), 0.0, _WgpuMeshPipelineValues.FRAME_UNIFORM_BYTES__wgpuMeshPipeline] : Array<Dynamic>));
  }
  ...
  public static final _frameScratch__wgpuMeshPipeline:Dynamic = _Runtime.construct(_Runtime.callProperty(_Runtime, 'globalValue', cast (['Float32Array'] : Array<Dynamic>)), [(_WgpuMeshPipelineValues.FRAME_UNIFORM_BYTES__wgpuMeshPipeline / 4.0)]);
  ...
  public static final _shadowSampleScratch__wgpuMeshPipeline:Dynamic = _Runtime.construct(_Runtime.callProperty(_Runtime, 'globalValue', cast (['Float32Array'] : Array<Dynamic>)), [(_WgpuMeshPipelineValues.SHADOW_SAMPLE_UNIFORM_BYTES__wgpuMeshPipeline / 4.0)]);

  public static final _iblSampleScratch__wgpuMeshPipeline:Dynamic = _Runtime.construct(_Runtime.callProperty(_Runtime, 'globalValue', cast (['Float32Array'] : Array<Dynamic>)), [(_WgpuMeshPipelineValues.IBL_SAMPLE_UNIFORM_BYTES__wgpuMeshPipeline / 4.0)]);
}
