...
class WgpuMatcapPrelude {
  ...
  public static final _scratch__wgpuMatcapPrelude:Dynamic = _Runtime.construct(_Runtime.globalValue('Float32Array'), [(WgpuMatcapPrelude.MATCAP_UNIFORM_BYTES__wgpuMatcapPrelude / 4.0)]);
}
