...
class BitmapText {
  ...
  public static function getBitmapTextQuadBatches(source:flighthq.types.BitmapText):Array<QuadBatch> {
  ...
  public static function setBitmapTextColor(target:flighthq.types.BitmapText, color:Float):Void {
