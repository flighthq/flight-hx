...
class RelativeTime {
  public static function formatRelativeTime(value:Float, unit:Dynamic, locale:LocaleInput, ?options:Dynamic):String {
    ...
    formatter = _Runtime.callValue(getCached, cast ([key, function() return _Runtime.construct(_Runtime.field(flighthq._internal._HostValueLut.get('Intl'), 'RelativeTimeFormat'), [(cast locale : Dynamic), options])] : Array<Dynamic>));
