...
class DisplayObject {
  ...
  public static function createDisplayObject(?obj:PartialNode<flighthq.types.DisplayObject>):flighthq.types.DisplayObject {
    return cast _Runtime.callValue(createDisplayObjectGeneric, cast ([DisplayObjectKind, obj] : Array<Dynamic>));
    return cast null;
  }

  public static function createDisplayObjectGeneric<R>(kind:Kind, ?obj:PartialNode<flighthq.types.DisplayObject>, ?createData:DisplayObjectDataFactory, ?createDisplayObjectRuntimeFactory:DisplayObjectRuntimeFactory<Dynamic>):flighthq.types.DisplayObject {
    var out:Dynamic = cast _Runtime.UNDEFINED;
    out = (cast _Runtime.callValue(createNode, cast ([kind, obj, createData, _Runtime.coalesce(createDisplayObjectRuntimeFactory, function():Dynamic return cast (cast (cast createDisplayObjectRuntime : Dynamic) : NodeRuntimeFactory<Dynamic>))] : Array<Dynamic>)) : flighthq.types.DisplayObject);
  ...
  public static function getDisplayObjectColorAdjustments(source:flighthq.types.DisplayObject):Null<Array<Adjustment>> {
    return cast _Runtime.field(_Runtime.callValue(getNodeRuntime, cast ([source] : Array<Dynamic>)), 'colorAdjustments');
    return cast null;
  }

  public static function getDisplayObjectRuntime(source:flighthq.types.DisplayObject):DisplayObjectRuntime {
  ...
  public static function setDisplayObjectClip(source:flighthq.types.DisplayObject, value:Null<ClipRegion>):Void {
    _Runtime.setField(source, 'clip', value);
    _Runtime.callValue(invalidateNodeAppearance, cast ([source] : Array<Dynamic>));
  }

  public static function setDisplayObjectColorAdjustments(source:flighthq.types.DisplayObject, value:Null<Array<Adjustment>>):Void {
    var runtime:Dynamic = cast _Runtime.UNDEFINED;
    runtime = (cast _Runtime.callValue(getNodeRuntime, cast ([source] : Array<Dynamic>)) : DisplayObjectRuntime);
