...
class Stage {
  public static function createStage(?obj:Dynamic):flighthq.types.Stage {
    ...
    stage = (cast _Runtime.callValue(createViewport, cast ([{ align: _Runtime.optionalField(obj, 'align'), root: root, scaleMode: _Runtime.optionalField(obj, 'scaleMode') }] : Array<Dynamic>)) : flighthq.types.Stage);
