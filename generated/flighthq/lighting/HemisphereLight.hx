...
class HemisphereLight {
  ...
  public static function createHemisphereLight(?options:HemisphereLightOptions):flighthq.types.HemisphereLight {
    return cast (cast createEntity(({ final __callArgument4:Dynamic = { groundColor: _Runtime.coalesce(({ final __structural1 = options; __structural1 == null ? _Runtime.UNDEFINED : (cast __structural1 : { @:optional var groundColor:Null<Float>; }).groundColor; }), function():Dynamic return cast 4294967295.0), intensity: _Runtime.coalesce(({ final __structural2 = options; __structural2 == null ? _Runtime.UNDEFINED : (cast __structural2 : { @:optional var intensity:Null<Float>; }).intensity; }), function():Dynamic return cast 1.0), kind: HemisphereLightKind, skyColor: _Runtime.coalesce(({ final __structural3 = options; __structural3 == null ? _Runtime.UNDEFINED : (cast __structural3 : { @:optional var skyColor:Null<Float>; }).skyColor; }), function():Dynamic return cast 4294967295.0) }; __callArgument4; })) : { >Entity, var groundColor:Float; var intensity:Float; var kind:String; var skyColor:Float; });
    return cast null;
  }
}
