...
class SpotLight {
  ...
  public static function createSpotLight(?options:SpotLightOptions):flighthq.types.SpotLight {
    ...
    position = ({ final __typedStruct8 = options; __typedStruct8 == null ? _Runtime.UNDEFINED : __typedStruct8.position; });
    direction = ({ final __typedStruct9 = options; __typedStruct9 == null ? _Runtime.UNDEFINED : __typedStruct9.direction; });
    light = (cast createEntity((cast { castsShadow: _Runtime.coalesce(({ final __typedStruct10 = options; __typedStruct10 == null ? _Runtime.UNDEFINED : __typedStruct10.castsShadow; }), function():Dynamic return cast false), color: _Runtime.coalesce(({ final __typedStruct11 = options; __typedStruct11 == null ? _Runtime.UNDEFINED : __typedStruct11.color; }), function():Dynamic return cast 4294967295.0), direction: _Runtime.select(direction, function():Dynamic return cast (cast cloneVector3(({ final __callArgument12:Dynamic = direction; __callArgument12; })) : Vector3), function():Dynamic return cast (cast createVector3(({ final __callArgument14:Dynamic = 0.0; __callArgument14; }), ({ final __callArgument15:Dynamic = -1.0; __callArgument15; }), ({ final __callArgument16:Dynamic = 0.0; __callArgument16; })) : Vector3)), innerConeCos: 1.0, intensity: _Runtime.coalesce(({ final __typedStruct20 = options; __typedStruct20 == null ? _Runtime.UNDEFINED : __typedStruct20.intensity; }), function():Dynamic return cast 1.0), kind: SpotLightKind, normalBias: _Runtime.coalesce(({ final __typedStruct21 = options; __typedStruct21 == null ? _Runtime.UNDEFINED : __typedStruct21.normalBias; }), function():Dynamic return cast 0.0), outerConeCos: 1.0, pcfRadius: _Runtime.coalesce(({ final __typedStruct22 = options; __typedStruct22 == null ? _Runtime.UNDEFINED : __typedStruct22.pcfRadius; }), function():Dynamic return cast 0.0), position: _Runtime.select(position, function():Dynamic return cast (cast cloneVector3(({ final __callArgument23:Dynamic = position; __callArgument23; })) : Vector3), function():Dynamic return cast (cast createVector3(({ final __callArgument25:Dynamic = 0.0; __callArgument25; }), ({ final __callArgument26:Dynamic = 0.0; __callArgument26; }), ({ final __callArgument27:Dynamic = 0.0; __callArgument27; })) : Vector3)), range: _Runtime.coalesce(({ final __typedStruct31 = options; __typedStruct31 == null ? _Runtime.UNDEFINED : __typedStruct31.range; }), function():Dynamic return cast -1.0), shadowBias: _Runtime.coalesce(({ final __typedStruct32 = options; __typedStruct32 == null ? _Runtime.UNDEFINED : __typedStruct32.shadowBias; }), function():Dynamic return cast 0.0) } : Dynamic)) : { >Entity, var castsShadow:Bool; var color:Float; var direction:Vector3; var innerConeCos:Float; var intensity:Float; var kind:String; var normalBias:Float; var outerConeCos:Float; var pcfRadius:Float; var position:Vector3; var range:Float; var shadowBias:Float; });
    setSpotLightCone(({ final __callArgument56:Dynamic = light; __callArgument56; }), (cast _Runtime.coalesce(({ final __typedStruct57 = options; __typedStruct57 == null ? _Runtime.UNDEFINED : __typedStruct57.innerConeDegrees; }), function():Dynamic return cast 0.0) : Float), (cast _Runtime.coalesce(({ final __typedStruct58 = options; __typedStruct58 == null ? _Runtime.UNDEFINED : __typedStruct58.outerConeDegrees; }), function():Dynamic return cast 45.0) : Float));
    return cast light;
    return cast null;
  }
  ...
  public static function setSpotLightDirection(out:flighthq.types.SpotLight, x:Float, y:Float, z:Float):Void {
    ...
    if ((cast ((cast len : Float) > (cast 0.0 : Float)) : Bool)) {
      setVector3(({ final __callArgument62:Dynamic = (cast out : flighthq.types.SpotLight).direction; __callArgument62; }), (cast (lx / len) : Float), (cast (ly / len) : Float), (cast (lz / len) : Float));
    }
  }
  ...
  public static function setSpotLightTarget(out:flighthq.types.SpotLight, targetX:Float, targetY:Float, targetZ:Float):Void {
    ...
    if ((cast ((cast len : Float) > (cast 0.0 : Float)) : Bool)) {
      setVector3(({ final __callArgument64:Dynamic = (cast out : flighthq.types.SpotLight).direction; __callArgument64; }), (cast (dx / len) : Float), (cast (dy / len) : Float), (cast (dz / len) : Float));
    }
  }
}
