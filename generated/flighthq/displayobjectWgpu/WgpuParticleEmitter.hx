...
@:expose("flighthq.displayobjectWgpu.WgpuParticleEmitter")
class WgpuParticleEmitter {
  public static final INSTANCE_FLOATS__wgpuParticleEmitter:Dynamic = 14.0;

  public static final INSTANCE_STRIDE__wgpuParticleEmitter:Dynamic = (WgpuParticleEmitter.INSTANCE_FLOATS__wgpuParticleEmitter * 4.0);
  ...
  public static function ensureParticleResources__wgpuParticleEmitter(state:WgpuRenderState):WgpuParticleResources__wgpuParticleEmitter {
    ...
    module = _Runtime.callProperty(device, 'createShaderModule', cast ([{ code: WgpuParticleEmitter.PARTICLE_SHADER_SRC__wgpuParticleEmitter }] : Array<Dynamic>));
  ...
  public static function drawWgpuParticleEmitter(state:WgpuRenderState, renderProxy:RenderProxy2D):Void {
    ...
    _Runtime.callProperty(_Runtime.field(device, 'queue'), 'writeBuffer', cast ([_Runtime.field(runtime, 'particleInstanceBuffer'), 0.0, _Runtime.field(instanceData, 'buffer'), 0.0, (drawCount * WgpuParticleEmitter.INSTANCE_STRIDE__wgpuParticleEmitter)] : Array<Dynamic>));
    ...
    _Runtime.callProperty(pass, 'setPipeline', cast ([_Runtime.callValue(WgpuParticleEmitter.getParticlePipeline__wgpuParticleEmitter, cast ([state, resources] : Array<Dynamic>))] : Array<Dynamic>));
