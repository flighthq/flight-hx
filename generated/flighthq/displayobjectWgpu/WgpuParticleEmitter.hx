...
class WgpuParticleEmitter {
  ...
  public static final _particleResources__wgpuParticleEmitter:Dynamic = _Runtime.construct(_Runtime.globalValue('WeakMap'), []);
