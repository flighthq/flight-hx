...
class WgpuCache {
  ...
  public static function refreshWgpuRenderCache(cacheState:WgpuRenderState, cache:RenderCache, source:DisplayObject, ?options:RenderCacheRefreshOptions):Bool {
    ...
    screenState = _Runtime.coalesce(((cast WgpuCache._cacheStateScreen__wgpuCache : flighthq._internal._WeakMap).get(cacheState)), function():Dynamic return cast cacheState);
