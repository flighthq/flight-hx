...
package flighthq.displayobjectWgpu._internal;
...
@:expose("flighthq.displayobjectWgpu._internal._WgpuShapeMeshValues")
class _WgpuShapeMeshValues {
  public static function drawWgpuShapeMeshes(state:Dynamic, renderProxy:RenderProxy2D, meshes:Array<WgpuShapeMesh>, buffers:WgpuShapeMeshBuffers):Void {
    ...
    pipelineEntry = _Runtime.callValue(_WgpuShapeMeshValues.ensureShapeMeshPipeline__wgpuShapeMesh, cast ([state] : Array<Dynamic>));
    device = _Runtime.field(state, 'device');
    queue = _Runtime.field(device, 'queue');
    uniform = _Runtime.callValue(_WgpuShapeMeshValues.ensureShapeMeshUniform__wgpuShapeMesh, cast ([state, pipelineEntry, buffers] : Array<Dynamic>));
    _Runtime.callValue(_WgpuShapeMeshValues.shapeMeshMatrix__wgpuShapeMesh, cast ([state, renderProxy] : Array<Dynamic>));
    ...
    nodeAlpha = _Runtime.field(renderProxy, 'alpha');
    {
      ...
      while (_Runtime.truthy(_Runtime.compare(i, _Runtime.field(meshes, 'length'), '<'))) {
        ...
        var vertexBuffer:Dynamic = _Runtime.callValue(_WgpuShapeMeshValues.ensureShapeMeshVertexBuffer__wgpuShapeMesh, cast ([state, buffers, _Runtime.field(_Runtime.field(mesh, 'vertices'), 'byteLength')] : Array<Dynamic>));
        var indexBuffer:Dynamic = _Runtime.callValue(_WgpuShapeMeshValues.ensureShapeMeshIndexBuffer__wgpuShapeMesh, cast ([state, buffers, _Runtime.field(_Runtime.field(mesh, 'indices'), 'byteLength')] : Array<Dynamic>));
        ...
        _Runtime.callValue(_WgpuShapeMeshValues.writeShapeMeshIndices__wgpuShapeMesh, cast ([queue, indexBuffer, _Runtime.field(mesh, 'indices')] : Array<Dynamic>));
  ...
  public static final SHAPE_MESH_UNIFORM_FLOATS__wgpuShapeMesh:Dynamic = (_WgpuShapeMeshValues.SHAPE_MESH_UNIFORM_BYTES__wgpuShapeMesh / 4.0);

  public static function ensureShapeMeshIndexBuffer__wgpuShapeMesh(state:Dynamic, buffers:WgpuShapeMeshBuffers, byteLength:Float):Dynamic {
  ...
  public static function ensureShapeMeshUniform__wgpuShapeMesh(state:Dynamic, pipelineEntry:WgpuShapeMeshPipeline, buffers:WgpuShapeMeshBuffers):flighthq._internal._Float32Array {
    if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.field(buffers, 'uniformBuffer'), null))) {
      _Runtime.setField(buffers, 'uniformBuffer', _Runtime.callProperty(_Runtime.field(state, 'device'), 'createBuffer', cast ([{ size: _WgpuShapeMeshValues.SHAPE_MESH_UNIFORM_BYTES__wgpuShapeMesh, usage: (Std.int(_Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['GPUBufferUsage'] : Array<Dynamic>)), 'UNIFORM')) | Std.int(_Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['GPUBufferUsage'] : Array<Dynamic>)), 'COPY_DST'))) }] : Array<Dynamic>)));
    ...
    return cast _WgpuShapeMeshValues._shapeMeshUniformScratch__wgpuShapeMesh;
    return cast null;
  }

  public static function ensureShapeMeshPipeline__wgpuShapeMesh(state:Dynamic):WgpuShapeMeshPipeline {
    var runtime:Dynamic = cast _Runtime.UNDEFINED;
    ...
    device = _Runtime.field(state, 'device');
    module = _Runtime.callProperty(device, 'createShaderModule', cast ([{ code: _WgpuShapeMeshValues.SHAPE_MESH_WGSL__wgpuShapeMesh }] : Array<Dynamic>));
  ...
  public static function ensureShapeMeshVertexBuffer__wgpuShapeMesh(state:Dynamic, buffers:WgpuShapeMeshBuffers, byteLength:Float):Dynamic {
    var size:Dynamic = cast _Runtime.UNDEFINED;
  ...
  public static function shapeMeshMatrix__wgpuShapeMesh(state:Dynamic, renderProxy:RenderProxy2D):flighthq._internal._Float32Array {
    var runtime:Dynamic = cast _Runtime.UNDEFINED;
  ...
  public static function writeShapeMeshIndices__wgpuShapeMesh(queue:Dynamic, indexBuffer:Dynamic, indices:flighthq._internal._UInt16Array):Void {
    ...
    if (_Runtime.truthy(_Runtime.compare(_Runtime.field(_WgpuShapeMeshValues._shapeMeshIndexScratch__wgpuShapeMesh, 'length'), wordCount, '<'))) { (_WgpuShapeMeshValues._shapeMeshIndexScratch__wgpuShapeMesh = cast (new flighthq._internal._UInt16Array(wordCount) : Dynamic)); }
    _Runtime.callProperty(_WgpuShapeMeshValues._shapeMeshIndexScratch__wgpuShapeMesh, 'set', cast ([indices] : Array<Dynamic>));
    _Runtime.callProperty(queue, 'writeBuffer', cast ([indexBuffer, 0.0, _Runtime.field(_WgpuShapeMeshValues._shapeMeshIndexScratch__wgpuShapeMesh, 'buffer'), 0.0, paddedBytes] : Array<Dynamic>));
  }

  public static final _shapeMeshUniformScratch__wgpuShapeMesh:Dynamic = _Runtime.construct(_Runtime.callProperty(_Runtime, 'globalValue', cast (['Float32Array'] : Array<Dynamic>)), [_WgpuShapeMeshValues.SHAPE_MESH_UNIFORM_FLOATS__wgpuShapeMesh]);
