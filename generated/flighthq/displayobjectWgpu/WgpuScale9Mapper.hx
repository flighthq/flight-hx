...
@:expose("flighthq.displayobjectWgpu.WgpuScale9Mapper")
class WgpuScale9Mapper {
  public static function buildWgpuScale9Mapper(bounds:RectangleLike, scale9Grid:RectangleLike, scaleX:Float, scaleY:Float):Null<Scale9Mapper> {
    ...
    return cast { mapX: function(x:Float) return _Runtime.callValue(WgpuScale9Mapper.toScale9Position__wgpuScale9Mapper, cast ([x, gx, gw, bw, scaleX] : Array<Dynamic>)), mapY: function(y:Float) return _Runtime.callValue(WgpuScale9Mapper.toScale9Position__wgpuScale9Mapper, cast ([y, gy, gh, bh, scaleY] : Array<Dynamic>)) };
    return cast null;
  }
