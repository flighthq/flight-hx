...
class ClipRegion {
  ...
  public static function createClipRegionFromCircle(x:Float, y:Float, radius:Float, tolerance:Float = 0.25):flighthq.types.ClipRegion {
    ...
    ClipRegion.appendCircleToPath__clipRegion(({ final __callArgument18:Dynamic = path; __callArgument18; }), (cast x : Float), (cast y : Float), (cast radius : Float));
    return cast (cast createClipRegionFromPath(({ final __callArgument20:Dynamic = path; __callArgument20; }), (cast tolerance : Float)) : flighthq.types.ClipRegion);
    return cast null;
  }
  ...
  public static function createClipRegionFromContours(contours:Array<Array<Float>>, winding:PathWinding):flighthq.types.ClipRegion {
    ...
    ClipRegion.setRectangleToContoursBounds__clipRegion(({ final __callArgument22:Dynamic = rect; __callArgument22; }), ({ final __callArgument23:Dynamic = contours; __callArgument23; }));
  ...
  public static function createClipRegionFromEllipse(rectangle:RectangleLike, tolerance:Float = 0.25):flighthq.types.ClipRegion {
    ...
    ClipRegion.appendEllipseToPath__clipRegion(({ final __callArgument28:Dynamic = path; __callArgument28; }), (cast rectangle.x : Float), (cast rectangle.y : Float), (cast rectangle.width : Float), (cast rectangle.height : Float));
    return cast (cast createClipRegionFromPath(({ final __callArgument30:Dynamic = path; __callArgument30; }), (cast tolerance : Float)) : flighthq.types.ClipRegion);
    return cast null;
  }
  ...
  public static function createClipRegionFromPath(path:Path, tolerance:Float = 0.25):flighthq.types.ClipRegion {
    ...
    rect = (cast (#if js _Runtime.callValue(createRectangle, cast ([] : Array<Dynamic>)) #else createRectangle(#if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end, #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end, #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end, #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end) : Rectangle);
    ClipRegion.setRectangleToContoursBounds__clipRegion(({ final __callArgument34:Dynamic = rect; __callArgument34; }), ({ final __callArgument35:Dynamic = contours; __callArgument35; }));
  ...
  public static function createClipRegionFromRoundedRectangle(rectangle:RectangleLike, radius:Float, tolerance:Float = 0.25):flighthq.types.ClipRegion {
    var path:Path = cast _Runtime.UNDEFINED;
    if ((cast ((cast radius : Float) <= (cast 0.0 : Float)) : Bool)) { return cast (cast createClipRegionFromRectangle(({ final __callArgument40:Dynamic = rectangle; __callArgument40; })) : flighthq.types.ClipRegion); }
    path = (cast createPath(({ final __callArgument42:Dynamic = 'nonZero'; __callArgument42; })) : Path);
    ClipRegion.appendRoundedRectToPath__clipRegion(({ final __callArgument44:Dynamic = path; __callArgument44; }), (cast rectangle.x : Float), (cast rectangle.y : Float), (cast rectangle.width : Float), (cast rectangle.height : Float), (cast radius : Float));
    return cast (cast createClipRegionFromPath(({ final __callArgument46:Dynamic = path; __callArgument46; }), (cast tolerance : Float)) : flighthq.types.ClipRegion);
    return cast null;
  }
  ...
  public static function releaseClipRegion(clip:flighthq.types.ClipRegion):Void {
    if ((cast ((cast !_Runtime.strictEquals(ClipRegion._releaseGuard__clipRegion, null) : Bool) && (cast _Runtime.includes(ClipRegion.clipRegionPool__clipRegion, clip) : Bool)) : Bool)) { (cast ClipRegion._releaseGuard__clipRegion : flighthq.types.ClipRegion->Void)(({ final __callArgument58:Dynamic = clip; __callArgument58; })); }
  ...
  public static function transformClipRegion(out:flighthq.types.ClipRegion, clip:flighthq.types.ClipRegion, matrix:MatrixLike):Void {
    ...
    if ((cast _Runtime.strictEquals(inContours, null) : Bool)) {
      ...
      if ((cast axisAligned : Bool)) {
        ...
        (out.winding = cast ('nonZero' : PathWinding));
        ClipRegion.setRectangleToContoursBounds__clipRegion(({ final __callArgument70:Dynamic = out.rect; __callArgument70; }), ({ final __callArgument71:Dynamic = cast ([quad] : Array<Dynamic>); __callArgument71; }));
      }
    } else {
      ...
      (out.winding = cast (inWinding : PathWinding));
      ClipRegion.setRectangleToContoursBounds__clipRegion(({ final __callArgument74:Dynamic = out.rect; __callArgument74; }), ({ final __callArgument75:Dynamic = newContours; __callArgument75; }));
    }
    (out.version = cast (_Runtime.unsignedShiftRight(_Runtime.toInt32((out.version + 1.0)), 0) : Float));
  }
