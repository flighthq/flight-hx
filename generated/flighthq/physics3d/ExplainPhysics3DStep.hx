...
class ExplainPhysics3DStep {
  public static function explainPhysics3DStep(world:Physics3DWorld, dt:Float):Physics3DStepExplanation {
    ...
    colliderStateValid = (cast isPhysics3DColliderStateValid(({ final __callArgument2:Dynamic = world; __callArgument2; })) : Bool);
    contactStateValid = (cast isPhysics3DContactStateValid(({ final __callArgument4:Dynamic = world; __callArgument4; })) : Bool);
    gravityValid = (cast isPhysics3DGravityValid(({ final __callArgument6:Dynamic = world; __callArgument6; })) : Bool);
    jointStateValid = (cast isPhysics3DJointStateValid(({ final __callArgument8:Dynamic = world; __callArgument8; })) : Bool);
    solverConfigValid = (cast isPhysics3DSolverConfigValid(({ final __callArgument10:Dynamic = config; __callArgument10; })) : Bool);
    substepsValid = (cast isPhysics3DSubstepsValid(({ final __callArgument12:Dynamic = config; __callArgument12; })) : Bool);
    timestepValid = (cast isPhysics3DTimestepValid((cast dt : Float)) : Bool);
    velocityIterationsValid = (cast isPhysics3DVelocityIterationsValid(({ final __callArgument14:Dynamic = config; __callArgument14; })) : Bool);
    positionIterationsValid = (cast isPhysics3DPositionIterationsValid(({ final __callArgument16:Dynamic = config; __callArgument16; })) : Bool);
