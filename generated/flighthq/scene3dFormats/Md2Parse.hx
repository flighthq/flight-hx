...
class Md2Parse {
  ...
  public static function parseMd2(bytes:flighthq._internal._UInt8Array, ?diagnostics:Array<ImportDiagnostic>):Scene3DDocument {
    ...
    if ((cast !_Runtime.strictEquals(version, MD2_VERSION) : Bool)) {
      reportImportDiagnostic(({ final __callArgument20:Dynamic = diagnostics; __callArgument20; }), ({ final __callArgument21:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument21; }), (cast 'md2.unsupported-version' : String), (cast 'parseMd2' : String), ({ final __callArgument22:Dynamic = { version: version }; __callArgument22; }));
      return cast (cast Md2Parse.emptyMd2Document__md2Parse() : Scene3DDocument);
    }
    ...
    if ((cast ((cast numFrames : Float) < (cast 1.0 : Float)) : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument28:Dynamic = diagnostics; __callArgument28; }), ({ final __callArgument29:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument29; }), (cast 'md2.no-frames' : String), (cast 'parseMd2' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument26:Dynamic = diagnostics; __callArgument26; }), ({ final __callArgument27:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument27; }), (cast 'md2.no-frames' : String), (cast 'parseMd2' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
      return cast (cast Md2Parse.emptyMd2Document__md2Parse() : Scene3DDocument);
    }
    if ((cast ((cast numTriangles : Float) < (cast 1.0 : Float)) : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument32:Dynamic = diagnostics; __callArgument32; }), ({ final __callArgument33:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument33; }), (cast 'md2.no-triangles' : String), (cast 'parseMd2' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument30:Dynamic = diagnostics; __callArgument30; }), ({ final __callArgument31:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument31; }), (cast 'md2.no-triangles' : String), (cast 'parseMd2' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
      return cast (cast Md2Parse.emptyMd2Document__md2Parse() : Scene3DDocument);
    }
    ...
    if ((cast ((cast ((cast declaredEnd : Float) > (cast 0.0 : Float)) : Bool) && (cast !_Runtime.strictEquals(declaredEnd, _Runtime.field(bytes, 'length')) : Bool)) : Bool)) {
      reportImportDiagnostic(({ final __callArgument52:Dynamic = diagnostics; __callArgument52; }), ({ final __callArgument53:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument53; }), (cast 'md2.file-size-mismatch' : String), (cast 'parseMd2' : String), ({ final __callArgument54:Dynamic = { actual: _Runtime.field(bytes, 'length'), expected: declaredEnd }; __callArgument54; }));
    }
    Md2Parse.reportMd2SectionOverlap__md2Parse(({ final __callArgument58:Dynamic = diagnostics; __callArgument58; }), ({ final __callArgument59:Dynamic = cast ([{ end: skinsEnd, name: 0.0, start: offSkins }, { end: texCoordsEnd, name: 1.0, start: offTexCoords }, { end: trianglesEnd, name: 2.0, start: offTriangles }, { end: allFramesEnd, name: 3.0, start: offFrames }] : Array<Dynamic>); __callArgument59; }));
    ...
    frames = (cast Md2Parse.readMd2Frames__md2Parse(({ final __callArgument62:Dynamic = bytes; __callArgument62; }), (cast view : flighthq._internal._Any), (cast offFrames : Float), (cast numFrames : Float), (cast numVertices : Float), (cast frameStride : Float), ({ final __callArgument63:Dynamic = diagnostics; __callArgument63; })) : Array<Md2Frame__md2Parse>);
    ...
    if ((cast ((cast outOfRangeVertexCorners : Float) > (cast 0.0 : Float)) : Bool)) {
      reportImportDiagnostic(({ final __callArgument66:Dynamic = diagnostics; __callArgument66; }), ({ final __callArgument67:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Drop; __callArgument67; }), (cast 'md2.triangle-vertex-index-out-of-range' : String), (cast 'parseMd2' : String), ({ final __callArgument68:Dynamic = { corners: outOfRangeVertexCorners }; __callArgument68; }));
    }
    if ((cast ((cast outOfRangeTexCoordCorners : Float) > (cast 0.0 : Float)) : Bool)) {
      reportImportDiagnostic(({ final __callArgument72:Dynamic = diagnostics; __callArgument72; }), ({ final __callArgument73:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Drop; __callArgument73; }), (cast 'md2.triangle-texcoord-index-out-of-range' : String), (cast 'parseMd2' : String), ({ final __callArgument74:Dynamic = { corners: outOfRangeTexCoordCorners }; __callArgument74; }));
    }
    if ((cast _Runtime.strictEquals(_Runtime.field(indices, 'length'), 0.0) : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument80:Dynamic = diagnostics; __callArgument80; }), ({ final __callArgument81:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument81; }), (cast 'md2.no-valid-triangles' : String), (cast 'parseMd2' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument78:Dynamic = diagnostics; __callArgument78; }), ({ final __callArgument79:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument79; }), (cast 'md2.no-valid-triangles' : String), (cast 'parseMd2' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
      return cast (cast Md2Parse.emptyMd2Document__md2Parse() : Scene3DDocument);
    }
    ...
    firstEmptySkin = -1.0;
    {
      ...
      while ((cast ((cast s : Float) < (cast numSkins : Float)) : Bool)) {
        ...
        if ((cast ((cast (skinOffset + MD2_SKIN_SIZE) : Float) > (cast _Runtime.field(bytes, 'length') : Float)) : Bool)) {
          reportImportDiagnostic(({ final __callArgument82:Dynamic = diagnostics; __callArgument82; }), ({ final __callArgument83:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Drop; __callArgument83; }), (cast 'md2.skin-record-truncated' : String), (cast 'parseMd2' : String), ({ final __callArgument84:Dynamic = { skin: s }; __callArgument84; }));
          break;
        }
        var skinName:String = (cast Md2Parse.readMd2SkinName__md2Parse(({ final __callArgument88:Dynamic = bytes; __callArgument88; }), (cast skinOffset : Float)) : String);
        ...
        var material:Material = (cast (cast createBlinnPhongMaterial((cast { diffuseMap: (cast createExternalTextureRef((cast skinName : String), ({ final __callArgument90:Dynamic = null; __callArgument90; }), (cast document.resources : Dynamic)) : Texture) } : Dynamic)) : flighthq._internal._Any) : Material);
    ...
    if ((cast ((cast emptySkinCount : Float) > (cast 0.0 : Float)) : Bool)) {
      reportImportDiagnostic(({ final __callArgument94:Dynamic = diagnostics; __callArgument94; }), ({ final __callArgument95:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Drop; __callArgument95; }), (cast 'md2.skin-empty-path' : String), (cast 'parseMd2' : String), ({ final __callArgument96:Dynamic = { count: emptySkinCount, firstSkin: firstEmptySkin }; __callArgument96; }));
    }
    reverseTriangleWinding(({ final __callArgument100:Dynamic = indices; __callArgument100; }));
    vertices = new flighthq._internal._Float32Array(interleavedVertices);
    indexArray = new flighthq._internal._UInt32Array(indices);
    geometry = (cast createMeshGeometry(({ final __callArgument102:Dynamic = { indices: indexArray, layout: CANONICAL_LAYOUT, vertices: vertices }; __callArgument102; })) : MeshGeometry);
    morph = (cast Md2Parse.buildMd2Morph__md2Parse((cast frames : Dynamic), ({ final __callArgument104:Dynamic = sourceVertexIndices; __callArgument104; })) : Null<MeshMorph>);
    ...
    _Runtime.callProperty(document.animations, 'push', _Runtime.concatArrays([_Runtime.toArray((cast Md2Parse.buildMd2MorphAnimations__md2Parse((cast frames : Dynamic), ({ final __callArgument106:Dynamic = morph; __callArgument106; })) : Array<Scene3DDocumentAnimation>))]));
  ...
  public static function readMd2Frames__md2Parse(bytes:flighthq._internal._UInt8Array, view:Dynamic, offFrames:Float, numFrames:Float, numVertices:Float, frameStride:Float, ?diagnostics:Array<ImportDiagnostic>):Array<Md2Frame__md2Parse> {
    ...
    outOfRangeNormals = _Runtime.select(diagnostics, function():Dynamic return cast _Runtime.construct(flighthq._internal._HostValueLut.get('Set'), []), function():Dynamic return cast null);
    {
      ...
      while ((cast ((cast f : Float) < (cast numFrames : Float)) : Bool)) {
        ...
        var name:String = (cast Md2Parse.readMd2FrameName__md2Parse(({ final __callArgument108:Dynamic = bytes; __callArgument108; }), (cast (frameBase + 24.0) : Float)) : String);
    ...
    if ((cast ((cast !_Runtime.strictEquals(outOfRangeNormals, null) : Bool) && (cast ((cast (cast outOfRangeNormals : flighthq._internal._Set<Float>).size : Float) > (cast 0.0 : Float)) : Bool)) : Bool)) {
      reportImportDiagnostic(({ final __callArgument110:Dynamic = diagnostics; __callArgument110; }), ({ final __callArgument111:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument111; }), (cast 'md2.normal-index-out-of-range' : String), (cast 'readMd2Frames' : String), ({ final __callArgument112:Dynamic = { distinctIndices: (cast outOfRangeNormals : flighthq._internal._Set<Float>).size, firstIndex: _Runtime.callProperty(HxMath, 'min', _Runtime.concatArrays([_Runtime.toArray(outOfRangeNormals)])) }; __callArgument112; }));
    }
    return cast frames;
    return cast null;
  }
  ...
  public static function buildMd2MorphAnimations__md2Parse(frames:Array<Md2Frame__md2Parse>, morph:Null<MeshMorph>):Array<Scene3DDocumentAnimation> {
    ...
    runStart = 0.0;
    {
      ...
      while ((cast ((cast k : Float) <= (cast _Runtime.field(frames, 'length') : Float)) : Bool)) {
        ...
        _Runtime.callProperty(animations, 'push', cast ([(cast Md2Parse.buildMd2ActionClip__md2Parse((cast runAction : String), (cast runStart : Float), (cast (k - 1.0) : Float), (cast targetCount : Float), ({ final __callArgument116:Dynamic = usedNames; __callArgument116; })) : Scene3DDocumentAnimation)] : Array<Dynamic>));
