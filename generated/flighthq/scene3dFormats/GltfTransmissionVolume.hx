  ...
  public static final GltfVolumeExtensionHandler:GltfExtensionHandler = (cast { apply: function(context:GltfExtensionContext):Void {
    ...
    materials = _Runtime.coalesce((cast _Runtime.field(context, 'source') : { @:optional var materials:Null<Array<GltfMaterial>>; }).materials, function():Dynamic return cast cast ([] : Array<Dynamic>));
    {
      ...
      while ((cast ((cast i : Float) < (cast _Runtime.field(materials, 'length') : Float)) : Bool)) {
        ...
        ((cast target : TransmissionVolumePbrExtension).attenuationColor = (cast packLinearToColor(({ final __callArgument4:Dynamic = cast ([_Runtime.coalesce(flighthq._internal._StaticIndex.readFloatArrayTyped((cast attenuation : Array<Float>), (cast 0.0 : Float)), function():Dynamic return cast 1.0), _Runtime.coalesce(flighthq._internal._StaticIndex.readFloatArrayTyped((cast attenuation : Array<Float>), (cast 1.0 : Float)), function():Dynamic return cast 1.0), _Runtime.coalesce(flighthq._internal._StaticIndex.readFloatArrayTyped((cast attenuation : Array<Float>), (cast 2.0 : Float)), function():Dynamic return cast 1.0), 1.0] : Array<Dynamic>); __callArgument4; })) : Float));
