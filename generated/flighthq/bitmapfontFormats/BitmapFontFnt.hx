...
class BitmapFontFnt {
  public static function formatBitmapFontFnt(font:BitmapFont):String {
    ...
    base = metrics.ascent;
    primaryTexture = ({ final __typedStruct2 = flighthq._internal._StaticIndex.readArray(font.pages, 0.0); __typedStruct2 == null ? _Runtime.UNDEFINED : (cast __typedStruct2 : { var texture:Null<Texture2D>; }).texture; });
    ...
    for (key in _Runtime.iterable(kernKeys)) {
      ...
      (cast unpackBitmapFontKerningKey((cast key : Float), ({ final __callArgument8:Dynamic = BitmapFontFnt._kerningPair__bitmapFontFnt; __callArgument8; })) : BitmapFontKerningPair);
  ...
  public static function parseBitmapFontFnt(text:String, ?options:BitmapFontParseOptions, ?diagnostics:Array<ImportDiagnostic>):Null<BitmapFont> {
    ...
    record = (cast BitmapFontFnt.parseBitmapFontFntRecord__bitmapFontFnt((cast text : String), ({ final __callArgument10:Dynamic = diagnostics; __callArgument10; })) : Null<BitmapFontRecord>);
  ...
  public static function parseBitmapFontFntRecord__bitmapFontFnt(text:String, diagnostics:Null<Array<ImportDiagnostic>>):Null<BitmapFontRecord> {
    ...
    for (rawLine in _Runtime.iterable(_Runtime.callProperty(text, 'split', cast ([_Runtime.regexp('\\r\\n?|\\n', '')] : Array<Dynamic>)))) {
      ...
      if ((cast _Runtime.strictEquals(tag, 'common') : Bool)) {
        (lineHeight = cast ((cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument18:Dynamic = (cast fields : { var lineHeight:String; }).lineHeight; __callArgument18; })) : Null<Float>) : Dynamic));
        (base = cast ((cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument20:Dynamic = (cast fields : { var base:String; }).base; __callArgument20; })) : Null<Float>) : Dynamic));
      } else { if ((cast _Runtime.strictEquals(tag, 'page') : Bool)) {
        var id:Null<Float> = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument22:Dynamic = (cast fields : { var id:String; }).id; __callArgument22; })) : Null<Float>);
        ...
        var char:Null<BitmapFontCharRecord> = (cast BitmapFontFnt.readFntChar__bitmapFontFnt(({ final __callArgument24:Dynamic = fields; __callArgument24; })) : Null<BitmapFontCharRecord>);
        ...
        var kerning:Null<BitmapFontKerningRecord> = (cast BitmapFontFnt.readFntKerning__bitmapFontFnt(({ final __callArgument26:Dynamic = fields; __callArgument26; })) : Null<BitmapFontKerningRecord>);
  ...
  public static function readFntChar__bitmapFontFnt(fields:flighthq._internal._Record<String, String>):Null<BitmapFontCharRecord> {
    ...
    id = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument30:Dynamic = (cast fields : { var id:String; }).id; __callArgument30; })) : Null<Float>);
    x = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument32:Dynamic = (cast fields : { var x:String; }).x; __callArgument32; })) : Null<Float>);
    y = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument34:Dynamic = (cast fields : { var y:String; }).y; __callArgument34; })) : Null<Float>);
    width = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument36:Dynamic = (cast fields : { var width:String; }).width; __callArgument36; })) : Null<Float>);
    height = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument38:Dynamic = (cast fields : { var height:String; }).height; __callArgument38; })) : Null<Float>);
    xoffset = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument40:Dynamic = (cast fields : { var xoffset:String; }).xoffset; __callArgument40; })) : Null<Float>);
    yoffset = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument42:Dynamic = (cast fields : { var yoffset:String; }).yoffset; __callArgument42; })) : Null<Float>);
    xadvance = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument44:Dynamic = (cast fields : { var xadvance:String; }).xadvance; __callArgument44; })) : Null<Float>);
    ...
    return cast { height: height, id: id, page: _Runtime.coalesce((cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument46:Dynamic = (cast fields : { var page:String; }).page; __callArgument46; })) : Null<Float>), function():Dynamic return cast 0.0), width: width, x: x, xadvance: xadvance, xoffset: xoffset, y: y, yoffset: yoffset };
    return cast null;
  }
  ...
  public static function readFntKerning__bitmapFontFnt(fields:flighthq._internal._Record<String, String>):Null<BitmapFontKerningRecord> {
    ...
    first = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument48:Dynamic = (cast fields : { var first:String; }).first; __callArgument48; })) : Null<Float>);
    second = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument50:Dynamic = (cast fields : { var second:String; }).second; __callArgument50; })) : Null<Float>);
    amount = (cast BitmapFontFnt.readFntNumber__bitmapFontFnt(({ final __callArgument52:Dynamic = (cast fields : { var amount:String; }).amount; __callArgument52; })) : Null<Float>);
