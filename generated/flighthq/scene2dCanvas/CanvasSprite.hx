...
class CanvasSprite {
  ...
  public static function drawCanvasSprite(state:CanvasRenderState, sprite:RenderProxy2D):Void {
    ...
    drawable = (cast resolveCanvasTexture((cast getCanvasRenderStateTextureResolvers(({ final __callArgument4:Dynamic = state; __callArgument4; })) : CanvasTextureResolvers), ({ final __callArgument6:Dynamic = texture; __callArgument6; })) : Null<flighthq._internal._Union2<flighthq._internal._Union2<flighthq._internal._Union2<flighthq._internal._Union2<flighthq._internal._Union2<flighthq._internal._Union2<flighthq._internal.dom.HTMLVideoElement, flighthq._internal.dom.HTMLImageElement>, flighthq._internal.dom.SVGImageElement>, flighthq._internal.dom.HTMLCanvasElement>, flighthq._internal.dom.ImageBitmap>, flighthq._internal.dom.OffscreenCanvas>, flighthq._internal.dom.VideoFrame>>);
    if ((cast _Runtime.strictEquals(drawable, null) : Bool)) { return; }
    textureWidth = (cast getTextureWidth(({ final __callArgument10:Dynamic = texture; __callArgument10; })) : Float);
    textureHeight = (cast getTextureHeight(({ final __callArgument12:Dynamic = texture; __callArgument12; })) : Float);
    ...
    setCanvasTransform(({ final __callArgument14:Dynamic = state; __callArgument14; }), ({ final __callArgument15:Dynamic = context; __callArgument15; }), (cast sprite : RenderProxy2D).transform2D);
