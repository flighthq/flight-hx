...
class CanvasBitmapTextureResolver {
  ...
  public static function resolveCanvasBitmapTexture__canvasBitmapTextureResolver(resolvers:CanvasTextureResolvers, texture:Texture):Null<flighthq._internal.dom.CanvasImageSource> {
    ...
    cache = ({ final __nullishOwner4 = resolvers; final __nullishValue5:Null<flighthq._internal._WeakMap<Bitmap, { var element:flighthq._internal.dom.HTMLCanvasElement; var version:Float; }>> = cast (cast __nullishOwner4 : CanvasTextureResolvers).bitmapElementCache; __nullishValue5 == null ? ((cast __nullishOwner4 : CanvasTextureResolvers).bitmapElementCache = (cast _Runtime.construct(flighthq._internal._HostValueLut.get('WeakMap'), []) : Null<flighthq._internal._WeakMap<Bitmap, { var element:flighthq._internal.dom.HTMLCanvasElement; var version:Float; }>>)) : (cast __nullishValue5 : Null<flighthq._internal._WeakMap<Bitmap, { var element:flighthq._internal.dom.HTMLCanvasElement; var version:Float; }>>); });
    ...
    if ((cast ((cast _Runtime.strictEquals(entry, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) || (cast !_Runtime.strictEquals((cast entry : { var element:flighthq._internal.dom.HTMLCanvasElement; var version:Float; }).version, (cast bitmap : { var version:Float; }).version) : Bool)) : Bool)) {
      var image:Image = (cast createImageResourceFromBitmap(({ final __callArgument6:Dynamic = bitmap; __callArgument6; })) : Image);
