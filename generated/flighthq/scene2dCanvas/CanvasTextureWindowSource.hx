...
class CanvasTextureWindowSource {
  ...
  public static function resolveCanvasTextureWindowSource(resolvers:CanvasTextureResolvers, texture:Texture):Null<flighthq._internal.dom.CanvasImageSource> {
    ...
    backingWidth = (cast getTextureWidth(({ final __callArgument2:Dynamic = texture; __callArgument2; })) : Float);
    backingHeight = (cast getTextureHeight(({ final __callArgument3:Dynamic = texture; __callArgument3; })) : Float);
    ...
    imageVersion = _Runtime.coalesce(({ final __typedStruct4 = image; __typedStruct4 == null ? _Runtime.UNDEFINED : (cast __typedStruct4 : { var version:Float; }).version; }), function():Dynamic return cast -1.0);
    cache = ({ final __nullishOwner5 = resolvers; final __nullishValue6:Null<flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>> = cast (cast __nullishOwner5 : CanvasTextureResolvers).textureWindowElementCache; __nullishValue6 == null ? ((cast __nullishOwner5 : CanvasTextureResolvers).textureWindowElementCache = (cast _Runtime.construct(flighthq._internal._HostValueLut.get('WeakMap'), []) : Null<flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>>)) : (cast __nullishValue6 : Null<flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>>); });
    entry = ({ final __collection7:Dynamic = cache; __collection7 == null ? _Runtime.UNDEFINED : ((cast __collection7 : flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>).get(texture)); });
    ...
    ({ final __collection8:Dynamic = cache; __collection8 == null ? _Runtime.UNDEFINED : ((cast __collection8 : flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>).set(texture, (cast entry))); });
    return cast element;
    return cast null;
  }
}
