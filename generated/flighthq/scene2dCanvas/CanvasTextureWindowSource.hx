...
class CanvasTextureWindowSource {
  ...
  private static function resolveCanvasTextureWindowSource(resolvers:CanvasTextureResolvers, texture:Texture):Null<flighthq._internal.dom.CanvasImageSource> {
    ...
    backingWidth = (cast getTextureWidth(({ final __callArgument4:Dynamic = texture; __callArgument4; })) : Float);
    backingHeight = (cast getTextureHeight(({ final __callArgument6:Dynamic = texture; __callArgument6; })) : Float);
    ...
    imageVersion = _Runtime.coalesce(({ final __typedStruct8 = image; __typedStruct8 == null ? _Runtime.UNDEFINED : (cast __typedStruct8 : { var version:Float; }).version; }), function():Dynamic return cast -1.0);
    cache = ({ final __nullishOwner9 = resolvers; final __nullishValue10:Null<flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>> = cast (cast __nullishOwner9 : CanvasTextureResolvers).textureWindowElementCache; __nullishValue10 == null ? ((cast __nullishOwner9 : CanvasTextureResolvers).textureWindowElementCache = (cast _Runtime.construct(flighthq._internal._HostValueLut.get('WeakMap'), []) : Null<flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>>)) : (cast __nullishValue10 : Null<flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>>); });
    entry = ({ final __collection11:Dynamic = cache; __collection11 == null ? _Runtime.UNDEFINED : ((cast __collection11 : flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>).get(texture)); });
    ...
    ({ final __collection12:Dynamic = cache; __collection12 == null ? _Runtime.UNDEFINED : ((cast __collection12 : flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>).set(texture, (cast entry))); });
    return cast element;
    return cast null;
  }
}
