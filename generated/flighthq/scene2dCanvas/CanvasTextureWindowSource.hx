...
class CanvasTextureWindowSource {
  ...
  public static function resolveCanvasTextureWindowSource(resolvers:CanvasTextureResolvers, texture:Texture):Null<flighthq._internal.dom.CanvasImageSource> {
    ...
    flighthq._internal.backend.Canvas2dBackend.setField(context, 'imageSmoothingEnabled', !(cast (cast (cast _Runtime.field(texture, 'sampler') : { var magFilter:TextureFilter; }).magFilter : { var startsWith:flighthq._internal._Any; }).startsWith((cast 'nearest' : String), (cast _Runtime.field(_Runtime, 'UNDEFINED'))) : Bool));
    ...
    ({ final __collection2:Dynamic = cache; __collection2 == null ? _Runtime.UNDEFINED : ((cast __collection2 : flighthq._internal._WeakMap<Texture, { var element:flighthq._internal.dom.HTMLCanvasElement; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flighthq._internal._Any; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>).set(texture, (cast entry))); });
    return cast element;
    return cast null;
  }
}
