...
class RichTextMetrics {
  ...
  public static function computeRichTextMaxScrollH(data:RichTextData, layout:TextLayoutResult):Float {
    ...
    visibleWidth = HxMath.max(0.0, ((cast computeTextBoundsWidth((cast data : Dynamic), ({ final __callArgument4:Dynamic = layout; __callArgument4; })) : Float) - (TEXT_BOUNDS_GUTTER * 2.0)));
  ...
  public static function computeRichTextMaxScrollV(data:RichTextData, layout:TextLayoutResult):Float {
    ...
    return cast HxMath.max(1.0, ((layout.numLines - (cast RichTextMetrics.getVisibleLineCount__richTextMetrics(({ final __callArgument6:Dynamic = data; __callArgument6; }), ({ final __callArgument7:Dynamic = layout; __callArgument7; })) : Float)) + 1.0));
    return cast null;
  }
  ...
  public static function getVisibleLineCount__richTextMetrics(data:RichTextData, layout:TextLayoutResult):Float {
    ...
    visibleHeight = HxMath.max(0.0, ((cast computeTextBoundsHeight((cast data : Dynamic), ({ final __callArgument10:Dynamic = layout; __callArgument10; })) : Float) - (TEXT_BOUNDS_GUTTER * 2.0)));
