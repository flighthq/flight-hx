...
class TextMarkup {
  ...
  public static function appendMarkupString__textMarkup(content:RichTextContent, value:String, format:TextFormat):Void {
    ...
    (content.text += value);
    TextMarkup.pushMarkupRange__textMarkup(content.formatRanges, ({ final __callArgument4:Dynamic = format; __callArgument4; }), (cast start : Float), (cast _Runtime.field(content.text, 'length') : Float));
  }

  public static function appendMarkupText__textMarkup(content:RichTextContent, raw:String, format:TextFormat):Void {
    TextMarkup.appendMarkupString__textMarkup(({ final __callArgument6:Dynamic = content; __callArgument6; }), (cast (cast TextMarkup.decodeMarkupEntities__textMarkup((cast raw : String)) : String) : String), ({ final __callArgument7:Dynamic = format; __callArgument7; }));
  }
  ...
  public static function formatMarkupRun__textMarkup(format:TextFormat, text:String):String {
    ...
    textformat = (cast TextMarkup.formatMarkupTextformatTag__textMarkup(({ final __callArgument12:Dynamic = format; __callArgument12; })) : Null<String>);
    ...
    if ((cast _Runtime.strictEquals(_Runtime.field(format, 'bullet'), true) : Bool)) {
      _Runtime.callProperty(open, 'push', cast ([(cast TextMarkup.formatMarkupListTag__textMarkup(({ final __callArgument14:Dynamic = format; __callArgument14; })) : String)] : Array<Dynamic>));
    ...
    if ((cast ((cast !_Runtime.strictEquals(_Runtime.field(format, 'url'), _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) || (cast !_Runtime.strictEquals(_Runtime.field(format, 'target'), _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) : Bool)) {
      _Runtime.callProperty(open, 'push', cast ([(cast TextMarkup.formatMarkupAnchorTag__textMarkup(({ final __callArgument16:Dynamic = format; __callArgument16; })) : String)] : Array<Dynamic>));
      _Runtime.callProperty(close, 'unshift', cast (['</a>'] : Array<Dynamic>));
    }
    font = (cast TextMarkup.formatMarkupFontTag__textMarkup(({ final __callArgument18:Dynamic = format; __callArgument18; })) : Null<String>);
  ...
  public static function formatTextMarkup(content:RichTextContent):String {
    ...
    formats = (cast TextMarkup.resolveMarkupFormats__textMarkup(({ final __callArgument20:Dynamic = content; __callArgument20; })) : Array<TextFormat>);
    output = '';
    runStart = 0.0;
    while ((cast ((cast runStart : Float) < (cast _Runtime.field(text, 'length') : Float)) : Bool)) {
      ...
      while ((cast ((cast ((cast runEnd : Float) < (cast _Runtime.field(text, 'length') : Float)) : Bool) && (cast (cast TextMarkup.equalsMarkupFormat__textMarkup(flighthq._internal._StaticIndex.readArray(formats, runEnd), ({ final __callArgument22:Dynamic = format; __callArgument22; })) : Bool) : Bool)) : Bool)) { runEnd++; }
      (output = cast ((output + (cast TextMarkup.formatMarkupRun__textMarkup(({ final __callArgument24:Dynamic = format; __callArgument24; }), (cast _Runtime.slice(text, runStart, runEnd) : String)) : String)) : Dynamic));
  ...
  public static function getDefaultMarkupTagRegistry__textMarkup():MarkupTagRegistry {
    ...
    if ((cast _Runtime.strictEquals(registry, null) : Bool)) {
      ...
      registerStandardMarkupTags(({ final __callArgument26:Dynamic = registry; __callArgument26; }));
  ...
  public static function handleMarkupToken__textMarkup(content:RichTextContent, handlers:flighthq._internal._Map<String, MarkupTagHandler>, token:String, stack:Array<TextFormat>):Void {
    ...
    result = (cast TextMarkup.normalizeMarkupTagResult__textMarkup((cast handler(({ final __callArgument28:Dynamic = attributes; __callArgument28; })) : MarkupTagResult)) : MarkupTagEffect);
    if ((cast ((cast _Runtime.strictEquals((cast result : MarkupTagEffect).format, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) && (cast !_Runtime.strictEquals((cast result : MarkupTagEffect).text, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) : Bool)) {
      TextMarkup.appendMarkupString__textMarkup(({ final __callArgument32:Dynamic = content; __callArgument32; }), (cast (cast result : MarkupTagEffect).text : String), ({ final __callArgument33:Dynamic = top; __callArgument33; }));
      return;
    }
    if ((cast _Runtime.strictEquals((cast result : MarkupTagEffect).breakBefore, true) : Bool)) { TextMarkup.appendMarkupBreakBefore__textMarkup(({ final __callArgument36:Dynamic = content; __callArgument36; })); }
    if ((cast !_Runtime.strictEquals((cast result : MarkupTagEffect).text, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) { TextMarkup.appendMarkupString__textMarkup(({ final __callArgument38:Dynamic = content; __callArgument38; }), (cast (cast result : MarkupTagEffect).text : String), ({ final __callArgument39:Dynamic = top; __callArgument39; })); }
  ...
  public static function parseTextMarkup(html:String, ?registry:MarkupTagRegistry):RichTextContent {
    ...
    while ((cast !_Runtime.strictEquals((match = cast (_Runtime.callProperty(tagPattern, 'exec', cast ([html] : Array<Dynamic>)) : Dynamic)), null) : Bool)) {
      TextMarkup.appendMarkupText__textMarkup(({ final __callArgument42:Dynamic = content; __callArgument42; }), (cast _Runtime.slice(html, index, _Runtime.field(match, 'index')) : String), flighthq._internal._StaticIndex.readArray(stack, _Runtime.subtractNumbers(_Runtime.field(stack, 'length'), 1.0)));
      TextMarkup.handleMarkupToken__textMarkup(({ final __callArgument44:Dynamic = content; __callArgument44; }), ({ final __callArgument45:Dynamic = handlers; __callArgument45; }), (cast _Runtime.getIndex(match, 0.0) : String), ({ final __callArgument46:Dynamic = stack; __callArgument46; }));
      (index = cast (_Runtime.addNumbers(_Runtime.field(match, 'index'), _Runtime.field(_Runtime.getIndex(match, 0.0), 'length')) : Dynamic));
    }
    TextMarkup.appendMarkupText__textMarkup(({ final __callArgument50:Dynamic = content; __callArgument50; }), (cast _Runtime.slice(html, index, null) : String), flighthq._internal._StaticIndex.readArray(stack, _Runtime.subtractNumbers(_Runtime.field(stack, 'length'), 1.0)));
    return cast content;
    return cast null;
  }
  ...
  public static function pushMarkupRange__textMarkup(ranges:Array<TextFormatRange>, format:TextFormat, start:Float, end:Float):Void {
    ...
    if ((cast ((cast ((cast !_Runtime.strictEquals(previous, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) && (cast _Runtime.strictEquals((cast previous : TextFormatRange).end, start) : Bool)) : Bool) && (cast (cast TextMarkup.equalsMarkupFormat__textMarkup((cast previous : TextFormatRange).format, ({ final __callArgument52:Dynamic = format; __callArgument52; })) : Bool) : Bool)) : Bool)) {
      ((cast previous : TextFormatRange).end = end);
      return;
    }
    _Runtime.callProperty(ranges, 'push', cast ([(cast createTextFormatRange(({ final __callArgument54:Dynamic = _Runtime.mergeObjects([format]); __callArgument54; }), (cast start : Float), (cast end : Float)) : TextFormatRange)] : Array<Dynamic>));
  }
