...
class DragonBonesParse {
  public static function parseDragonBonesSkeleton(json:String, ?diagnostics:Array<ImportDiagnostic>):Null<Skeleton2DImport> {
    ...
    if ((cast ((cast _Runtime.field(armatures, 'length') : Float) > (cast 1.0 : Float)) : Bool)) {
      reportImportDiagnostic(({ final __callArgument1:Dynamic = diagnostics; __callArgument1; }), ({ final __callArgument2:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument2; }), (cast 'dragonbones.multi-armature-unsupported' : String), (cast 'parseDragonBonesSkeleton' : String), ({ final __callArgument3:Dynamic = { armatures: _Runtime.subtractNumbers(_Runtime.field(armatures, 'length'), 1.0) }; __callArgument3; }));
    }
    ...
    __destructure0 = (cast DragonBonesParse.parseDragonBonesBones__dragonBonesParse((cast (cast armature : { var bone:flighthq._internal._Any; }).bone : flighthq._internal._Any), ({ final __callArgument4:Dynamic = diagnostics; __callArgument4; })) : { var bones:Array<Bone2D>; var rawIndexToOutput:Array<Float>; });
    bones = _Runtime.field(__destructure0, 'bones');
    rawIndexToOutput = _Runtime.field(__destructure0, 'rawIndexToOutput');
    boneIndexByName = (cast DragonBonesParse.buildBoneIndexByName__dragonBonesParse(({ final __callArgument5:Dynamic = bones; __callArgument5; })) : flighthq._internal._Map<String, Float>);
    remapBoneIndex = (cast DragonBonesParse.buildDragonBonesBoneRemap__dragonBonesParse(({ final __callArgument6:Dynamic = rawIndexToOutput; __callArgument6; })) : DragonBonesBoneRemap__dragonBonesParse);
    ...
    __destructure1 = (cast DragonBonesParse.parseDragonBonesSkins__dragonBonesParse((cast (cast armature : { var skin:flighthq._internal._Any; }).skin : flighthq._internal._Any), ({ final __callArgument7:Dynamic = slotOrder; __callArgument7; }), (cast remapBoneIndex : Dynamic), ({ final __callArgument8:Dynamic = diagnostics; __callArgument8; })) : { var skins:Array<AttachmentSkin2D>; var table:flighthq._internal._Map<String, Array<Null<Attachment2D>>>; });
    skins = _Runtime.field(__destructure1, 'skins');
    table = _Runtime.field(__destructure1, 'table');
    slots = (cast DragonBonesParse.parseDragonBonesSlots__dragonBonesParse((cast (cast armature : { var slot:flighthq._internal._Any; }).slot : flighthq._internal._Any), ({ final __callArgument9:Dynamic = boneIndexByName; __callArgument9; }), ({ final __callArgument10:Dynamic = table; __callArgument10; }), ({ final __callArgument11:Dynamic = diagnostics; __callArgument11; })) : Array<Slot2D>);
    frameRate = (cast DragonBonesParse.dragonBonesFrameRate__dragonBonesParse(({ final __callArgument12:Dynamic = armature; __callArgument12; }), (cast doc : flighthq._internal._Record<String, flighthq._internal._Any>)) : Float);
    animations = (cast DragonBonesParse.parseDragonBonesAnimations__dragonBonesParse((cast (cast armature : { var animation:flighthq._internal._Any; }).animation : flighthq._internal._Any), ({ final __callArgument13:Dynamic = boneIndexByName; __callArgument13; }), ({ final __callArgument14:Dynamic = slotOrder; __callArgument14; }), ({ final __callArgument15:Dynamic = table; __callArgument15; }), (cast frameRate : Float), ({ final __callArgument16:Dynamic = diagnostics; __callArgument16; })) : Array<Skeleton2DImportAnimation>);
    DragonBonesParse.skipCrumbDragonBonesGroup__dragonBonesParse(({ final __callArgument17:Dynamic = diagnostics; __callArgument17; }), (cast (cast armature : { var ik:flighthq._internal._Any; }).ik : flighthq._internal._Any), (cast 'dragonbones.ik-constraint-unsupported' : String));
    skeleton = (cast createSkeleton2D(({ final __callArgument18:Dynamic = bones; __callArgument18; }), ({ final __callArgument19:Dynamic = slots; __callArgument19; })) : Skeleton2D);
  ...
  public static function parseDragonBonesAnimations__dragonBonesParse(raw:flighthq._internal._Any, boneIndexByName:flighthq._internal._Map<String, Float>, slotOrder:flighthq._internal._Map<String, Float>, displayTable:flighthq._internal._Map<String, Array<Null<Attachment2D>>>, frameRate:Float, ?diagnostics:Array<ImportDiagnostic>):Array<Skeleton2DImportAnimation> {
    ...
    for (entry in _Runtime.iterable(raw)) {
      ...
      if ((cast _Runtime.isArray((cast animation : { var bone:flighthq._internal._Any; }).bone) : Bool)) {
        for (rawTimeline in _Runtime.iterable((cast animation : { var bone:flighthq._internal._Any; }).bone)) {
          ...
          DragonBonesParse.parseDragonBonesBoneTimeline__dragonBonesParse(({ final __callArgument24:Dynamic = channels; __callArgument24; }), ({ final __callArgument25:Dynamic = timeline; __callArgument25; }), (cast boneIndex : Float), (cast frameRate : Float), ({ final __callArgument26:Dynamic = diagnostics; __callArgument26; }));
        }
      }
      DragonBonesParse.parseDragonBonesSlotTimelines__dragonBonesParse(({ final __callArgument27:Dynamic = channels; __callArgument27; }), (cast (cast animation : { var slot:flighthq._internal._Any; }).slot : flighthq._internal._Any), ({ final __callArgument28:Dynamic = slotOrder; __callArgument28; }), ({ final __callArgument29:Dynamic = displayTable; __callArgument29; }), (cast frameRate : Float), ({ final __callArgument30:Dynamic = unmodeled; __callArgument30; }));
      DragonBonesParse.skipCrumbDragonBonesGroup__dragonBonesParse(({ final __callArgument31:Dynamic = diagnostics; __callArgument31; }), (cast (cast animation : { var ffd:flighthq._internal._Any; }).ffd : flighthq._internal._Any), (cast 'dragonbones.deform-timeline-unsupported' : String));
      DragonBonesParse.skipCrumbDragonBonesGroup__dragonBonesParse(({ final __callArgument32:Dynamic = diagnostics; __callArgument32; }), (cast (cast animation : { var ik:flighthq._internal._Any; }).ik : flighthq._internal._Any), (cast 'dragonbones.ik-timeline-unsupported' : String));
      DragonBonesParse.skipCrumbDragonBonesGroup__dragonBonesParse(({ final __callArgument33:Dynamic = diagnostics; __callArgument33; }), (cast (cast animation : { var zOrder:flighthq._internal._Any; }).zOrder : flighthq._internal._Any), (cast 'dragonbones.zorder-timeline-unsupported' : String));
    ...
    for (__iteration2 in _Runtime.iterable(unmodeled)) {
      ...
      reportImportDiagnostic(({ final __callArgument40:Dynamic = diagnostics; __callArgument40; }), ({ final __callArgument41:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument41; }), (cast 'dragonbones.' + Std.string(kind) + '-timeline-unsupported' : String), (cast 'parseDragonBonesSkeleton' : String), ({ final __callArgument42:Dynamic = { timelines: count }; __callArgument42; }));
    }
    if ((cast ((cast unresolvedBones : Float) > (cast 0.0 : Float)) : Bool)) {
      reportImportDiagnostic(({ final __callArgument43:Dynamic = diagnostics; __callArgument43; }), ({ final __callArgument44:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument44; }), (cast 'dragonbones.animation-bone-unresolved' : String), (cast 'parseDragonBonesSkeleton' : String), ({ final __callArgument45:Dynamic = { bones: unresolvedBones }; __callArgument45; }));
    }
  ...
  public static function parseDragonBonesSlotTimelines__dragonBonesParse(channels:Array<AnimationChannel>, raw:flighthq._internal._Any, slotOrder:flighthq._internal._Map<String, Float>, displayTable:flighthq._internal._Map<String, Array<Null<Attachment2D>>>, frameRate:Float, unmodeled:flighthq._internal._Map<String, Float>):Void {
    ...
    for (entry in _Runtime.iterable(raw)) {
      ...
      var displayFrames:Array<flighthq._internal._Record<String, flighthq._internal._Any>> = (cast DragonBonesParse.dragonBonesFrames__dragonBonesParse((cast _Runtime.coalesce((cast timeline : { var displayFrame:flighthq._internal._Any; }).displayFrame, function():Dynamic return cast (cast timeline : { var display:flighthq._internal._Any; }).display) : flighthq._internal._Any), ({ final __callArgument48:Dynamic = _Runtime.field(_Runtime, 'UNDEFINED'); __callArgument48; })) : Array<flighthq._internal._Record<String, flighthq._internal._Any>>);
      if ((cast ((cast _Runtime.field(displayFrames, 'length') : Float) > (cast 0.0 : Float)) : Bool)) {
        DragonBonesParse.addDragonBonesDisplayChannel__dragonBonesParse(({ final __callArgument49:Dynamic = channels; __callArgument49; }), ({ final __callArgument50:Dynamic = displayFrames; __callArgument50; }), (cast slotIndex : Float), ({ final __callArgument51:Dynamic = _Runtime.coalesce(((cast displayTable : flighthq._internal._Map<String, Array<Null<Attachment2D>>>).get(_Runtime.coalesce(name, function():Dynamic return cast ''))), function():Dynamic return cast cast ([] : Array<Dynamic>)); __callArgument51; }), (cast frameRate : Float));
      }
      var colorFrames:Array<flighthq._internal._Record<String, flighthq._internal._Any>> = (cast DragonBonesParse.dragonBonesFrames__dragonBonesParse((cast _Runtime.coalesce((cast timeline : { var colorFrame:flighthq._internal._Any; }).colorFrame, function():Dynamic return cast (cast timeline : { var color:flighthq._internal._Any; }).color) : flighthq._internal._Any), ({ final __callArgument52:Dynamic = _Runtime.field(_Runtime, 'UNDEFINED'); __callArgument52; })) : Array<flighthq._internal._Record<String, flighthq._internal._Any>>);
      if ((cast ((cast _Runtime.field(colorFrames, 'length') : Float) > (cast 0.0 : Float)) : Bool)) { DragonBonesParse.addDragonBonesSlotColorChannel__dragonBonesParse(({ final __callArgument53:Dynamic = channels; __callArgument53; }), ({ final __callArgument54:Dynamic = colorFrames; __callArgument54; }), (cast slotIndex : Float), (cast frameRate : Float)); }
    }
  }
  ...
  public static function addDragonBonesDisplayChannel__dragonBonesParse(channels:Array<AnimationChannel>, frames:Array<flighthq._internal._Record<String, flighthq._internal._Any>>, slotIndex:Float, displays:Array<Null<Attachment2D>>, frameRate:Float):Void {
    ...
    times = (cast DragonBonesParse.dragonBonesFrameTimes__dragonBonesParse(({ final __callArgument55:Dynamic = frames; __callArgument55; }), (cast frameRate : Float)) : Array<Float>);
    ...
    track = (cast createAnimationTrack(({ final __callArgument58:Dynamic = { components: 1.0, interpolation: AnimationInterpolationStep, times: times, values: values }; __callArgument58; })) : AnimationTrack);
    _Runtime.callProperty(channels, 'push', cast ([(cast createAnimationChannel(({ final __callArgument59:Dynamic = track; __callArgument59; }), (cast (cast createSkeleton2DSlotAnimationTarget((cast slotIndex : Float), ({ final __callArgument60:Dynamic = (cast Skeleton2DSlotAnimationPathValue : { var Attachment:String; var Color:String; }).Attachment; __callArgument60; }), ({ final __callArgument61:Dynamic = _Runtime.slice(displays, 0, null); __callArgument61; })) : Skeleton2DSlotAnimationTarget) : flighthq._internal._Any)) : AnimationChannel)] : Array<Dynamic>));
  }
  ...
  public static function addDragonBonesSlotColorChannel__dragonBonesParse(channels:Array<AnimationChannel>, frames:Array<flighthq._internal._Record<String, flighthq._internal._Any>>, slotIndex:Float, frameRate:Float):Void {
    ...
    var values:Array<Float> = cast _Runtime.UNDEFINED;
    var track:AnimationTrack = cast _Runtime.UNDEFINED;
    times = (cast DragonBonesParse.dragonBonesFrameTimes__dragonBonesParse(({ final __callArgument62:Dynamic = frames; __callArgument62; }), (cast frameRate : Float)) : Array<Float>);
    values = (cast cast ([] : Array<Dynamic>));
    for (frame in _Runtime.iterable(frames)) {
    ...
    track = (cast createAnimationTrack(({ final __callArgument68:Dynamic = { components: 4.0, interpolation: (cast DragonBonesParse.dragonBonesInterpolation__dragonBonesParse(({ final __callArgument65:Dynamic = frames; __callArgument65; }), ({ final __callArgument66:Dynamic = _Runtime.field(_Runtime, 'UNDEFINED'); __callArgument66; })) : AnimationInterpolation), segmentEasings: (cast DragonBonesParse.buildDragonBonesSegmentEasings__dragonBonesParse(({ final __callArgument67:Dynamic = frames; __callArgument67; })) : Null<Array<Null<EasingFunction>>>), times: times, values: values }; __callArgument68; })) : AnimationTrack);
    _Runtime.callProperty(channels, 'push', cast ([(cast createAnimationChannel(({ final __callArgument69:Dynamic = track; __callArgument69; }), (cast (cast createSkeleton2DSlotAnimationTarget((cast slotIndex : Float), ({ final __callArgument70:Dynamic = (cast Skeleton2DSlotAnimationPathValue : { var Attachment:String; var Color:String; }).Color; __callArgument70; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) : Skeleton2DSlotAnimationTarget) : flighthq._internal._Any)) : AnimationChannel)] : Array<Dynamic>));
  }
  ...
  public static function parseDragonBonesBoneTimeline__dragonBonesParse(channels:Array<AnimationChannel>, timeline:flighthq._internal._Record<String, flighthq._internal._Any>, boneIndex:Float, frameRate:Float, ?diagnostics:Array<ImportDiagnostic>):Void {
    DragonBonesParse.addDragonBonesVectorChannel__dragonBonesParse(({ final __callArgument71:Dynamic = channels; __callArgument71; }), (cast (cast timeline : { var translateFrame:flighthq._internal._Any; }).translateFrame : flighthq._internal._Any), (cast boneIndex : Float), ({ final __callArgument72:Dynamic = (cast Skeleton2DAnimationPathValue : { var Translation:String; var TranslationX:String; var TranslationY:String; var Rotation:String; var Scale:String; var ScaleX:String; var ScaleY:String; var Shear:String; var ShearX:String; var ShearY:String; }).Translation; __callArgument72; }), (cast frameRate : Float), ({ final __callArgument73:Dynamic = diagnostics; __callArgument73; }));
    DragonBonesParse.addDragonBonesRotateChannels__dragonBonesParse(({ final __callArgument74:Dynamic = channels; __callArgument74; }), (cast (cast timeline : { var rotateFrame:flighthq._internal._Any; }).rotateFrame : flighthq._internal._Any), (cast boneIndex : Float), (cast frameRate : Float), ({ final __callArgument75:Dynamic = diagnostics; __callArgument75; }));
    DragonBonesParse.addDragonBonesVectorChannel__dragonBonesParse(({ final __callArgument76:Dynamic = channels; __callArgument76; }), (cast (cast timeline : { var scaleFrame:flighthq._internal._Any; }).scaleFrame : flighthq._internal._Any), (cast boneIndex : Float), ({ final __callArgument77:Dynamic = (cast Skeleton2DAnimationPathValue : { var Translation:String; var TranslationX:String; var TranslationY:String; var Rotation:String; var Scale:String; var ScaleX:String; var ScaleY:String; var Shear:String; var ShearX:String; var ShearY:String; }).Scale; __callArgument77; }), (cast frameRate : Float), ({ final __callArgument78:Dynamic = diagnostics; __callArgument78; }));
    DragonBonesParse.skipCrumbDragonBonesGroup__dragonBonesParse(({ final __callArgument79:Dynamic = diagnostics; __callArgument79; }), (cast (cast timeline : { var frame:flighthq._internal._Any; }).frame : flighthq._internal._Any), (cast 'dragonbones.legacy-bone-frame-unsupported' : String));
  }
  ...
  public static function addDragonBonesVectorChannel__dragonBonesParse(channels:Array<AnimationChannel>, raw:flighthq._internal._Any, boneIndex:Float, path:Skeleton2DAnimationPath, frameRate:Float, ?diagnostics:Array<ImportDiagnostic>):Void {
    ...
    var values:Array<Float> = cast _Runtime.UNDEFINED;
    frames = (cast DragonBonesParse.dragonBonesFrames__dragonBonesParse((cast raw : flighthq._internal._Any), ({ final __callArgument80:Dynamic = diagnostics; __callArgument80; })) : Array<flighthq._internal._Record<String, flighthq._internal._Any>>);
    ...
    DragonBonesParse.addDragonBonesBoneChannel__dragonBonesParse(({ final __callArgument83:Dynamic = channels; __callArgument83; }), (cast DragonBonesParse.dragonBonesFrameTimes__dragonBonesParse(({ final __callArgument84:Dynamic = frames; __callArgument84; }), (cast frameRate : Float)) : Array<Float>), ({ final __callArgument85:Dynamic = values; __callArgument85; }), (cast 2.0 : Float), (cast DragonBonesParse.dragonBonesInterpolation__dragonBonesParse(({ final __callArgument86:Dynamic = frames; __callArgument86; }), ({ final __callArgument87:Dynamic = diagnostics; __callArgument87; })) : AnimationInterpolation), (cast boneIndex : Float), ({ final __callArgument88:Dynamic = path; __callArgument88; }), (cast DragonBonesParse.buildDragonBonesSegmentEasings__dragonBonesParse(({ final __callArgument89:Dynamic = frames; __callArgument89; })) : Null<Array<Null<EasingFunction>>>));
  }
  ...
  public static function addDragonBonesRotateChannels__dragonBonesParse(channels:Array<AnimationChannel>, raw:flighthq._internal._Any, boneIndex:Float, frameRate:Float, ?diagnostics:Array<ImportDiagnostic>):Void {
    ...
    frames = (cast DragonBonesParse.dragonBonesFrames__dragonBonesParse((cast raw : flighthq._internal._Any), ({ final __callArgument90:Dynamic = diagnostics; __callArgument90; })) : Array<flighthq._internal._Record<String, flighthq._internal._Any>>);
    if ((cast _Runtime.strictEquals(_Runtime.field(frames, 'length'), 0.0) : Bool)) { return; }
    times = (cast DragonBonesParse.dragonBonesFrameTimes__dragonBonesParse(({ final __callArgument91:Dynamic = frames; __callArgument91; }), (cast frameRate : Float)) : Array<Float>);
    interpolation = (cast DragonBonesParse.dragonBonesInterpolation__dragonBonesParse(({ final __callArgument92:Dynamic = frames; __callArgument92; }), ({ final __callArgument93:Dynamic = diagnostics; __callArgument93; })) : AnimationInterpolation);
    ...
    easings = (cast DragonBonesParse.buildDragonBonesSegmentEasings__dragonBonesParse(({ final __callArgument94:Dynamic = frames; __callArgument94; })) : Null<Array<Null<EasingFunction>>>);
    ...
    DragonBonesParse.addDragonBonesBoneChannel__dragonBonesParse(({ final __callArgument95:Dynamic = channels; __callArgument95; }), ({ final __callArgument96:Dynamic = times; __callArgument96; }), ({ final __callArgument97:Dynamic = rotations; __callArgument97; }), (cast 1.0 : Float), ({ final __callArgument98:Dynamic = interpolation; __callArgument98; }), (cast boneIndex : Float), ({ final __callArgument99:Dynamic = rotationPath; __callArgument99; }), ({ final __callArgument100:Dynamic = easings; __callArgument100; }));
    if ((cast skewed : Bool)) {
      ...
      DragonBonesParse.addDragonBonesBoneChannel__dragonBonesParse(({ final __callArgument101:Dynamic = channels; __callArgument101; }), ({ final __callArgument102:Dynamic = times; __callArgument102; }), ({ final __callArgument103:Dynamic = shears; __callArgument103; }), (cast 2.0 : Float), ({ final __callArgument104:Dynamic = interpolation; __callArgument104; }), (cast boneIndex : Float), ({ final __callArgument105:Dynamic = shearPath; __callArgument105; }), ({ final __callArgument106:Dynamic = easings; __callArgument106; }));
    }
  }
  ...
  public static function addDragonBonesBoneChannel__dragonBonesParse(channels:Array<AnimationChannel>, times:Array<Float>, values:Array<Float>, components:Float, interpolation:AnimationInterpolation, boneIndex:Float, path:Skeleton2DAnimationPath, ?segmentEasings:Null<Array<Null<EasingFunction>>>):Void {
    ...
    var track:AnimationTrack = cast _Runtime.UNDEFINED;
    track = (cast createAnimationTrack(({ final __callArgument107:Dynamic = { components: components, interpolation: interpolation, segmentEasings: segmentEasings, times: _Runtime.slice(times, 0, null), values: values }; __callArgument107; })) : AnimationTrack);
    _Runtime.callProperty(channels, 'push', cast ([(cast createAnimationChannel(({ final __callArgument108:Dynamic = track; __callArgument108; }), (cast (cast createSkeleton2DBoneAnimationTarget((cast boneIndex : Float), ({ final __callArgument109:Dynamic = path; __callArgument109; })) : Skeleton2DAnimationTarget) : flighthq._internal._Any)) : AnimationChannel)] : Array<Dynamic>));
  }
  ...
  public static function dragonBonesFrames__dragonBonesParse(raw:flighthq._internal._Any, ?diagnostics:Array<ImportDiagnostic>):Array<flighthq._internal._Record<String, flighthq._internal._Any>> {
    ...
    if ((cast ((cast recovered : Float) > (cast 0.0 : Float)) : Bool)) {
      reportImportDiagnostic(({ final __callArgument114:Dynamic = diagnostics; __callArgument114; }), ({ final __callArgument115:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument115; }), (cast 'dragonbones.malformed-frame-recovered' : String), (cast 'dragonBonesFrames' : String), ({ final __callArgument116:Dynamic = { frames: recovered }; __callArgument116; }));
    }
    return cast frames;
    return cast null;
  }
  ...
  public static function dragonBonesInterpolation__dragonBonesParse(frames:Array<flighthq._internal._Record<String, flighthq._internal._Any>>, ?diagnostics:Array<ImportDiagnostic>):AnimationInterpolation {
    ...
    approximated = 0.0;
    {
      ...
      while ((cast ((cast (i + 1.0) : Float) < (cast _Runtime.field(frames, 'length') : Float)) : Bool)) {
        var frame:flighthq._internal._Record<String, flighthq._internal._Any> = flighthq._internal._StaticIndex.readArray(frames, i);
        if ((cast !(cast (cast DragonBonesParse.isDragonBonesFrameStepped__dragonBonesParse(({ final __callArgument117:Dynamic = frame; __callArgument117; })) : Bool) : Bool) : Bool)) { (stepped = cast (false : Dynamic)); }
    ...
    if ((cast ((cast approximated : Float) > (cast 0.0 : Float)) : Bool)) {
      reportImportDiagnostic(({ final __callArgument118:Dynamic = diagnostics; __callArgument118; }), ({ final __callArgument119:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument119; }), (cast 'dragonbones.tween-easing-approximated' : String), (cast 'dragonBonesInterpolation' : String), ({ final __callArgument120:Dynamic = { frames: approximated }; __callArgument120; }));
    }
  ...
  public static function parseDragonBonesSkins__dragonBonesParse(raw:flighthq._internal._Any, slotOrder:flighthq._internal._Map<String, Float>, remapBoneIndex:DragonBonesBoneRemap__dragonBonesParse, ?diagnostics:Array<ImportDiagnostic>):{ var skins:Array<AttachmentSkin2D>; var table:flighthq._internal._Map<String, Array<Null<Attachment2D>>>; } {
    ...
    for (rawSkin in _Runtime.iterable(raw)) {
      ...
      for (rawSlot in _Runtime.iterable((cast skin : { var slot:flighthq._internal._Any; }).slot)) {
        ...
        var displays:Array<Null<Attachment2D>> = (cast DragonBonesParse.parseDragonBonesDisplayList__dragonBonesParse((cast (cast slot : { var display:flighthq._internal._Any; }).display : flighthq._internal._Any), (cast remapBoneIndex : Dynamic), ({ final __callArgument128:Dynamic = diagnostics; __callArgument128; })) : Array<Null<Attachment2D>>);
        ...
        for (display in _Runtime.iterable(displays)) {
          var displayName:Null<String> = ({ final __structural131 = display; __structural131 == null ? _Runtime.UNDEFINED : (cast __structural131 : { @:optional var name:Null<String>; }).name; });
  ...
  public static function parseDragonBonesDisplay__dragonBonesParse(raw:flighthq._internal._Any, remapBoneIndex:DragonBonesBoneRemap__dragonBonesParse, ?diagnostics:Array<ImportDiagnostic>):Null<Attachment2D> {
    ...
    if ((cast _Runtime.strictEquals(type, 'image') : Bool)) { return cast (cast DragonBonesParse.parseDragonBonesRegionDisplay__dragonBonesParse(({ final __callArgument132:Dynamic = display; __callArgument132; })) : RegionAttachment2D); }
    if ((cast _Runtime.strictEquals(type, 'mesh') : Bool)) { return cast (cast DragonBonesParse.parseDragonBonesMeshDisplay__dragonBonesParse(({ final __callArgument133:Dynamic = display; __callArgument133; }), (cast remapBoneIndex : Dynamic), ({ final __callArgument134:Dynamic = diagnostics; __callArgument134; })) : Null<MeshAttachment2D>); }
    reportImportDiagnostic(({ final __callArgument135:Dynamic = diagnostics; __callArgument135; }), ({ final __callArgument136:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument136; }), (cast 'dragonbones.' + Std.string(type) + '-display-unsupported' : String), (cast 'parseDragonBonesDisplay' : String), ({ final __callArgument137:Dynamic = { displays: 1.0 }; __callArgument137; }));
    return cast null;
    return cast null;
  }
  ...
  public static function parseDragonBonesMeshDisplay__dragonBonesParse(display:flighthq._internal._Record<String, flighthq._internal._Any>, remapBoneIndex:DragonBonesBoneRemap__dragonBonesParse, ?diagnostics:Array<ImportDiagnostic>):Null<MeshAttachment2D> {
    ...
    if ((cast _Runtime.hasField(display, 'share') : Bool)) {
      reportImportDiagnostic(({ final __callArgument138:Dynamic = diagnostics; __callArgument138; }), ({ final __callArgument139:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument139; }), (cast 'dragonbones.shared-mesh-unsupported' : String), (cast 'parseDragonBonesMeshDisplay' : String), ({ final __callArgument140:Dynamic = { displays: 1.0 }; __callArgument140; }));
      return cast null;
    }
    if ((cast _Runtime.hasField(display, 'weights') : Bool)) {
      if ((cast _Runtime.hasField(display, 'bonePose') : Bool)) { return cast (cast DragonBonesParse.parseDragonBonesWeightedMesh__dragonBonesParse(({ final __callArgument141:Dynamic = display; __callArgument141; }), (cast remapBoneIndex : Dynamic), ({ final __callArgument142:Dynamic = diagnostics; __callArgument142; })) : MeshAttachment2D); }
      reportImportDiagnostic(({ final __callArgument143:Dynamic = diagnostics; __callArgument143; }), ({ final __callArgument144:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument144; }), (cast 'dragonbones.legacy-weighted-mesh-unsupported' : String), (cast 'parseDragonBonesMeshDisplay' : String), ({ final __callArgument145:Dynamic = { displays: 1.0 }; __callArgument145; }));
      return cast null;
    }
  ...
  public static function parseDragonBonesWeightedMesh__dragonBonesParse(display:flighthq._internal._Record<String, flighthq._internal._Any>, remapBoneIndex:DragonBonesBoneRemap__dragonBonesParse, ?diagnostics:Array<ImportDiagnostic>):MeshAttachment2D {
    ...
    spA = (cast DragonBonesParse.numAt__dragonBonesParse(({ final __callArgument146:Dynamic = slotPose; __callArgument146; }), (cast 0.0 : Float), (cast 1.0 : Float)) : Float);
    spB = (cast DragonBonesParse.numAt__dragonBonesParse(({ final __callArgument147:Dynamic = slotPose; __callArgument147; }), (cast 1.0 : Float), (cast 0.0 : Float)) : Float);
    spC = (cast DragonBonesParse.numAt__dragonBonesParse(({ final __callArgument148:Dynamic = slotPose; __callArgument148; }), (cast 2.0 : Float), (cast 0.0 : Float)) : Float);
    spD = (cast DragonBonesParse.numAt__dragonBonesParse(({ final __callArgument149:Dynamic = slotPose; __callArgument149; }), (cast 3.0 : Float), (cast 1.0 : Float)) : Float);
    spTx = (cast DragonBonesParse.numAt__dragonBonesParse(({ final __callArgument150:Dynamic = slotPose; __callArgument150; }), (cast 4.0 : Float), (cast 0.0 : Float)) : Float);
    spTy = (cast DragonBonesParse.numAt__dragonBonesParse(({ final __callArgument151:Dynamic = slotPose; __callArgument151; }), (cast 5.0 : Float), (cast 0.0 : Float)) : Float);
    ...
    iW = 0.0;
    {
      ...
      while ((cast ((cast v : Float) < (cast vertexCount : Float)) : Bool)) {
        ...
        var vx:Float = (cast DragonBonesParse.numAt__dragonBonesParse(({ final __callArgument152:Dynamic = verts; __callArgument152; }), (cast (v * 2.0) : Float), (cast 0.0 : Float)) : Float);
        var vy:Float = (cast DragonBonesParse.numAt__dragonBonesParse(({ final __callArgument153:Dynamic = verts; __callArgument153; }), (cast ((v * 2.0) + 1.0) : Float), (cast 0.0 : Float)) : Float);
        ...
        var realCount:Float = 0.0;
        {
          ...
          while ((cast ((cast j : Float) < (cast declaredCount : Float)) : Bool)) {
            ...
            var ordinal:Float = (cast DragonBonesParse.findBonePoseOrdinal__dragonBonesParse(({ final __callArgument154:Dynamic = bonePose; __callArgument154; }), (cast usedBoneCount : Float), (cast rawBoneIndex : Float)) : Float);
  ...
  public static function parseDragonBonesDisplayList__dragonBonesParse(raw:flighthq._internal._Any, remapBoneIndex:DragonBonesBoneRemap__dragonBonesParse, ?diagnostics:Array<ImportDiagnostic>):Array<Null<Attachment2D>> {
    ...
    for (rawDisplay in _Runtime.iterable(raw)) {
      _Runtime.callProperty(displays, 'push', cast ([(cast DragonBonesParse.parseDragonBonesDisplay__dragonBonesParse((cast rawDisplay : flighthq._internal._Any), (cast remapBoneIndex : Dynamic), ({ final __callArgument160:Dynamic = diagnostics; __callArgument160; })) : Null<Attachment2D>)] : Array<Dynamic>));
    }
  ...
  public static function parseDragonBonesSlots__dragonBonesParse(raw:flighthq._internal._Any, boneIndexByName:flighthq._internal._Map<String, Float>, skin:flighthq._internal._Map<String, Array<Null<Attachment2D>>>, ?diagnostics:Array<ImportDiagnostic>):Array<Slot2D> {
    ...
    for (entry in _Runtime.iterable(raw)) {
      ...
      _Runtime.callProperty(slots, 'push', cast ([{ attachment: attachment, boneIndex: boneIndex, color: (cast DragonBonesParse.parseDragonBonesColor__dragonBonesParse((cast (cast slot : { var color:flighthq._internal._Any; }).color : flighthq._internal._Any), ({ final __callArgument163:Dynamic = diagnostics; __callArgument163; })) : Float), name: name }] : Array<Dynamic>));
    }
    return cast slots;
    return cast null;
  }
  ...
  public static function parseDragonBonesBones__dragonBonesParse(raw:flighthq._internal._Any, ?diagnostics:Array<ImportDiagnostic>):{ var bones:Array<Bone2D>; var rawIndexToOutput:Array<Float>; } {
    ...
    if ((cast ((cast _Runtime.field(pending, 'length') : Float) > (cast 0.0 : Float)) : Bool)) {
      reportImportDiagnostic(({ final __callArgument167:Dynamic = diagnostics; __callArgument167; }), ({ final __callArgument168:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Drop; __callArgument168; }), (cast 'dragonbones.unresolved-bone-parent' : String), (cast 'parseDragonBonesSkeleton' : String), ({ final __callArgument169:Dynamic = { count: _Runtime.field(pending, 'length') }; __callArgument169; }));
  ...
  public static function skipCrumbDragonBonesGroup__dragonBonesParse(diagnostics:Null<Array<ImportDiagnostic>>, raw:flighthq._internal._Any, kind:String):Void {
    ...
    if ((cast ((cast count : Float) > (cast 0.0 : Float)) : Bool)) { reportImportDiagnostic(({ final __callArgument172:Dynamic = diagnostics; __callArgument172; }), ({ final __callArgument173:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument173; }), (cast kind : String), (cast 'parseDragonBonesSkeleton' : String), ({ final __callArgument174:Dynamic = { count: count }; __callArgument174; })); }
  }
  ...
  public static function checkDragonBonesVersion__dragonBonesParse(doc:flighthq._internal._Record<String, flighthq._internal._Any>, ?diagnostics:Array<ImportDiagnostic>):Bool {
    ...
    if ((cast _Runtime.strictEquals(resolved, null) : Bool)) {
      reportImportDiagnostic(({ final __callArgument175:Dynamic = diagnostics; __callArgument175; }), ({ final __callArgument176:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument176; }), (cast 'dragonbones.version-missing' : String), (cast 'parseDragonBonesSkeleton' : String), ({ final __callArgument177:Dynamic = {  }; __callArgument177; }));
      return cast false;
    }
    if ((cast !_Runtime.strictEquals(resolved, DragonBonesParse.DRAGONBONES_COMPATIBLE_VERSION__dragonBonesParse) : Bool)) {
      reportImportDiagnostic(({ final __callArgument178:Dynamic = diagnostics; __callArgument178; }), ({ final __callArgument179:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument179; }), (cast 'dragonbones.version-unsupported' : String), (cast 'parseDragonBonesSkeleton' : String), ({ final __callArgument180:Dynamic = { version: resolved }; __callArgument180; }));
      return cast false;
    }
    return cast true;
    return cast null;
