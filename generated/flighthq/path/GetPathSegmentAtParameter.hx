...
class GetPathSegmentAtParameter {
  ...
  public static function getPathSegmentTangentAtParameter(path:Path, segmentIndex:Float, t:Float, out:Vector2Like):Bool {
    return cast (cast GetPathSegmentAtParameter.walkPathSegment__getPathSegmentAtParameter(({ final __callArgument4:Dynamic = path; __callArgument4; }), (cast segmentIndex : Float), (cast t : Float), ({ final __callArgument5:Dynamic = out; __callArgument5; }), (cast true : Bool)) : Bool);
    return cast null;
  }
    ...
    di = 0.0;
    {
      ...
      while ((cast ((cast ci : Float) < (cast _Runtime.field(commands, 'length') : Float)) : Bool)) {
        ...
        if ((cast _Runtime.strictEquals(command, (cast PathCommandValue : { var NO_OP:Float; var MOVE_TO:Float; var LINE_TO:Float; var CURVE_TO:Float; var WIDE_MOVE_TO:Float; var WIDE_LINE_TO:Float; var CUBIC_CURVE_TO:Float; var CLOSE:Float; }).MOVE_TO) : Bool)) {
          ...
          if ((cast _Runtime.strictEquals(currentSegment, segmentIndex) : Bool)) {
            if ((cast wantTangent : Bool)) {
              (cast getQuadraticBezierTangent((cast x : Float), (cast y : Float), (cast cx : Float), (cast cy : Float), (cast x1 : Float), (cast y1 : Float), (cast t : Float), ({ final __callArgument8:Dynamic = out; __callArgument8; })) : Vector2Like);
            } else {
              (cast getQuadraticBezierPoint((cast x : Float), (cast y : Float), (cast cx : Float), (cast cy : Float), (cast x1 : Float), (cast y1 : Float), (cast t : Float), ({ final __callArgument10:Dynamic = out; __callArgument10; })) : Vector2Like);
            }
            return cast true;
          }
          (x = cast (x1 : Dynamic));
          ...
          if ((cast _Runtime.strictEquals(currentSegment, segmentIndex) : Bool)) {
            if ((cast wantTangent : Bool)) {
              (cast getCubicBezierTangent((cast x : Float), (cast y : Float), (cast c1x : Float), (cast c1y : Float), (cast c2x : Float), (cast c2y : Float), (cast x1 : Float), (cast y1 : Float), (cast t : Float), ({ final __callArgument12:Dynamic = out; __callArgument12; })) : Vector2Like);
            } else {
              (cast getCubicBezierPoint((cast x : Float), (cast y : Float), (cast c1x : Float), (cast c1y : Float), (cast c2x : Float), (cast c2y : Float), (cast x1 : Float), (cast y1 : Float), (cast t : Float), ({ final __callArgument14:Dynamic = out; __callArgument14; })) : Vector2Like);
            }
            return cast true;
          }
          (x = cast (x1 : Dynamic));
