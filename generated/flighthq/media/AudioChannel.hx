...
class AudioChannel {
  ...
  public static function setAudioChannelCurrentTime(channel:flighthq.types.AudioResource.AudioChannel, value:Float):Float {
    ...
    if ((cast _Runtime.strictEquals(channel.state, 'playing') : Bool)) {
      ...
      AudioChannel.startAudioChannel__audioChannel(({ final __callArgument18:Dynamic = channel; __callArgument18; }));
    }
  ...
  public static function completeAudioChannel__audioChannel(channel:flighthq.types.AudioResource.AudioChannel):Void {
    ...
    if ((cast !_Runtime.strictEquals((cast runtime : AudioChannelRuntime__audioChannel).loopsRemaining, 0.0) : Bool)) {
      ...
      (channel.currentTime = cast (0.0 : Float));
      AudioChannel.startAudioChannel__audioChannel(({ final __callArgument26:Dynamic = channel; __callArgument26; }));
      return;
    }
  ...
  public static function startAudioChannel__audioChannel(channel:flighthq.types.AudioResource.AudioChannel):Void {
    ...
    ((cast sourceNode : flighthq._internal.dom.AudioBufferSourceNode).onended = function(__unused0:flighthq._internal.dom.Event):Void { AudioChannel.completeAudioChannel__audioChannel(({ final __callArgument28:Dynamic = channel; __callArgument28; })); });
  ...
  public static function stopActiveNode__audioChannel(channel:flighthq.types.AudioResource.AudioChannel, complete:Bool):Void {
    ...
    ((cast runtime : AudioChannelRuntime__audioChannel).sourceNode = null);
    ((cast runtime : AudioChannelRuntime__audioChannel).gainNode = null);
    ((cast sourceNode : flighthq._internal.dom.AudioBufferSourceNode).onended = ((cast complete : Bool) ? (cast function(__unused2:flighthq._internal.dom.Event):Void { AudioChannel.completeAudioChannel__audioChannel(({ final __callArgument31:Dynamic = channel; __callArgument31; })); } : Dynamic) : (cast null : Dynamic)));
