...
class TiledXmlParse {
  ...
  public static function buildTiledLayerFromXml__tiledXmlParse(element:XmlElement, ?options:TiledParseOptions):Null<TiledLayer> {
    ...
    if ((cast _Runtime.strictEquals(element.name, 'objectgroup') : Bool)) {
      return cast _Runtime.mergeObjects([base, { objects: (cast _Runtime.mapArray((cast (cast getXmlElementChildrenByName((cast element), (cast 'object' : String)) : Array<XmlElement>) : Array<XmlElement>), TiledXmlParse.buildTiledObjectFromXml__tiledXmlParse, _Runtime.UNDEFINED)) }, { type: 'objectgroup' }]);
    }
  ...
  public static function buildTiledTilesetTileFromXml__tiledXmlParse(element:XmlElement):TiledTilesetTile {
    ...
    image = (cast getXmlElementChildByName((cast element), (cast 'image' : String)) : Null<XmlElement>);
    frames = ((cast !_Runtime.strictEquals(animation, null) : Bool) ? (cast (cast _Runtime.mapArray((cast (cast getXmlElementChildrenByName((cast animation), (cast 'frame' : String)) : Array<XmlElement>) : Array<XmlElement>), function(frame:XmlElement, __unused4:Float, __unused5:Array<XmlElement>):{ var duration:Float; var tileId:Float; } return { duration: (cast TiledXmlParse.attrNumber__tiledXmlParse((cast frame), (cast 'duration' : String), (cast 0.0 : Float)) : Float), tileId: (cast TiledXmlParse.attrNumber__tiledXmlParse((cast frame), (cast 'tileid' : String), (cast 0.0 : Float)) : Float) }, _Runtime.UNDEFINED)) : Dynamic) : (cast null : Dynamic));
    return cast { animation: frames, id: (cast TiledXmlParse.attrNumber__tiledXmlParse((cast element), (cast 'id' : String), (cast 0.0 : Float)) : Float), image: ((cast !_Runtime.strictEquals(image, null) : Bool) ? (cast (cast TiledXmlParse.attrString__tiledXmlParse((cast image), (cast 'source' : String), (cast '' : String)) : String) : Dynamic) : (cast null : Dynamic)), objects: ((cast !_Runtime.strictEquals(objectGroup, null) : Bool) ? (cast (cast _Runtime.mapArray((cast (cast getXmlElementChildrenByName((cast objectGroup), (cast 'object' : String)) : Array<XmlElement>) : Array<XmlElement>), TiledXmlParse.buildTiledObjectFromXml__tiledXmlParse, _Runtime.UNDEFINED)) : Dynamic) : (cast null : Dynamic)), properties: (cast TiledXmlParse.buildTiledPropertiesFromXml__tiledXmlParse((cast element)) : Array<TiledProperty>), type: (cast TiledXmlParse.attrString__tiledXmlParse((cast element), (cast 'type' : String), (cast (cast TiledXmlParse.attrString__tiledXmlParse((cast element), (cast 'class' : String), (cast '' : String)) : String) : String)) : String) };
    return cast null;
  }
