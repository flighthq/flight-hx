...
class TimelineApi {
  public static function addTimelineFrameScript(timeline:Timeline, frame:Dynamic, script:FrameScript):Void {
    ...
    resolved = _Runtime.callValue(TimelineApi.resolveFrame__timeline, cast ([timeline, frame] : Array<Dynamic>));
  ...
  public static function advanceFrame__timeline(timeline:Timeline, deltaTime:Float):Float {
    ...
    frameRate = _Runtime.callValue(TimelineApi.getTimelineFrameRate__timeline, cast ([timeline] : Array<Dynamic>));
    totalFrames = _Runtime.callValue(TimelineApi.getTimelineTotalFrames__timeline, cast ([timeline] : Array<Dynamic>));
  ...
  public static function enableTimelineSignals(timeline:Timeline):TimelineSignals {
    return cast _Runtime.setField(timeline, 'signals', (_Runtime.field(timeline, 'signals') ?? _Runtime.callValue(TimelineApi.createTimelineSignals__timeline, cast ([] : Array<Dynamic>))));
    return cast null;
  }

  public static function findTimelineLabel(timeline:Timeline, name:String):Null<TimelineLabel> {
    return cast _Runtime.coalesce(_Runtime.find(_Runtime.callValue(TimelineApi.getTimelineLabels__timeline, cast ([timeline] : Array<Dynamic>)), function(l:Dynamic) return _Runtime.strictEquals(_Runtime.field(l, 'name'), name)), function():Dynamic return cast null);
    return cast null;
  }
  ...
  if (_Runtime.truthy(_Runtime.andValue(!_Runtime.strictEquals(script, _Runtime.UNDEFINED), function():Dynamic return cast !_Runtime.strictEquals(target, null)))) { _Runtime.callValue(script, cast ([target, current] : Array<Dynamic>)); }
}
  ...
  public static function getTimelineCurrentLabel(timeline:Timeline):Null<TimelineLabel> {
    ...
    labels = _Runtime.callValue(TimelineApi.getTimelineLabels__timeline, cast ([timeline] : Array<Dynamic>));
  ...
  public static function getTimelineLabels__timeline(timeline:Timeline):Array<TimelineLabel> {
    return cast _Runtime.coalesce(_Runtime.optionalField(_Runtime.field(timeline, 'source'), 'labels'), function():Dynamic return cast TimelineApi.EMPTY_LABELS__timeline);
    return cast null;
  }
  ...
  public static function gotoAndPlayTimeline(timeline:Timeline, frame:Dynamic):Void {
    ...
    _Runtime.callValue(TimelineApi.seekTimeline__timeline, cast ([timeline, _Runtime.callValue(TimelineApi.resolveFrame__timeline, cast ([timeline, frame] : Array<Dynamic>))] : Array<Dynamic>));
  }
  ...
  public static function nextFrameTimeline(timeline:Timeline):Void {
    _Runtime.callValue(stopTimeline, cast ([timeline] : Array<Dynamic>));
    _Runtime.callValue(TimelineApi.seekTimeline__timeline, cast ([timeline, (_Runtime.field(timeline, 'currentFrame') + 1.0)] : Array<Dynamic>));
  }
  ...
  public static function playTimeline(timeline:Timeline):Void {
    if (_Runtime.truthy(_Runtime.orValue(_Runtime.field(timeline, 'isPlaying'), function():Dynamic return cast _Runtime.compare(_Runtime.callValue(TimelineApi.getTimelineTotalFrames__timeline, cast ([timeline] : Array<Dynamic>)), 2.0, '<')))) { return; }
  ...
  public static function seekTimeline__timeline(timeline:Timeline, frame:Float):Void {
    _Runtime.setField(timeline, 'currentFrame', _Runtime.callProperty(HxMath, 'max', cast ([1.0, _Runtime.callProperty(HxMath, 'min', cast ([frame, _Runtime.callValue(TimelineApi.getTimelineTotalFrames__timeline, cast ([timeline] : Array<Dynamic>))] : Array<Dynamic>))] : Array<Dynamic>)));
    _Runtime.setField(timeline, 'lastFrameUpdate', -1.0);
    _Runtime.callValue(TimelineApi.fireConstructFrame__timeline, cast ([timeline] : Array<Dynamic>));
  }
  ...
  _Runtime.setField(timeline, 'currentFrame', _Runtime.callValue(TimelineApi.advanceFrame__timeline, cast ([timeline, deltaTime] : Array<Dynamic>)));
}
    _Runtime.callValue(TimelineApi.fireConstructFrame__timeline, cast ([timeline] : Array<Dynamic>));
    if (_Runtime.truthy(_Runtime.andValue(_Runtime.field(timeline, 'isPlaying'), function():Dynamic return cast _Runtime.strictEquals(frameRate, null)))) {
  _Runtime.setField(timeline, 'currentFrame', _Runtime.callValue(TimelineApi.advanceFrame__timeline, cast ([timeline, deltaTime] : Array<Dynamic>)));
