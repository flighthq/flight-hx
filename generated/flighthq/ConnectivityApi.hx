...
class ConnectivityApi {
  ...
  public static function attachConnectivity(net:Connectivity):Void {
    ...
    initial = _Runtime.callProperty(backend, 'getStatus', cast ([ConnectivityApi._scratch__connectivity] : Array<Dynamic>));
  ...
  status = _Runtime.callProperty(backend, 'getStatus', cast ([ConnectivityApi._scratch__connectivity] : Array<Dynamic>));
  ...
  _Runtime.callValue(emitSignal, cast ([_Runtime.field(net, 'onMeteredChange'), _Runtime.field(status, 'metered')] : Array<Dynamic>));
    ...
    _Runtime.callProperty(ConnectivityApi._subscriptions__connectivity, 'set', cast ([net, unsubscribe] : Array<Dynamic>));
  }
  ...
  conn = _Runtime.callValue(ConnectivityApi.getWebConnection__connectivity, cast ([] : Array<Dynamic>));
  _Runtime.setField(out, 'type', _Runtime.callValue(ConnectivityApi.mapWebConnectionType__connectivity, cast ([_Runtime.optionalField(conn, 'type')] : Array<Dynamic>)));
  ...
  combinedSignal = _Runtime.select(_Runtime.field(options, 'signal'), function():Dynamic return cast _Runtime.callValue(ConnectivityApi.anyAbortSignal__connectivity, cast ([_Runtime.field(options, 'signal'), _Runtime.field(controller, 'signal')] : Array<Dynamic>)), function():Dynamic return cast _Runtime.field(controller, 'signal'));
  ...
  public static function detachConnectivity(net:Connectivity):Void {
    var unsubscribe:Dynamic = cast _Runtime.UNDEFINED;
    unsubscribe = _Runtime.callProperty(ConnectivityApi._subscriptions__connectivity, 'get', cast ([net] : Array<Dynamic>));
    if (_Runtime.truthy(!_Runtime.strictEquals(unsubscribe, _Runtime.UNDEFINED))) {
  _Runtime.callValue(unsubscribe, cast ([] : Array<Dynamic>));
  _Runtime.callProperty(ConnectivityApi._subscriptions__connectivity, 'delete', cast ([net] : Array<Dynamic>));
}
  }
  ...
  public static function detectConnectivityReachability(options:ConnectivityReachabilityOptions, out:ConnectivityReachability):flighthq._internal._Promise<ConnectivityReachability> {
    return cast flighthq._internal._Async.make(function():flighthq._internal._Promise<ConnectivityReachability> {
      ...
      backend = _Runtime.callValue(getConnectivityBackend, cast ([] : Array<Dynamic>));
      if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(backend, 'detectReachability'), _Runtime.UNDEFINED))) {
  return cast _Runtime.callProperty(backend, 'detectReachability', cast ([options, out] : Array<Dynamic>));
}
      if (_Runtime.truthy(_Runtime.strictEquals(ConnectivityApi._cachedWebBackend__connectivity, null))) { (ConnectivityApi._cachedWebBackend__connectivity = cast (_Runtime.callValue(createWebConnectivityBackend, cast ([] : Array<Dynamic>)) : Dynamic)); }
      webBackend = ConnectivityApi._cachedWebBackend__connectivity;
      if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(webBackend, 'detectReachability'), _Runtime.UNDEFINED))) {
  ...
  public static function getConnectivityBackend():ConnectivityBackend {
    if (_Runtime.truthy(_Runtime.strictEquals(ConnectivityApi._backend__connectivity, null))) { (ConnectivityApi._backend__connectivity = cast (_Runtime.callValue(createWebConnectivityBackend, cast ([] : Array<Dynamic>)) : Dynamic)); }
  ...
  public static function isConnectivityMetered():Bool {
    return cast _Runtime.field(_Runtime.callProperty(_Runtime.callValue(getConnectivityBackend, cast ([] : Array<Dynamic>)), 'getStatus', cast ([ConnectivityApi._scratch__connectivity] : Array<Dynamic>)), 'metered');
    return cast null;
  }

  public static function isConnectivityOnline():Bool {
    return cast _Runtime.field(_Runtime.callProperty(_Runtime.callValue(getConnectivityBackend, cast ([] : Array<Dynamic>)), 'getStatus', cast ([ConnectivityApi._scratch__connectivity] : Array<Dynamic>)), 'online');
    return cast null;
  }

  public static function isConnectivitySaveDataEnabled():Bool {
    return cast _Runtime.field(_Runtime.callProperty(_Runtime.callValue(getConnectivityBackend, cast ([] : Array<Dynamic>)), 'getStatus', cast ([ConnectivityApi._scratch__connectivity] : Array<Dynamic>)), 'saveData');
    return cast null;
  }
