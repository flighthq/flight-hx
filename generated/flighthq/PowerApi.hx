...
class PowerApi {
  ...
  public static function attachPower(power:Power, idleThresholdSeconds:Dynamic = 60.0):Void {
    ...
    wasCharging = _Runtime.field(_Runtime.callProperty(backend, 'getStatus', cast ([PowerApi._scratch__power] : Array<Dynamic>)), 'isCharging');
    unsubscribeChange = _Runtime.callProperty(backend, 'subscribe', cast ([function() {
  var status:Dynamic = cast _Runtime.UNDEFINED;
  status = _Runtime.callProperty(backend, 'getStatus', cast ([PowerApi._scratch__power] : Array<Dynamic>));
  ...
  _Runtime.callValue(emitSignal, cast ([idleSignal] : Array<Dynamic>));
    ...
    _Runtime.callProperty(PowerApi._subscriptions__power, 'set', cast ([power, function() {
  ...
  return cast !_Runtime.strictEquals(PowerApi._wakeLockSentinel__power, null);
  ...
  if (_Runtime.truthy(_Runtime.strictEquals(wakeLock, _Runtime.UNDEFINED))) { return cast false; }
  try {
  if (_Runtime.truthy(!_Runtime.truthy(enabled))) {
  _Runtime.callOptionalProperty(_Runtime.callOptionalProperty(PowerApi._wakeLockSentinel__power, 'release', cast ([] : Array<Dynamic>)), 'catch', cast ([function() {
  ...
  if (_Runtime.truthy(_Runtime.andValue(_Runtime.strictEquals(PowerApi._wakeLockSentinel__power, sentinel), function():Dynamic return cast !_Runtime.truthy(_Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['document'] : Array<Dynamic>)), 'hidden'))))) {
  ...
  if (_Runtime.truthy(_Runtime.strictEquals(PowerApi._wakeLockSentinel__power, sentinel))) { (PowerApi._wakeLockSentinel__power = cast (newSentinel : Dynamic)); }
  ...
  battery = _Runtime.callValue(PowerApi.getWebBatteryManagerPromise__power, cast ([] : Array<Dynamic>));
  ...
  public static function detachPower(power:Power):Void {
    ...
    unsubscribe = _Runtime.callProperty(PowerApi._subscriptions__power, 'get', cast ([power] : Array<Dynamic>));
    if (_Runtime.truthy(!_Runtime.strictEquals(unsubscribe, _Runtime.UNDEFINED))) {
  _Runtime.callValue(unsubscribe, cast ([] : Array<Dynamic>));
  _Runtime.callProperty(PowerApi._subscriptions__power, 'delete', cast ([power] : Array<Dynamic>));
}
  }
  ...
  public static function getPowerBackend():PowerBackend {
    if (_Runtime.truthy(_Runtime.strictEquals(PowerApi._backend__power, null))) { (PowerApi._backend__power = cast (_Runtime.callValue(createWebPowerBackend, cast ([] : Array<Dynamic>)) : Dynamic)); }
  ...
  public static function getPowerThermalState():PowerThermalState {
    return cast _Runtime.field(_Runtime.callProperty(_Runtime.callValue(getPowerBackend, cast ([] : Array<Dynamic>)), 'getStatus', cast ([PowerApi._scratch__power] : Array<Dynamic>)), 'thermalState');
    return cast null;
  }
