...
class CocosPlistSerialize {
  public static function serializeCocosPlistSpritesheet(data:SpritesheetData, ?existing:{ @:optional var frames:Null<flighthq._internal._Record<String, CocosPlistFrame>>; @:optional var metadata:Null<CocosPlistMetadata>; }):String {
    ...
    doc = (cast { frames: frames, metadata: { format: _Runtime.coalesce(({ final __typedStruct5 = ({ final __structural4 = existing; __structural4 == null ? _Runtime.UNDEFINED : (cast __structural4 : { @:optional var metadata:Null<CocosPlistMetadata>; }).metadata; }); __typedStruct5 == null ? _Runtime.UNDEFINED : (cast __typedStruct5 : { var format:Float; }).format; }), function():Dynamic return cast 3.0), size: '{' + Std.string(data.imageWidth) + ',' + Std.string(data.imageHeight) + '}', textureFileName: _Runtime.orValue(_Runtime.orValue(data.imageFile, function():Dynamic return cast ({ final __typedStruct7 = ({ final __structural6 = existing; __structural6 == null ? _Runtime.UNDEFINED : (cast __structural6 : { @:optional var metadata:Null<CocosPlistMetadata>; }).metadata; }); __typedStruct7 == null ? _Runtime.UNDEFINED : (cast __typedStruct7 : { var textureFileName:String; }).textureFileName; })), function():Dynamic return cast '') } });
    return cast (cast CocosPlistSerialize.documentToXml__cocosPlistSerialize(({ final __callArgument8:Dynamic = doc; __callArgument8; })) : String);
    return cast null;
  }
