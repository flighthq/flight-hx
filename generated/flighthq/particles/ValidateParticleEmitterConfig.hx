...
class ValidateParticleEmitterConfig {
  ...
  public static function normalizeParticleEmitterConfig(?config:{ @:optional var alphaEnd:Null<Float>; @:optional var alphaStart:Null<Float>; @:optional var blendMode:Null<ParticleBlendMode>; @:optional var colorEndB:Null<Float>; @:optional var colorEndG:Null<Float>; @:optional var colorEndR:Null<Float>; @:optional var colorEndVarianceB:Null<Float>; @:optional var colorEndVarianceG:Null<Float>; @:optional var colorEndVarianceR:Null<Float>; @:optional var colorStartB:Null<Float>; @:optional var colorStartG:Null<Float>; @:optional var colorStartR:Null<Float>; @:optional var colorStartVarianceB:Null<Float>; @:optional var colorStartVarianceG:Null<Float>; @:optional var colorStartVarianceR:Null<Float>; @:optional var directionX:Null<Float>; @:optional var directionY:Null<Float>; @:optional var directionZ:Null<Float>; @:optional var gravityX:Null<Float>; @:optional var gravityY:Null<Float>; @:optional var gravityZ:Null<Float>; @:optional var emitterConeAngle:Null<Float>; @:optional var emitterDepth:Null<Float>; @:optional var emitterHeight:Null<Float>; @:optional var emitterRadius:Null<Float>; @:optional var emitterShape:Null<ParticleEmitterShape>; @:optional var emitterWidth:Null<Float>; @:optional var burstCount:Null<Float>; @:optional var burstInterval:Null<Float>; @:optional var duration:Null<Float>; @:optional var loop:Null<Bool>; @:optional var frameCount:Null<Float>; @:optional var frameRate:Null<Float>; @:optional var lifetimeMax:Null<Float>; @:optional var lifetimeMin:Null<Float>; @:optional var maxParticles:Null<Float>; @:optional var regionIdMax:Null<Float>; @:optional var regionIdMin:Null<Float>; @:optional var scaleEnd:Null<Float>; @:optional var scaleMax:Null<Float>; @:optional var scaleMin:Null<Float>; @:optional var speedMax:Null<Float>; @:optional var speedMin:Null<Float>; @:optional var spawnRate:Null<Float>; @:optional var spread:Null<Float>; @:optional var rotationSpeedMax:Null<Float>; @:optional var rotationSpeedMin:Null<Float>; @:optional var velocityInheritance:Null<Float>; @:optional var alphaCurve:Null<ParticleCurve>; @:optional var colorCurve:Null<ParticleCurve>; @:optional var scaleCurve:Null<ParticleCurve>; @:optional var worldSpace:Null<Bool>; }):ParticleEmitterConfig {
    ...
    return cast _Runtime.mergeObjects([out, { alphaCurve: ((cast (cast ValidateParticleEmitterConfig.isFiniteCurve__validateParticleEmitterConfig(({ final __callArgument2:Dynamic = out.alphaCurve; __callArgument2; })) : Bool) : Bool) ? (cast out.alphaCurve : Dynamic) : (cast null : Dynamic)) }, { colorCurve: ((cast (cast ValidateParticleEmitterConfig.isFiniteCurve__validateParticleEmitterConfig(({ final __callArgument4:Dynamic = out.colorCurve; __callArgument4; })) : Bool) : Bool) ? (cast out.colorCurve : Dynamic) : (cast null : Dynamic)) }, { scaleCurve: ((cast (cast ValidateParticleEmitterConfig.isFiniteCurve__validateParticleEmitterConfig(({ final __callArgument6:Dynamic = out.scaleCurve; __callArgument6; })) : Bool) : Bool) ? (cast out.scaleCurve : Dynamic) : (cast null : Dynamic)) }, { maxParticles: HxMath.max(0.0, HxMath.floor(out.maxParticles)) }, { burstCount: HxMath.max(0.0, HxMath.floor(out.burstCount)) }, { burstInterval: HxMath.max(0.0, out.burstInterval) }, { duration: HxMath.max(0.0, out.duration) }, { frameCount: HxMath.max(1.0, HxMath.floor(out.frameCount)) }, { frameRate: HxMath.max(0.0, out.frameRate) }, { regionIdMin: HxMath.max(0.0, HxMath.floor(out.regionIdMin)) }, { regionIdMax: HxMath.max(HxMath.max(0.0, HxMath.floor(out.regionIdMin)), HxMath.floor(out.regionIdMax)) }, { spawnRate: HxMath.max(0.0, out.spawnRate) }, { lifetimeMin: HxMath.max(0.0, out.lifetimeMin) }, { lifetimeMax: HxMath.max(0.0, out.lifetimeMax) }, { speedMin: HxMath.max(0.0, out.speedMin) }, { speedMax: HxMath.max(0.0, out.speedMax) }, { scaleMin: HxMath.max(0.0, out.scaleMin) }, { scaleMax: HxMath.max(0.0, out.scaleMax) }, { emitterConeAngle: HxMath.max(0.0, out.emitterConeAngle) }, { emitterDepth: HxMath.max(0.0, out.emitterDepth) }, { emitterRadius: HxMath.max(0.0, out.emitterRadius) }, { emitterWidth: HxMath.max(0.0, out.emitterWidth) }, { emitterHeight: HxMath.max(0.0, out.emitterHeight) }]);
    return cast null;
  }
  ...
  public static function validateParticleEmitterConfig(config:ParticleEmitterConfig):Array<ParticleConfigIssue> {
    ...
    ValidateParticleEmitterConfig.reportInvertedRange__validateParticleEmitterConfig(({ final __callArgument12:Dynamic = issues; __callArgument12; }), ({ final __callArgument13:Dynamic = config; __callArgument13; }), (cast 'lifetimeMin' : String), (cast 'lifetimeMax' : String));
    ValidateParticleEmitterConfig.reportInvertedRange__validateParticleEmitterConfig(({ final __callArgument16:Dynamic = issues; __callArgument16; }), ({ final __callArgument17:Dynamic = config; __callArgument17; }), (cast 'speedMin' : String), (cast 'speedMax' : String));
    ValidateParticleEmitterConfig.reportInvertedRange__validateParticleEmitterConfig(({ final __callArgument20:Dynamic = issues; __callArgument20; }), ({ final __callArgument21:Dynamic = config; __callArgument21; }), (cast 'scaleMin' : String), (cast 'scaleMax' : String));
    ValidateParticleEmitterConfig.reportInvertedRange__validateParticleEmitterConfig(({ final __callArgument24:Dynamic = issues; __callArgument24; }), ({ final __callArgument25:Dynamic = config; __callArgument25; }), (cast 'rotationSpeedMin' : String), (cast 'rotationSpeedMax' : String));
    ValidateParticleEmitterConfig.reportUnitRange__validateParticleEmitterConfig(({ final __callArgument28:Dynamic = issues; __callArgument28; }), ({ final __callArgument29:Dynamic = config; __callArgument29; }), (cast 'alphaStart' : String));
    ValidateParticleEmitterConfig.reportUnitRange__validateParticleEmitterConfig(({ final __callArgument32:Dynamic = issues; __callArgument32; }), ({ final __callArgument33:Dynamic = config; __callArgument33; }), (cast 'alphaEnd' : String));
    ValidateParticleEmitterConfig.reportCurve__validateParticleEmitterConfig(({ final __callArgument36:Dynamic = issues; __callArgument36; }), ({ final __callArgument37:Dynamic = config.alphaCurve; __callArgument37; }), (cast 'alphaCurve' : String), (cast 1.0 : Float));
    ValidateParticleEmitterConfig.reportCurve__validateParticleEmitterConfig(({ final __callArgument40:Dynamic = issues; __callArgument40; }), ({ final __callArgument41:Dynamic = config.colorCurve; __callArgument41; }), (cast 'colorCurve' : String), (cast 3.0 : Float));
    ValidateParticleEmitterConfig.reportCurve__validateParticleEmitterConfig(({ final __callArgument44:Dynamic = issues; __callArgument44; }), ({ final __callArgument45:Dynamic = config.scaleCurve; __callArgument45; }), (cast 'scaleCurve' : String), (cast 1.0 : Float));
    return cast issues;
    return cast null;
  }
