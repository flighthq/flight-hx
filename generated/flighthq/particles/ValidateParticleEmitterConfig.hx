...
class ValidateParticleEmitterConfig {
  ...
  public static function normalizeParticleEmitterConfig(?config:flighthq._internal._Partial<ParticleEmitterConfig>):ParticleEmitterConfig {
    ...
    out = (cast createParticleEmitterConfig(({ final __callArgument0:Dynamic = config; __callArgument0; })) : ParticleEmitterConfig);
    ...
    return cast _Runtime.mergeObjects([out, { alphaCurve: ((cast (cast ValidateParticleEmitterConfig.isFiniteCurve__validateParticleEmitterConfig(({ final __callArgument3:Dynamic = out.alphaCurve; __callArgument3; })) : Bool) : Bool) ? (cast out.alphaCurve : Dynamic) : (cast null : Dynamic)) }, { colorCurve: ((cast (cast ValidateParticleEmitterConfig.isFiniteCurve__validateParticleEmitterConfig(({ final __callArgument4:Dynamic = out.colorCurve; __callArgument4; })) : Bool) : Bool) ? (cast out.colorCurve : Dynamic) : (cast null : Dynamic)) }, { scaleCurve: ((cast (cast ValidateParticleEmitterConfig.isFiniteCurve__validateParticleEmitterConfig(({ final __callArgument5:Dynamic = out.scaleCurve; __callArgument5; })) : Bool) : Bool) ? (cast out.scaleCurve : Dynamic) : (cast null : Dynamic)) }, { maxParticles: HxMath.max(0.0, HxMath.floor(out.maxParticles)) }, { burstCount: HxMath.max(0.0, HxMath.floor(out.burstCount)) }, { burstInterval: HxMath.max(0.0, out.burstInterval) }, { duration: HxMath.max(0.0, out.duration) }, { frameCount: HxMath.max(1.0, HxMath.floor(out.frameCount)) }, { frameRate: HxMath.max(0.0, out.frameRate) }, { regionIdMin: HxMath.max(0.0, HxMath.floor(out.regionIdMin)) }, { regionIdMax: HxMath.max(HxMath.max(0.0, HxMath.floor(out.regionIdMin)), HxMath.floor(out.regionIdMax)) }, { spawnRate: HxMath.max(0.0, out.spawnRate) }, { lifetimeMin: HxMath.max(0.0, out.lifetimeMin) }, { lifetimeMax: HxMath.max(0.0, out.lifetimeMax) }, { speedMin: HxMath.max(0.0, out.speedMin) }, { speedMax: HxMath.max(0.0, out.speedMax) }, { scaleMin: HxMath.max(0.0, out.scaleMin) }, { scaleMax: HxMath.max(0.0, out.scaleMax) }, { emitterConeAngle: HxMath.max(0.0, out.emitterConeAngle) }, { emitterDepth: HxMath.max(0.0, out.emitterDepth) }, { emitterRadius: HxMath.max(0.0, out.emitterRadius) }, { emitterWidth: HxMath.max(0.0, out.emitterWidth) }, { emitterHeight: HxMath.max(0.0, out.emitterHeight) }]);
    return cast null;
  }
  ...
  public static function validateParticleEmitterConfig(config:ParticleEmitterConfig):Array<ParticleConfigIssue> {
    ...
    ValidateParticleEmitterConfig.reportInvertedRange__validateParticleEmitterConfig(({ final __callArgument10:Dynamic = issues; __callArgument10; }), ({ final __callArgument11:Dynamic = config; __callArgument11; }), (cast 'lifetimeMin' : String), (cast 'lifetimeMax' : String));
    ValidateParticleEmitterConfig.reportInvertedRange__validateParticleEmitterConfig(({ final __callArgument12:Dynamic = issues; __callArgument12; }), ({ final __callArgument13:Dynamic = config; __callArgument13; }), (cast 'speedMin' : String), (cast 'speedMax' : String));
    ValidateParticleEmitterConfig.reportInvertedRange__validateParticleEmitterConfig(({ final __callArgument14:Dynamic = issues; __callArgument14; }), ({ final __callArgument15:Dynamic = config; __callArgument15; }), (cast 'scaleMin' : String), (cast 'scaleMax' : String));
    ValidateParticleEmitterConfig.reportInvertedRange__validateParticleEmitterConfig(({ final __callArgument16:Dynamic = issues; __callArgument16; }), ({ final __callArgument17:Dynamic = config; __callArgument17; }), (cast 'rotationSpeedMin' : String), (cast 'rotationSpeedMax' : String));
    ValidateParticleEmitterConfig.reportUnitRange__validateParticleEmitterConfig(({ final __callArgument18:Dynamic = issues; __callArgument18; }), ({ final __callArgument19:Dynamic = config; __callArgument19; }), (cast 'alphaStart' : String));
    ValidateParticleEmitterConfig.reportUnitRange__validateParticleEmitterConfig(({ final __callArgument20:Dynamic = issues; __callArgument20; }), ({ final __callArgument21:Dynamic = config; __callArgument21; }), (cast 'alphaEnd' : String));
    ValidateParticleEmitterConfig.reportCurve__validateParticleEmitterConfig(({ final __callArgument22:Dynamic = issues; __callArgument22; }), ({ final __callArgument23:Dynamic = config.alphaCurve; __callArgument23; }), (cast 'alphaCurve' : String), (cast 1.0 : Float));
    ValidateParticleEmitterConfig.reportCurve__validateParticleEmitterConfig(({ final __callArgument24:Dynamic = issues; __callArgument24; }), ({ final __callArgument25:Dynamic = config.colorCurve; __callArgument25; }), (cast 'colorCurve' : String), (cast 3.0 : Float));
    ValidateParticleEmitterConfig.reportCurve__validateParticleEmitterConfig(({ final __callArgument26:Dynamic = issues; __callArgument26; }), ({ final __callArgument27:Dynamic = config.scaleCurve; __callArgument27; }), (cast 'scaleCurve' : String), (cast 1.0 : Float));
    return cast issues;
    return cast null;
  }
