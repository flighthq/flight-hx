...
class Log {
  ...
  public static function createChildLogContext(parent:LogContext, fields:Dynamic, ?channel:Null<String>):LogContext {
    ...
    return cast { channel: _Runtime.select(!_Runtime.strictEquals(channel, _Runtime.UNDEFINED), function():Dynamic return cast channel, function():Dynamic return cast _Runtime.field(parent, 'channel')), fields: merged };
    return cast null;
  }
  ...
  public static function serializeLogError(value:Dynamic):Dynamic {
    ...
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(value, 'stack'), _Runtime.UNDEFINED))) { _Runtime.setField(result, 'stack', _Runtime.field(value, 'stack')); }
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(value, 'cause'), _Runtime.UNDEFINED))) { _Runtime.setField(result, 'cause', _Runtime.callValue(serializeLogError, cast ([_Runtime.field(value, 'cause')] : Array<Dynamic>))); }
    return cast result;
    return cast null;
  }
