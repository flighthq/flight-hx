...
class SubsurfacePbrGlMeshMaterialRenderer {
  public static final subsurfacePbrGlMeshMaterialRenderer:GlMeshMaterialRenderer = { bind: function(state:GlRenderState, material:Null<Material>, lights:SceneLightBlock, camera:Camera3D) {
    ...
    flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locAlphaCutoff'), _Runtime.select(!_Runtime.strictEquals(subsurface, null), function():Dynamic return cast _Runtime.field(subsurface, 'alphaCutoff'), function():Dynamic return cast 0.5)] : Array<Dynamic>));
    if (_Runtime.truthy(!_Runtime.strictEquals(subsurface, null))) {
      ...
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locSubsurface'), _Runtime.field(subsurface, 'subsurface')] : Array<Dynamic>));
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform3f', cast ([_Runtime.field(program, 'locSubsurfaceColor'), _Runtime.getIndex(SubsurfacePbrGlMeshMaterialRenderer.scratchRgba__subsurfacePbrGlMeshMaterialRenderer, 0.0), _Runtime.getIndex(SubsurfacePbrGlMeshMaterialRenderer.scratchRgba__subsurfacePbrGlMeshMaterialRenderer, 1.0), _Runtime.getIndex(SubsurfacePbrGlMeshMaterialRenderer.scratchRgba__subsurfacePbrGlMeshMaterialRenderer, 2.0)] : Array<Dynamic>));
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locThickness'), _Runtime.field(subsurface, 'thickness')] : Array<Dynamic>));
    } else {
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locSubsurface'), 0.0] : Array<Dynamic>));
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform3f', cast ([_Runtime.field(program, 'locSubsurfaceColor'), 1.0, 1.0, 1.0] : Array<Dynamic>));
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locThickness'), 0.0] : Array<Dynamic>));
    }
