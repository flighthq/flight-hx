...
class SubsurfacePbrGlMeshMaterialRenderer {
  public static final subsurfacePbrGlMeshMaterialRenderer:GlMeshMaterialRenderer = { bind: function(state:GlRenderState, material:Null<Material>, lights:SceneLightBlock, camera:Camera) {
    ...
    flighthq._internal.backend.WebGl2Backend.uniform1f(gl, _Runtime.field(program, 'locAlphaCutoff'), _Runtime.select(!_Runtime.strictEquals(subsurface, null), function():Dynamic return cast _Runtime.field(subsurface, 'alphaCutoff'), function():Dynamic return cast 0.5));
    if (_Runtime.truthy(!_Runtime.strictEquals(subsurface, null))) {
      ...
      flighthq._internal.backend.WebGl2Backend.uniform3f(gl, _Runtime.field(program, 'locSubsurfaceColor'), 1.0, 1.0, 1.0);
      flighthq._internal.backend.WebGl2Backend.uniform1f(gl, _Runtime.field(program, 'locThickness'), 0.0);
    }
