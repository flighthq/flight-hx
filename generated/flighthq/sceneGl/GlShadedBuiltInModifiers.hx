...
class GlShadedBuiltInModifiers {
  ...
  public static final rimGlModifierSnippet:GlModifierSnippet = _Runtime.mergeObjects([rimModifierDefinition, { bind: function(modifier:Modifier, context:GlModifierBindContext) {
    ...
    flighthq._internal.backend.WebGl2Backend.uniform3f(gl, flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, _Runtime.field(context, 'program'), 'u_rimColor' + Std.string(suffix) + ''), _Runtime.getIndex(GlShadedBuiltInModifiers.scratchRgba__glShadedBuiltInModifiers, 0.0), _Runtime.getIndex(GlShadedBuiltInModifiers.scratchRgba__glShadedBuiltInModifiers, 1.0), _Runtime.getIndex(GlShadedBuiltInModifiers.scratchRgba__glShadedBuiltInModifiers, 2.0));
  ...
  public static final envReflectGlModifierSnippet:GlModifierSnippet = _Runtime.mergeObjects([envReflectModifierDefinition, { bind: function(modifier:Modifier, context:GlModifierBindContext) {
    ...
    flighthq._internal.backend.WebGl2Backend.uniform3f(gl, flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, _Runtime.field(context, 'program'), 'u_envReflectTint' + Std.string(suffix) + ''), _Runtime.getIndex(GlShadedBuiltInModifiers.scratchRgba__glShadedBuiltInModifiers, 0.0), _Runtime.getIndex(GlShadedBuiltInModifiers.scratchRgba__glShadedBuiltInModifiers, 1.0), _Runtime.getIndex(GlShadedBuiltInModifiers.scratchRgba__glShadedBuiltInModifiers, 2.0));
