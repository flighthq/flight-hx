...
class GlShadedBuiltInModifiers {
  public static final animatedNormalGlModifierSnippet:GlModifierSnippet = _Runtime.mergeObjects([animatedNormalModifierDefinition, { bind: function(modifier:Modifier, context:GlModifierBindContext) {
    ...
    flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform2f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_animNormalScroll' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.field(scroll, 'x'), _Runtime.field(scroll, 'y')] : Array<Dynamic>));
    flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_animNormalStrength' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.coalesce(_Runtime.field(animated, 'strength'), function():Dynamic return cast 1.0)] : Array<Dynamic>));
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(animated, 'secondaryMap'), _Runtime.field(_Runtime, 'UNDEFINED')))) {
      ...
      flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform2f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_animNormalScroll2' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.field(secondary, 'x'), _Runtime.field(secondary, 'y')] : Array<Dynamic>));
    }
  ...
  public static final emissiveGlModifierSnippet:GlModifierSnippet = _Runtime.mergeObjects([emissiveModifierDefinition, { bind: function(modifier:Modifier, context:GlModifierBindContext) {
    ...
    if (_Runtime.truthy(_Runtime.callValue(GlShadedBuiltInModifiers.isEmissiveGated__glShadedBuiltInModifiers, cast ([emissive] : Array<Dynamic>)))) {
      ...
      flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_emissiveFacingSign' + Std.string(suffix) + ''] : Array<Dynamic>)), sign] : Array<Dynamic>));
  ...
  public static final rimGlModifierSnippet:GlModifierSnippet = _Runtime.mergeObjects([rimModifierDefinition, { bind: function(modifier:Modifier, context:GlModifierBindContext) {
    ...
    flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_rimPower' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.coalesce(_Runtime.field(rim, 'power'), function():Dynamic return cast 3.0)] : Array<Dynamic>));
    flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_rimIntensity' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.coalesce(_Runtime.field(rim, 'intensity'), function():Dynamic return cast 1.0)] : Array<Dynamic>));
    flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_rimBias' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.coalesce(_Runtime.field(rim, 'bias'), function():Dynamic return cast 0.0)] : Array<Dynamic>));
  ...
  public static final dissolveGlModifierSnippet:GlModifierSnippet = _Runtime.mergeObjects([dissolveModifierDefinition, { bind: function(modifier:Modifier, context:GlModifierBindContext) {
    ...
    gl = _Runtime.field(_Runtime.field(context, 'state'), 'gl');
    suffix = '_' + Std.string(_Runtime.field(context, 'index')) + '';
    flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_dissolveThreshold' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.field(dissolve, 'threshold')] : Array<Dynamic>));
  ...
  public static final fogGlModifierSnippet:GlModifierSnippet = _Runtime.mergeObjects([fogModifierDefinition, { bind: function(modifier:Modifier, context:GlModifierBindContext) {
    ...
    if (_Runtime.truthy(_Runtime.orValue(_Runtime.strictEquals(_Runtime.field(fog, 'mode'), _Runtime.field(_Runtime, 'UNDEFINED')), function():Dynamic return cast _Runtime.strictEquals(_Runtime.field(fog, 'mode'), FogModifierModeValue.Linear)))) {
      flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_fogNear' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.coalesce(_Runtime.field(fog, 'near'), function():Dynamic return cast 0.0)] : Array<Dynamic>));
      flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_fogFar' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.coalesce(_Runtime.field(fog, 'far'), function():Dynamic return cast 1.0)] : Array<Dynamic>));
    } else {
  ...
  public static final toonGlModifierSnippet:GlModifierSnippet = _Runtime.mergeObjects([toonModifierDefinition, { bind: function(modifier:Modifier, context:GlModifierBindContext) {
    ...
    gl = _Runtime.field(_Runtime.field(context, 'state'), 'gl');
    suffix = '_' + Std.string(_Runtime.field(context, 'index')) + '';
    flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_toonSteps' + Std.string(suffix) + ''] : Array<Dynamic>)), HxMath.max(_Runtime.field(toon, 'steps'), 2.0)] : Array<Dynamic>));
  ...
  public static final vertexDisplaceGlModifierSnippet:GlModifierSnippet = _Runtime.mergeObjects([vertexDisplaceModifierDefinition, { bind: function(modifier:Modifier, context:GlModifierBindContext) {
    ...
    gl = _Runtime.field(_Runtime.field(context, 'state'), 'gl');
    suffix = '_' + Std.string(_Runtime.field(context, 'index')) + '';
    flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_vDisplaceAmplitude' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.field(displace, 'amplitude')] : Array<Dynamic>));
    ...
    if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.field(displace, 'source'), VertexDisplaceModifierSourceValue.HeightMap))) {
      ...
      flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform3f', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), 'u_vDisplaceDir' + Std.string(suffix) + ''] : Array<Dynamic>)), _Runtime.field(dir, 'x'), _Runtime.field(dir, 'y'), _Runtime.field(dir, 'z')] : Array<Dynamic>));
    }
  } }, { contribution: function(modifier:Modifier, index:Float) {
    var displace:Dynamic = cast _Runtime.UNDEFINED;
    var suffix:Dynamic = cast _Runtime.UNDEFINED;
  ...
  public static function bindGlModifierTexture__glShadedBuiltInModifiers(context:GlModifierBindContext, texture:Texture, uniformName:String):Void {
    ...
    flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform1i', cast ([flighthq._internal.WebGl2RenderingContext.call(gl, 'getUniformLocation', cast ([_Runtime.field(context, 'program'), uniformName] : Array<Dynamic>)), unit] : Array<Dynamic>));
