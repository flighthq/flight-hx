...
class TransmissionVolumePbrGlMeshMaterialRenderer {
  public static final transmissionVolumePbrGlMeshMaterialRenderer:GlMeshMaterialRenderer = { bind: function(state:GlRenderState, material:Null<Material>, lights:SceneLightBlock, camera:Camera) {
    ...
    flighthq._internal.backend.WebGl2Backend.uniform1f(gl, _Runtime.field(program, 'locAlphaCutoff'), _Runtime.select(!_Runtime.strictEquals(transmission, null), function():Dynamic return cast _Runtime.field(transmission, 'alphaCutoff'), function():Dynamic return cast 0.5));
