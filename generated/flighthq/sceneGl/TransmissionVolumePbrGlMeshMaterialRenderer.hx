...
class TransmissionVolumePbrGlMeshMaterialRenderer {
  public static final transmissionVolumePbrGlMeshMaterialRenderer:GlMeshMaterialRenderer = { bind: function(state:GlRenderState, material:Null<Material>, lights:SceneLightBlock, camera:Camera) {
    ...
    if ((cast !_Runtime.strictEquals(transmission, null) : Bool)) {
      ...
      flighthq._internal.backend.WebGl2Backend.uniform3f(gl, _Runtime.field(program, 'locAttenuationColor'), flighthq._internal._StaticIndex.readArray(TransmissionVolumePbrGlMeshMaterialRenderer.scratchRgba__transmissionVolumePbrGlMeshMaterialRenderer, 0.0), flighthq._internal._StaticIndex.readArray(TransmissionVolumePbrGlMeshMaterialRenderer.scratchRgba__transmissionVolumePbrGlMeshMaterialRenderer, 1.0), flighthq._internal._StaticIndex.readArray(TransmissionVolumePbrGlMeshMaterialRenderer.scratchRgba__transmissionVolumePbrGlMeshMaterialRenderer, 2.0));
    } else {
