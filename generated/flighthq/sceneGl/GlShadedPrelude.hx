...
class GlShadedPrelude {
  ...
  public static function compileGlShadedProgram(gl:Dynamic, key:GlShadedDefineKey, orderedModifiers:Array<Modifier>, registry:ModifierRegistry):GlShadedProgram {
    ...
    return cast _Runtime.mergeObjects([_Runtime.callValue(resolveGlLitLocations, cast ([gl, program] : Array<Dynamic>)), { program: program }, { locAlphaCutoff: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_alphaCutoff'] : Array<Dynamic>)) }, { locDiffuse: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_diffuse'] : Array<Dynamic>)) }, { locDiffuseMap: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_diffuseMap'] : Array<Dynamic>)) }, { locJointTexture: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_jointTexture'] : Array<Dynamic>)) }, { locModel: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_model'] : Array<Dynamic>)) }, { locNormalMap: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_normalMap'] : Array<Dynamic>)) }, { locNormalMatrix: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_normalMatrix'] : Array<Dynamic>)) }, { locNormalScale: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_normalScale'] : Array<Dynamic>)) }, { locShininess: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_shininess'] : Array<Dynamic>)) }, { locSpecular: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_specular'] : Array<Dynamic>)) }, { locSpecularMap: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_specularMap'] : Array<Dynamic>)) }, { locTime: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_time'] : Array<Dynamic>)) }, { locViewProjection: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_viewProjection'] : Array<Dynamic>)) }]);
    return cast null;
  }
