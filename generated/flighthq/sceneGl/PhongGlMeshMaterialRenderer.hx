...
class PhongGlMeshMaterialRenderer {
  ...
  public static function bindGlPhongMaterialUniforms__phongGlMeshMaterialRenderer(state:GlRenderState, program:GlClassicProgram, material:Null<PhongMaterial>):Void {
    ...
    flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform4f', cast ([_Runtime.field(program, 'locDiffuse'), _Runtime.getIndex(PhongGlMeshMaterialRenderer.scratchRgba__phongGlMeshMaterialRenderer, 0.0), _Runtime.getIndex(PhongGlMeshMaterialRenderer.scratchRgba__phongGlMeshMaterialRenderer, 1.0), _Runtime.getIndex(PhongGlMeshMaterialRenderer.scratchRgba__phongGlMeshMaterialRenderer, 2.0), _Runtime.getIndex(PhongGlMeshMaterialRenderer.scratchRgba__phongGlMeshMaterialRenderer, 3.0)] : Array<Dynamic>));
