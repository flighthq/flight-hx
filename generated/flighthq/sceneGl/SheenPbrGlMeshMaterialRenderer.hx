...
class SheenPbrGlMeshMaterialRenderer {
  public static final sheenPbrGlMeshMaterialRenderer:GlMeshMaterialRenderer = { bind: function(state:GlRenderState, material:Null<Material>, lights:SceneLightBlock, camera:Camera) {
    ...
    flighthq._internal.backend.WebGl2Backend.uniform1f(gl, _Runtime.field(program, 'locAlphaCutoff'), _Runtime.select(!_Runtime.strictEquals(sheen, null), function():Dynamic return cast _Runtime.field(sheen, 'alphaCutoff'), function():Dynamic return cast 0.5));
    if (_Runtime.truthy(!_Runtime.strictEquals(sheen, null))) {
      ...
      flighthq._internal.backend.WebGl2Backend.uniform1f(gl, _Runtime.field(program, 'locSheenRoughness'), 0.0);
    }
