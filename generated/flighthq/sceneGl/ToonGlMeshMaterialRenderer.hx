...
class ToonGlMeshMaterialRenderer {
  ...
  public static function bindGlToonMaterialUniforms__toonGlMeshMaterialRenderer(state:GlRenderState, program:GlToonProgram, material:Null<ToonMaterial>):Void {
    ...
    if (_Runtime.truthy(_Runtime.strictEquals(material, null))) {
      ...
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locSteps'), 3.0] : Array<Dynamic>));
    ...
    flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locSteps'), _Runtime.field(material, 'steps')] : Array<Dynamic>));
    ...
    if (_Runtime.truthy(_Runtime.andValue(_Runtime.andValue(!_Runtime.strictEquals(baseColorMap, null), function():Dynamic return cast !_Runtime.strictEquals(_Runtime.field(baseColorMap, 'image'), null)), function():Dynamic return cast _Runtime.callValue(hasImageResourcePixels, cast ([_Runtime.field(baseColorMap, 'image')] : Array<Dynamic>))))) {
      ...
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1i', cast ([_Runtime.field(program, 'locBaseColorMap'), 0.0] : Array<Dynamic>));
    }
    ...
    if (_Runtime.truthy(_Runtime.andValue(_Runtime.andValue(!_Runtime.strictEquals(ramp, null), function():Dynamic return cast !_Runtime.strictEquals(_Runtime.field(ramp, 'image'), null)), function():Dynamic return cast _Runtime.callValue(hasImageResourcePixels, cast ([_Runtime.field(ramp, 'image')] : Array<Dynamic>))))) {
      ...
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1i', cast ([_Runtime.field(program, 'locRamp'), 1.0] : Array<Dynamic>));
    }
