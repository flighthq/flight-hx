...
class GlMeshProgram {
  ...
  public static function bindGlUvTransform(gl:Dynamic, program:flighthq.types.GlMeshProgram, texture:Null<TextureLike>):Void {
    ...
    flighthq._internal.backend.WebGl2Backend.uniformMatrix3fv(gl, loc, false, _Runtime.field(GlMeshProgram.scratchUvMatrix__glMeshProgram, 'm'));
  }
  ...
  public static function drawGlMeshSubset(state:GlRenderState, program:flighthq.types.GlMeshProgram, proxy:SceneRenderProxy, geometry:MeshGeometry):Void {
    ...
    if (_Runtime.truthy(gpuSkinned)) {
      ...
      _Runtime.callValue(uploadGlSkinPaletteTexture, cast ([gl, palette, jointMatrices, (_Runtime.toInt32((_Runtime.field(jointMatrices, 'length') / 16.0)) | _Runtime.toInt32(0.0))] : Array<Dynamic>));
    ...
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(upload, 'indexBuffer'), null))) {
      ...
      flighthq._internal.backend.WebGl2Backend.drawElements(gl, _Runtime.field(upload, 'primitiveMode'), _Runtime.field(subset, 'indexCount'), _Runtime.field(upload, 'indexType'), (_Runtime.field(subset, 'indexOffset') * elementSize));
    } else {
      flighthq._internal.backend.WebGl2Backend.drawArrays(gl, _Runtime.field(upload, 'primitiveMode'), _Runtime.field(subset, 'indexOffset'), _Runtime.field(subset, 'indexCount'));
    }
  }
  ...
  public static function setGlMeshViewProjection(gl:Dynamic, locViewProjection:Null<Dynamic>, camera:Camera3D):Void {
    ...
    flighthq._internal.backend.WebGl2Backend.uniformMatrix4fv(gl, locViewProjection, false, _Runtime.field(GlMeshProgram.scratchViewProjection__glMeshProgram, 'm'));
  }
