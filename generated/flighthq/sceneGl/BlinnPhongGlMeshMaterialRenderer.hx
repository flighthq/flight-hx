...
class BlinnPhongGlMeshMaterialRenderer {
  ...
  public static function bindGlBlinnPhongMaterialUniforms__blinnPhongGlMeshMaterialRenderer(state:GlRenderState, program:GlClassicProgram, material:Null<BlinnPhongMaterial>):Void {
    ...
    flighthq._internal.backend.WebGl2Backend.uniform4f(gl, _Runtime.field(program, 'locDiffuse'), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 0.0), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 1.0), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 2.0), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 3.0));
    ...
    flighthq._internal.backend.WebGl2Backend.uniform4f(gl, _Runtime.field(program, 'locSpecular'), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 0.0), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 1.0), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 2.0), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 3.0));
