...
class BlinnPhongGlMeshMaterialRenderer {
  ...
  public static function bindGlBlinnPhongMaterialUniforms__blinnPhongGlMeshMaterialRenderer(state:GlRenderState, program:GlClassicProgram, material:Null<BlinnPhongMaterial>):Void {
    ...
    flighthq._internal.WebGl2RenderingContext.call(gl, 'uniform4f', cast ([_Runtime.field(program, 'locDiffuse'), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 0.0), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 1.0), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 2.0), _Runtime.getIndex(BlinnPhongGlMeshMaterialRenderer.scratchRgba__blinnPhongGlMeshMaterialRenderer, 3.0)] : Array<Dynamic>));
