...
class _GlMeshProgramValues {
  ...
  public static function bindGlUvTransform(gl:Dynamic, program:GlMeshProgram, texture:Null<TextureLike>):Void {
    ...
    _Runtime.callProperty(gl, 'uniformMatrix3fv', cast ([loc, false, _Runtime.field(_GlMeshProgramValues.scratchUvMatrix__glMeshProgram, 'm')] : Array<Dynamic>));
  }
  ...
  public static function setGlMeshViewProjection(gl:Dynamic, locViewProjection:Null<Dynamic>, camera:Dynamic):Void {
    ...
    _Runtime.callProperty(gl, 'uniformMatrix4fv', cast ([locViewProjection, false, _Runtime.field(_GlMeshProgramValues.scratchViewProjection__glMeshProgram, 'm')] : Array<Dynamic>));
  }
