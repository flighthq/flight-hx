...
class IridescencePbrGlMeshMaterialRenderer {
  public static final iridescencePbrGlMeshMaterialRenderer:GlMeshMaterialRenderer = { bind: function(state:GlRenderState, material:Null<Material>, lights:SceneLightBlock, camera:Camera3D) {
    ...
    flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locAlphaCutoff'), _Runtime.select(!_Runtime.strictEquals(iridescence, null), function():Dynamic return cast _Runtime.field(iridescence, 'alphaCutoff'), function():Dynamic return cast 0.5)] : Array<Dynamic>));
    if (_Runtime.truthy(!_Runtime.strictEquals(iridescence, null))) {
      ...
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locIridescence'), _Runtime.field(iridescence, 'iridescence')] : Array<Dynamic>));
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locIridescenceIor'), _Runtime.field(iridescence, 'iridescenceIor')] : Array<Dynamic>));
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locIridescenceThickness'), thickness] : Array<Dynamic>));
    } else {
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locIridescence'), 0.0] : Array<Dynamic>));
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locIridescenceIor'), 1.3] : Array<Dynamic>));
      flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(program, 'locIridescenceThickness'), 250.0] : Array<Dynamic>));
    }
