...
typedef GlUnlitDefineKey = { var alphaMaskEnabled:Bool; @:optional var colorMapLinear:Bool; var hasColorMap:Bool; @:optional var hasSkin:Bool; var hasUvTransform:Bool; var vertexColor:Bool; };
