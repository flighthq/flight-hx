...
typedef AudioChannel = { var currentTime:Float; var gain:Float; var length:Float; var loops:Float; var playbackRate:Float; var source:flighthq.types.AudioResource; var state:AudioChannelState; var onComplete:Signal<Dynamic>; };
