...
typedef Physics2DJointOptions = { var bodyA:Float; var bodyB:Float; @:optional var localAnchorAX:Float; @:optional var localAnchorAY:Float; @:optional var localAnchorBX:Float; @:optional var localAnchorBY:Float; @:optional var collideConnected:Bool; @:optional var breakForce:Float; @:optional var breakTorque:Float; };
...
typedef Physics2DRevoluteJointOptions = { var bodyA:Float; var bodyB:Float; @:optional var localAnchorAX:Float; @:optional var localAnchorAY:Float; @:optional var localAnchorBX:Float; @:optional var localAnchorBY:Float; @:optional var collideConnected:Bool; @:optional var breakForce:Float; @:optional var breakTorque:Float; @:optional var enableMotor:Bool; @:optional var motorSpeed:Float; @:optional var maxMotorTorque:Float; @:optional var enableLimit:Bool; @:optional var lowerAngle:Float; @:optional var upperAngle:Float; @:optional var referenceAngle:Float; @:optional var enableLimitSpring:Bool; @:optional var limitFrequencyHz:Float; @:optional var limitDampingRatio:Float; };
...
typedef Physics2DCollisionExplanation = { var unsupportedKinds:Array<String>; var status:String; };
