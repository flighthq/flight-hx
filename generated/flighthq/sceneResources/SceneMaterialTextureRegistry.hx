...
@:expose("flighthq.sceneResources.SceneMaterialTextureRegistry")
class SceneMaterialTextureRegistry {
  public static function createSceneMaterialTextureRegistry():SceneMaterialTextureRegistry {
    return cast _Runtime.callValue(createEntity, cast ([{ listers: _Runtime.construct(_Runtime.callProperty(_Runtime, 'globalValue', cast (['Map'] : Array<Dynamic>)), []) }] : Array<Dynamic>));
    return cast null;
  }
  ...
  public static function registerBuiltInSceneMaterialTextures(registry:SceneMaterialTextureRegistry):Void {
    _Runtime.callValue(registerSceneMaterialTextures, cast ([registry, StandardPbrMaterialKind, SceneMaterialTextureRegistry.listStandardPbrMaterialTextures__sceneMaterialTextureRegistry] : Array<Dynamic>));
    _Runtime.callValue(registerSceneMaterialTextures, cast ([registry, UnlitMaterialKind, SceneMaterialTextureRegistry.listUnlitMaterialTextures__sceneMaterialTextureRegistry] : Array<Dynamic>));
  }
