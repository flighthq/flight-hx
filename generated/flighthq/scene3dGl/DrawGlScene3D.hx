  ...
  public static function drawGlScene3D(state:GlRenderState, scene:Node3D, camera:Camera3D, lights:Scene3DLightsLike, ?forwardLights:GlScene3DForwardLightList):Void {
    ...
    colorAdjustmentFeatureEnabled = !_Runtime.looseEquals((cast (cast getGlRenderStateRuntime(({ final __callArgument21:Dynamic = state; __callArgument21; })) : GlRenderStateRuntime) : { @:optional var glColorAdjustmentMaterialFeature:Null<GlColorAdjustmentMaterialFeature>; }).glColorAdjustmentMaterialFeature, null);
    {
      ...
      while ((cast ((cast i : Float) < (cast _Runtime.field(opaqueDrawList, 'length') : Float)) : Bool)) {
        ...
        (DrawGlScene3D.proxy__drawGlScene3D.jointMatrices = cast (((cast skinned : Bool) ? (cast (cast (cast (cast (cast entry : DrawEntry__drawGlScene3D).mesh : { @:optional var skin:Null<Skin>; }).skin : Skin).skeleton : { var jointMatrices:flighthq._internal._Float32Array; }).jointMatrices : Dynamic) : (cast null : Dynamic)) : Null<flighthq._internal._Float32Array>));
