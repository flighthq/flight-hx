...
class GlViewportAspect {
  public static function getGlScene3DViewportAspect(state:GlRenderState):Float {
    ...
    viewport = _Runtime.coalesce((cast (cast getGlRenderStateRuntime(({ final __callArgument0:Dynamic = state; __callArgument0; })) : GlRenderStateRuntime) : GlRenderStateRuntime).renderTargetViewport, function():Dynamic return cast _Runtime.field(state, 'canvas'));
