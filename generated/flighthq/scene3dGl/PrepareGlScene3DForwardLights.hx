    ...
    ((cast out : GlScene3DForwardLightList).meshCount = sceneRenderList.meshCount);
    {
      ...
      while ((cast ((cast meshIndex : Float) < (cast sceneRenderList.meshCount : Float)) : Bool)) {
        ...
        if ((cast ((cast blockIndex : Float) < (cast 0.0 : Float)) : Bool)) {
          ...
          PrepareGlScene3DForwardLights.copyIndices__prepareGlScene3DForwardLights((cast block : PreparedForwardLightBlock__prepareGlScene3DForwardLights).indices, (cast (cast prepared : PreparedGlScene3DForwardLights__prepareGlScene3DForwardLights).selection : { var indices:Array<Float>; }).indices);
