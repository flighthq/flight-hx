...
class GlScene3DRuntime {
  ...
  public static function getGlScene3DRuntime(state:GlRenderState):flighthq.types.GlScene3DRuntime {
    ...
    if ((cast _Runtime.strictEquals(scene, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) {
      (scene = cast ({ activeColorAdjustmentRun: false, activeColorMatrixRun: false, activeMeshProgram: null, activeSkinnedRun: false, blendedDrawList: cast ([] : Array<Dynamic>), blendedPool: cast ([] : Array<Dynamic>), environmentSourceCube: null, ibl: null, iblBakeFramebuffer: null, materialRegistry: _Runtime.construct(_Runtime.globalValue('Map'), []), modifierSnippetRegistry: null, opaqueDrawList: cast ([] : Array<Dynamic>), opaquePool: cast ([] : Array<Dynamic>), pbrExtensionGuard: null, pbrExtensionRegistry: _Runtime.construct(_Runtime.globalValue('Map'), []), pbrExtensionRegistryVersion: 0.0, pbrTransmissionSceneColor: null, programCache: _Runtime.construct(_Runtime.globalValue('Map'), []), shadow: null, shadowTarget: null, skinPalette: null, time: 0.0, uploadCache: _Runtime.construct(_Runtime.globalValue('WeakMap'), []) } : Dynamic));
  ...
  public static final sceneRuntimes__glScene3DRuntime:Dynamic = _Runtime.construct(_Runtime.globalValue('WeakMap'), []);
}
