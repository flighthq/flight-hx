...
class GlShadedPrelude {
  ...
  public static function compileGlShadedProgram(gl:flighthq._internal.dom.WebGL2RenderingContext, key:GlShadedDefineKey, orderedModifiers:Array<Modifier>, registry:ModifierRegistry, ?colorAdjustmentFeature:Null<GlColorAdjustmentMaterialFeature>):GlShadedProgram {
    ...
    defineSource = (cast GlShadedPrelude.buildGlShadedDefineSource__glShadedPrelude((cast key : GlShadedDefineKey)) : String);
    vertexSource = ((defineSource + _Runtime.select(_Runtime.field(key, 'hasSkin'), function():Dynamic return cast GL_SKIN_VERTEX_DECLARATIONS_GLSL, function():Dynamic return cast '')) + (cast GlShadedPrelude.assembleGlShadedVertexBody__glShadedPrelude((cast orderedModifiers : Array<Modifier>), (cast registry : ModifierRegistry)) : String));
    fragmentBody = (cast GlShadedPrelude.assembleGlShadedFragmentBody__glShadedPrelude((cast orderedModifiers : Array<Modifier>), (cast registry : ModifierRegistry)) : String);
  ...
  public static function ensureGlShadedProgram(state:GlRenderState, key:GlShadedDefineKey, modifiers:Array<Modifier>):GlShadedProgram {
    ...
    registry = _Runtime.coalesce((cast (cast getGlScene3DRuntime((cast state : GlRenderState)) : GlScene3DRuntime) : GlScene3DRuntime).modifierSnippetRegistry, function():Dynamic return cast GlShadedPrelude.EMPTY_MODIFIER_REGISTRY__glShadedPrelude);
    ...
    cacheKey = (cast buildGlShadedCacheKey((cast fullKey : GlShadedDefineKey), (cast (cast getModifierDefineKey((cast modifiers : Array<Modifier>), (cast registry : Null<ModifierRegistry>)) : String) : String)) : String);
    return cast (cast ensureGlScene3DProgram((cast state : GlRenderState), (cast cacheKey : String), (cast function(gl:flighthq._internal.dom.WebGL2RenderingContext):GlShadedProgram return (cast compileGlShadedProgram((cast gl : flighthq._internal.dom.WebGL2RenderingContext), (cast fullKey : GlShadedDefineKey), (cast ordered : Array<Modifier>), (cast registry : ModifierRegistry), (cast _Runtime.coalesce((cast (cast getGlRenderStateRuntime((cast state : GlRenderState)) : GlRenderStateRuntime) : GlRenderStateRuntime).glColorAdjustmentMaterialFeature, function():Dynamic return cast null) : Null<GlColorAdjustmentMaterialFeature>)) : GlShadedProgram) : flighthq._internal.dom.WebGL2RenderingContext->GlShadedProgram)) : GlShadedProgram);
    return cast null;
  }
  ...
  public static function assembleGlShadedFragmentBody__glShadedPrelude(orderedModifiers:Array<Modifier>, registry:ModifierRegistry):String {
    ...
    effect = '';
    {
      ...
      while ((cast ((cast index : Float) < (cast _Runtime.field(orderedModifiers, 'length') : Float)) : Bool)) {
        ...
        if ((cast !_Runtime.strictEquals((cast snippet : GlModifierSnippet).declarations, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) { (declarations = cast ((declarations + '' + Std.string((cast snippet : GlModifierSnippet).declarations(modifier, index)) + '\n') : Dynamic)); }
        var contribution:String = '' + Std.string((cast snippet : GlModifierSnippet).contribution(modifier, index)) + '\n';
  ...
  public static function assembleGlShadedVertexBody__glShadedPrelude(orderedModifiers:Array<Modifier>, registry:ModifierRegistry):String {
    ...
    vertex = '';
    {
      ...
      while ((cast ((cast index : Float) < (cast _Runtime.field(orderedModifiers, 'length') : Float)) : Bool)) {
        ...
        if ((cast ((cast _Runtime.strictEquals(snippet, null) : Bool) || (cast !_Runtime.strictEquals((cast snippet : GlModifierSnippet).slot, (cast ModifierSlotValue : { var Diffuse:String; var Effect:String; var Emissive:String; var Normal:String; var Specular:String; var Vertex:String; }).Vertex) : Bool)) : Bool)) { index++; continue; }
        if ((cast !_Runtime.strictEquals((cast snippet : GlModifierSnippet).declarations, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) { (declarations = cast ((declarations + '' + Std.string((cast snippet : GlModifierSnippet).declarations(modifier, index)) + '\n') : Dynamic)); }
        (vertex = cast ((vertex + '' + Std.string((cast snippet : GlModifierSnippet).contribution(modifier, index)) + '\n') : Dynamic));
        index++;
      }
    }
