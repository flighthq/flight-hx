...
class GlShadedPrelude {
  ...
  public static function ensureGlShadedProgram(state:GlRenderState, key:GlShadedDefineKey, modifiers:Array<Modifier>):GlShadedProgram {
    ...
    registry = _Runtime.coalesce((cast (cast getGlScene3DRuntime(({ final __callArgument8:Dynamic = state; __callArgument8; })) : GlScene3DRuntime) : { var modifierSnippetRegistry:Null<ModifierRegistry>; }).modifierSnippetRegistry, function():Dynamic return cast GlShadedPrelude.EMPTY_MODIFIER_REGISTRY__glShadedPrelude);
    ordered = (cast orderModifierStack(({ final __callArgument9:Dynamic = modifiers; __callArgument9; })) : Array<Modifier>);
    fullKey = (cast _Runtime.mergeObjects([key, { hasColorAdjustment: (cast (cast getGlScene3DRuntime(({ final __callArgument10:Dynamic = state; __callArgument10; })) : GlScene3DRuntime) : { var activeColorAdjustmentRun:Bool; }).activeColorAdjustmentRun }, { hasColorMatrix: (cast (cast getGlScene3DRuntime(({ final __callArgument11:Dynamic = state; __callArgument11; })) : GlScene3DRuntime) : { var activeColorMatrixRun:Bool; }).activeColorMatrixRun }, { hasSkin: (cast (cast getGlScene3DRuntime(({ final __callArgument12:Dynamic = state; __callArgument12; })) : GlScene3DRuntime) : { var activeSkinnedRun:Bool; }).activeSkinnedRun }]));
