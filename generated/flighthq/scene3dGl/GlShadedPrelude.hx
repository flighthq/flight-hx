...
class GlShadedPrelude {
  ...
  public static function compileGlShadedProgram(gl:flighthq._internal.dom.WebGL2RenderingContext, key:GlShadedDefineKey, orderedModifiers:Array<Modifier>, registry:GlModifierSnippetSource__glShadedPrelude, ?colorAdjustmentFeature:Null<GlColorAdjustmentMaterialFeature>):GlShadedProgram {
    ...
    vertexSource = ((defineSource + _Runtime.select(_Runtime.field(key, 'hasSkin'), function():Dynamic return cast GL_SKIN_VERTEX_DECLARATIONS_GLSL, function():Dynamic return cast '')) + (cast GlShadedPrelude.assembleGlShadedVertexBody__glShadedPrelude(({ final __callArgument1:Dynamic = orderedModifiers; __callArgument1; }), (cast registry : Dynamic)) : String));
    fragmentBody = (cast GlShadedPrelude.assembleGlShadedFragmentBody__glShadedPrelude(({ final __callArgument2:Dynamic = orderedModifiers; __callArgument2; }), (cast registry : Dynamic)) : String);
  ...
  public static function ensureGlShadedProgram(state:GlRenderState, key:GlShadedDefineKey, modifiers:Array<Modifier>):GlShadedProgram {
    ...
    registries = (cast (cast getGlRenderStateRuntime(({ final __callArgument6:Dynamic = state; __callArgument6; })) : GlRenderStateRuntime) : { var registries:GlRenderRegistries; }).registries;
    registry = (cast registries : GlRenderRegistries).modifierSnippets;
    ordered = (cast orderModifierStack(({ final __callArgument7:Dynamic = modifiers; __callArgument7; })) : Array<Modifier>);
    fullKey = (cast _Runtime.mergeObjects([key, { hasColorAdjustment: (cast (cast getGlScene3DRuntime(({ final __callArgument8:Dynamic = state; __callArgument8; })) : GlScene3DRuntime) : { var activeColorAdjustmentRun:Bool; }).activeColorAdjustmentRun }, { hasColorMatrix: (cast (cast getGlScene3DRuntime(({ final __callArgument9:Dynamic = state; __callArgument9; })) : GlScene3DRuntime) : { var activeColorMatrixRun:Bool; }).activeColorMatrixRun }, { hasSkin: (cast (cast getGlScene3DRuntime(({ final __callArgument10:Dynamic = state; __callArgument10; })) : GlScene3DRuntime) : { var activeSkinnedRun:Bool; }).activeSkinnedRun }]));
    cacheKey = '' + Std.string((cast buildGlShadedCacheKey(({ final __callArgument11:Dynamic = fullKey; __callArgument11; }), (cast (cast GlShadedPrelude.getGlModifierDefineKey__glShadedPrelude(({ final __callArgument12:Dynamic = modifiers; __callArgument12; }), (cast registry : Dynamic)) : String) : String)) : String)) + '|registry:' + Std.string((cast registries : GlRenderRegistries).modifierSnippetRevision) + '';
    return cast (cast (cast ensureGlScene3DProgram : GlRenderState->String->(flighthq._internal.dom.WebGL2RenderingContext->GlShadedProgram)->GlShadedProgram)(({ final __callArgument13:Dynamic = state; __callArgument13; }), (cast cacheKey : String), ({ final __callArgument18:Dynamic = function(gl:flighthq._internal.dom.WebGL2RenderingContext):GlShadedProgram return (cast compileGlShadedProgram(({ final __callArgument14:Dynamic = gl; __callArgument14; }), ({ final __callArgument15:Dynamic = fullKey; __callArgument15; }), ({ final __callArgument16:Dynamic = ordered; __callArgument16; }), (cast registry : Dynamic), (cast getGlColorAdjustmentMaterialFeature(({ final __callArgument17:Dynamic = state; __callArgument17; })) : Null<GlColorAdjustmentMaterialFeature>)) : GlShadedProgram); __callArgument18; })) : GlShadedProgram);
    return cast null;
  }
  ...
  public static function assembleGlShadedFragmentBody__glShadedPrelude(orderedModifiers:Array<Modifier>, registry:GlModifierSnippetSource__glShadedPrelude):String {
    ...
    effect = '';
    {
      ...
      while ((cast ((cast index : Float) < (cast _Runtime.field(orderedModifiers, 'length') : Float)) : Bool)) {
        ...
        var snippet:Null<GlModifierSnippet> = (cast GlShadedPrelude.resolveGlModifierSnippetSource__glShadedPrelude((cast registry : Dynamic), (cast modifier.kind : String)) : Null<GlModifierSnippet>);
        ...
        if ((cast !_Runtime.strictEquals((cast snippet : GlModifierSnippet).declarations, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) { (declarations = cast ((declarations + '' + Std.string((cast snippet : GlModifierSnippet).declarations(({ final __callArgument19:Dynamic = modifier; __callArgument19; }), (cast index : Float))) + '\n') : Dynamic)); }
        var contribution:String = '' + Std.string((cast snippet : GlModifierSnippet).contribution(({ final __callArgument20:Dynamic = modifier; __callArgument20; }), (cast index : Float))) + '\n';
  ...
  public static function assembleGlShadedVertexBody__glShadedPrelude(orderedModifiers:Array<Modifier>, registry:GlModifierSnippetSource__glShadedPrelude):String {
    ...
    vertex = '';
    {
      ...
      while ((cast ((cast index : Float) < (cast _Runtime.field(orderedModifiers, 'length') : Float)) : Bool)) {
        ...
        var snippet:Null<GlModifierSnippet> = (cast GlShadedPrelude.resolveGlModifierSnippetSource__glShadedPrelude((cast registry : Dynamic), (cast modifier.kind : String)) : Null<GlModifierSnippet>);
        if ((cast ((cast _Runtime.strictEquals(snippet, null) : Bool) || (cast !_Runtime.strictEquals((cast snippet : GlModifierSnippet).slot, (cast ModifierSlotValue : { var Diffuse:String; var Effect:String; var Emissive:String; var Normal:String; var Specular:String; var Vertex:String; }).Vertex) : Bool)) : Bool)) { index++; continue; }
        if ((cast !_Runtime.strictEquals((cast snippet : GlModifierSnippet).declarations, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) { (declarations = cast ((declarations + '' + Std.string((cast snippet : GlModifierSnippet).declarations(({ final __callArgument21:Dynamic = modifier; __callArgument21; }), (cast index : Float))) + '\n') : Dynamic)); }
        (vertex = cast ((vertex + '' + Std.string((cast snippet : GlModifierSnippet).contribution(({ final __callArgument22:Dynamic = modifier; __callArgument22; }), (cast index : Float))) + '\n') : Dynamic));
        index++;
      }
    }
  ...
  public static function getGlModifierDefineKey__glShadedPrelude(stack:Array<Modifier>, registry:GlModifierSnippetSource__glShadedPrelude):String {
    ...
    if ((cast !(cast (cast GlShadedPrelude.isGlModifierSnippetTable__glShadedPrelude((cast registry : Dynamic)) : Bool) : Bool) : Bool)) { return cast (cast getModifierDefineKey(({ final __callArgument25:Dynamic = stack; __callArgument25; }), ({ final __callArgument26:Dynamic = registry; __callArgument26; })) : String); }
    ordered = (cast orderModifierStack(({ final __callArgument27:Dynamic = stack; __callArgument27; })) : Array<Modifier>);
    key = '';
    for (modifier in _Runtime.iterable(ordered)) {
      var snippet:Null<GlModifierSnippet> = (cast GlShadedPrelude.resolveGlModifierSnippetSource__glShadedPrelude((cast registry : Dynamic), (cast modifier.kind : String)) : Null<GlModifierSnippet>);
      var signature:String = _Runtime.coalesce(_Runtime.callOptionalValue(({ final __structural30 = snippet; __structural30 == null ? _Runtime.UNDEFINED : (cast __structural30 : { @:optional var getDefineSignature:Null<Modifier->String>; }).getDefineSignature; }), cast ([modifier] : Array<Dynamic>)), function():Dynamic return cast '');
  ...
  public static function resolveGlModifierSnippetSource__glShadedPrelude(registry:GlModifierSnippetSource__glShadedPrelude, kind:ModifierKind):Null<GlModifierSnippet> {
    ...
    if ((cast !(cast (cast GlShadedPrelude.isGlModifierSnippetTable__glShadedPrelude((cast registry : Dynamic)) : Bool) : Bool) : Bool)) { return cast (cast resolveModifier(({ final __callArgument31:Dynamic = registry; __callArgument31; }), (cast kind : String)) : Null<GlModifierSnippet>); }
    entry = ((cast _Runtime.field(registry, 'entries') : flighthq._internal._Map<String, RegistryTableEntry<GlModifierSnippet>>).get(kind));
    return cast ((cast _Runtime.strictEquals(({ final __structural32 = entry; __structural32 == null ? _Runtime.UNDEFINED : (cast __structural32 : { var state:String; }).state; }), (cast RegistryEntryStateValue : { var Bound:String; var Tombstoned:String; }).Bound) : Bool) ? (cast (cast entry : { var state:String; var value:GlModifierSnippet; }).value : Dynamic) : (cast null : Dynamic));
    return cast null;
  }
