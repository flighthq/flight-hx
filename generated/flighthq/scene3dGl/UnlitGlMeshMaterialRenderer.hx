...
class UnlitGlMeshMaterialRenderer {
  public static final unlitGlMeshMaterialRenderer:GlMeshMaterialRenderer = (cast { bind: function(state:GlRenderState, material:Null<Material>, _lights:Scene3DLightBlock, camera:Camera3D):Void {
    ...
    beginGlMeshDraw(({ final __callArgument3:Dynamic = state; __callArgument3; }), ({ final __callArgument4:Dynamic = program; __callArgument4; }), (cast ((cast !_Runtime.strictEquals(unlit, null) : Bool) && (cast _Runtime.field(unlit, 'doubleSided') : Bool)) : Bool));
    ...
    (cast unpackColorToLinear(({ final __callArgument10:Dynamic = UnlitGlMeshMaterialRenderer.scratchRgba__unlitGlMeshMaterialRenderer; __callArgument10; }), (cast _Runtime.field(unlit, 'baseColor') : Float)) : LinearColor);
    bindGlUnlitSurface(({ final __callArgument11:Dynamic = state; __callArgument11; }), ({ final __callArgument12:Dynamic = program; __callArgument12; }), ({ final __callArgument13:Dynamic = UnlitGlMeshMaterialRenderer.scratchRgba__unlitGlMeshMaterialRenderer; __callArgument13; }), (cast 1.0 : Float), (cast _Runtime.field(unlit, 'baseColorMap') : Dynamic), (cast _Runtime.field(unlit, 'alphaCutoff') : Float));
    bindGlUvTransform(({ final __callArgument14:Dynamic = gl; __callArgument14; }), ({ final __callArgument15:Dynamic = program; __callArgument15; }), (cast _Runtime.field(unlit, 'baseColorMap') : Dynamic));
  ...
  public static function defineKeyForMaterial__unlitGlMeshMaterialRenderer(state:GlRenderState, material:Null<UnlitMaterial>):GlUnlitDefineKey {
    ...
    return cast { alphaMaskEnabled: ((cast !_Runtime.strictEquals(material, null) : Bool) && (cast _Runtime.strictEquals(_Runtime.field(material, 'alphaMode'), 'mask') : Bool)), hasColorMap: colorMapReady, hasUvTransform: ((cast colorMapReady : Bool) && (cast (cast hasGlUvTransform((cast colorMap : Dynamic)) : Bool) : Bool)), vertexColor: false };
    return cast null;
  }
