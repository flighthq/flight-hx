...
class ExtendedPbrGlMeshMaterialRenderer {
  public static final extendedPbrGlMeshMaterialRenderer:GlMeshMaterialRenderer = (cast { bind: function(state:GlRenderState, material:Null<Material>, lights:Scene3DLightBlock, camera:Camera3D):Void {
    ...
    flighthq._internal.backend.WebGl2Backend.uniform1f((cast state : GlRenderState).gl, program.locAlphaCutoff, _Runtime.coalesce(({ final __structural19 = extended; __structural19 == null ? _Runtime.UNDEFINED : (cast __structural19 : { var alphaCutoff:Float; }).alphaCutoff; }), function():Dynamic return cast 0.5));
