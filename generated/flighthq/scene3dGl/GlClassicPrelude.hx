...
import flighthq.types.GlClassicProgram.GlClassicLightingModel;
...
class GlClassicPrelude {
  ...
  public static function compileGlClassicProgram(gl:flighthq._internal.dom.WebGL2RenderingContext, key:GlClassicDefineKey, ?colorAdjustmentFeature:Null<GlColorAdjustmentMaterialFeature>):GlClassicProgram {
    ...
    fragmentSource = (cast getGlClassicFragmentSourceForKey(({ final __callArgument1:Dynamic = key; __callArgument1; }), ({ final __callArgument2:Dynamic = colorAdjustmentFeature; __callArgument2; })) : String);
  ...
  public static function ensureGlClassicProgram(state:GlRenderState, key:GlClassicDefineKey):GlClassicProgram {
    ...
    fullKey = (cast _Runtime.mergeObjects([key, { hasColorAdjustment: (cast (cast getGlScene3DRuntime(({ final __callArgument6:Dynamic = state; __callArgument6; })) : GlScene3DRuntime) : { var activeColorAdjustmentRun:Bool; }).activeColorAdjustmentRun }, { hasColorMatrix: (cast (cast getGlScene3DRuntime(({ final __callArgument7:Dynamic = state; __callArgument7; })) : GlScene3DRuntime) : { var activeColorMatrixRun:Bool; }).activeColorMatrixRun }, { hasSkin: (cast (cast getGlScene3DRuntime(({ final __callArgument8:Dynamic = state; __callArgument8; })) : GlScene3DRuntime) : { var activeSkinnedRun:Bool; }).activeSkinnedRun }]));
    return cast (cast (cast ensureGlScene3DProgram : GlRenderState->String->(flighthq._internal.dom.WebGL2RenderingContext->GlClassicProgram)->GlClassicProgram)(({ final __callArgument9:Dynamic = state; __callArgument9; }), (cast 'classic:' + Std.string((cast buildGlClassicDefineKey(({ final __callArgument10:Dynamic = fullKey; __callArgument10; })) : String)) + '' : String), ({ final __callArgument15:Dynamic = function(gl:flighthq._internal.dom.WebGL2RenderingContext):GlClassicProgram return (cast compileGlClassicProgram(({ final __callArgument11:Dynamic = gl; __callArgument11; }), ({ final __callArgument12:Dynamic = fullKey; __callArgument12; }), ({ final __callArgument14:Dynamic = _Runtime.coalesce((cast (cast getGlRenderStateRuntime(({ final __callArgument13:Dynamic = state; __callArgument13; })) : GlRenderStateRuntime) : { @:optional var glColorAdjustmentMaterialFeature:Null<GlColorAdjustmentMaterialFeature>; }).glColorAdjustmentMaterialFeature, function():Dynamic return cast null); __callArgument14; })) : GlClassicProgram); __callArgument15; })) : GlClassicProgram);
    return cast null;
  }
  ...
  public static function getGlClassicFragmentSourceForKey(key:GlClassicDefineKey, ?colorAdjustmentFeature:Null<GlColorAdjustmentMaterialFeature>):String {
    ...
    return cast ((cast GlClassicPrelude.buildGlClassicDefineSource__glClassicPrelude(({ final __callArgument16:Dynamic = key; __callArgument16; })) : String) + body);
    return cast null;
  }
  ...
  public static function getGlClassicVertexSourceForKey(key:GlClassicDefineKey):String {
    ...
    return cast (((cast GlClassicPrelude.buildGlClassicDefineSource__glClassicPrelude(({ final __callArgument17:Dynamic = key; __callArgument17; })) : String) + skin) + GlClassicPrelude.CLASSIC_VERTEX_BODY__glClassicPrelude);
    return cast null;
  }
