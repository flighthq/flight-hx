...
class Net {
  ...
  return cast buffer;
      ...
      loaded = 0.0;
      {
        while (true) {
          ...
          if (_Runtime.truthy(_Runtime.strictEquals(value, _Runtime.UNDEFINED))) { continue; }
  ...
  public static function _toNetFetchInit__net(request:NetRequest, signal:Dynamic):Dynamic {
    ...
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(request, 'headers'), _Runtime.UNDEFINED))) { _Runtime.setField(init, 'headers', _Runtime.mergeObjects([_Runtime.field(request, 'headers')])); }
    if (_Runtime.truthy(_Runtime.andValue(!_Runtime.strictEquals(_Runtime.field(request, 'body'), _Runtime.UNDEFINED), function():Dynamic return cast !_Runtime.strictEquals(_Runtime.field(request, 'body'), null)))) { _Runtime.setField(init, 'body', (cast _Runtime.field(request, 'body') : Dynamic)); }
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(request, 'credentials'), _Runtime.UNDEFINED))) { _Runtime.setField(init, 'credentials', _Runtime.field(request, 'credentials')); }
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(request, 'redirect'), _Runtime.UNDEFINED))) { _Runtime.setField(init, 'redirect', _Runtime.field(request, 'redirect')); }
    return cast init;
    return cast null;
  }
  ...
  if (_Runtime.truthy(_Runtime.andValue(!_Runtime.strictEquals(onAbort, null), function():Dynamic return cast !_Runtime.strictEquals(signal, _Runtime.UNDEFINED)))) { _Runtime.callProperty(signal, 'removeEventListener', cast (['abort', onAbort] : Array<Dynamic>)); }
};
    return cast null;
  }
