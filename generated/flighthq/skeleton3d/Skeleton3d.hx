...
class Skeleton3d {
  ...
  public static function cloneSkeleton3DJointHierarchy(skeleton:Skeleton3D, cloneJoint:Dynamic):Skeleton3D {
    ...
    return cast _Runtime.callValue(createEntity, cast ([{ inverseBindMatrices: new flighthq._internal._Float32Array(_Runtime.field(skeleton, 'inverseBindMatrices')), jointMatrices: new flighthq._internal._Float32Array(_Runtime.field(skeleton, 'jointMatrices')), joints: joints, names: _Runtime.select(_Runtime.strictEquals(_Runtime.field(skeleton, 'names'), _Runtime.field(_Runtime, 'UNDEFINED')), function():Dynamic return cast _Runtime.field(_Runtime, 'UNDEFINED'), function():Dynamic return cast _Runtime.select(_Runtime.strictEquals(_Runtime.field(skeleton, 'names'), null), function():Dynamic return cast null, function():Dynamic return cast _Runtime.slice(_Runtime.field(skeleton, 'names'), 0, null))) }] : Array<Dynamic>));
    return cast null;
  }
