...
class Keyboard {
  ...
  if (_Runtime.truthy(_Runtime.orValue(_Runtime.strictEquals(viewport, _Runtime.UNDEFINED), function():Dynamic return cast _Runtime.strictEquals(viewport, null)))) { return cast function() {
  ...
  public static function getSoftKeyboardResizeMode():SoftKeyboardResizeMode {
    var backend:Dynamic = cast _Runtime.UNDEFINED;
    backend = _Runtime.callValue(getSoftKeyboardBackend, cast ([] : Array<Dynamic>));
    return cast _Runtime.coalesce(_Runtime.callOptionalProperty(backend, 'getResizeMode', cast ([] : Array<Dynamic>)), function():Dynamic return cast Types.SoftKeyboardResizeNoneKind);
    return cast null;
  }
  ...
  return cast { height: _Runtime.field(rect, 'height'), width: _Runtime.field(rect, 'width'), x: _Runtime.field(rect, 'x'), y: _Runtime.field(rect, 'y') };
    ...
    viewport = _Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'visualViewport');
    if (_Runtime.truthy(_Runtime.orValue(_Runtime.strictEquals(viewport, _Runtime.UNDEFINED), function():Dynamic return cast _Runtime.strictEquals(viewport, null)))) { return cast { height: 0.0, width: 0.0, x: 0.0, y: 0.0 }; }
