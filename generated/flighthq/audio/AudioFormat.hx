...
class AudioFormat {
  ...
  public static function detectAudioMimeType(data:Dynamic):Null<String> {
    ...
    if (_Runtime.truthy(_Runtime.andValue(_Runtime.strictEquals(_Runtime.getIndex(b, 0.0), 255.0), function():Dynamic return cast _Runtime.strictEquals((_Runtime.toInt32(_Runtime.getIndex(b, 1.0)) & _Runtime.toInt32(224.0)), 224.0)))) { return cast 'audio/mpeg'; }
