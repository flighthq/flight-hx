...
class Material {
  public static function cloneMaterial(source:flighthq.types.Material):flighthq.types.Material {
    ...
    Material.copyMaterialFields__material(({ final __callArgument2:Dynamic = clone; __callArgument2; }), ({ final __callArgument3:Dynamic = source; __callArgument3; }), (cast _Runtime.field(source, 'kind') : String));
    return cast clone;
    return cast null;
  }
  ...
  public static function copyMaterial(out:flighthq.types.Material, source:flighthq.types.Material):Void {
    ...
    Material.copyMaterialFields__material(({ final __callArgument6:Dynamic = out; __callArgument6; }), ({ final __callArgument7:Dynamic = source; __callArgument7; }), (cast _Runtime.field(source, 'kind') : String));
  }
  ...
  public static function createMaterial(kind:Kind):flighthq.types.Material {
    ...
    material = (cast createEntity(({ final __callArgument10:Dynamic = { kind: kind }; __callArgument10; })) : flighthq.types.Material);
