...
class HasTransform2d {
  @:allow(flighthq)
  @:keep
  private static function initTransform2DRuntimeTrait(target:HasTransform2DRuntime, ?_methods:flighthq._internal._Partial<MethodsOf<HasTransform2DRuntime>>):Void {
