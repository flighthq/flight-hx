...
class SvgDocument {
  ...
  public static function copyNonEmptySvgBounds__svgDocument(out:Rectangle, source:Rectangle, hasBounds:Bool):Bool {
    ...
    maximumX = HxMath.max((_Runtime.field(out, 'x') + _Runtime.field(out, 'width')), (_Runtime.field(source, 'x') + _Runtime.field(source, 'width')));
    maximumY = HxMath.max((_Runtime.field(out, 'y') + _Runtime.field(out, 'height')), (_Runtime.field(source, 'y') + _Runtime.field(source, 'height')));
  ...
  public static function createSvgImageNode__svgDocument(element:XmlElement, parentStyle:SvgStyle__svgDocument, context:SvgImportContext__svgDocument):Null<Node2D> {
    ...
    scaleX = ((cast ((cast ((cast _Runtime.field(image, 'width') : Float) > (cast 0.0 : Float)) : Bool) && (cast ((cast width : Float) >= (cast 0.0 : Float)) : Bool)) : Bool) ? (cast (width / _Runtime.field(image, 'width')) : Dynamic) : (cast 1.0 : Dynamic));
    scaleY = ((cast ((cast ((cast _Runtime.field(image, 'height') : Float) > (cast 0.0 : Float)) : Bool) && (cast ((cast height : Float) >= (cast 0.0 : Float)) : Bool)) : Bool) ? (cast (height / _Runtime.field(image, 'height')) : Dynamic) : (cast 1.0 : Dynamic));
  ...
  public static function createSvgTextNode__svgDocument(element:XmlElement, parentStyle:SvgStyle__svgDocument, context:SvgImportContext__svgDocument):Node2D {
    ...
    lastRun = flighthq._internal._StaticIndex.readArray(runs, (_Runtime.field(runs, 'length') - 1.0));
    ...
    for (run in _Runtime.iterable(runs)) {
      var end:Dynamic = (offset + _Runtime.field(_Runtime.field(run, 'text'), 'length'));
    ...
    x = ((_Runtime.callValue(SvgDocument.firstNumber__svgDocument, cast ([_Runtime.callValue(SvgDocument.attribute__svgDocument, cast ([xElement, 'x'] : Array<Dynamic>)), 0.0] : Array<Dynamic>)) + _Runtime.callValue(SvgDocument.firstNumber__svgDocument, cast ([_Runtime.callValue(SvgDocument.attribute__svgDocument, cast ([element, 'dx'] : Array<Dynamic>)), 0.0] : Array<Dynamic>))) + ((cast _Runtime.strictEquals(xElement, element) : Bool) ? (cast 0.0 : Dynamic) : (cast _Runtime.callValue(SvgDocument.firstNumber__svgDocument, cast ([_Runtime.callValue(SvgDocument.attribute__svgDocument, cast ([xElement, 'dx'] : Array<Dynamic>)), 0.0] : Array<Dynamic>)) : Dynamic)));
    y = (((_Runtime.callValue(SvgDocument.firstNumber__svgDocument, cast ([_Runtime.callValue(SvgDocument.attribute__svgDocument, cast ([yElement, 'y'] : Array<Dynamic>)), 0.0] : Array<Dynamic>)) + _Runtime.callValue(SvgDocument.firstNumber__svgDocument, cast ([_Runtime.callValue(SvgDocument.attribute__svgDocument, cast ([element, 'dy'] : Array<Dynamic>)), 0.0] : Array<Dynamic>))) + ((cast _Runtime.strictEquals(yElement, element) : Bool) ? (cast 0.0 : Dynamic) : (cast _Runtime.callValue(SvgDocument.firstNumber__svgDocument, cast ([_Runtime.callValue(SvgDocument.attribute__svgDocument, cast ([yElement, 'dy'] : Array<Dynamic>)), 0.0] : Array<Dynamic>)) : Dynamic))) - _Runtime.field(style, 'fontSize'));
    ...
    label = ((cast _Runtime.strictEquals(_Runtime.field(ranges, 'length'), 0.0) : Bool) ? (cast _Runtime.callValue(createTextLabel, cast ([_Runtime.mergeObjects([common, { data: { autoSize: 'left', height: (_Runtime.field(style, 'fontSize') * 1.25), text: text, textFormat: format, width: 10000.0 } }])] : Array<Dynamic>)) : Dynamic) : (cast _Runtime.callValue(createRichText, cast ([_Runtime.mergeObjects([common, { data: { autoSize: 'left', defaultTextFormat: format, height: (_Runtime.field(style, 'fontSize') * 1.25), text: text, textFormat: format, textFormatRanges: ranges, width: 10000.0 } }])] : Array<Dynamic>)) : Dynamic));
  ...
  public static function appendSvgTextRun__svgDocument(out:Array<SvgTextRun__svgDocument>, style:SvgStyle__svgDocument, source:String):Void {
    ...
    previous = flighthq._internal._StaticIndex.readArray(out, (_Runtime.field(out, 'length') - 1.0));
  ...
  public static function createSvgGradientMatrix__svgDocument(gradient:SvgGradient__svgDocument, path:Path):Matrix {
    ...
    _Runtime.callValue(getPathBounds, cast ([path, bounds] : Array<Dynamic>));
    mapX = function(value:Float) return ((cast _Runtime.strictEquals(_Runtime.field(gradient, 'units'), 'objectBoundingBox') : Bool) ? (cast (_Runtime.field(bounds, 'x') + (value * _Runtime.field(bounds, 'width'))) : Dynamic) : (cast value : Dynamic));
    mapY = function(value:Float) return ((cast _Runtime.strictEquals(_Runtime.field(gradient, 'units'), 'objectBoundingBox') : Bool) ? (cast (_Runtime.field(bounds, 'y') + (value * _Runtime.field(bounds, 'height'))) : Dynamic) : (cast value : Dynamic));
    if ((cast _Runtime.strictEquals(_Runtime.field(gradient, 'kind'), 'linear') : Bool)) {
      ...
      var radiusX:Dynamic = ((cast _Runtime.strictEquals(_Runtime.field(gradient, 'units'), 'objectBoundingBox') : Bool) ? (cast (_Runtime.field(gradient, 'radius') * _Runtime.field(bounds, 'width')) : Dynamic) : (cast _Runtime.field(gradient, 'radius') : Dynamic));
      var radiusY:Dynamic = ((cast _Runtime.strictEquals(_Runtime.field(gradient, 'units'), 'objectBoundingBox') : Bool) ? (cast (_Runtime.field(gradient, 'radius') * _Runtime.field(bounds, 'height')) : Dynamic) : (cast _Runtime.field(gradient, 'radius') : Dynamic));
  ...
  public static function createSvgViewportMatrix__svgDocument(element:XmlElement, ?viewport:{ @:optional var height:Float; @:optional var width:Float; @:optional var x:Float; @:optional var y:Float; }):Null<Matrix> {
    ...
    sx = ((cast _Runtime.strictEquals(flighthq._internal._StaticIndex.readArray(viewBox, 2.0), 0.0) : Bool) ? (cast 1.0 : Dynamic) : (cast (width / flighthq._internal._StaticIndex.readArray(viewBox, 2.0)) : Dynamic));
    sy = ((cast _Runtime.strictEquals(flighthq._internal._StaticIndex.readArray(viewBox, 3.0), 0.0) : Bool) ? (cast 1.0 : Dynamic) : (cast (height / flighthq._internal._StaticIndex.readArray(viewBox, 3.0)) : Dynamic));
    ...
    if ((cast _Runtime.strictEquals(preserveAspectRatio, 'none') : Bool)) {
      return cast _Runtime.callValue(createMatrix, cast ([sx, 0.0, 0.0, sy, (x - (flighthq._internal._StaticIndex.readArray(viewBox, 0.0) * sx)), (y - (flighthq._internal._StaticIndex.readArray(viewBox, 1.0) * sy))] : Array<Dynamic>));
    }
    ...
    spareX = (width - (flighthq._internal._StaticIndex.readArray(viewBox, 2.0) * sx));
    spareY = (height - (flighthq._internal._StaticIndex.readArray(viewBox, 3.0) * sy));
    ...
    return cast _Runtime.callValue(createMatrix, cast ([sx, 0.0, 0.0, sy, ((x + alignX) - (flighthq._internal._StaticIndex.readArray(viewBox, 0.0) * sx)), ((y + alignY) - (flighthq._internal._StaticIndex.readArray(viewBox, 1.0) * sy))] : Array<Dynamic>));
    return cast null;
  }
  ...
  public static function parseSvgColor__svgDocument(value:String):Null<SvgColor__svgDocument> {
    ...
    if ((cast StringTools.startsWith(normalized, '#') : Bool)) {
      ...
      if ((cast ((cast _Runtime.strictEquals(_Runtime.field(hex, 'length'), 3.0) : Bool) || (cast _Runtime.strictEquals(_Runtime.field(hex, 'length'), 4.0) : Bool)) : Bool)) {
        ...
        var a:Dynamic = ((cast _Runtime.strictEquals(_Runtime.field(hex, 'length'), 4.0) : Bool) ? (cast (_Runtime.callProperty(_Runtime.globalValue('Number'), 'parseInt', cast ([(_Runtime.getIndex(hex, 3.0) + _Runtime.getIndex(hex, 3.0)), 16.0] : Array<Dynamic>)) / 255.0) : Dynamic) : (cast 1.0 : Dynamic));
      ...
      if ((cast ((cast _Runtime.strictEquals(_Runtime.field(hex, 'length'), 6.0) : Bool) || (cast _Runtime.strictEquals(_Runtime.field(hex, 'length'), 8.0) : Bool)) : Bool)) {
        ...
        var alpha:Dynamic = ((cast _Runtime.strictEquals(_Runtime.field(hex, 'length'), 8.0) : Bool) ? (cast (_Runtime.callProperty(_Runtime.globalValue('Number'), 'parseInt', cast ([_Runtime.slice(hex, 6.0, null), 16.0] : Array<Dynamic>)) / 255.0) : Dynamic) : (cast 1.0 : Dynamic));
    ...
    if ((cast ((cast !_Runtime.strictEquals(functionMatch, null) : Bool) && (cast _Runtime.orValue(_Runtime.strictEquals(_Runtime.getIndex(functionMatch, 1.0), 'rgb'), function():Dynamic return cast _Runtime.strictEquals(_Runtime.getIndex(functionMatch, 1.0), 'rgba')) : Bool)) : Bool)) {
      ...
      if ((cast ((cast _Runtime.field(components, 'length') : Float) >= (cast 3.0 : Float)) : Bool)) {
        var component:Dynamic = function(index:Float) {
          ...
          return cast ((cast StringTools.endsWith(Std.string(text), '%') : Bool) ? (cast ((_Runtime.callProperty(_Runtime.globalValue('Number'), 'parseFloat', cast ([text] : Array<Dynamic>)) * 255.0) / 100.0) : Dynamic) : (cast _Runtime.callProperty(_Runtime.globalValue('Number'), 'parseFloat', cast ([text] : Array<Dynamic>)) : Dynamic));
        };
  ...
  public static function parseSvgGradient__svgDocument(element:XmlElement, context:SvgImportContext__svgDocument):Null<SvgGradient__svgDocument> {
    ...
    _Runtime.sortAndReturn(resolvedStops, function(a:Dynamic, b:Dynamic) return (_Runtime.field(a, 'offset') - _Runtime.field(b, 'offset')));
  ...
  public static function parseSvgTransform__svgDocument(value:Null<String>):Null<Matrix> {
    ...
    while ((cast !_Runtime.strictEquals((match = cast (_Runtime.callProperty(expression, 'exec', cast ([value] : Array<Dynamic>)) : Dynamic)), null) : Bool)) {
      ...
      if ((cast ((cast _Runtime.strictEquals(_Runtime.getIndex(match, 1.0), 'matrix') : Bool) && (cast ((cast _Runtime.field(values, 'length') : Float) >= (cast 6.0 : Float)) : Bool)) : Bool)) {
        ...
        var radians:Dynamic = ((_Runtime.coalesce(flighthq._internal._StaticIndex.readArray(values, 0.0), function():Dynamic return cast 0.0) * HxMath.PI) / 180.0);
        ...
        (operation.c = cast (HxMath.tan(((_Runtime.coalesce(flighthq._internal._StaticIndex.readArray(values, 0.0), function():Dynamic return cast 0.0) * HxMath.PI) / 180.0)) : Dynamic));
      } else { if ((cast _Runtime.strictEquals(_Runtime.getIndex(match, 1.0), 'skewY') : Bool)) {
        (operation.b = cast (HxMath.tan(((_Runtime.coalesce(flighthq._internal._StaticIndex.readArray(values, 0.0), function():Dynamic return cast 0.0) * HxMath.PI) / 180.0)) : Dynamic));
      } else {
        continue;
      } } } } } }
