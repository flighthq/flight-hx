...
class EnableGlRenderStateGuards {
  ...
  public static function areGlRenderStateGuardsEnabled(state:GlRenderState):Bool {
    ...
    entry = ({ final __structural1 = (cast (cast (cast getRenderStateRuntime(({ final __callArgument0:Dynamic = state; __callArgument0; })) : RenderStateRuntime) : { var registries:RenderRegistries; }).registries : { @:optional var renderRootGuard:Null<SlotTable<RenderRootGuard>>; }).renderRootGuard; __structural1 == null ? _Runtime.UNDEFINED : (cast __structural1 : { var entry:Null<flighthq._internal._Union2<{ var state:String; }, { var state:String; var value:RenderRootGuard; }>>; }).entry; });
