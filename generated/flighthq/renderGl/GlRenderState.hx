...
class GlRenderState {
  ...
  public static function getGlColorAdjustmentMaterialFeature(state:flighthq.types.GlRenderState):Null<GlColorAdjustmentMaterialFeature> {
    ...
    entry = ({ final __structural22 = (cast (cast (cast getGlRenderStateRuntime(({ final __callArgument21:Dynamic = state; __callArgument21; })) : GlRenderStateRuntime) : { var registries:GlRenderRegistries; }).registries : { @:optional var colorAdjustmentFeature:Null<SlotTable<GlColorAdjustmentMaterialFeature>>; }).colorAdjustmentFeature; __structural22 == null ? _Runtime.UNDEFINED : (cast __structural22 : { var entry:Null<flighthq._internal._Union2<{ var state:String; }, { var state:String; var value:GlColorAdjustmentMaterialFeature; }>>; }).entry; });
  ...
  public static function getGlColorAdjustmentMaterialFeatureGuard(state:flighthq.types.GlRenderState):Null<GlColorAdjustmentMaterialFeatureGuard> {
    ...
    entry = ({ final __structural25 = (cast (cast (cast getGlRenderStateRuntime(({ final __callArgument24:Dynamic = state; __callArgument24; })) : GlRenderStateRuntime) : { var registries:GlRenderRegistries; }).registries : { @:optional var colorAdjustmentFeatureGuard:Null<SlotTable<GlColorAdjustmentMaterialFeatureGuard>>; }).colorAdjustmentFeatureGuard; __structural25 == null ? _Runtime.UNDEFINED : (cast __structural25 : { var entry:Null<flighthq._internal._Union2<{ var state:String; }, { var state:String; var value:GlColorAdjustmentMaterialFeatureGuard; }>>; }).entry; });
