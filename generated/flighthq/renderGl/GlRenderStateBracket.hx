...
typedef SavedGlRenderState__glRenderStateBracket = { var activeTexture:Float; var blend:Bool; var blendDstAlpha:Float; var blendDstRgb:Float; var blendEquationAlpha:Float; var blendEquationRgb:Float; var blendSrcAlpha:Float; var blendSrcRgb:Float; var cullFace:Bool; var cullFaceMode:Float; var currentFramebuffer:Null<Dynamic>; var currentBlendMode:Dynamic; var currentRenderTarget:Dynamic; var currentProgram:Dynamic; var currentScissorRect:Dynamic; var currentTexture:Dynamic; var currentTextureStraightAlpha:Bool; var depthFunc:Float; var depthMask:Bool; var depthTest:Bool; var framebuffer:Null<Dynamic>; var program:Null<Dynamic>; var renderTargetViewport:Dynamic; var scissorBox:GlBox__glRenderStateBracket; var scissorTest:Bool; var texture2DByUnit:Array<Null<Dynamic>>; var vertexArray:Null<Dynamic>; var viewport:GlBox__glRenderStateBracket; };
...
class GlRenderStateBracket {
  public static function popGlRenderState(state:GlRenderState):Void {
    ...
    _Runtime.callValue(GlRenderStateBracket.restoreGlCapability__glRenderStateBracket, cast ([gl, flighthq._internal.backend.WebGl2Backend.DEPTH_TEST, _Runtime.field(saved, 'depthTest')] : Array<Dynamic>));
    ...
    _Runtime.callValue(GlRenderStateBracket.restoreGlCapability__glRenderStateBracket, cast ([gl, flighthq._internal.backend.WebGl2Backend.CULL_FACE, _Runtime.field(saved, 'cullFace')] : Array<Dynamic>));
    flighthq._internal.backend.WebGl2Backend.cullFace(gl, _Runtime.field(saved, 'cullFaceMode'));
    _Runtime.callValue(GlRenderStateBracket.restoreGlCapability__glRenderStateBracket, cast ([gl, flighthq._internal.backend.WebGl2Backend.BLEND, _Runtime.field(saved, 'blend')] : Array<Dynamic>));
    ...
    flighthq._internal.backend.WebGl2Backend.bindFramebuffer(gl, flighthq._internal.backend.WebGl2Backend.FRAMEBUFFER, _Runtime.field(saved, 'framebuffer'));
    {
      ...
      while ((cast ((cast i : Float) < (cast _Runtime.field(_Runtime.field(saved, 'texture2DByUnit'), 'length') : Float)) : Bool)) {
        ...
        flighthq._internal.backend.WebGl2Backend.bindTexture(gl, flighthq._internal.backend.WebGl2Backend.TEXTURE_2D, flighthq._internal._StaticIndex.readArray(_Runtime.field(saved, 'texture2DByUnit'), i));
        i++;
      }
    }
    flighthq._internal.backend.WebGl2Backend.activeTexture(gl, _Runtime.field(saved, 'activeTexture'));
    _Runtime.callValue(GlRenderStateBracket.restoreGlCapability__glRenderStateBracket, cast ([gl, flighthq._internal.backend.WebGl2Backend.SCISSOR_TEST, _Runtime.field(saved, 'scissorTest')] : Array<Dynamic>));
  ...
  public static function pushGlRenderState(state:GlRenderState):Void {
    ...
    var texture2DByUnit:Array<Null<Dynamic>> = cast _Runtime.UNDEFINED;
    ...
    gl = _Runtime.field(state, 'gl');
    activeTexture = (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.ACTIVE_TEXTURE) : Float);
    texture2DByUnit = cast ([] : Array<Dynamic>);
    {
      ...
      while ((cast ((cast i : Float) < (cast GlRenderStateBracket.GL_RENDER_STATE_TEXTURE_UNIT_COUNT__glRenderStateBracket : Float)) : Bool)) {
        flighthq._internal.backend.WebGl2Backend.activeTexture(gl, (flighthq._internal.backend.WebGl2Backend.TEXTURE0 + i));
        _Runtime.callProperty(texture2DByUnit, 'push', cast ([(cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.TEXTURE_BINDING_2D) : Null<Dynamic>)] : Array<Dynamic>));
        i++;
      }
    }
    ...
    _Runtime.callProperty(stack, 'push', cast ([{ activeTexture: activeTexture, blend: flighthq._internal.backend.WebGl2Backend.isEnabled(gl, flighthq._internal.backend.WebGl2Backend.BLEND), blendDstAlpha: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.BLEND_DST_ALPHA) : Float), blendDstRgb: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.BLEND_DST_RGB) : Float), blendEquationAlpha: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.BLEND_EQUATION_ALPHA) : Float), blendEquationRgb: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.BLEND_EQUATION_RGB) : Float), blendSrcAlpha: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.BLEND_SRC_ALPHA) : Float), blendSrcRgb: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.BLEND_SRC_RGB) : Float), cullFace: flighthq._internal.backend.WebGl2Backend.isEnabled(gl, flighthq._internal.backend.WebGl2Backend.CULL_FACE), cullFaceMode: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.CULL_FACE_MODE) : Float), currentFramebuffer: _Runtime.field(runtime, 'currentFramebuffer'), currentBlendMode: _Runtime.field(runtime, 'currentBlendMode'), currentRenderTarget: _Runtime.field(runtime, 'currentRenderTarget'), currentProgram: _Runtime.field(runtime, 'currentProgram'), currentScissorRect: _Runtime.field(runtime, 'currentScissorRect'), currentTexture: _Runtime.field(runtime, 'currentTexture'), currentTextureStraightAlpha: _Runtime.field(runtime, 'currentTextureStraightAlpha'), depthFunc: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.DEPTH_FUNC) : Float), depthMask: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.DEPTH_WRITEMASK) : Bool), depthTest: flighthq._internal.backend.WebGl2Backend.isEnabled(gl, flighthq._internal.backend.WebGl2Backend.DEPTH_TEST), framebuffer: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.FRAMEBUFFER_BINDING) : Null<Dynamic>), program: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.CURRENT_PROGRAM) : Null<Dynamic>), renderTargetViewport: _Runtime.field(runtime, 'renderTargetViewport'), scissorBox: _Runtime.callValue(GlRenderStateBracket.readGlBox__glRenderStateBracket, cast ([gl, flighthq._internal.backend.WebGl2Backend.SCISSOR_BOX] : Array<Dynamic>)), scissorTest: flighthq._internal.backend.WebGl2Backend.isEnabled(gl, flighthq._internal.backend.WebGl2Backend.SCISSOR_TEST), texture2DByUnit: texture2DByUnit, vertexArray: (cast flighthq._internal.backend.WebGl2Backend.getParameter(gl, flighthq._internal.backend.WebGl2Backend.VERTEX_ARRAY_BINDING) : Null<Dynamic>), viewport: _Runtime.callValue(GlRenderStateBracket.readGlBox__glRenderStateBracket, cast ([gl, flighthq._internal.backend.WebGl2Backend.VIEWPORT] : Array<Dynamic>)) }] : Array<Dynamic>));
  }
  ...
  public static function readGlBox__glRenderStateBracket(gl:Dynamic, parameter:GLenum):GlBox__glRenderStateBracket {
  ...
  public static function restoreGlCapability__glRenderStateBracket(gl:Dynamic, capability:GLenum, enabled:Bool):Void {
