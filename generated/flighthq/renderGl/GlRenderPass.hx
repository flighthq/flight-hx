...
class GlRenderPass {
  ...
  public static function endGlRenderPass(state:GlRenderState):Void {
    ...
    if (_Runtime.truthy(!_Runtime.strictEquals(saved, _Runtime.field(_Runtime, 'UNDEFINED')))) {
      flighthq._internal.backend.WebGl2Backend.call(gl, 'bindFramebuffer', cast ([flighthq._internal.backend.WebGl2Backend.field(gl, 'FRAMEBUFFER'), _Runtime.field(saved, 'framebuffer')] : Array<Dynamic>));
      ...
      flighthq._internal.backend.WebGl2Backend.call(gl, 'viewport', cast ([0.0, 0.0, _Runtime.field(viewport, 'width'), _Runtime.field(viewport, 'height')] : Array<Dynamic>));
  ...
  public static function clearGlRenderPass__glRenderPass(state:GlRenderState, target:GlRenderTarget, preserve:Null<RenderPassPreserve>):Void {
    ...
    preserveColor = _Runtime.coalesce(_Runtime.optionalField(preserve, 'preserveColor'), function():Dynamic return cast false);
    {
      ...
      while (_Runtime.truthy(_Runtime.compare(i, _Runtime.field(_Runtime.field(target, 'textures'), 'length'), '<'))) {
        ...
        flighthq._internal.backend.WebGl2Backend.call(gl, 'clearBufferfv', cast ([flighthq._internal.backend.WebGl2Backend.field(gl, 'COLOR'), i, GlRenderPass._clearRgba__glRenderPass] : Array<Dynamic>));
        i++;
      }
    }
    ...
    if (_Runtime.truthy(_Runtime.andValue(hasDepth, function():Dynamic return cast !_Runtime.strictEquals(_Runtime.optionalField(preserve, 'preserveDepth'), true)))) {
      ...
      flighthq._internal.backend.WebGl2Backend.call(gl, 'clearBufferfi', cast ([flighthq._internal.backend.WebGl2Backend.field(gl, 'DEPTH_STENCIL'), 0.0, _Runtime.field(target, 'clearDepth'), 0.0] : Array<Dynamic>));
    }
