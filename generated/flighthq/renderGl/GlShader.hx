...
class GlShader {
  ...
  public static function compileGlBitmapProgram(gl:Dynamic, fragmentSrc:String = '#version 300 es\nprecision mediump float;\nin vec2 v_texCoord;\nuniform sampler2D u_texture;\nuniform float u_alpha;\nout vec4 fragColor;\nvoid main() {\n  vec4 color = texture(u_texture, v_texCoord) * clamp(u_alpha, 0.0, 1.0);\n  if (color.a <= 0.0) discard;\n  fragColor = color;\n}'):GlShaderLocations {
    ...
    return cast { program: program, locPosition: flighthq._internal.backend.WebGl2Backend.call(gl, 'getAttribLocation', cast ([program, 'a_position'] : Array<Dynamic>)), locTexCoord: flighthq._internal.backend.WebGl2Backend.call(gl, 'getAttribLocation', cast ([program, 'a_texCoord'] : Array<Dynamic>)), locMatrix: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_matrix'] : Array<Dynamic>)), locAlpha: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_alpha'] : Array<Dynamic>)), locTexture: flighthq._internal.backend.WebGl2Backend.call(gl, 'getUniformLocation', cast ([program, 'u_texture'] : Array<Dynamic>)) };
    return cast null;
  }
  ...
  public static function setGlAttributes(gl:Dynamic, loc:GlShaderLocations):Void {
    flighthq._internal.backend.WebGl2Backend.call(gl, 'enableVertexAttribArray', cast ([_Runtime.field(loc, 'locPosition')] : Array<Dynamic>));
    flighthq._internal.backend.WebGl2Backend.call(gl, 'enableVertexAttribArray', cast ([_Runtime.field(loc, 'locTexCoord')] : Array<Dynamic>));
    flighthq._internal.backend.WebGl2Backend.call(gl, 'vertexAttribPointer', cast ([_Runtime.field(loc, 'locPosition'), 2.0, flighthq._internal.backend.WebGl2Backend.field(gl, 'FLOAT'), false, 16.0, 0.0] : Array<Dynamic>));
    flighthq._internal.backend.WebGl2Backend.call(gl, 'vertexAttribPointer', cast ([_Runtime.field(loc, 'locTexCoord'), 2.0, flighthq._internal.backend.WebGl2Backend.field(gl, 'FLOAT'), false, 16.0, 8.0] : Array<Dynamic>));
  }

  public static function setGlBaseUniforms(gl:Dynamic, loc:GlShaderLocations, renderProxy:RenderProxy):Void {
    flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1f', cast ([_Runtime.field(loc, 'locAlpha'), _Runtime.field(renderProxy, 'alpha')] : Array<Dynamic>));
    flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1i', cast ([_Runtime.field(loc, 'locTexture'), 0.0] : Array<Dynamic>));
  }
  ...
  public static function setGlMatrixFromTransform(gl:Dynamic, loc:GlShaderLocations, m:flighthq._internal._Float32Array, t:{ var a:Float; var b:Float; var c:Float; var d:Float; var tx:Float; var ty:Float; }, viewport:{ var width:Float; var height:Float; }):Void {
    ...
    flighthq._internal.backend.WebGl2Backend.call(gl, 'uniformMatrix3fv', cast ([_Runtime.field(loc, 'locMatrix'), false, m] : Array<Dynamic>));
  }
