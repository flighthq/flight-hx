...
class CanvasCompositeEffect {
  ...
  public static function registerCanvasCompositeEffect(state:CanvasRenderState):Void {
    registerCanvasRenderEffect(({ final __callArgument4:Dynamic = state; __callArgument4; }), (cast 'CompositeEffect' : String), ({ final __callArgument5:Dynamic = defaultCanvasCompositeEffectRunner; __callArgument5; }));
  }
