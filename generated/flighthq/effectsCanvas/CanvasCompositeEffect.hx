...
class CanvasCompositeEffect {
  ...
  public static function applyCompositeEffectToCanvas(state:CanvasRenderState, source:CanvasRenderTarget, dest:CanvasRenderTarget, effect:CompositeEffect):Void {
    ...
    if ((cast !_Runtime.strictEquals(_Runtime.field(effect, 'operator'), (cast CompositeOperatorValues : { var Clear:String; var Copy:String; var DestinationAtop:String; var DestinationIn:String; var DestinationOut:String; var DestinationOver:String; var SourceAtop:String; var SourceIn:String; var SourceOut:String; var SourceOver:String; var Xor:String; }).Clear) : Bool)) {
      var backdrop:Null<CanvasRenderTarget> = (cast getCanvasBlendEffectBackdrop((cast state), (cast _Runtime.coalesce(_Runtime.field(effect, 'backdropKey'), function():Dynamic return cast null))) : Null<CanvasRenderTarget>);
  ...
  public static final defaultCanvasCompositeEffectRunner:CanvasRenderEffectRunner = (cast function(ctx:CanvasRenderEffectContext, effect:RenderEffect):Void {
    applyCompositeEffectToCanvas((cast _Runtime.field(ctx, 'state')), (cast _Runtime.field(ctx, 'source')), (cast _Runtime.field(ctx, 'dest')), (cast (cast effect : CompositeEffect)));
  });
  ...
  public static function registerCanvasCompositeEffect(state:CanvasRenderState):Void {
    registerCanvasRenderEffect((cast state), (cast 'CompositeEffect' : String), (cast defaultCanvasCompositeEffectRunner));
  }
