...
class Share {
  ...
  public static function hasShareContentFields(content:ShareContent):Bool {
    if (_Runtime.truthy(_Runtime.andValue(!_Runtime.strictEquals(_Runtime.field(content, 'title'), _Runtime.UNDEFINED), function():Dynamic return cast !_Runtime.strictEquals(_Runtime.field(content, 'title'), '')))) { return cast true; }
    if (_Runtime.truthy(_Runtime.andValue(!_Runtime.strictEquals(_Runtime.field(content, 'text'), _Runtime.UNDEFINED), function():Dynamic return cast !_Runtime.strictEquals(_Runtime.field(content, 'text'), '')))) { return cast true; }
    if (_Runtime.truthy(_Runtime.andValue(!_Runtime.strictEquals(_Runtime.field(content, 'url'), _Runtime.UNDEFINED), function():Dynamic return cast !_Runtime.strictEquals(_Runtime.field(content, 'url'), '')))) { return cast true; }
    if (_Runtime.truthy(_Runtime.andValue(!_Runtime.strictEquals(_Runtime.field(content, 'files'), _Runtime.UNDEFINED), function():Dynamic return cast _Runtime.compare(_Runtime.field(_Runtime.field(content, 'files'), 'length'), 0.0, '>')))) { return cast true; }
    return cast false;
    return cast null;
  }
  ...
  public static function shareContentToNavigatorData__share(content:ShareContent):Dynamic {
    ...
    data = {  };
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(content, 'title'), _Runtime.UNDEFINED))) { _Runtime.setField(data, 'title', _Runtime.field(content, 'title')); }
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(content, 'text'), _Runtime.UNDEFINED))) { _Runtime.setField(data, 'text', _Runtime.field(content, 'text')); }
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(content, 'url'), _Runtime.UNDEFINED))) { _Runtime.setField(data, 'url', _Runtime.field(content, 'url')); }
    if (_Runtime.truthy(_Runtime.andValue(!_Runtime.strictEquals(_Runtime.field(content, 'files'), _Runtime.UNDEFINED), function():Dynamic return cast _Runtime.compare(_Runtime.field(_Runtime.field(content, 'files'), 'length'), 0.0, '>')))) {
