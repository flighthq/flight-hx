...
class ParseKtx2 {
  public static function getKtx2ParseFailureReason(bytes:flighthq._internal._UInt8Array):Null<TextureContainerParseFailureReason> {
    ...
    container = (cast ParseKtx2.parseKtx2Internal__parseKtx2(({ final __callArgument0:Dynamic = bytes; __callArgument0; }), (cast failure : Dynamic)) : Null<TextureContainer>);
  ...
  public static function parseKtx2(bytes:flighthq._internal._UInt8Array):Null<TextureContainer> {
    return cast (cast (#if js _Runtime.callValue(ParseKtx2.parseKtx2Internal__parseKtx2, cast ([({ final __callArgument3:Dynamic = bytes; __callArgument3; })] : Array<Dynamic>)) #else ParseKtx2.parseKtx2Internal__parseKtx2(({ final __callArgument2:Dynamic = bytes; __callArgument2; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end) : Null<TextureContainer>);
    return cast null;
  }
  ...
  public static function parseKtx2Internal__parseKtx2(bytes:flighthq._internal._UInt8Array, ?failure:ParseFailure__parseKtx2):Null<TextureContainer> {
    ...
    if ((cast !(cast (cast ParseKtx2.hasKtx2Identifier__parseKtx2(({ final __callArgument4:Dynamic = bytes; __callArgument4; })) : Bool) : Bool) : Bool)) { return cast (cast ParseKtx2.reject__parseKtx2((cast failure : Dynamic), ({ final __callArgument6:Dynamic = 'container-unrecognized'; __callArgument6; })) : Null<TextureContainer>); }
    if ((cast ((cast _Runtime.field(bytes, 'byteLength') : Float) < (cast ParseKtx2.ktx2LevelIndexOffset__parseKtx2 : Float)) : Bool)) { return cast (cast ParseKtx2.reject__parseKtx2((cast failure : Dynamic), ({ final __callArgument8:Dynamic = 'header-truncated'; __callArgument8; })) : Null<TextureContainer>); }
    reader = (cast createByteReader(({ final __callArgument10:Dynamic = bytes; __callArgument10; }), (cast 12.0 : Float)) : ByteReader);
    vkFormat = (cast readByteReaderU32(({ final __callArgument12:Dynamic = reader; __callArgument12; })) : Float);
    skipByteReader(({ final __callArgument14:Dynamic = reader; __callArgument14; }), (cast 4.0 : Float));
    pixelWidth = (cast readByteReaderU32(({ final __callArgument16:Dynamic = reader; __callArgument16; })) : Float);
    pixelHeight = (cast readByteReaderU32(({ final __callArgument18:Dynamic = reader; __callArgument18; })) : Float);
    pixelDepth = (cast readByteReaderU32(({ final __callArgument20:Dynamic = reader; __callArgument20; })) : Float);
    layerCount = (cast readByteReaderU32(({ final __callArgument22:Dynamic = reader; __callArgument22; })) : Float);
    faceCount = (cast readByteReaderU32(({ final __callArgument24:Dynamic = reader; __callArgument24; })) : Float);
    levelCount = (cast readByteReaderU32(({ final __callArgument26:Dynamic = reader; __callArgument26; })) : Float);
    supercompressionScheme = (cast readByteReaderU32(({ final __callArgument28:Dynamic = reader; __callArgument28; })) : Float);
    supercompression = _Runtime.getIndex(ParseKtx2.ktx2Supercompression__parseKtx2, supercompressionScheme);
    if ((cast _Runtime.strictEquals(supercompression, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) { return cast (cast ParseKtx2.reject__parseKtx2((cast failure : Dynamic), ({ final __callArgument30:Dynamic = 'format-unsupported'; __callArgument30; })) : Null<TextureContainer>); }
    format = (cast ParseKtx2.mapKtx2Format__parseKtx2((cast vkFormat : Float), (cast supercompressionScheme : Float)) : Null<String>);
    if ((cast _Runtime.strictEquals(format, null) : Bool)) { return cast (cast ParseKtx2.reject__parseKtx2((cast failure : Dynamic), ({ final __callArgument32:Dynamic = 'format-unsupported'; __callArgument32; })) : Null<TextureContainer>); }
    ...
    if ((cast !(cast (cast hasByteReaderBytes(({ final __callArgument34:Dynamic = reader; __callArgument34; }), (cast (levelCountPresent * 24.0) : Float)) : Bool) : Bool) : Bool)) { return cast (cast ParseKtx2.reject__parseKtx2((cast failure : Dynamic), ({ final __callArgument36:Dynamic = 'level-range-out-of-bounds'; __callArgument36; })) : Null<TextureContainer>); }
    ...
    imagesPerLevel = (layers * faces);
    {
      ...
      while ((cast ((cast mip : Float) < (cast levelCountPresent : Float)) : Bool)) {
        var byteOffset:Float = (cast readByteReaderU64(({ final __callArgument38:Dynamic = reader; __callArgument38; })) : Float);
        var byteLength:Float = (cast readByteReaderU64(({ final __callArgument40:Dynamic = reader; __callArgument40; })) : Float);
        skipByteReader(({ final __callArgument42:Dynamic = reader; __callArgument42; }), (cast 8.0 : Float));
        if ((cast ((cast (byteOffset + byteLength) : Float) > (cast _Runtime.field(bytes, 'byteLength') : Float)) : Bool)) { return cast (cast ParseKtx2.reject__parseKtx2((cast failure : Dynamic), ({ final __callArgument44:Dynamic = 'level-range-out-of-bounds'; __callArgument44; })) : Null<TextureContainer>); }
