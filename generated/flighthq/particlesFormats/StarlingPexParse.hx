...
class StarlingPexParse {
  public static function parseStarlingPex(xml:String, ?options:StarlingPexParseOptions):ParticleEmitterConfig {
    ...
    doc = (cast StarlingPexParse.dictToDocument__starlingPexParse((cast d)) : StarlingPexDocument);
    return cast (cast StarlingPexParse.documentToConfig__starlingPexParse((cast doc), (cast _Runtime.coalesce(({ final __typedStruct0 = options; __typedStruct0 == null ? _Runtime.UNDEFINED : __typedStruct0.textureSize; }), function():Dynamic return cast 1.0) : Float)) : ParticleEmitterConfig);
    return cast null;
  }
  ...
  public static function parseStarlingPexDocument(xml:String, ?options:StarlingPexParseOptions):StarlingPexParseResult {
    ...
    d = (cast StarlingPexParse.parsePexXml__starlingPexParse((cast xml : String)) : PexDict__starlingPexParse);
    doc = (cast StarlingPexParse.dictToDocument__starlingPexParse((cast d)) : StarlingPexDocument);
    return cast { config: (cast StarlingPexParse.documentToConfig__starlingPexParse((cast doc), (cast _Runtime.coalesce(({ final __typedStruct1 = options; __typedStruct1 == null ? _Runtime.UNDEFINED : __typedStruct1.textureSize; }), function():Dynamic return cast 1.0) : Float)) : ParticleEmitterConfig), diagnostics: (cast StarlingPexParse.collectStarlingPexDiagnostics__starlingPexParse((cast doc)) : Array<ImportDiagnostic>), document: doc };
    return cast null;
  }
  ...
  public static function dictToDocument__starlingPexParse(d:PexDict__starlingPexParse):StarlingPexDocument {
    ...
    return cast { maxParticles: (_Runtime.toInt32((cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'maxParticles' : String), (cast 200.0 : Float)) : Float)) | 0), emitterType: (cast ((cast _Runtime.strictEquals((cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'emitterType' : String), (cast 0.0 : Float)) : Float), 1.0) : Bool) ? (cast 1.0 : Dynamic) : (cast 0.0 : Dynamic)) : Float), duration: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'duration' : String), (cast -1.0 : Float)) : Float), particleLifespan: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'particleLifespan' : String), (cast 1.0 : Float)) : Float), particleLifespanVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'particleLifespanVariance' : String), (cast 0.0 : Float)) : Float), speed: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'speed' : String), (cast 100.0 : Float)) : Float), speedVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'speedVariance' : String), (cast 0.0 : Float)) : Float), angle: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'angle' : String), (cast 90.0 : Float)) : Float), angleVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'angleVariance' : String), (cast 0.0 : Float)) : Float), gravityx: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'gravityx' : String), (cast 0.0 : Float)) : Float), gravityy: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'gravityy' : String), (cast 0.0 : Float)) : Float), sourcePositionVariancex: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'sourcePositionVariancex' : String), (cast 0.0 : Float)) : Float), sourcePositionVariancey: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'sourcePositionVariancey' : String), (cast 0.0 : Float)) : Float), startParticleSize: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'startParticleSize' : String), (cast 32.0 : Float)) : Float), startParticleSizeVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'startParticleSizeVariance' : String), (cast 0.0 : Float)) : Float), finishParticleSize: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'finishParticleSize' : String), (cast 16.0 : Float)) : Float), finishParticleSizeVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'finishParticleSizeVariance' : String), (cast 0.0 : Float)) : Float), startColor: (cast StarlingPexParse.pColor__starlingPexParse((cast d), (cast 'startColor' : String), (cast WHITE)) : StarlingPexColor), startColorVariance: (cast StarlingPexParse.pColor__starlingPexParse((cast d), (cast 'startColorVariance' : String), (cast ZERO)) : StarlingPexColor), finishColor: (cast StarlingPexParse.pColor__starlingPexParse((cast d), (cast 'finishColor' : String), (cast CLEAR)) : StarlingPexColor), finishColorVariance: (cast StarlingPexParse.pColor__starlingPexParse((cast d), (cast 'finishColorVariance' : String), (cast ZERO)) : StarlingPexColor), rotationStart: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'rotationStart' : String), (cast 0.0 : Float)) : Float), rotationStartVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'rotationStartVariance' : String), (cast 0.0 : Float)) : Float), rotationEnd: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'rotationEnd' : String), (cast 0.0 : Float)) : Float), rotationEndVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'rotationEndVariance' : String), (cast 0.0 : Float)) : Float), maxRadius: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'maxRadius' : String), (cast 0.0 : Float)) : Float), maxRadiusVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'maxRadiusVariance' : String), (cast 0.0 : Float)) : Float), minRadius: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'minRadius' : String), (cast 0.0 : Float)) : Float), minRadiusVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'minRadiusVariance' : String), (cast 0.0 : Float)) : Float), rotatePerSecond: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'rotatePerSecond' : String), (cast 0.0 : Float)) : Float), rotatePerSecondVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'rotatePerSecondVariance' : String), (cast 0.0 : Float)) : Float), radialAcceleration: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'radialAcceleration' : String), (cast 0.0 : Float)) : Float), radialAccelVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'radialAccelVariance' : String), (cast 0.0 : Float)) : Float), tangentialAcceleration: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'tangentialAcceleration' : String), (cast 0.0 : Float)) : Float), tangentialAccelVariance: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'tangentialAccelVariance' : String), (cast 0.0 : Float)) : Float), blendFuncSource: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'blendFuncSource' : String), (cast 770.0 : Float)) : Float), blendFuncDestination: (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast 'blendFuncDestination' : String), (cast 771.0 : Float)) : Float), textureFileName: (cast StarlingPexParse.pStr__starlingPexParse((cast d), (cast 'textureFileName' : String), (cast '' : String)) : String) };
    return cast null;
  }
  ...
  public static function pColor__starlingPexParse(d:PexDict__starlingPexParse, prefix:String, defColor:StarlingPexColor):StarlingPexColor {
    ...
    r = (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast '' + Std.string(prefix) + '.red' : String), (cast (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast '' + Std.string(prefix) + 'Red' : String), (cast defColor.red : Float)) : Float) : Float)) : Float);
    g = (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast '' + Std.string(prefix) + '.green' : String), (cast (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast '' + Std.string(prefix) + 'Green' : String), (cast defColor.green : Float)) : Float) : Float)) : Float);
    b = (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast '' + Std.string(prefix) + '.blue' : String), (cast (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast '' + Std.string(prefix) + 'Blue' : String), (cast defColor.blue : Float)) : Float) : Float)) : Float);
    a = (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast '' + Std.string(prefix) + '.alpha' : String), (cast (cast StarlingPexParse.pNum__starlingPexParse((cast d), (cast '' + Std.string(prefix) + 'Alpha' : String), (cast defColor.alpha : Float)) : Float) : Float)) : Float);
