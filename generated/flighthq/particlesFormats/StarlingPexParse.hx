...
class StarlingPexParse {
  ...
  public static function parseStarlingPexDocument(xml:String, ?options:StarlingPexParseOptions):StarlingPexParseResult {
    ...
    d = (cast StarlingPexParse.parsePexXml__starlingPexParse((cast xml : String)) : PexDict__starlingPexParse);
    doc = (cast StarlingPexParse.dictToDocument__starlingPexParse((cast d : Dynamic)) : StarlingPexDocument);
    return cast { config: (cast StarlingPexParse.documentToConfig__starlingPexParse(({ final __callArgument4:Dynamic = doc; __callArgument4; }), (cast _Runtime.coalesce(({ final __typedStruct5 = options; __typedStruct5 == null ? _Runtime.UNDEFINED : __typedStruct5.textureSize; }), function():Dynamic return cast 1.0) : Float)) : ParticleEmitterConfig), diagnostics: (cast StarlingPexParse.collectStarlingPexDiagnostics__starlingPexParse(({ final __callArgument8:Dynamic = doc; __callArgument8; })) : Array<ImportDiagnostic>), document: doc };
    return cast null;
  }
  ...
  public static function collectStarlingPexDiagnostics__starlingPexParse(doc:StarlingPexDocument):Array<ImportDiagnostic> {
    ...
    if ((cast _Runtime.strictEquals(doc.emitterType, 1.0) : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument12:Dynamic = diagnostics; __callArgument12; }), ({ final __callArgument13:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument13; }), (cast 'starlingpex.radial-approximated' : String), (cast 'collectStarlingPexDiagnostics' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument10:Dynamic = diagnostics; __callArgument10; }), ({ final __callArgument11:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument11; }), (cast 'starlingpex.radial-approximated' : String), (cast 'collectStarlingPexDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    }
    if ((cast ((cast !_Runtime.strictEquals(doc.radialAcceleration, 0.0) : Bool) || (cast !_Runtime.strictEquals(doc.radialAccelVariance, 0.0) : Bool)) : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument16:Dynamic = diagnostics; __callArgument16; }), ({ final __callArgument17:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument17; }), (cast 'starlingpex.radial-acceleration-unsupported' : String), (cast 'collectStarlingPexDiagnostics' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument14:Dynamic = diagnostics; __callArgument14; }), ({ final __callArgument15:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument15; }), (cast 'starlingpex.radial-acceleration-unsupported' : String), (cast 'collectStarlingPexDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    }
    if ((cast ((cast !_Runtime.strictEquals(doc.tangentialAcceleration, 0.0) : Bool) || (cast !_Runtime.strictEquals(doc.tangentialAccelVariance, 0.0) : Bool)) : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument20:Dynamic = diagnostics; __callArgument20; }), ({ final __callArgument21:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument21; }), (cast 'starlingpex.tangential-acceleration-unsupported' : String), (cast 'collectStarlingPexDiagnostics' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument18:Dynamic = diagnostics; __callArgument18; }), ({ final __callArgument19:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument19; }), (cast 'starlingpex.tangential-acceleration-unsupported' : String), (cast 'collectStarlingPexDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    }
    if ((cast !_Runtime.strictEquals(doc.finishParticleSizeVariance, 0.0) : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument24:Dynamic = diagnostics; __callArgument24; }), ({ final __callArgument25:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument25; }), (cast 'starlingpex.finish-size-variance-unsupported' : String), (cast 'collectStarlingPexDiagnostics' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument22:Dynamic = diagnostics; __callArgument22; }), ({ final __callArgument23:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument23; }), (cast 'starlingpex.finish-size-variance-unsupported' : String), (cast 'collectStarlingPexDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    }
    if ((cast ((cast !_Runtime.strictEquals((cast doc.startColorVariance : { var alpha:Float; }).alpha, 0.0) : Bool) || (cast !_Runtime.strictEquals((cast doc.finishColorVariance : { var alpha:Float; }).alpha, 0.0) : Bool)) : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument28:Dynamic = diagnostics; __callArgument28; }), ({ final __callArgument29:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument29; }), (cast 'starlingpex.alpha-variance-unsupported' : String), (cast 'collectStarlingPexDiagnostics' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument26:Dynamic = diagnostics; __callArgument26; }), ({ final __callArgument27:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument27; }), (cast 'starlingpex.alpha-variance-unsupported' : String), (cast 'collectStarlingPexDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    }
