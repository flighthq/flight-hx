...
class LibgdxParse {
  ...
  public static function collectLibgdxDiagnostics__libgdxParse(doc:LibgdxParticleDocument):Array<ImportDiagnostic> {
    ...
    if ((cast (cast doc.delay : { var active:Bool; }).active : Bool)) {
      reportImportDiagnostic((cast diagnostics), (cast (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip), (cast 'libgdx.delay-unsupported' : String), (cast 'collectLibgdxDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED')) #else (cast null) #end);
    }
    if ((cast (cast doc.lifeOffset : { var active:Bool; }).active : Bool)) {
      reportImportDiagnostic((cast diagnostics), (cast (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip), (cast 'libgdx.life-offset-unsupported' : String), (cast 'collectLibgdxDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED')) #else (cast null) #end);
    }
    if ((cast ((cast (cast doc.xOffset : { var active:Bool; }).active : Bool) || (cast (cast doc.yOffset : { var active:Bool; }).active : Bool)) : Bool)) {
      reportImportDiagnostic((cast diagnostics), (cast (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip), (cast 'libgdx.position-offset-unsupported' : String), (cast 'collectLibgdxDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED')) #else (cast null) #end);
    }
    if ((cast doc.premultipliedAlpha : Bool)) {
      reportImportDiagnostic((cast diagnostics), (cast (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip), (cast 'libgdx.premultiplied-alpha-informational' : String), (cast 'collectLibgdxDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED')) #else (cast null) #end);
    }
    if ((cast _Runtime.strictEquals((cast doc.spawnShape : { var shape:String; var edges:Bool; var side:String; }).shape, 'line') : Bool)) {
      reportImportDiagnostic((cast diagnostics), (cast (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover), (cast 'libgdx.line-shape-mapped-to-point' : String), (cast 'collectLibgdxDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED')) #else (cast null) #end);
    }
    reportImportDiagnostic((cast diagnostics), (cast (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover), (cast 'libgdx.emission-unsupported' : String), (cast 'collectLibgdxDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED')) #else (cast null) #end);
    if ((cast ((cast _Runtime.field((cast doc.tint : { var colors:Array<String>; var timeline:Array<Float>; }).colors, 'length') : Float) > (cast 2.0 : Float)) : Bool)) {
      reportImportDiagnostic((cast diagnostics), (cast (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover), (cast 'libgdx.tint-reduced' : String), (cast 'collectLibgdxDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED')) #else (cast null) #end);
    }
    if ((cast ((cast _Runtime.field((cast doc.transparency : { var scaling:Array<Float>; }).scaling, 'length') : Float) > (cast 2.0 : Float)) : Bool)) {
      reportImportDiagnostic((cast diagnostics), (cast (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover), (cast 'libgdx.transparency-reduced' : String), (cast 'collectLibgdxDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED')) #else (cast null) #end);
    }
    if ((cast ((cast (cast doc.spawnShape : { var shape:String; var edges:Bool; var side:String; }).edges : Bool) || (cast !_Runtime.strictEquals((cast doc.spawnShape : { var shape:String; var edges:Bool; var side:String; }).side, 'both') : Bool)) : Bool)) {
      reportImportDiagnostic((cast diagnostics), (cast (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip), (cast 'libgdx.spawn-edges-unsupported' : String), (cast 'collectLibgdxDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED')) #else (cast null) #end);
    }
