...
class UnitySerialize {
  ...
  public static function serializeUnityParticle(config:ParticleEmitterConfig, ?existing:flighthq._internal._Partial<UnityParticleDocument>, ?options:UnitySerializeOptions):String {
    ...
    doc = (cast UnitySerialize.configToDocument__unitySerialize(({ final __callArgument5:Dynamic = config; __callArgument5; }), (cast _Runtime.coalesce(existing, function():Dynamic return cast {  }) : flighthq._internal._Any), (cast ppu : Float)) : UnityParticleDocument);
  ...
  public static function serializeUnityParticleDocument(config:ParticleEmitterConfig, ?existing:flighthq._internal._Partial<UnityParticleDocument>, ?options:UnitySerializeOptions):ParticleSerializeResult {
    ...
    text = (cast serializeUnityParticle(({ final __callArgument6:Dynamic = config; __callArgument6; }), ({ final __callArgument7:Dynamic = existing; __callArgument7; }), ({ final __callArgument8:Dynamic = options; __callArgument8; })) : String);
    warnings = (cast UnitySerialize.collectUnitySerializeWarnings__unitySerialize(({ final __callArgument9:Dynamic = config; __callArgument9; })) : Array<String>);
