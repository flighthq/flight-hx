...
class UnitySerialize {
  ...
  public static function buildSizeCurve__unitySerialize(scaleCurve:Array<Float>):UnityAnimationCurve {
    return cast { keys: _Runtime.callProperty((cast particleCurveToKeyframes((cast scaleCurve)) : Array<CurveKeyframe>), 'map', cast ([function(k:CurveKeyframe, __unused4:Float, __unused5:Array<CurveKeyframe>):{ var time:Float; var value:Float; } return { time: k.time, value: k.value }] : Array<Dynamic>)) };
    return cast null;
  }
