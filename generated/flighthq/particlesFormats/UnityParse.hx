...
class UnityParse {
  ...
  public static function rawToConfig__unityParse(raw:Dynamic, ppu:Float):ParticleEmitterConfig {
    ...
    scaleEnd = _Runtime.select(solEnabled, function():Dynamic return cast (_Runtime.callValue(UnityParse.rn__unityParse, cast ([_Runtime.optionalField(solRaw, 'sizeEnd'), 1.0] : Array<Dynamic>)) / _Runtime.callProperty(HxMath, 'max', cast ([0.001, ((scaleLow + scaleHigh) * 0.5)] : Array<Dynamic>))), function():Dynamic return cast 1.0);
