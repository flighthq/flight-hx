...
class UnityParse {
  ...
  public static function rawToConfig__unityParse(raw:flighthq._internal._Record<String, flighthq._internal._Any>, ppu:Float):ParticleEmitterConfig {
    ...
    startColor = ((cast colEnabled : Bool) ? (cast (cast UnityParse.colorAt__unityParse((cast _Runtime.optionalField(colRaw, 'colorStart') : flighthq._internal._Any), ({ final __callArgument0:Dynamic = WHITE; __callArgument0; })) : UnityColor) : Dynamic) : (cast (cast UnityParse.colorAt__unityParse((cast (cast raw : { var startColor:flighthq._internal._Any; }).startColor : flighthq._internal._Any), ({ final __callArgument1:Dynamic = WHITE; __callArgument1; })) : UnityColor) : Dynamic));
    endColor = ((cast colEnabled : Bool) ? (cast (cast UnityParse.colorAt__unityParse((cast _Runtime.optionalField(colRaw, 'colorEnd') : flighthq._internal._Any), ({ final __callArgument2:Dynamic = FADE; __callArgument2; })) : UnityColor) : Dynamic) : (cast (cast UnityParse.colorAt__unityParse((cast (cast raw : { var startColor:flighthq._internal._Any; }).startColor : flighthq._internal._Any), ({ final __callArgument3:Dynamic = WHITE; __callArgument3; })) : UnityColor) : Dynamic));
  ...
  public static function colorKeysToCurve__unityParse(arr:flighthq._internal._Any):Null<ParticleCurve> {
    ...
    return cast (cast particleColorCurveFromKeyframes(({ final __callArgument23:Dynamic = keys; __callArgument23; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) : Array<Float>);
    return cast null;
  }
  ...
  public static function alphaKeysToCurve__unityParse(arr:flighthq._internal._Any):Null<ParticleCurve> {
    ...
    return cast (cast particleCurveFromKeyframes(({ final __callArgument24:Dynamic = keys; __callArgument24; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) : Array<Float>);
    return cast null;
  }
  ...
  public static function sizeKeysToCurve__unityParse(curve:flighthq._internal._Any):Null<ParticleCurve> {
    ...
    return cast (cast particleCurveFromKeyframes(({ final __callArgument25:Dynamic = keys; __callArgument25; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) : Array<Float>);
    return cast null;
  }
  ...
  public static function parseUnityParticleDocument(json:String, ?options:UnityParseOptions):UnityParsed {
    ...
    ppu = _Runtime.coalesce(({ final __typedStruct28 = options; __typedStruct28 == null ? _Runtime.UNDEFINED : __typedStruct28.pixelsPerUnit; }), function():Dynamic return cast UnityParse.DEFAULT_PPU__unityParse);
    ...
    return cast { config: (cast UnityParse.rawToConfig__unityParse(({ final __callArgument29:Dynamic = raw; __callArgument29; }), (cast ppu : Float)) : ParticleEmitterConfig), diagnostics: (cast UnityParse.collectUnityDiagnostics__unityParse(({ final __callArgument30:Dynamic = raw; __callArgument30; })) : Array<ImportDiagnostic>), document: (cast UnityParse.rawToDocument__unityParse(({ final __callArgument31:Dynamic = raw; __callArgument31; })) : UnityParticleDocument) };
    return cast null;
  }
}
