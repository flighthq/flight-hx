...
class UnityParse {
  ...
  public static function rawToConfig__unityParse(raw:flighthq._internal._Record<String, flighthq._internal._Any>, ppu:Float):ParticleEmitterConfig {
    ...
    if ((cast shapeEnabled : Bool)) {
      ...
      if ((cast ((cast ((cast _Runtime.strictEquals(shapeType, 'Sphere') : Bool) || (cast _Runtime.strictEquals(shapeType, 'Hemisphere') : Bool)) : Bool) || (cast _Runtime.strictEquals(shapeType, 'Circle') : Bool)) : Bool)) {
        ...
        (spread = cast (((cast UnityParse.rn__unityParse((cast _Runtime.optionalField(shapeRaw, 'angle') : flighthq._internal._Any), (cast 25.0 : Float)) : Float) * DEG_TO_RAD) : Dynamic));
    ...
    startColor = ((cast colEnabled : Bool) ? (cast (cast UnityParse.colorAt__unityParse((cast _Runtime.optionalField(colRaw, 'colorStart') : flighthq._internal._Any), ({ final __callArgument0:Dynamic = WHITE; __callArgument0; })) : UnityColor) : Dynamic) : (cast (cast UnityParse.colorAt__unityParse((cast (cast raw : { var startColor:flighthq._internal._Any; }).startColor : flighthq._internal._Any), ({ final __callArgument2:Dynamic = WHITE; __callArgument2; })) : UnityColor) : Dynamic));
    endColor = ((cast colEnabled : Bool) ? (cast (cast UnityParse.colorAt__unityParse((cast _Runtime.optionalField(colRaw, 'colorEnd') : flighthq._internal._Any), ({ final __callArgument4:Dynamic = FADE; __callArgument4; })) : UnityColor) : Dynamic) : (cast (cast UnityParse.colorAt__unityParse((cast (cast raw : { var startColor:flighthq._internal._Any; }).startColor : flighthq._internal._Any), ({ final __callArgument6:Dynamic = WHITE; __callArgument6; })) : UnityColor) : Dynamic));
    ...
    rotLow = ((cast rolEnabled : Bool) ? (cast ((cast UnityParse.mmLow__unityParse((cast _Runtime.optionalField(rolRaw, 'angularVelocity') : flighthq._internal._Any), (cast 0.0 : Float)) : Float) * DEG_TO_RAD) : Dynamic) : (cast 0.0 : Dynamic));
    rotHigh = ((cast rolEnabled : Bool) ? (cast ((cast UnityParse.mmHigh__unityParse((cast _Runtime.optionalField(rolRaw, 'angularVelocity') : flighthq._internal._Any), (cast 0.0 : Float)) : Float) * DEG_TO_RAD) : Dynamic) : (cast 0.0 : Dynamic));
  ...
  public static function collectUnityDiagnostics__unityParse(raw:flighthq._internal._Record<String, flighthq._internal._Any>):Array<ImportDiagnostic> {
    ...
    if ((cast (cast UnityParse.rb__unityParse((cast (cast raw : { var prewarm:flighthq._internal._Any; }).prewarm : flighthq._internal._Any), (cast false : Bool)) : Bool) : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument38:Dynamic = diagnostics; __callArgument38; }), ({ final __callArgument39:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument39; }), (cast 'unity.prewarm-unsupported' : String), (cast 'collectUnityDiagnostics' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument36:Dynamic = diagnostics; __callArgument36; }), ({ final __callArgument37:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument37; }), (cast 'unity.prewarm-unsupported' : String), (cast 'collectUnityDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    }
    ...
    if ((cast startRotationDropped : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument42:Dynamic = diagnostics; __callArgument42; }), ({ final __callArgument43:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument43; }), (cast 'unity.start-rotation-unsupported' : String), (cast 'collectUnityDiagnostics' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument40:Dynamic = diagnostics; __callArgument40; }), ({ final __callArgument41:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Skip; __callArgument41; }), (cast 'unity.start-rotation-unsupported' : String), (cast 'collectUnityDiagnostics' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    }
  ...
  public static function colorKeysToCurve__unityParse(arr:flighthq._internal._Any):Null<ParticleCurve> {
    ...
    return cast (cast (#if js _Runtime.callValue(particleColorCurveFromKeyframes, cast ([({ final __callArgument45:Dynamic = keys; __callArgument45; })] : Array<Dynamic>)) #else particleColorCurveFromKeyframes(({ final __callArgument44:Dynamic = keys; __callArgument44; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end) : Array<Float>);
    return cast null;
  }
  ...
  public static function alphaKeysToCurve__unityParse(arr:flighthq._internal._Any):Null<ParticleCurve> {
    ...
    return cast (cast (#if js _Runtime.callValue(particleCurveFromKeyframes, cast ([({ final __callArgument47:Dynamic = keys; __callArgument47; })] : Array<Dynamic>)) #else particleCurveFromKeyframes(({ final __callArgument46:Dynamic = keys; __callArgument46; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end) : Array<Float>);
    return cast null;
  }
  ...
  public static function sizeKeysToCurve__unityParse(curve:flighthq._internal._Any):Null<ParticleCurve> {
    ...
    return cast (cast (#if js _Runtime.callValue(particleCurveFromKeyframes, cast ([({ final __callArgument49:Dynamic = keys; __callArgument49; })] : Array<Dynamic>)) #else particleCurveFromKeyframes(({ final __callArgument48:Dynamic = keys; __callArgument48; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end) : Array<Float>);
    return cast null;
  }
  ...
  public static function readColorLifetime__unityParse(obj:flighthq._internal._Any):UnityColorOverLifetime {
    ...
    if ((cast ((cast _Runtime.looseEquals(obj, null) : Bool) || (cast !_Runtime.strictEquals(_Runtime.typeofValue(obj), 'object') : Bool)) : Bool)) { return cast def; }
    o = (cast obj : flighthq._internal._Record<String, flighthq._internal._Any>);
    return cast { enabled: (cast UnityParse.rb__unityParse((cast (cast o : { var enabled:flighthq._internal._Any; }).enabled : flighthq._internal._Any), (cast false : Bool)) : Bool), colorStart: (cast UnityParse.colorAt__unityParse((cast (cast o : { var colorStart:flighthq._internal._Any; }).colorStart : flighthq._internal._Any), def.colorStart) : UnityColor), colorEnd: (cast UnityParse.colorAt__unityParse((cast (cast o : { var colorEnd:flighthq._internal._Any; }).colorEnd : flighthq._internal._Any), def.colorEnd) : UnityColor) };
    return cast null;
  }
  ...
  public static function parseUnityParticleDocument(json:String, ?options:UnityParseOptions):UnityParsed {
    ...
    ppu = _Runtime.coalesce(({ final __typedStruct54 = options; __typedStruct54 == null ? _Runtime.UNDEFINED : __typedStruct54.pixelsPerUnit; }), function():Dynamic return cast UnityParse.DEFAULT_PPU__unityParse);
    ...
    return cast { config: (cast UnityParse.rawToConfig__unityParse(({ final __callArgument55:Dynamic = raw; __callArgument55; }), (cast ppu : Float)) : ParticleEmitterConfig), diagnostics: (cast UnityParse.collectUnityDiagnostics__unityParse(({ final __callArgument57:Dynamic = raw; __callArgument57; })) : Array<ImportDiagnostic>), document: (cast UnityParse.rawToDocument__unityParse(({ final __callArgument59:Dynamic = raw; __callArgument59; })) : UnityParticleDocument) };
    return cast null;
  }
}
