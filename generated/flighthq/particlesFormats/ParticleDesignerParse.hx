...
class ParticleDesignerParse {
  ...
  public static function rawDictToConfig__particleDesignerParse(d:ParticleDesignerRawDict, textureSize:Float):ParticleEmitterConfig {
    ...
    angleRad = _Runtime.multiplyNumbers(_Runtime.callValue(ParticleDesignerParse.num__particleDesignerParse, cast ([d, 'angle', 90.0] : Array<Dynamic>)), ParticleDesignerParse.DEG2RAD__particleDesignerParse);
    ...
    startSize = _Runtime.divideNumbers(_Runtime.callValue(ParticleDesignerParse.num__particleDesignerParse, cast ([d, 'startParticleSize', 32.0] : Array<Dynamic>)), textureSize);
    startVar = _Runtime.divideNumbers(_Runtime.callValue(ParticleDesignerParse.num__particleDesignerParse, cast ([d, 'startParticleSizeVariance', 0.0] : Array<Dynamic>)), textureSize);
    finishSize = _Runtime.divideNumbers(_Runtime.callValue(ParticleDesignerParse.num__particleDesignerParse, cast ([d, 'finishParticleSize', 16.0] : Array<Dynamic>)), textureSize);
  ...
  public static function parseParticleDesignerPlist(plistXml:String, ?options:ParticleDesignerParseOptions):ParticleEmitterConfig {
    return cast _Runtime.callValue(ParticleDesignerParse.rawDictToConfig__particleDesignerParse, cast ([_Runtime.callValue(ParticleDesignerParse.parsePlistRawDict__particleDesignerParse, cast ([plistXml] : Array<Dynamic>)), _Runtime.coalesce(({ final __typedStruct0 = options; __typedStruct0 == null ? _Runtime.UNDEFINED : __typedStruct0.textureSize; }), function():Dynamic return cast 1.0)] : Array<Dynamic>));
    return cast null;
  }
