...
class WgpuScale9Shape {
  ...
  private static function drawWgpuScale9Shape(state:WgpuRenderState, renderProxy:RenderProxy2D):Void {
    ...
    rasterizer = (cast getWgpuShapeRasterizer(({ final __callArgument10:Dynamic = state; __callArgument10; })) : Null<ShapeRasterizer>);
    if ((cast _Runtime.strictEquals(rasterizer, null) : Bool)) {
      _Runtime.callOptionalValue((cast (cast getWgpuRenderStateRuntime(({ final __callArgument16:Dynamic = state; __callArgument16; })) : WgpuRenderStateRuntime) : { var registryMiss:Null<flighthq._internal._Intersection2<RenderRegistry->String->Void, { var clear:Void->Void; var signals:RenderRegistrySignals; }>>; }).registryMiss, cast ([RenderRegistry.ShapeRasterizer, Scale9ShapeKind] : Array<Dynamic>));
      return;
    }
    bounds = (cast getNodeLocalBoundsRectangle((cast source : Dynamic)) : Rectangle);
    mapper = (cast buildWgpuScale9Mapper(({ final __callArgument18:Dynamic = bounds; __callArgument18; }), ({ final __callArgument19:Dynamic = scale9Grid; __callArgument19; }), (cast source.scaleX : Float), (cast source.scaleY : Float)) : Null<Scale9Mapper>);
    if ((cast _Runtime.strictEquals(mapper, null) : Bool)) {
      drawWgpuShape(({ final __callArgument22:Dynamic = state; __callArgument22; }), ({ final __callArgument23:Dynamic = renderProxy; __callArgument23; }));
      return;
    }
    shapeData = (cast getWgpuRendererData(({ final __callArgument26:Dynamic = (cast renderProxy : RenderProxy2D).rendererData; __callArgument26; })) : Null<WgpuScale9ShapeData__wgpuScale9Shape>);
    ...
    if ((cast ((cast ((cast ((cast ((cast ((cast !_Runtime.strictEquals(version, (cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).lastContentId) : Bool) || (cast !_Runtime.strictEquals(w, (cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).lastW) : Bool)) : Bool) || (cast !_Runtime.strictEquals(h, (cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).lastH) : Bool)) : Bool) || (cast !_Runtime.strictEquals(source.scaleX, (cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).lastScaleX) : Bool)) : Bool) || (cast !_Runtime.strictEquals(source.scaleY, (cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).lastScaleY) : Bool)) : Bool) || (cast !_Runtime.strictEquals(pixelRatio, (cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).lastPixelRatio) : Bool)) : Bool)) {
      ...
      mapScale9ShapeCommands(({ final __callArgument28:Dynamic = WgpuScale9Shape._remappedCommands__wgpuScale9Shape; __callArgument28; }), ({ final __callArgument29:Dynamic = commands; __callArgument29; }), ({ final __callArgument30:Dynamic = mapper; __callArgument30; }));
      rasterizer(({ final __callArgument34:Dynamic = ctx; __callArgument34; }), ({ final __callArgument35:Dynamic = WgpuScale9Shape._remappedCommands__wgpuScale9Shape; __callArgument35; }), ({ final __callArgument36:Dynamic = state; __callArgument36; }));
      ...
      if ((cast ((cast ((cast ((cast _Runtime.strictEquals((cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).entry, null) : Bool) || (cast !_Runtime.strictEquals((cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).lastW, w) : Bool)) : Bool) || (cast !_Runtime.strictEquals((cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).lastH, h) : Bool)) : Bool) || (cast !_Runtime.strictEquals((cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).lastPixelRatio, pixelRatio) : Bool)) : Bool)) {
        var nextEntry:Null<WgpuTextureEntry> = (cast createWgpuTextureEntry(({ final __callArgument40:Dynamic = state; __callArgument40; }), (cast pw : Float), (cast ph : Float), (cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).canvas) : Null<WgpuTextureEntry>);
        if ((cast _Runtime.strictEquals(nextEntry, null) : Bool)) { return; }
        if ((cast !_Runtime.strictEquals((cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).entry, null) : Bool)) { retireWgpuTexture(({ final __callArgument42:Dynamic = state; __callArgument42; }), (cast (cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).entry : WgpuTextureEntry).texture); }
        ((cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).entry = nextEntry);
      } else {
        updateWgpuTextureEntry(({ final __callArgument44:Dynamic = state; __callArgument44; }), (cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).entry, (cast shapeData : WgpuScale9ShapeData__wgpuScale9Shape).canvas);
      }
