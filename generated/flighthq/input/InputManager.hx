...
class InputManager {
  ...
  public static function getKeyCodeFromDomKeyboardEvent(event:Dynamic):Float {
    ...
    if (_Runtime.truthy(!_Runtime.strictEquals(code, KeyCode.UNKNOWN))) { return cast code; }
    ...
    return cast _Runtime.coalesce(_Runtime.getIndex(InputManager.keyCodesByKey__inputManager, _Runtime.field(event, 'key')), function():Dynamic return cast KeyCode.UNKNOWN);
    return cast null;
  }
  ...
  public static function getKeyModifierFromDomKeyboardEvent(event:Dynamic):Float {
    ...
    if (_Runtime.truthy(_Runtime.field(event, 'altKey'))) { (modifier = (Std.int(modifier) | Std.int(_Runtime.select(_Runtime.strictEquals(_Runtime.field(event, 'location'), _Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['KeyboardEvent'] : Array<Dynamic>)), 'DOM_KEY_LOCATION_RIGHT')), function():Dynamic return cast KeyModifier.RIGHT_ALT, function():Dynamic return cast KeyModifier.LEFT_ALT)))); }
    if (_Runtime.truthy(_Runtime.field(event, 'ctrlKey'))) { (modifier = (Std.int(modifier) | Std.int(_Runtime.select(_Runtime.strictEquals(_Runtime.field(event, 'location'), _Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['KeyboardEvent'] : Array<Dynamic>)), 'DOM_KEY_LOCATION_RIGHT')), function():Dynamic return cast KeyModifier.RIGHT_CTRL, function():Dynamic return cast KeyModifier.LEFT_CTRL)))); }
    if (_Runtime.truthy(_Runtime.field(event, 'metaKey'))) { (modifier = (Std.int(modifier) | Std.int(_Runtime.select(_Runtime.strictEquals(_Runtime.field(event, 'location'), _Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['KeyboardEvent'] : Array<Dynamic>)), 'DOM_KEY_LOCATION_RIGHT')), function():Dynamic return cast KeyModifier.RIGHT_META, function():Dynamic return cast KeyModifier.LEFT_META)))); }
    if (_Runtime.truthy(_Runtime.field(event, 'shiftKey'))) { (modifier = (Std.int(modifier) | Std.int(_Runtime.select(_Runtime.strictEquals(_Runtime.field(event, 'location'), _Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['KeyboardEvent'] : Array<Dynamic>)), 'DOM_KEY_LOCATION_RIGHT')), function():Dynamic return cast KeyModifier.RIGHT_SHIFT, function():Dynamic return cast KeyModifier.LEFT_SHIFT)))); }
    if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.callOptionalProperty(event, 'getModifierState', cast (['CapsLock'] : Array<Dynamic>)), true))) { (modifier = (Std.int(modifier) | Std.int(KeyModifier.CAPS_LOCK))); }
    if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.callOptionalProperty(event, 'getModifierState', cast (['NumLock'] : Array<Dynamic>)), true))) { (modifier = (Std.int(modifier) | Std.int(KeyModifier.NUM_LOCK))); }
  ...
  public static function getKeyCodeFromDomKeyboardCode__inputManager(code:String, location:Float):Float {
    ...
    return cast _Runtime.coalesce(_Runtime.getIndex(InputManager.keyCodesByCode__inputManager, code), function():Dynamic return cast KeyCode.UNKNOWN);
    return cast null;
  }
  ...
  public static function setInputKeyboardData__inputManager(out:InputKeyboardData, event:Dynamic):Void {
    ...
    _Runtime.setField(out, 'capsLock', !_Runtime.strictEquals((Std.int(modifier) & Std.int(KeyModifier.CAPS_LOCK)), 0.0));
    ...
    _Runtime.setField(out, 'numLock', !_Runtime.strictEquals((Std.int(modifier) & Std.int(KeyModifier.NUM_LOCK)), 0.0));
  ...
  public static final keyCodesByCode__inputManager:Dynamic = { Again: KeyCode.AGAIN, AltLeft: KeyCode.LEFT_ALT, AltRight: KeyCode.RIGHT_ALT, ArrowDown: KeyCode.DOWN, ArrowLeft: KeyCode.LEFT, ArrowRight: KeyCode.RIGHT, ArrowUp: KeyCode.UP, AudioVolumeDown: KeyCode.AUDIO_MUTE, Backspace: KeyCode.BACKSPACE, BrowserBack: KeyCode.APP_CONTROL_BACK, BrowserBookmarks: KeyCode.APP_CONTROL_BOOKMARKS, BrowserForward: KeyCode.APP_CONTROL_FORWARD, BrowserHome: KeyCode.APP_CONTROL_HOME, BrowserRefresh: KeyCode.APP_CONTROL_REFRESH, BrowserSearch: KeyCode.APP_CONTROL_SEARCH, BrowserStop: KeyCode.APP_CONTROL_STOP, CapsLock: KeyCode.CAPS_LOCK, ContextMenu: KeyCode.APPLICATION, ControlLeft: KeyCode.LEFT_CTRL, ControlRight: KeyCode.RIGHT_CTRL, Convert: KeyCode.UNKNOWN, Copy: KeyCode.COPY, Cut: KeyCode.CUT, Delete: KeyCode.DELETE, Eject: KeyCode.EJECT, End: KeyCode.END, Enter: KeyCode.RETURN, Escape: KeyCode.ESCAPE, F1: KeyCode.F1, F2: KeyCode.F2, F3: KeyCode.F3, F4: KeyCode.F4, F5: KeyCode.F5, F6: KeyCode.F6, F7: KeyCode.F7, F8: KeyCode.F8, F9: KeyCode.F9, F10: KeyCode.F10, F11: KeyCode.F11, F12: KeyCode.F12, F13: KeyCode.F13, F14: KeyCode.F14, F15: KeyCode.F15, F16: KeyCode.F16, F17: KeyCode.F17, F18: KeyCode.F18, F19: KeyCode.F19, F20: KeyCode.F20, F21: KeyCode.F21, F22: KeyCode.F22, F23: KeyCode.F23, F24: KeyCode.F24, Find: KeyCode.FIND, Help: KeyCode.HELP, Home: KeyCode.HOME, Insert: KeyCode.INSERT, IntlBackslash: KeyCode.BACKSLASH, LaunchApp1: KeyCode.COMPUTER, LaunchApp2: KeyCode.CALCULATOR, LaunchMail: KeyCode.MAIL, LaunchMediaPlayer: KeyCode.MEDIA_SELECT, MediaPlayPause: KeyCode.AUDIO_PLAY, MediaStop: KeyCode.AUDIO_STOP, MediaTrackNext: KeyCode.AUDIO_NEXT, MediaTrackPrevious: KeyCode.AUDIO_PREVIOUS, MetaLeft: KeyCode.LEFT_META, MetaRight: KeyCode.RIGHT_META, NonConvert: KeyCode.UNKNOWN, NumLock: KeyCode.NUM_LOCK, PageDown: KeyCode.PAGE_DOWN, PageUp: KeyCode.PAGE_UP, Paste: KeyCode.PASTE, Pause: KeyCode.PAUSE, Power: KeyCode.POWER, PrintScreen: KeyCode.PRINT_SCREEN, ScrollLock: KeyCode.SCROLL_LOCK, Select: KeyCode.SELECT, ShiftLeft: KeyCode.LEFT_SHIFT, ShiftRight: KeyCode.RIGHT_SHIFT, Sleep: KeyCode.SLEEP, Space: KeyCode.SPACE, Tab: KeyCode.TAB, Undo: KeyCode.UNDO, VolumeDown: KeyCode.VOLUME_DOWN, VolumeMute: KeyCode.AUDIO_MUTE, VolumeUp: KeyCode.VOLUME_UP, WakeUp: KeyCode.UNKNOWN, WWW: KeyCode.WWW };

  public static final keyCodesByKey__inputManager:Dynamic = { Alt: KeyCode.LEFT_ALT, ArrowDown: KeyCode.DOWN, ArrowLeft: KeyCode.LEFT, ArrowRight: KeyCode.RIGHT, ArrowUp: KeyCode.UP, Backspace: KeyCode.BACKSPACE, CapsLock: KeyCode.CAPS_LOCK, Control: KeyCode.LEFT_CTRL, Delete: KeyCode.DELETE, End: KeyCode.END, Enter: KeyCode.RETURN, Escape: KeyCode.ESCAPE, Home: KeyCode.HOME, Insert: KeyCode.INSERT, Meta: KeyCode.LEFT_META, NumLock: KeyCode.NUM_LOCK, PageDown: KeyCode.PAGE_DOWN, PageUp: KeyCode.PAGE_UP, Pause: KeyCode.PAUSE, PrintScreen: KeyCode.PRINT_SCREEN, ScrollLock: KeyCode.SCROLL_LOCK, Shift: KeyCode.LEFT_SHIFT, Tab: KeyCode.TAB, F1: KeyCode.F1, F2: KeyCode.F2, F3: KeyCode.F3, F4: KeyCode.F4, F5: KeyCode.F5, F6: KeyCode.F6, F7: KeyCode.F7, F8: KeyCode.F8, F9: KeyCode.F9, F10: KeyCode.F10, F11: KeyCode.F11, F12: KeyCode.F12, F13: KeyCode.F13, F14: KeyCode.F14, F15: KeyCode.F15, F16: KeyCode.F16, F17: KeyCode.F17, F18: KeyCode.F18, F19: KeyCode.F19, F20: KeyCode.F20, F21: KeyCode.F21, F22: KeyCode.F22, F23: KeyCode.F23, F24: KeyCode.F24, AudioVolumeDown: KeyCode.VOLUME_DOWN, AudioVolumeMute: KeyCode.AUDIO_MUTE, AudioVolumeUp: KeyCode.VOLUME_UP, MediaPlayPause: KeyCode.AUDIO_PLAY, MediaStop: KeyCode.AUDIO_STOP, MediaTrackNext: KeyCode.AUDIO_NEXT, MediaTrackPrevious: KeyCode.AUDIO_PREVIOUS, BrowserBack: KeyCode.APP_CONTROL_BACK, BrowserBookmarks: KeyCode.APP_CONTROL_BOOKMARKS, BrowserForward: KeyCode.APP_CONTROL_FORWARD, BrowserHome: KeyCode.APP_CONTROL_HOME, BrowserRefresh: KeyCode.APP_CONTROL_REFRESH, BrowserSearch: KeyCode.APP_CONTROL_SEARCH, BrowserStop: KeyCode.APP_CONTROL_STOP, ContextMenu: KeyCode.APPLICATION, Copy: KeyCode.COPY, Cut: KeyCode.CUT, Find: KeyCode.FIND, Help: KeyCode.HELP, Paste: KeyCode.PASTE, Select: KeyCode.SELECT, Undo: KeyCode.UNDO };

  public static final numpadKeyCodesByCode__inputManager:Dynamic = { Enter: KeyCode.NUMPAD_ENTER, Numpad0: KeyCode.NUMPAD_0, Numpad1: KeyCode.NUMPAD_1, Numpad2: KeyCode.NUMPAD_2, Numpad3: KeyCode.NUMPAD_3, Numpad4: KeyCode.NUMPAD_4, Numpad5: KeyCode.NUMPAD_5, Numpad6: KeyCode.NUMPAD_6, Numpad7: KeyCode.NUMPAD_7, Numpad8: KeyCode.NUMPAD_8, Numpad9: KeyCode.NUMPAD_9, NumpadAdd: KeyCode.NUMPAD_PLUS, NumpadBackspace: KeyCode.NUMPAD_BACKSPACE, NumpadClear: KeyCode.NUMPAD_CLEAR, NumpadClearEntry: KeyCode.NUMPAD_CLEAR_ENTRY, NumpadComma: KeyCode.NUMPAD_COMMA, NumpadDecimal: KeyCode.NUMPAD_PERIOD, NumpadDivide: KeyCode.NUMPAD_DIVIDE, NumpadEqual: KeyCode.NUMPAD_EQUALS, NumpadHash: KeyCode.NUMPAD_HASH, NumpadMemoryAdd: KeyCode.NUMPAD_MEM_ADD, NumpadMemoryClear: KeyCode.NUMPAD_MEM_CLEAR, NumpadMemoryRecall: KeyCode.NUMPAD_MEM_RECALL, NumpadMemoryStore: KeyCode.NUMPAD_MEM_STORE, NumpadMemorySubtract: KeyCode.NUMPAD_MEM_SUBTRACT, NumpadMultiply: KeyCode.NUMPAD_MULTIPLY, NumpadParenLeft: KeyCode.NUMPAD_LEFT_PARENTHESIS, NumpadParenRight: KeyCode.NUMPAD_RIGHT_PARENTHESIS, NumpadSubtract: KeyCode.NUMPAD_MINUS };
