...
class WgpuClassicPrelude {
  ...
  public static function bindWgpuClassicSurface(state:WgpuRenderState, pipeline:WgpuClassicPipeline, materialKey:Dynamic, diffuse:LinearColor, specular:LinearColor, shininess:Float, alphaCutoff:Float, diffuseMap:Null<Texture>, specularMap:Null<Texture>, normalMap:Null<Texture>, alphaMap:Null<Texture>):flighthq._internal.dom.GPUBindGroup {
    ...
    flighthq._internal._StaticIndex.writeArray(WgpuClassicPrelude._samplerScratch__wgpuClassicPrelude, 2.0, _Runtime.callValue(getWgpuMaterialSampler, cast ([state, normalMap] : Array<Dynamic>)));
    flighthq._internal._StaticIndex.writeArray(WgpuClassicPrelude._samplerScratch__wgpuClassicPrelude, 3.0, _Runtime.callValue(getWgpuMaterialSampler, cast ([state, alphaMap] : Array<Dynamic>)));
    flighthq._internal._StaticIndex.writeArray(WgpuClassicPrelude._viewScratch__wgpuClassicPrelude, 0.0, _Runtime.callValue(resolveWgpuMaterialTextureView, cast ([state, diffuseMap] : Array<Dynamic>)));
    flighthq._internal._StaticIndex.writeArray(WgpuClassicPrelude._viewScratch__wgpuClassicPrelude, 1.0, _Runtime.callValue(resolveWgpuMaterialTextureView, cast ([state, specularMap] : Array<Dynamic>)));
    flighthq._internal._StaticIndex.writeArray(WgpuClassicPrelude._viewScratch__wgpuClassicPrelude, 2.0, _Runtime.callValue(resolveWgpuMaterialTextureView, cast ([state, normalMap] : Array<Dynamic>)));
    flighthq._internal._StaticIndex.writeArray(WgpuClassicPrelude._viewScratch__wgpuClassicPrelude, 3.0, _Runtime.callValue(resolveWgpuMaterialTextureView, cast ([state, alphaMap] : Array<Dynamic>)));
    binding = _Runtime.callValue(ensureWgpuPerMapMaterialBinding, cast ([state, materialKey, _Runtime.field(pipeline, 'materialBindGroupLayout'), WgpuClassicPrelude.CLASSIC_UNIFORM_BYTES__wgpuClassicPrelude, WgpuClassicPrelude._samplerScratch__wgpuClassicPrelude, WgpuClassicPrelude._viewScratch__wgpuClassicPrelude] : Array<Dynamic>));
  ...
  public static function compileWgpuClassicPipeline(state:WgpuRenderState, key:WgpuClassicDefineKey, format:flighthq._internal.dom.GPUTextureFormat, blended:Dynamic = false, skinned:Dynamic = false, ?colorAdjustmentFeature:Null<WgpuColorAdjustmentMaterialFeature>):WgpuClassicPipeline {
    ...
    module = flighthq._internal.backend.WebGpuDeviceBackend.call(device, 'createShaderModule', cast ([{ code: _Runtime.callValue(getWgpuClassicModuleSourceForKey, cast ([key, skinned, _Runtime.callValue(getWgpuSkinningAdapter, cast ([state] : Array<Dynamic>)), colorAdjustmentFeature] : Array<Dynamic>)) }] : Array<Dynamic>));
  ...
  public static function getWgpuClassicModuleSourceForKey(key:WgpuClassicDefineKey, skinned:Dynamic = false, ?skinning:Null<WgpuSkinningAdapter>, ?colorAdjustmentFeature:Null<WgpuColorAdjustmentMaterialFeature>):String {
    ...
    source = _Runtime.callValue(WgpuClassicPrelude.assembleWgpuClassicModuleSource__wgpuClassicPrelude, cast ([key, skinned, skinning, WgpuClassicPrelude.CLASSIC_WGSL_BODY__wgpuClassicPrelude] : Array<Dynamic>));
