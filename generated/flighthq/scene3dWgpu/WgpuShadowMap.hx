...
class WgpuShadowMap {
  ...
  public static function drawWgpuScene3DShadowMap(state:WgpuRenderState, scene:Node3D, shadowCamera:Camera3D, directionalLight:Null<DirectionalLight>):Void {
    ...
    forEachNodeDescendant((cast scene : Dynamic), (cast function(node:Node<Node3DTraits>):Void {
      ...
      multiplyMatrix4(({ final __callArgument10:Dynamic = (cast WgpuShadowMap._shadowProxy__wgpuShadowMap : Scene3DRenderProxy).worldMatrix; __callArgument10; }), ({ final __callArgument11:Dynamic = lightMatrix; __callArgument11; }), ({ final __callArgument12:Dynamic = world; __callArgument12; }));
