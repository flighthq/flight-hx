...
class WgpuShadowMap {
  ...
  public static function drawWgpuScene3DShadowMap(state:WgpuRenderState, scene:Node3D, shadowCamera:Camera3D, directionalLight:Null<DirectionalLight>):Void {
    ...
    sceneRuntime = (cast getWgpuScene3DRuntime(({ final __callArgument2:Dynamic = state; __callArgument2; })) : WgpuScene3DRuntime);
    ...
    getCamera3DViewProjectionMatrix4(({ final __callArgument6:Dynamic = lightMatrix; __callArgument6; }), ({ final __callArgument7:Dynamic = shadowCamera; __callArgument7; }), (cast 1.0 : Float));
    skinning = (cast getWgpuSkinningAdapter(({ final __callArgument10:Dynamic = state; __callArgument10; })) : Null<WgpuSkinningAdapter>);
    rigidPipeline = (cast WgpuShadowMap.ensureWgpuShadowDepthPipeline__wgpuShadowMap(({ final __callArgument12:Dynamic = state; __callArgument12; }), (cast false : Bool)) : flighthq._internal.dom.GPURenderPipeline);
    ...
    forEachNodeDescendant((cast scene : Dynamic), (cast function(node:Node<Node3DTraits>):Void {
      ...
      skinned = _Runtime.coalesce(_Runtime.callOptionalValue(({ final __structural14 = skinning; __structural14 == null ? _Runtime.UNDEFINED : (cast __structural14 : { var isGpuSkinned:Mesh->Bool; }).isGpuSkinned; }), cast ([mesh] : Array<Dynamic>)), function():Dynamic return cast false);
      pipeline = ((cast skinned : Bool) ? (cast (cast WgpuShadowMap.ensureWgpuShadowDepthPipeline__wgpuShadowMap(({ final __callArgument15:Dynamic = state; __callArgument15; }), (cast true : Bool)) : flighthq._internal.dom.GPURenderPipeline) : Dynamic) : (cast rigidPipeline : Dynamic));
      upload = (cast ensureWgpuMeshUpload(({ final __callArgument17:Dynamic = state; __callArgument17; }), mesh.geometry, (cast skinned : Bool)) : WgpuMeshUpload);
      ...
      multiplyMatrix4(({ final __callArgument19:Dynamic = WgpuShadowMap._shadowProxy__wgpuShadowMap.worldMatrix; __callArgument19; }), ({ final __callArgument20:Dynamic = lightMatrix; __callArgument20; }), ({ final __callArgument21:Dynamic = world; __callArgument21; }));
      ...
      skinDrawBindGroup = ((cast _Runtime.strictEquals(jointMatrices, null) : Bool) ? (cast null : Dynamic) : (cast (cast skinning : WgpuSkinningAdapter).getDrawBindGroup(({ final __callArgument25:Dynamic = state; __callArgument25; }), ({ final __callArgument26:Dynamic = jointMatrices; __callArgument26; })) : Dynamic));
      rigidDrawBindGroup = (cast writeWgpuDrawUniform(({ final __callArgument27:Dynamic = state; __callArgument27; }), ({ final __callArgument28:Dynamic = WgpuShadowMap._shadowProxy__wgpuShadowMap; __callArgument28; })) : flighthq._internal.dom.GPUBindGroup);
  ...
  public static function ensureWgpuShadowDepthPipeline__wgpuShadowMap(state:WgpuRenderState, skinned:Bool):flighthq._internal.dom.GPURenderPipeline {
    ...
    skinning = (cast getWgpuSkinningAdapter(({ final __callArgument50:Dynamic = state; __callArgument50; })) : Null<WgpuSkinningAdapter>);
    ...
    layout = flighthq._internal.backend.WebGpuDeviceBackend.call(device, 'createPipelineLayout', cast ([{ bindGroupLayouts: cast ([((cast ((cast skinned : Bool) && (cast !_Runtime.strictEquals(skinning, null) : Bool)) : Bool) ? (cast (cast skinning : WgpuSkinningAdapter).getDrawLayout(({ final __callArgument52:Dynamic = state; __callArgument52; })) : Dynamic) : (cast (cast (cast ensureWgpuScene3DLayouts(({ final __callArgument53:Dynamic = state; __callArgument53; })) : WgpuScene3DLayouts) : WgpuScene3DLayouts).drawBindGroupLayout : Dynamic))] : Array<Dynamic>) }] : Array<Dynamic>));
