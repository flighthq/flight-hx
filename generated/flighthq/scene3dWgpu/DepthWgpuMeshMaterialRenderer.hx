...
class DepthWgpuMeshMaterialRenderer {
  ...
  public static final depthWgpuMeshMaterialRenderer:WgpuMeshMaterialRenderer = (cast { bind: function(state:WgpuRenderState, material:Null<Material>, _lights:Scene3DLightBlock, camera:Camera3D):Void {
    ...
    if ((cast _Runtime.strictEquals(depth, null) : Bool)) {
      (group = cast (bindWgpuDebugSurface(({ final __callArgument7:Dynamic = state; __callArgument7; }), ({ final __callArgument8:Dynamic = pipeline; __callArgument8; }), ({ final __callArgument9:Dynamic = DepthWgpuMeshMaterialRenderer.FALLBACK_MATERIAL__depthWgpuMeshMaterialRenderer; __callArgument9; }), (cast 0.0 : Float), (cast 1.0 : Float), (cast 1.0 : Float)) : Dynamic));
    } else {
      (group = cast (bindWgpuDebugSurface(({ final __callArgument10:Dynamic = state; __callArgument10; }), ({ final __callArgument11:Dynamic = pipeline; __callArgument11; }), ({ final __callArgument12:Dynamic = depth; __callArgument12; }), (cast (cast depth : { var near:Float; }).near : Float), (cast (cast depth : { var far:Float; }).far : Float), (cast 1.0 : Float)) : Dynamic));
    }
