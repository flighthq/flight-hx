...
class UnlitWgpuMeshMaterialRenderer {
  public static final unlitWgpuMeshMaterialRenderer:WgpuMeshMaterialRenderer = (cast { bind: function(state:WgpuRenderState, material:Null<Material>, _lights:Scene3DLightBlock, camera:Camera3D):Void {
    ...
    pipeline = (cast ensureWgpuUnlitPipeline(({ final __callArgument2:Dynamic = state; __callArgument2; }), (cast UnlitWgpuMeshMaterialRenderer.defineKeyForMaterial__unlitWgpuMeshMaterialRenderer(({ final __callArgument3:Dynamic = unlit; __callArgument3; })) : WgpuUnlitDefineKey), (cast format : String)) : WgpuUnlitPipeline);
    ...
    if ((cast _Runtime.strictEquals(unlit, null) : Bool)) {
      (group = cast ((cast bindWgpuUnlitSurface(({ final __callArgument14:Dynamic = state; __callArgument14; }), ({ final __callArgument15:Dynamic = pipeline; __callArgument15; }), ({ final __callArgument16:Dynamic = UnlitWgpuMeshMaterialRenderer.FALLBACK_MATERIAL__unlitWgpuMeshMaterialRenderer; __callArgument16; }), ({ final __callArgument17:Dynamic = UnlitWgpuMeshMaterialRenderer.WHITE__unlitWgpuMeshMaterialRenderer; __callArgument17; }), (cast 1.0 : Float), (cast 0.5 : Float), (cast null : Dynamic)) : flighthq._internal.dom.GPUBindGroup) : Dynamic));
    } else {
      (cast unpackColorToLinear(({ final __callArgument22:Dynamic = UnlitWgpuMeshMaterialRenderer._scratch__unlitWgpuMeshMaterialRenderer; __callArgument22; }), (cast (cast unlit : { var baseColor:Float; }).baseColor : Float)) : LinearColor);
      (group = cast ((cast bindWgpuUnlitSurface(({ final __callArgument24:Dynamic = state; __callArgument24; }), ({ final __callArgument25:Dynamic = pipeline; __callArgument25; }), ({ final __callArgument26:Dynamic = unlit; __callArgument26; }), ({ final __callArgument27:Dynamic = UnlitWgpuMeshMaterialRenderer._scratch__unlitWgpuMeshMaterialRenderer; __callArgument27; }), (cast 1.0 : Float), (cast (cast unlit : { var alphaCutoff:Float; }).alphaCutoff : Float), (cast (cast unlit : { var baseColorMap:Null<flighthq._internal._Union2<flighthq._internal._Union2<flighthq._internal._Union2<Texture2D, { var colorSpace:TextureColorSpace; var sampler:Sampler; var version:Float; var ___u40_EntityRuntimeKey_u40_9932:Null<EntityRuntime>; var flipX:Bool; var flipY:Bool; var uvOffset:Vector2; var uvRotation:Float; var uvScale:Vector2; var dimension:String; var sources:Array<Null<TextureSource>>; }>, { var colorSpace:TextureColorSpace; var sampler:Sampler; var version:Float; var ___u40_EntityRuntimeKey_u40_9932:Null<EntityRuntime>; var flipX:Bool; var flipY:Bool; var uvOffset:Vector2; var uvRotation:Float; var uvScale:Vector2; var dimension:String; var source:Null<VoxelGrid>; }>, { var colorSpace:TextureColorSpace; var sampler:Sampler; var version:Float; var ___u40_EntityRuntimeKey_u40_9932:Null<EntityRuntime>; var flipX:Bool; var flipY:Bool; var uvOffset:Vector2; var uvRotation:Float; var uvScale:Vector2; var dimension:String; var sources:TextureSourceCubeFaces; }>>; }).baseColorMap : Dynamic)) : flighthq._internal.dom.GPUBindGroup) : Dynamic));
    }
  ...
  public static function registerWgpuUnlitMaterial(state:WgpuRenderState):Void {
    ...
    registerWgpuRenderTextureResolver(({ final __callArgument46:Dynamic = state; __callArgument46; }));
    registerWgpuMeshMaterialRenderer(({ final __callArgument48:Dynamic = state; __callArgument48; }), (cast UnlitMaterialKind : String), ({ final __callArgument49:Dynamic = unlitWgpuMeshMaterialRenderer; __callArgument49; }));
  }
