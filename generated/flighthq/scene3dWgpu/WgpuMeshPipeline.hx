...
class WgpuMeshPipeline {
  public static function beginWgpuMeshDraw(state:WgpuRenderState, pipeline:flighthq.types.WgpuMeshPipeline):Void {
    ...
    if ((cast pipeline.hasPbrSampleGroup : Bool)) {
      (cast pass : flighthq._internal.dom.GPURenderPassEncoder).setBindGroup(3.0, (cast ensureWgpuPbrSampleBindGroup(({ final __callArgument4:Dynamic = state; __callArgument4; })) : flighthq._internal.dom.GPUBindGroup));
    } else { if ((cast pipeline.hasShadowGroup : Bool)) {
      (cast pass : flighthq._internal.dom.GPURenderPassEncoder).setBindGroup(3.0, (cast ensureWgpuShadowSampleBindGroup(({ final __callArgument6:Dynamic = state; __callArgument6; })) : flighthq._internal.dom.GPUBindGroup));
    } }
    if ((cast pipeline.hasIblGroup : Bool)) {
      (cast pass : flighthq._internal.dom.GPURenderPassEncoder).setBindGroup(4.0, (cast ensureWgpuIblSampleBindGroup(({ final __callArgument8:Dynamic = state; __callArgument8; })) : flighthq._internal.dom.GPUBindGroup));
    }
  }
  ...
  private static function createWgpuMeshPipeline(state:WgpuRenderState, options:{ @:optional var blended:Bool; var doubleSided:Bool; @:optional var extraBindGroupLayout:flighthq._internal.dom.GPUBindGroupLayout; var format:flighthq._internal.dom.GPUTextureFormat; @:optional var iblBindGroupLayout:flighthq._internal.dom.GPUBindGroupLayout; var materialBindGroupLayout:flighthq._internal.dom.GPUBindGroupLayout; var module:flighthq._internal.dom.GPUShaderModule; @:optional var pbrSampleBindGroupLayout:flighthq._internal.dom.GPUBindGroupLayout; @:optional var shadowBindGroupLayout:flighthq._internal.dom.GPUBindGroupLayout; @:optional var skinned:Bool; @:optional var topology:flighthq._internal.dom.GPUPrimitiveTopology; }):flighthq.types.WgpuMeshPipeline {
    ...
    layouts = (cast ensureWgpuScene3DLayouts(({ final __callArgument10:Dynamic = state; __callArgument10; })) : WgpuScene3DLayouts);
    sceneRuntime = (cast getWgpuScene3DRuntime(({ final __callArgument12:Dynamic = state; __callArgument12; })) : WgpuScene3DRuntime);
  ...
  private static function drawWgpuMeshSubset(state:WgpuRenderState, proxy:Scene3DRenderProxy, geometry:MeshGeometry):Void {
    ...
    upload = (cast ensureWgpuMeshUpload(({ final __callArgument21:Dynamic = state; __callArgument21; }), ({ final __callArgument22:Dynamic = geometry; __callArgument22; }), (cast (cast scene.activeMeshPipeline : { var skinned:Bool; }).skinned : Bool)) : WgpuMeshUpload);
    ...
    skinDrawBindGroup = ((cast ((cast ((cast ((cast activePipeline.skinned : Bool) && (cast !_Runtime.strictEquals(jointMatrices, null) : Bool)) : Bool) && (cast !_Runtime.strictEquals(normalMatrices, null) : Bool)) : Bool) && (cast !_Runtime.strictEquals(skinning, null) : Bool)) : Bool) ? (cast (cast skinning : WgpuSkinningAdapter).getMeshDrawBindGroup(({ final __callArgument25:Dynamic = state; __callArgument25; }), ({ final __callArgument26:Dynamic = jointMatrices; __callArgument26; }), ({ final __callArgument27:Dynamic = normalMatrices; __callArgument27; })) : Dynamic) : (cast null : Dynamic));
    drawBindGroup = (cast writeWgpuDrawUniform(({ final __callArgument28:Dynamic = state; __callArgument28; }), ({ final __callArgument29:Dynamic = proxy; __callArgument29; })) : flighthq._internal.dom.GPUBindGroup);
  ...
  private static function ensureWgpuIblSampleBindGroup(state:WgpuRenderState):flighthq._internal.dom.GPUBindGroup {
    ...
    if ((cast ((cast _Runtime.strictEquals(scene.iblSampleBindGroup, null) : Bool) || (cast !_Runtime.strictEquals(scene.iblSampleCubeView, irradianceView) : Bool)) : Bool)) {
      (scene.iblSampleBindGroup = cast (flighthq._internal.backend.WebGpuDeviceBackend.call(device, 'createBindGroup', cast ([{ layout: (cast ensureWgpuIblSampleLayout(({ final __callArgument38:Dynamic = state; __callArgument38; })) : flighthq._internal.dom.GPUBindGroupLayout), entries: cast ([{ binding: 0.0, resource: { buffer: scene.iblUniformBuffer } }, { binding: 1.0, resource: irradianceView }, { binding: 2.0, resource: prefilteredView }, { binding: 3.0, resource: brdfView }, { binding: 4.0, resource: scene.iblSampler }] : Array<Dynamic>) }] : Array<Dynamic>)) : Null<flighthq._internal.dom.GPUBindGroup>));
  ...
  private static function ensureWgpuMaterialBinding(state:WgpuRenderState, key:flighthq._internal._Object, layout:flighthq._internal.dom.GPUBindGroupLayout, uniformByteSize:Float, sampler:flighthq._internal.dom.GPUSampler, views:Array<flighthq._internal.dom.GPUTextureView>):WgpuMaterialBinding {
    ...
    if ((cast _Runtime.strictEquals(binding, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) {
      ...
      (binding = cast ({ bindGroup: (cast buildWgpuMaterialBindGroup(({ final __callArgument44:Dynamic = state; __callArgument44; }), ({ final __callArgument45:Dynamic = layout; __callArgument45; }), ({ final __callArgument46:Dynamic = buffer; __callArgument46; }), ({ final __callArgument47:Dynamic = sampler; __callArgument47; }), ({ final __callArgument48:Dynamic = views; __callArgument48; })) : flighthq._internal.dom.GPUBindGroup), buffer: buffer, sampler: sampler, views: _Runtime.slice(views, 0, null) } : Dynamic));
    ...
    } else { if ((cast (cast isWgpuMaterialBindGroupRebuildNeeded(({ final __callArgument54:Dynamic = binding; __callArgument54; }), ({ final __callArgument55:Dynamic = sampler; __callArgument55; }), ({ final __callArgument56:Dynamic = views; __callArgument56; })) : Bool) : Bool)) {
      ((cast binding : WgpuMaterialBinding).bindGroup = (cast buildWgpuMaterialBindGroup(({ final __callArgument60:Dynamic = state; __callArgument60; }), ({ final __callArgument61:Dynamic = layout; __callArgument61; }), (cast binding : WgpuMaterialBinding).buffer, ({ final __callArgument62:Dynamic = sampler; __callArgument62; }), ({ final __callArgument63:Dynamic = views; __callArgument63; })) : flighthq._internal.dom.GPUBindGroup));
  ...
  private static function ensureWgpuPbrSampleBindGroup(state:WgpuRenderState):flighthq._internal.dom.GPUBindGroup {
    ...
    var prefilteredView:flighthq._internal.dom.GPUTextureView = cast _Runtime.UNDEFINED;
    var brdfView:flighthq._internal.dom.GPUTextureView = cast _Runtime.UNDEFINED;
    scene = (cast getWgpuScene3DRuntime(({ final __callArgument68:Dynamic = state; __callArgument68; })) : WgpuScene3DRuntime);
    device = (cast state : WgpuRenderState).device;
    ...
    shadow = (cast WgpuMeshPipeline.writeWgpuShadowSampleUniform__wgpuMeshPipeline(({ final __callArgument70:Dynamic = state; __callArgument70; })) : Null<WgpuScene3DShadow>);
    ibl = scene.ibl;
    u = WgpuMeshPipeline._iblSampleScratch__wgpuMeshPipeline;
    if ((cast !_Runtime.strictEquals(ibl, null) : Bool)) {
      flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast u : flighthq._internal._Float32Array), (cast 0.0 : Float), (cast 1.0 : Float));
    ...
    if ((cast ((cast ((cast _Runtime.strictEquals(scene.pbrSampleBindGroup, null) : Bool) || (cast !_Runtime.strictEquals(scene.pbrSampleShadowView, shadowView) : Bool)) : Bool) || (cast !_Runtime.strictEquals(scene.pbrSampleIblCubeView, irradianceView) : Bool)) : Bool)) {
      (scene.pbrSampleBindGroup = cast (flighthq._internal.backend.WebGpuDeviceBackend.call(device, 'createBindGroup', cast ([{ layout: (cast ensureWgpuPbrSampleLayout(({ final __callArgument72:Dynamic = state; __callArgument72; })) : flighthq._internal.dom.GPUBindGroupLayout), entries: cast ([{ binding: 0.0, resource: { buffer: scene.shadowUniformBuffer } }, { binding: 1.0, resource: shadowView }, { binding: 2.0, resource: scene.shadowComparisonSampler }, { binding: 3.0, resource: { buffer: scene.iblUniformBuffer } }, { binding: 4.0, resource: irradianceView }, { binding: 5.0, resource: prefilteredView }, { binding: 6.0, resource: brdfView }, { binding: 7.0, resource: scene.iblSampler }] : Array<Dynamic>) }] : Array<Dynamic>)) : Null<flighthq._internal.dom.GPUBindGroup>));
  ...
  private static function ensureWgpuPerMapMaterialBinding(state:WgpuRenderState, key:flighthq._internal._Object, layout:flighthq._internal.dom.GPUBindGroupLayout, uniformByteSize:Float, samplers:Array<flighthq._internal.dom.GPUSampler>, views:Array<flighthq._internal.dom.GPUTextureView>):WgpuMaterialBinding {
    ...
    if ((cast _Runtime.strictEquals(binding, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) {
      var buffer:flighthq._internal.dom.GPUBuffer = flighthq._internal.backend.WebGpuDeviceBackend.call((cast state : WgpuRenderState).device, 'createBuffer', cast ([{ size: uniformByteSize, usage: (_Runtime.toInt32(flighthq._internal.backend.WebGpuConstantsBackend.value('GPUBufferUsage', 'UNIFORM')) | _Runtime.toInt32(flighthq._internal.backend.WebGpuConstantsBackend.value('GPUBufferUsage', 'COPY_DST'))) }] : Array<Dynamic>));
      (binding = cast ({ bindGroup: (cast buildWgpuPerMapMaterialBindGroup(({ final __callArgument78:Dynamic = state; __callArgument78; }), ({ final __callArgument79:Dynamic = layout; __callArgument79; }), ({ final __callArgument80:Dynamic = buffer; __callArgument80; }), ({ final __callArgument81:Dynamic = samplers; __callArgument81; }), ({ final __callArgument82:Dynamic = views; __callArgument82; })) : flighthq._internal.dom.GPUBindGroup), buffer: buffer, samplers: _Runtime.slice(samplers, 0, null), views: _Runtime.slice(views, 0, null) } : Dynamic));
      ((cast scene.materialBindGroups : flighthq._internal._WeakMap<flighthq._internal._Object, WgpuMaterialBinding>).set(key, (cast binding)));
    } else { if ((cast (cast wgpuPerMapMaterialBindGroupNeedsRebuild(({ final __callArgument88:Dynamic = binding; __callArgument88; }), ({ final __callArgument89:Dynamic = samplers; __callArgument89; }), ({ final __callArgument90:Dynamic = views; __callArgument90; })) : Bool) : Bool)) {
      ((cast binding : WgpuMaterialBinding).bindGroup = (cast buildWgpuPerMapMaterialBindGroup(({ final __callArgument94:Dynamic = state; __callArgument94; }), ({ final __callArgument95:Dynamic = layout; __callArgument95; }), (cast binding : WgpuMaterialBinding).buffer, ({ final __callArgument96:Dynamic = samplers; __callArgument96; }), ({ final __callArgument97:Dynamic = views; __callArgument97; })) : flighthq._internal.dom.GPUBindGroup));
      (cast WgpuMeshPipeline.overwriteIdentityCache__wgpuMeshPipeline : WgpuMaterialBinding->String->Array<flighthq._internal.dom.GPUSampler>->Void)(({ final __callArgument102:Dynamic = binding; __callArgument102; }), (cast 'samplers' : String), ({ final __callArgument103:Dynamic = samplers; __callArgument103; }));
      (cast WgpuMeshPipeline.overwriteIdentityCache__wgpuMeshPipeline : WgpuMaterialBinding->String->Array<flighthq._internal.dom.GPUTextureView>->Void)(({ final __callArgument106:Dynamic = binding; __callArgument106; }), (cast 'views' : String), ({ final __callArgument107:Dynamic = views; __callArgument107; }));
    } }
    return cast binding;
    return cast null;
  }
  ...
  private static function ensureWgpuScene3DPipeline<T:flighthq.types.WgpuMeshPipeline>(state:WgpuRenderState, key:String, compile:Bool->Bool->T):T {
    ...
    runtime = (cast getWgpuScene3DRuntime(({ final __callArgument114:Dynamic = state; __callArgument114; })) : WgpuScene3DRuntime);
  ...
  private static function ensureWgpuShadowSampleBindGroup(state:WgpuRenderState):flighthq._internal.dom.GPUBindGroup {
    ...
    scene = (cast getWgpuScene3DRuntime(({ final __callArgument116:Dynamic = state; __callArgument116; })) : WgpuScene3DRuntime);
    device = (cast state : WgpuRenderState).device;
    if ((cast _Runtime.strictEquals(scene.shadowUniformBuffer, null) : Bool)) {
      (scene.shadowUniformBuffer = cast (flighthq._internal.backend.WebGpuDeviceBackend.call(device, 'createBuffer', cast ([{ size: WgpuMeshPipeline.SHADOW_SAMPLE_UNIFORM_BYTES__wgpuMeshPipeline, usage: (_Runtime.toInt32(flighthq._internal.backend.WebGpuConstantsBackend.value('GPUBufferUsage', 'UNIFORM')) | _Runtime.toInt32(flighthq._internal.backend.WebGpuConstantsBackend.value('GPUBufferUsage', 'COPY_DST'))) }] : Array<Dynamic>)) : Null<flighthq._internal.dom.GPUBuffer>));
    }
    ...
    shadow = (cast WgpuMeshPipeline.writeWgpuShadowSampleUniform__wgpuMeshPipeline(({ final __callArgument118:Dynamic = state; __callArgument118; })) : Null<WgpuScene3DShadow>);
    ...
    if ((cast ((cast _Runtime.strictEquals(scene.shadowSampleBindGroup, null) : Bool) || (cast !_Runtime.strictEquals(scene.shadowSampleView, view) : Bool)) : Bool)) {
      (scene.shadowSampleBindGroup = cast (flighthq._internal.backend.WebGpuDeviceBackend.call(device, 'createBindGroup', cast ([{ layout: (cast ensureWgpuShadowSampleLayout(({ final __callArgument120:Dynamic = state; __callArgument120; })) : flighthq._internal.dom.GPUBindGroupLayout), entries: cast ([{ binding: 0.0, resource: { buffer: scene.shadowUniformBuffer } }, { binding: 1.0, resource: view }, { binding: 2.0, resource: scene.shadowComparisonSampler }] : Array<Dynamic>) }] : Array<Dynamic>)) : Null<flighthq._internal.dom.GPUBindGroup>));
  ...
  public static function writeWgpuShadowSampleUniform__wgpuMeshPipeline(state:WgpuRenderState):Null<WgpuScene3DShadow> {
    ...
    scene = (cast getWgpuScene3DRuntime(({ final __callArgument122:Dynamic = state; __callArgument122; })) : WgpuScene3DRuntime);
    shadow = scene.shadow;
  ...
  public static function ensureWgpuShadowSampleLayout(state:WgpuRenderState):flighthq._internal.dom.GPUBindGroupLayout {
    var scene:WgpuScene3DRuntime = cast _Runtime.UNDEFINED;
    scene = (cast getWgpuScene3DRuntime(({ final __callArgument124:Dynamic = state; __callArgument124; })) : WgpuScene3DRuntime);
  ...
  private static function getWgpuMaterialSampler(state:WgpuRenderState, texture:Null<Texture>):flighthq._internal.dom.GPUSampler {
    ...
    if ((cast _Runtime.strictEquals(texture, null) : Bool)) { return cast (cast (cast getWgpuRenderStateRuntime(({ final __callArgument126:Dynamic = state; __callArgument126; })) : WgpuRenderStateRuntime) : { var linearSampler:flighthq._internal.dom.GPUSampler; }).linearSampler; }
    ...
    return cast (cast getWgpuSampler(({ final __callArgument128:Dynamic = state; __callArgument128; }), (cast minFilter : String), (cast magFilter : String), sampler.wrapU, sampler.wrapV, ({ final __callArgument129:Dynamic = mipmapFilter; __callArgument129; }), (cast sampler.anisotropy : Float)) : flighthq._internal.dom.GPUSampler);
    return cast null;
  }
  ...
  private static function stashWgpuUvTransform(state:WgpuRenderState, texture:Null<TextureLike>):Void {
    ...
    if ((cast ((cast ((cast _Runtime.strictEquals(texture, null) : Bool) || (cast _Runtime.andValue(_Runtime.hasField(texture, 'storage'), function():Dynamic return cast !(cast (cast hasTextureSource(({ final __callArgument143:Dynamic = texture; __callArgument143; })) : Bool) : Bool)) : Bool)) : Bool) || (cast !(cast (cast hasTextureUvTransform(({ final __callArgument145:Dynamic = texture; __callArgument145; })) : Bool) : Bool) : Bool)) : Bool)) {
      WgpuMeshPipeline.resetWgpuUvTransformStash__wgpuMeshPipeline(({ final __callArgument147:Dynamic = out; __callArgument147; }));
      return;
    }
    getTextureUvMatrix(({ final __callArgument149:Dynamic = WgpuMeshPipeline.scratchUvMatrix__wgpuMeshPipeline; __callArgument149; }), ({ final __callArgument150:Dynamic = texture; __callArgument150; }));
  ...
  public static function writeWgpuDrawUniform(state:WgpuRenderState, proxy:Scene3DRenderProxy):flighthq._internal.dom.GPUBindGroup {
    ...
    scene = (cast getWgpuScene3DRuntime(({ final __callArgument153:Dynamic = state; __callArgument153; })) : WgpuScene3DRuntime);
    stateRuntime = (cast getWgpuRenderStateRuntime(({ final __callArgument155:Dynamic = state; __callArgument155; })) : WgpuRenderStateRuntime);
    if ((cast _Runtime.strictEquals(scene.drawBindGroup, null) : Bool)) {
      (scene.drawBindGroup = cast (flighthq._internal.backend.WebGpuDeviceBackend.call((cast state : WgpuRenderState).device, 'createBindGroup', cast ([{ layout: (cast (cast ensureWgpuScene3DLayouts(({ final __callArgument157:Dynamic = state; __callArgument157; })) : WgpuScene3DLayouts) : WgpuScene3DLayouts).drawBindGroupLayout, entries: cast ([{ binding: 0.0, resource: { buffer: stateRuntime.uniformBuffer, size: WgpuMeshPipeline.DRAW_UNIFORM_BYTES__wgpuMeshPipeline } }] : Array<Dynamic>) }] : Array<Dynamic>)) : Null<flighthq._internal.dom.GPUBindGroup>));
    }
  ...
  private static function writeWgpuFrameUniform(state:WgpuRenderState, camera:Camera3D, lights:Scene3DLightBlock):Void {
    ...
    scene = (cast getWgpuScene3DRuntime(({ final __callArgument161:Dynamic = state; __callArgument161; })) : WgpuScene3DRuntime);
    ...
    getCamera3DViewProjectionMatrix4(({ final __callArgument165:Dynamic = WgpuMeshPipeline.scratchViewProjection__wgpuMeshPipeline; __callArgument165; }), ({ final __callArgument166:Dynamic = camera; __callArgument166; }), (cast ((cast !_Runtime.strictEquals(aspect, 0.0) : Bool) ? (cast aspect : Dynamic) : (cast 1.0 : Dynamic)) : Float));
    ...
    getCamera3DPosition(({ final __callArgument169:Dynamic = WgpuMeshPipeline.scratchCameraPosition__wgpuMeshPipeline; __callArgument169; }), ({ final __callArgument170:Dynamic = camera; __callArgument170; }));
