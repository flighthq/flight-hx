...
class WgpuWireframeUpload {
  ...
  public static function ensureWgpuWireframeUpload(state:WgpuRenderState, geometry:MeshGeometry):Null<flighthq.types.WgpuWireframePipeline.WgpuWireframeUpload> {
    ...
    var lineIndexBuffer:flighthq._internal._Any = cast _Runtime.UNDEFINED;
    ...
    if ((cast !_Runtime.strictEquals(upload, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) { _Runtime.callProperty((cast upload : flighthq.types.WgpuWireframePipeline.WgpuWireframeUpload).lineIndexBuffer, 'destroy', cast ([] : Array<Dynamic>)); }
    ...
    _Runtime.callProperty(flighthq._internal.backend.WebGpuDeviceBackend.field(device, 'queue'), 'writeBuffer', cast ([lineIndexBuffer, 0.0, (cast lines : { var buffer:haxe.io.Bytes; }).buffer, (cast lines : { var byteOffset:Float; }).byteOffset, (cast lines : { var byteLength:Float; }).byteLength] : Array<Dynamic>));
