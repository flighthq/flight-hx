...
class DrawWgpuScene3D {
  ...
  public static function drawEntries__drawWgpuScene3D(state:WgpuRenderState, entries:Array<WgpuScene3DDrawEntry>, camera:Camera3D, blended:Bool):Void {
    ...
    boundRenderer = null;
    colorAdjustmentFeatureEnabled = !_Runtime.strictEquals((cast getWgpuColorAdjustmentMaterialFeature(({ final __callArgument30:Dynamic = state; __callArgument30; })) : Null<WgpuColorAdjustmentMaterialFeature>), null);
    {
      var i:Float = 0.0;
