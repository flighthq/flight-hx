...
class EmissiveWgpuMeshMaterialRenderer {
  ...
  public static final emissiveWgpuMeshMaterialRenderer:WgpuMeshMaterialRenderer = (cast { bind: function(state:WgpuRenderState, material:Null<Material>, _lights:Scene3DLightBlock, camera:Camera3D):Void {
    ...
    pipeline = (cast ensureWgpuUnlitPipeline(({ final __callArgument1:Dynamic = state; __callArgument1; }), (cast EmissiveWgpuMeshMaterialRenderer.defineKeyForMaterial__emissiveWgpuMeshMaterialRenderer(({ final __callArgument2:Dynamic = emissive; __callArgument2; })) : WgpuUnlitDefineKey), (cast format : flighthq._internal._Any)) : WgpuUnlitPipeline);
