...
class WgpuParticleEmitter3D {
  ...
  public static function wgpuParticleBlendState__wgpuParticleEmitter3D(mode:ParticleBlendMode):flighthq._internal.dom.GPUBlendState {
    {
      ...
      if (__switchValue == 'add') {
        ...
        return cast (cast getWgpuBlendState(({ final __callArgument2:Dynamic = (cast BlendModeValue : { var Add:String; var Darken:String; var Lighten:String; var Multiply:String; var Normal:String; var Screen:String; }).Multiply; __callArgument2; })) : flighthq._internal.dom.GPUBlendState);
      }
      else if (__switchValue == 'screen') {
        return cast (cast getWgpuBlendState(({ final __callArgument4:Dynamic = (cast BlendModeValue : { var Add:String; var Darken:String; var Lighten:String; var Multiply:String; var Normal:String; var Screen:String; }).Screen; __callArgument4; })) : flighthq._internal.dom.GPUBlendState);
      }
      else  {
        return cast (cast getWgpuBlendState(({ final __callArgument6:Dynamic = (cast BlendModeValue : { var Add:String; var Darken:String; var Lighten:String; var Multiply:String; var Normal:String; var Screen:String; }).Normal; __callArgument6; })) : flighthq._internal.dom.GPUBlendState);
      }
    }
    return cast null;
  }
    ...
    if ((cast !_Runtime.strictEquals(children, null) : Bool)) {
      {
        ...
        while ((cast ((cast i : Float) < (cast _Runtime.field(children, 'length') : Float)) : Bool)) {
          WgpuParticleEmitter3D.collectParticleEmitter3DNodes__wgpuParticleEmitter3D(({ final __callArgument8:Dynamic = flighthq._internal._StaticIndex.readArray(children, i); __callArgument8; }), ({ final __callArgument9:Dynamic = out; __callArgument9; }));
          i++;
        }
      }
    }
  ...
  public static function ensureParticle3DPipeline__wgpuParticleEmitter3D(state:WgpuRenderState, resources:WgpuParticle3DResources__wgpuParticleEmitter3D, mode:ParticleBlendMode, hasTexture:Bool):flighthq._internal.dom.GPURenderPipeline {
    ...
    format = _Runtime.coalesce((cast (cast getWgpuRenderStateRuntime(({ final __callArgument12:Dynamic = state; __callArgument12; })) : WgpuRenderStateRuntime) : { @:optional var currentColorFormat:Null<String>; }).currentColorFormat, function():Dynamic return cast (cast state : WgpuRenderState).format);
  ...
  public static function drawParticleEmitter3DNode__wgpuParticleEmitter3D(state:WgpuRenderState, resources:WgpuParticle3DResources__wgpuParticleEmitter3D, pass:flighthq._internal.dom.GPURenderPassEncoder, emitter:ParticleEmitter3D):Void {
    ...
    atlasTexture = _Runtime.coalesce(({ final __typedStruct16 = atlas; __typedStruct16 == null ? _Runtime.UNDEFINED : __typedStruct16.texture; }), function():Dynamic return cast null);
    textureEntry = ((cast ((cast !_Runtime.strictEquals(atlasTexture, null) : Bool) && (cast (cast hasTextureSource(({ final __callArgument17:Dynamic = atlasTexture; __callArgument17; })) : Bool) : Bool)) : Bool) ? (cast (cast (#if js _Runtime.callValue(resolveWgpuTexture, cast ([({ final __callArgument21:Dynamic = state; __callArgument21; }), ({ final __callArgument22:Dynamic = atlasTexture; __callArgument22; }), (cast false : Bool)] : Array<Dynamic>)) #else resolveWgpuTexture(({ final __callArgument19:Dynamic = state; __callArgument19; }), ({ final __callArgument20:Dynamic = atlasTexture; __callArgument20; }), (cast false : Bool), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end) : Null<WgpuTextureEntry>) : Dynamic) : (cast null : Dynamic));
    ...
    iw = ((cast hasAtlas : Bool) ? (cast _Runtime.divideNumbers(1.0, HxMath.max(1.0, (cast getTextureWidth(({ final __callArgument23:Dynamic = atlasTexture; __callArgument23; })) : Float))) : Dynamic) : (cast 0.0 : Dynamic));
    ih = ((cast hasAtlas : Bool) ? (cast _Runtime.divideNumbers(1.0, HxMath.max(1.0, (cast getTextureHeight(({ final __callArgument25:Dynamic = atlasTexture; __callArgument25; })) : Float))) : Dynamic) : (cast 0.0 : Dynamic));
    ...
    instanceBuffer = (cast WgpuParticleEmitter3D.ensureParticle3DInstanceBuffer__wgpuParticleEmitter3D(({ final __callArgument27:Dynamic = state; __callArgument27; }), (cast resources : Dynamic), (cast emitter : ParticleEmitter3D), (cast drawCount : Float)) : flighthq._internal.dom.GPUBuffer);
  ...
  public static function drawWgpuScene3DParticleEmitter3Ds(state:WgpuRenderState, scene:Node3D, camera:Camera3D, lights:Scene3DLightsLike):Void {
    ...
    WgpuParticleEmitter3D.collectParticleEmitter3DNodes__wgpuParticleEmitter3D(({ final __callArgument38:Dynamic = scene; __callArgument38; }), ({ final __callArgument39:Dynamic = WgpuParticleEmitter3D.emitterScratch__wgpuParticleEmitter3D; __callArgument39; }));
    ...
    pass = (cast (cast getWgpuRenderStateRuntime(({ final __callArgument42:Dynamic = state; __callArgument42; })) : WgpuRenderStateRuntime) : { var renderPass:Null<flighthq._internal.dom.GPURenderPassEncoder>; }).renderPass;
    if ((cast _Runtime.strictEquals(pass, null) : Bool)) { return; }
    list = (cast (#if js _Runtime.callValue(prepareScene3DRender, cast ([({ final __callArgument48:Dynamic = state; __callArgument48; }), ({ final __callArgument49:Dynamic = scene; __callArgument49; }), ({ final __callArgument50:Dynamic = camera; __callArgument50; }), ({ final __callArgument51:Dynamic = lights; __callArgument51; })] : Array<Dynamic>)) #else prepareScene3DRender(({ final __callArgument44:Dynamic = state; __callArgument44; }), ({ final __callArgument45:Dynamic = scene; __callArgument45; }), ({ final __callArgument46:Dynamic = camera; __callArgument46; }), ({ final __callArgument47:Dynamic = lights; __callArgument47; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end) : Scene3DRenderList);
    resources = (cast WgpuParticleEmitter3D.ensureParticle3DResources__wgpuParticleEmitter3D(({ final __callArgument52:Dynamic = state; __callArgument52; })) : WgpuParticle3DResources__wgpuParticleEmitter3D);
    ...
    flighthq._internal.backend.WebGpuQueueBackend.call(flighthq._internal.backend.WebGpuDeviceBackend.field((cast state : WgpuRenderState).device, 'queue'), 'writeBuffer', cast ([(cast resources : WgpuParticle3DResources__wgpuParticleEmitter3D).frameBuffer, 0.0, _Runtime.field(f, 'buffer'), 0.0, WgpuParticleEmitter3D.FRAME_UNIFORM_BYTES__wgpuParticleEmitter3D] : Array<Dynamic>));
    {
      ...
      while ((cast ((cast i : Float) < (cast _Runtime.field(WgpuParticleEmitter3D.emitterScratch__wgpuParticleEmitter3D, 'length') : Float)) : Bool)) {
        WgpuParticleEmitter3D.drawParticleEmitter3DNode__wgpuParticleEmitter3D(({ final __callArgument54:Dynamic = state; __callArgument54; }), (cast resources : Dynamic), ({ final __callArgument55:Dynamic = pass; __callArgument55; }), flighthq._internal._StaticIndex.readArray(WgpuParticleEmitter3D.emitterScratch__wgpuParticleEmitter3D, i));
        i++;
      }
    }
  }
