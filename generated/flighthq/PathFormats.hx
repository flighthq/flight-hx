...
class PathFormats {
  ...
  if (_Runtime.truthy(!_Runtime.truthy(_Runtime.callValue(PathFormats.isSvgCommandLetter__svgPathData, cast ([commandLetter] : Array<Dynamic>))))) { return cast false; }
  pos++;
  ...
  _Runtime.callValue(skipSeparators, cast ([] : Array<Dynamic>));
  if (_Runtime.truthy(_Runtime.compare(pos, length, '>='))) { break; }
  if (_Runtime.truthy(_Runtime.callValue(PathFormats.isSvgCommandLetter__svgPathData, cast ([_Runtime.getIndex(d, pos)] : Array<Dynamic>)))) { break; }
}
  ...
  public static function formatSvgNumber__svgPathData(value:Float, ?precision:Float):String {
    ...
    if (_Runtime.truthy(_Runtime.strictEquals(precision, _Runtime.UNDEFINED))) { return cast Std.string(value); }
  ...
  _Runtime.callProperty(parts, 'push', cast (['M' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'x'), precision] : Array<Dynamic>))) + ' ' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'y'), precision] : Array<Dynamic>))) + ''] : Array<Dynamic>));
} else { if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.field(segment, 'kind'), 'lineTo'))) {
  _Runtime.callProperty(parts, 'push', cast (['L' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'x'), precision] : Array<Dynamic>))) + ' ' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'y'), precision] : Array<Dynamic>))) + ''] : Array<Dynamic>));
} else { if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.field(segment, 'kind'), 'curveTo'))) {
  _Runtime.callProperty(parts, 'push', cast ([('Q' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'controlX'), precision] : Array<Dynamic>))) + ' ' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'controlY'), precision] : Array<Dynamic>))) + ' ' + '' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'x'), precision] : Array<Dynamic>))) + ' ' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'y'), precision] : Array<Dynamic>))) + '')] : Array<Dynamic>));
} else { if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.field(segment, 'kind'), 'cubicCurveTo'))) {
  _Runtime.callProperty(parts, 'push', cast ([(('C' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'control1X'), precision] : Array<Dynamic>))) + ' ' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'control1Y'), precision] : Array<Dynamic>))) + ' ' + '' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'control2X'), precision] : Array<Dynamic>))) + ' ' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'control2Y'), precision] : Array<Dynamic>))) + ' ') + '' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'x'), precision] : Array<Dynamic>))) + ' ' + Std.string(_Runtime.callValue(PathFormats.formatSvgNumber__svgPathData, cast ([_Runtime.field(segment, 'y'), precision] : Array<Dynamic>))) + '')] : Array<Dynamic>));
