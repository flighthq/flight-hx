...
class TextureAtlasRegion {
  ...
  public static function getTextureAtlasRegionSequence(atlas:Dynamic, prefix:String):Array<Dynamic> {
    var result:Array<Dynamic> = cast _Runtime.UNDEFINED;
  ...
  public static function setTextureAtlasRegion(out:Dynamic, x:Float, y:Float = 0.0, width:Float = 0.0, height:Float = 0.0, pivotX:Float = 0.0, pivotY:Float = 0.0):Void {
