...
class WgpuFxaaEffect {
  ...
  public static function registerWgpuFxaaEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument10:Dynamic = state; __callArgument10; }), (cast 'FxaaEffect' : String), ({ final __callArgument11:Dynamic = defaultWgpuFxaaEffectRunner; __callArgument11; }));
  }
