...
class WgpuFxaaEffect {
  ...
  public static function registerWgpuFxaaEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'FxaaEffect' : String), ({ final __callArgument6:Dynamic = defaultWgpuFxaaEffectRunner; __callArgument6; }));
  }
