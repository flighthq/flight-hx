...
class WgpuFxaaEffect {
  ...
  public static function applyFxaaEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, effect:FxaaEffect):Void {
    ...
    pipeline = (cast getWgpuEffectPipeline((cast state), (cast 'antialiasing.fxaa' : String), (cast WgpuFxaaEffect.FXAA_FRAGMENT_WGSL__wgpuFxaaEffect : String), (cast 'replace' : String)) : WgpuEffectPipeline);
    drawWgpuEffectPass((cast state), (cast (cast source : WgpuRenderTarget)), (cast (cast dest : WgpuRenderTarget)), (cast pipeline), (cast function(__unused1:flighthq._internal._Float32Array, __unused2:flighthq._internal._Int32Array):Void { _Runtime.callValue(function(f32:flighthq._internal._Float32Array, __unused0:flighthq._internal._Int32Array):Void {
      ...
      flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast f32 : flighthq._internal._Float32Array), (cast 2.0 : Float), (cast edgeThreshold : Float));
  ...
  public static final defaultWgpuFxaaEffectRunner:WgpuRenderEffectRunner = (cast function(ctx:WgpuRenderEffectContext, effect:RenderEffect):Void {
    applyFxaaEffectToWgpu((cast _Runtime.field(ctx, 'state')), (cast _Runtime.field(ctx, 'source')), (cast _Runtime.field(ctx, 'dest')), (cast (cast effect : FxaaEffect)));
  });

  public static function registerWgpuFxaaEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect((cast state), (cast 'FxaaEffect' : String), (cast defaultWgpuFxaaEffectRunner));
  }
