...
class WgpuScanlinesEffect {
  ...
  public static function registerWgpuScanlinesEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument10:Dynamic = state; __callArgument10; }), (cast 'ScanlinesEffect' : String), ({ final __callArgument11:Dynamic = defaultWgpuScanlinesEffectRunner; __callArgument11; }));
  }
