...
class WgpuGradientBevelEffect {
  ...
  public static function applyGradientBevelEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, pool:WgpuRenderTargetPool, effect:GradientBevelEffect):Void {
    ...
    rampTexture = (cast getWgpuEffectGradientRampTexture(({ final __callArgument21:Dynamic = state; __callArgument21; }), _Runtime.field(effect, 'colors'), _Runtime.field(effect, 'alphas'), _Runtime.field(effect, 'ratios')) : flighthq._internal.dom.GPUTexture);
