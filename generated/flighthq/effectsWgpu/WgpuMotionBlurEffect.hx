...
class WgpuMotionBlurEffect {
  ...
  public static function applyMotionBlurEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, velocityTexture:Null<flighthq._internal.dom.GPUTexture>, effect:MotionBlurEffect):Void {
    ...
    pipeline = (cast WgpuMotionBlurEffect.getMotionBlurPipeline__wgpuMotionBlurEffect(({ final __callArgument4:Dynamic = state; __callArgument4; })) : WgpuEffectPipeline);
    if ((cast _Runtime.strictEquals(velocityTexture, null) : Bool)) {
      drawWgpuDualSourceEffectPass(({ final __callArgument6:Dynamic = state; __callArgument6; }), (cast source : WgpuRenderTarget), (cast source : WgpuRenderTarget), ({ final __callArgument7:Dynamic = (cast dest : WgpuRenderTarget); __callArgument7; }), ({ final __callArgument8:Dynamic = pipeline; __callArgument8; }), ({ final __callArgument9:Dynamic = function(__unused1:flighthq._internal._Float32Array, __unused2:flighthq._internal._Int32Array):Void { _Runtime.callValue(function(f32:flighthq._internal._Float32Array, __unused0:flighthq._internal._Int32Array):Void {
    ...
    drawWgpuDualSourceEffectPass(({ final __callArgument14:Dynamic = state; __callArgument14; }), (cast source : WgpuRenderTarget), ({ final __callArgument15:Dynamic = velocitySource; __callArgument15; }), ({ final __callArgument16:Dynamic = (cast dest : WgpuRenderTarget); __callArgument16; }), ({ final __callArgument17:Dynamic = pipeline; __callArgument17; }), ({ final __callArgument18:Dynamic = function(__unused4:flighthq._internal._Float32Array, __unused5:flighthq._internal._Int32Array):Void { _Runtime.callValue(function(f32:flighthq._internal._Float32Array, __unused3:flighthq._internal._Int32Array):Void {
      flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast f32 : flighthq._internal._Float32Array), (cast 0.0 : Float), (cast intensity : Float));
      flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast f32 : flighthq._internal._Float32Array), (cast 1.0 : Float), (cast samples : Float));
      flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast f32 : flighthq._internal._Float32Array), (cast 2.0 : Float), (cast (cast resolution : { var height:Float; var texelsPerLogicalPixel:Float; var width:Float; }).width : Float));
      flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast f32 : flighthq._internal._Float32Array), (cast 3.0 : Float), (cast (cast resolution : { var height:Float; var texelsPerLogicalPixel:Float; var width:Float; }).height : Float));
    ...
    }, cast ([__unused4] : Array<Dynamic>)); }; __callArgument18; }));
  }
  ...
  public static function registerWgpuMotionBlurEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument24:Dynamic = state; __callArgument24; }), (cast 'MotionBlurEffect' : String), ({ final __callArgument25:Dynamic = defaultWgpuMotionBlurEffectRunner; __callArgument25; }));
  }
  ...
  public static function getMotionBlurPipeline__wgpuMotionBlurEffect(state:WgpuRenderState):WgpuDualSourceEffectPipeline {
    ...
    if ((cast _Runtime.strictEquals(pipeline, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) {
      (pipeline = cast ((cast createWgpuDualSourceEffectPipeline(({ final __callArgument28:Dynamic = state; __callArgument28; }), (cast WgpuMotionBlurEffect.MOTION_BLUR_FRAGMENT_WGSL__wgpuMotionBlurEffect : String), ({ final __callArgument29:Dynamic = 'replace'; __callArgument29; })) : WgpuEffectPipeline) : Dynamic));
