...
class WgpuSsaoEffect {
  ...
  private static function applySsaoEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, effect:SsaoEffect):Void {
    ...
    pipeline = (cast getWgpuEffectPipeline(({ final __callArgument4:Dynamic = state; __callArgument4; }), (cast 'atmospheric.ssao' : String), (cast WgpuSsaoEffect.SSAO_FRAGMENT_WGSL__wgpuSsaoEffect : String), (cast 'replace' : String)) : WgpuEffectPipeline);
  ...
  public static function registerWgpuSsaoEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument14:Dynamic = state; __callArgument14; }), (cast 'SsaoEffect' : String), ({ final __callArgument15:Dynamic = defaultWgpuSsaoEffectRunner; __callArgument15; }));
  }
