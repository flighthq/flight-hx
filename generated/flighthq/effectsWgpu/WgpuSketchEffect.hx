...
class WgpuSketchEffect {
  ...
  public static function applySketchEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, effect:SketchEffect):Void {
    ...
    pipeline = (cast getWgpuEffectPipeline((cast state : WgpuRenderState), (cast 'stylization.sketch' : String), (cast WgpuSketchEffect.SKETCH_FRAGMENT_WGSL__wgpuSketchEffect : String), (cast 'replace' : String)) : WgpuEffectPipeline);
    drawWgpuEffectPass((cast state : WgpuRenderState), (cast (cast source : WgpuRenderTarget) : WgpuRenderTarget), (cast (cast dest : WgpuRenderTarget) : Null<WgpuRenderTarget>), pipeline, (cast function(__unused1:flighthq._internal._Float32Array, __unused2:flighthq._internal._Int32Array):Void return _Runtime.callValue(function(f32:flighthq._internal._Float32Array, __unused0:flighthq._internal._Int32Array):Void {
      flighthq._internal._StaticIndex.writeFloat32Array(f32, 0.0, strength);
  ...
  public static final defaultWgpuSketchEffectRunner:WgpuRenderEffectRunner = function(ctx:WgpuRenderEffectContext, effect:RenderEffect):Void {
    applySketchEffectToWgpu((cast _Runtime.field(ctx, 'state') : WgpuRenderState), (cast _Runtime.field(ctx, 'source') : WgpuRenderTarget), (cast _Runtime.field(ctx, 'dest') : WgpuRenderTarget), (cast (cast effect : SketchEffect) : SketchEffect));
  };

  public static function registerWgpuSketchEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect((cast state : WgpuRenderState), (cast 'SketchEffect' : String), (cast defaultWgpuSketchEffectRunner : WgpuRenderEffectRunner));
  }
