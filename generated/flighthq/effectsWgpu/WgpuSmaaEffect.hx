...
class WgpuSmaaEffect {
  ...
  public static function registerWgpuSmaaEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument10:Dynamic = state; __callArgument10; }), (cast 'SmaaEffect' : String), ({ final __callArgument11:Dynamic = defaultWgpuSmaaEffectRunner; __callArgument11; }));
  }
