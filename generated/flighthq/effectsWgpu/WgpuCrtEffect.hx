...
class WgpuCrtEffect {
  ...
  private static function applyCrtEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, effect:CrtEffect):Void {
    ...
    pipeline = (cast getWgpuEffectPipeline(({ final __callArgument4:Dynamic = state; __callArgument4; }), (cast 'stylization.crt' : String), (cast WgpuCrtEffect.CRT_FRAGMENT_WGSL__wgpuCrtEffect : String), (cast 'replace' : String)) : WgpuEffectPipeline);
  ...
  public static function registerWgpuCrtEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument14:Dynamic = state; __callArgument14; }), (cast 'CrtEffect' : String), ({ final __callArgument15:Dynamic = defaultWgpuCrtEffectRunner; __callArgument15; }));
  }
