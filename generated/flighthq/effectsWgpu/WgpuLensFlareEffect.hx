...
class WgpuLensFlareEffect {
  ...
  public static function registerWgpuLensFlareEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument10:Dynamic = state; __callArgument10; }), (cast 'LensFlareEffect' : String), ({ final __callArgument11:Dynamic = defaultWgpuLensFlareEffectRunner; __callArgument11; }));
  }
