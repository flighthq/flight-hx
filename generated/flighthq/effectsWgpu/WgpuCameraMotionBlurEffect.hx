...
class WgpuCameraMotionBlurEffect {
  ...
  private static function applyCameraMotionBlurEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, effect:CameraMotionBlurEffect):Void {
    ...
    pipeline = (cast getWgpuEffectPipeline(({ final __callArgument0:Dynamic = state; __callArgument0; }), (cast 'motion.cameraMotionBlur' : String), (cast WgpuCameraMotionBlurEffect.CAMERA_MOTION_BLUR_FRAGMENT_WGSL__wgpuCameraMotionBlurEffect : String), (cast 'replace' : String)) : WgpuEffectPipeline);
  ...
  public static function registerWgpuCameraMotionBlurEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument10:Dynamic = state; __callArgument10; }), (cast 'CameraMotionBlurEffect' : String), ({ final __callArgument11:Dynamic = defaultWgpuCameraMotionBlurEffectRunner; __callArgument11; }));
  }
