...
class WgpuDisplacementEffect {
  ...
  public static function applyDisplacementEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, effect:DisplacementEffect):Void {
    ...
    pipeline = (cast getWgpuEffectPipeline(({ final __callArgument2:Dynamic = state; __callArgument2; }), (cast 'lens.displacement' : String), (cast WgpuDisplacementEffect.DISPLACEMENT_FRAGMENT_WGSL__wgpuDisplacementEffect : String), (cast 'replace' : String)) : WgpuEffectPipeline);
  ...
  public static function registerWgpuDisplacementEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument7:Dynamic = state; __callArgument7; }), (cast 'DisplacementEffect' : String), ({ final __callArgument8:Dynamic = defaultWgpuDisplacementEffectRunner; __callArgument8; }));
  }
