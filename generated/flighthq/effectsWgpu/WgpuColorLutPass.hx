...
class WgpuColorLutPass {
  ...
  public static function applyColorLutPassToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, lut:ColorLut, cache:WgpuColorLutTextureCache):Void {
    ...
    texture = (cast WgpuColorLutPass.uploadLutTexture__wgpuColorLutPass(({ final __callArgument2:Dynamic = state; __callArgument2; }), ({ final __callArgument3:Dynamic = lut; __callArgument3; }), ({ final __callArgument4:Dynamic = cache; __callArgument4; })) : flighthq._internal.dom.GPUTexture);
    ...
    lutBG = flighthq._internal.backend.WebGpuDeviceBackend.call(device, 'createBindGroup', cast ([{ layout: (cast WgpuColorLutPass.getLutBindGroupLayout__wgpuColorLutPass(({ final __callArgument8:Dynamic = state; __callArgument8; })) : flighthq._internal.dom.GPUBindGroupLayout), entries: cast ([{ binding: 0.0, resource: (cast texture : flighthq._internal.dom.GPUTexture).createView({ dimension: '3d' }) }, { binding: 1.0, resource: (cast fs : { var uniformBG:flighthq._internal.dom.GPUBindGroup; var textureBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var uniformBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var sampler:flighthq._internal.dom.GPUSampler; var acquireSlot:Void->Float; var writeSlot:Float->(flighthq._internal._Float32Array->flighthq._internal._Int32Array->Void)->Void; var beginPass:Null<WgpuRenderTarget>->String->flighthq._internal.dom.GPURenderPassEncoder; }).sampler }] : Array<Dynamic>) }] : Array<Dynamic>));
    pipeline = (cast WgpuColorLutPass.getLutPipeline__wgpuColorLutPass(({ final __callArgument10:Dynamic = state; __callArgument10; }), (cast (cast (cast dest : WgpuRenderTarget) : { var format:String; }).format : String)) : WgpuEffectPipeline);
    slotOffset = (cast fs : { var uniformBG:flighthq._internal.dom.GPUBindGroup; var textureBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var uniformBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var sampler:flighthq._internal.dom.GPUSampler; var acquireSlot:Void->Float; var writeSlot:Float->(flighthq._internal._Float32Array->flighthq._internal._Int32Array->Void)->Void; var beginPass:Null<WgpuRenderTarget>->String->flighthq._internal.dom.GPURenderPassEncoder; }).acquireSlot();
    (cast fs : { var uniformBG:flighthq._internal.dom.GPUBindGroup; var textureBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var uniformBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var sampler:flighthq._internal.dom.GPUSampler; var acquireSlot:Void->Float; var writeSlot:Float->(flighthq._internal._Float32Array->flighthq._internal._Int32Array->Void)->Void; var beginPass:Null<WgpuRenderTarget>->String->flighthq._internal.dom.GPURenderPassEncoder; }).writeSlot((cast slotOffset : Float), ({ final __callArgument12:Dynamic = function(__unused2:flighthq._internal._Float32Array, __unused3:flighthq._internal._Int32Array):Void { _Runtime.callValue(function(f32:flighthq._internal._Float32Array, __unused1:flighthq._internal._Int32Array):Void {
    ...
    }, cast ([__unused2] : Array<Dynamic>)); }; __callArgument12; }));
    pass = (cast fs : { var uniformBG:flighthq._internal.dom.GPUBindGroup; var textureBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var uniformBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var sampler:flighthq._internal.dom.GPUSampler; var acquireSlot:Void->Float; var writeSlot:Float->(flighthq._internal._Float32Array->flighthq._internal._Int32Array->Void)->Void; var beginPass:Null<WgpuRenderTarget>->String->flighthq._internal.dom.GPURenderPassEncoder; }).beginPass(({ final __callArgument13:Dynamic = (cast dest : WgpuRenderTarget); __callArgument13; }), (cast 'load' : String));
  ...
  public static function getLutPipeline__wgpuColorLutPass(state:WgpuRenderState, format:flighthq._internal.dom.GPUTextureFormat):WgpuEffectPipeline {
    ...
    if ((cast _Runtime.strictEquals(pipeline, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) {
      var fs:{ var uniformBG:flighthq._internal.dom.GPUBindGroup; var textureBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var uniformBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var sampler:flighthq._internal.dom.GPUSampler; var acquireSlot:Void->Float; var writeSlot:Float->(flighthq._internal._Float32Array->flighthq._internal._Int32Array->Void)->Void; var beginPass:Null<WgpuRenderTarget>->String->flighthq._internal.dom.GPURenderPassEncoder; } = (cast getWgpuEffectPassState(({ final __callArgument14:Dynamic = state; __callArgument14; })) : { var uniformBG:flighthq._internal.dom.GPUBindGroup; var textureBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var uniformBGLayout:flighthq._internal.dom.GPUBindGroupLayout; var sampler:flighthq._internal.dom.GPUSampler; var acquireSlot:Void->Float; var writeSlot:Float->(flighthq._internal._Float32Array->flighthq._internal._Int32Array->Void)->Void; var beginPass:Null<WgpuRenderTarget>->String->flighthq._internal.dom.GPURenderPassEncoder; });
  ...
  public static function uploadLutTexture__wgpuColorLutPass(state:WgpuRenderState, lut:ColorLut, cache:WgpuColorLutTextureCache):flighthq._internal.dom.GPUTexture {
    ...
    if ((cast ((cast _Runtime.strictEquals(cache.texture, null) : Bool) || (cast !_Runtime.strictEquals(cache.size, n) : Bool)) : Bool)) {
      ({ final __hostTypeCall18 = cache.texture; __hostTypeCall18 == null ? _Runtime.UNDEFINED : (cast __hostTypeCall18 : flighthq._internal.dom.GPUTexture).destroy(); });
