...
class WgpuColorLutPass {
  ...
  public static function applyColorLutPassToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, lut:ColorLut, cache:WgpuColorLutTextureCache):Void {
    ...
    pipeline = (cast WgpuColorLutPass.getLutPipeline__wgpuColorLutPass(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast (cast (cast dest : WgpuRenderTarget) : WgpuRenderTarget).format : String)) : WgpuEffectPipeline);
