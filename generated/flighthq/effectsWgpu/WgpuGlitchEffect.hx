...
class WgpuGlitchEffect {
  ...
  public static function applyGlitchEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, effect:GlitchEffect):Void {
    ...
    pipeline = (cast getWgpuEffectPipeline(({ final __callArgument4:Dynamic = state; __callArgument4; }), (cast 'stylization.glitch' : String), (cast WgpuGlitchEffect.GLITCH_FRAGMENT_WGSL__wgpuGlitchEffect : String), (cast 'replace' : String)) : WgpuEffectPipeline);
  ...
  public static function registerWgpuGlitchEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument14:Dynamic = state; __callArgument14; }), (cast 'GlitchEffect' : String), ({ final __callArgument15:Dynamic = defaultWgpuGlitchEffectRunner; __callArgument15; }));
  }
