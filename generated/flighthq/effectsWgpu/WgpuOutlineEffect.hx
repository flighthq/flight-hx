...
class WgpuOutlineEffect {
  ...
  public static function registerWgpuOutlineEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'OutlineEffect' : String), ({ final __callArgument6:Dynamic = defaultWgpuOutlineEffectRunner; __callArgument6; }));
  }
