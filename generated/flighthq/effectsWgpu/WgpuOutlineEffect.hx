...
class WgpuOutlineEffect {
  ...
  public static function applyOutlineEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, effect:OutlineEffect):Void {
    ...
    pipeline = (cast getWgpuEffectPipeline((cast state), (cast 'stylization.outline' : String), (cast WgpuOutlineEffect.OUTLINE_FRAGMENT_WGSL__wgpuOutlineEffect : String), (cast 'replace' : String)) : WgpuEffectPipeline);
  ...
  public static final defaultWgpuOutlineEffectRunner:WgpuRenderEffectRunner = (cast function(ctx:WgpuRenderEffectContext, effect:RenderEffect):Void {
    applyOutlineEffectToWgpu((cast _Runtime.field(ctx, 'state')), (cast _Runtime.field(ctx, 'source')), (cast _Runtime.field(ctx, 'dest')), (cast (cast effect : OutlineEffect)));
  });

  public static function registerWgpuOutlineEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect((cast state), (cast 'OutlineEffect' : String), (cast defaultWgpuOutlineEffectRunner));
  }
