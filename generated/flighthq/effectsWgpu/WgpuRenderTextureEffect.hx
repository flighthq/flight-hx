...
class WgpuRenderTextureEffect {
  public static function applyWgpuRenderEffectsToRenderTexture(state:WgpuRenderState, pool:WgpuRenderTexturePool, source:RenderTexture, dest:RenderTexture, scratch:RenderTexture, effects:Array<RenderEffect>):Bool {
    ...
    operations = (cast _Runtime.flatMapArray((cast effects : Array<RenderEffect>), function(effect:RenderEffect, __unused0:Float, __unused1:Array<RenderEffect>):flighthq._internal._Union2<{ var effect:RenderEffect; var runner:WgpuRenderEffectRunner; }, Array<{ var effect:RenderEffect; var runner:WgpuRenderEffectRunner; }>> {
      ...
      runner = (cast getWgpuRenderEffectRunner(({ final __callArgument4:Dynamic = state; __callArgument4; }), (cast _Runtime.field(effect, 'kind') : String)) : Null<WgpuRenderEffectRunner>);
    ...
    WgpuRenderTextureEffect.reportWgpuRenderEffectApplication__wgpuRenderTextureEffect(({ final __callArgument6:Dynamic = state; __callArgument6; }), ({ final __callArgument15:Dynamic = { registeredCount: _Runtime.field(operations, 'length'), requestedCount: _Runtime.field(effects, 'length'), status: (cast WgpuRenderTextureEffect.getWgpuRenderEffectApplicationStatus__wgpuRenderTextureEffect((cast _Runtime.field(effects, 'length') : Float), (cast _Runtime.field(operations, 'length') : Float), (cast !_Runtime.strictEquals(sourceTarget, null) : Bool), (cast !_Runtime.strictEquals((cast getWgpuRenderTextureTarget(({ final __callArgument7:Dynamic = state; __callArgument7; }), ({ final __callArgument8:Dynamic = dest; __callArgument8; })) : Null<WgpuRenderTarget>), null) : Bool)) : WgpuRenderEffectApplicationStatus), unregisteredKinds: unregisteredKinds }; __callArgument15; }));
    ...
    current = sourceTarget;
    {
      ...
      while ((cast ((cast index : Float) < (cast _Runtime.field(operations, 'length') : Float)) : Bool)) {
        ...
        writeWgpuRenderTextureTarget(({ final __callArgument26:Dynamic = state; __callArgument26; }), ({ final __callArgument27:Dynamic = output; __callArgument27; }), (cast function(target:WgpuRenderTarget):Void {
          (cast operation : { var effect:RenderEffect; var runner:WgpuRenderEffectRunner; }).runner(({ final __callArgument28:Dynamic = { state: state, source: current, dest: target, pool: pool.effectTargets, sceneDepthTexture: null, sceneVelocityTexture: null }; __callArgument28; }), (cast operation : { var effect:RenderEffect; var runner:WgpuRenderEffectRunner; }).effect);
        } : Dynamic));
        (current = cast ((cast getWgpuRenderTextureTarget(({ final __callArgument32:Dynamic = state; __callArgument32; }), ({ final __callArgument33:Dynamic = output; __callArgument33; })) : Null<WgpuRenderTarget>) : Dynamic));
        index++;
      }
    }
    return cast true;
  ...
  private static function explainWgpuRenderEffectApplication(state:WgpuRenderState, source:RenderTexture, dest:RenderTexture, effects:Array<RenderEffect>):WgpuRenderEffectApplicationExplanation {
    ...
    return cast { registeredCount: registeredCount, requestedCount: _Runtime.field(effects, 'length'), status: (cast WgpuRenderTextureEffect.getWgpuRenderEffectApplicationStatus__wgpuRenderTextureEffect((cast _Runtime.field(effects, 'length') : Float), (cast registeredCount : Float), (cast !_Runtime.strictEquals((cast getWgpuRenderTextureTarget(({ final __callArgument40:Dynamic = state; __callArgument40; }), ({ final __callArgument41:Dynamic = source; __callArgument41; })) : Null<WgpuRenderTarget>), null) : Bool), (cast !_Runtime.strictEquals((cast getWgpuRenderTextureTarget(({ final __callArgument44:Dynamic = state; __callArgument44; }), ({ final __callArgument45:Dynamic = dest; __callArgument45; })) : Null<WgpuRenderTarget>), null) : Bool)) : WgpuRenderEffectApplicationStatus), unregisteredKinds: unregisteredKinds };
    return cast null;
  }
