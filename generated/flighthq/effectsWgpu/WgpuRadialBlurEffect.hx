...
@:expose("flighthq.effectsWgpu.WgpuRadialBlurEffect")
class WgpuRadialBlurEffect {
  ...
  public static final defaultWgpuRadialBlurEffectRunner:WgpuRenderEffectRunner = function(ctx:Dynamic, effect:Dynamic) {
    _Runtime.callValue(applyRadialBlurEffectToWgpu, cast ([_Runtime.field(ctx, 'state'), _Runtime.field(ctx, 'source'), _Runtime.field(ctx, 'dest'), (cast effect : Dynamic)] : Array<Dynamic>));
  };
