...
class WgpuRadialBlurEffect {
  ...
  public static function applyRadialBlurEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, effect:RadialBlurEffect):Void {
    ...
    pipeline = (cast getWgpuEffectPipeline((cast state), (cast 'motion.radialBlur' : String), (cast WgpuRadialBlurEffect.RADIAL_BLUR_FRAGMENT_WGSL__wgpuRadialBlurEffect : String), (cast 'replace' : String)) : WgpuEffectPipeline);
  ...
  public static final defaultWgpuRadialBlurEffectRunner:WgpuRenderEffectRunner = (cast function(ctx:WgpuRenderEffectContext, effect:RenderEffect):Void {
    applyRadialBlurEffectToWgpu((cast _Runtime.field(ctx, 'state')), (cast _Runtime.field(ctx, 'source')), (cast _Runtime.field(ctx, 'dest')), (cast (cast effect : RadialBlurEffect)));
  });

  public static function registerWgpuRadialBlurEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect((cast state), (cast 'RadialBlurEffect' : String), (cast defaultWgpuRadialBlurEffectRunner));
  }
