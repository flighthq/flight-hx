...
class WgpuKuwaharaEffect {
  ...
  private static function applyKuwaharaEffectToWgpu(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, effect:KuwaharaEffect):Void {
    ...
    pipeline = (cast getWgpuEffectPipeline(({ final __callArgument4:Dynamic = state; __callArgument4; }), (cast 'stylization.kuwahara' : String), (cast WgpuKuwaharaEffect.KUWAHARA_FRAGMENT_WGSL__wgpuKuwaharaEffect : String), (cast 'replace' : String)) : WgpuEffectPipeline);
  ...
  public static function registerWgpuKuwaharaEffect(state:WgpuRenderState):Void {
    registerWgpuRenderEffect(({ final __callArgument14:Dynamic = state; __callArgument14; }), (cast 'KuwaharaEffect' : String), ({ final __callArgument15:Dynamic = defaultWgpuKuwaharaEffectRunner; __callArgument15; }));
  }
