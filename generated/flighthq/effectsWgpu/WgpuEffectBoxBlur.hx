...
class WgpuEffectBoxBlur {
  ...
  private static function applyWgpuEffectBoxBlur(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, temp:WgpuRenderTarget, options:{ @:optional var blurX:Float; @:optional var blurY:Float; @:optional var passes:Float; @:optional var edgeColor:Array<Float>; }):Void {
    ...
    write = temp;
    {
      ...
      while ((cast ((cast pass : Float) < (cast passes : Float)) : Bool)) {
        ...
        if ((cast ((cast radiusY : Float) > (cast 0.0 : Float)) : Bool)) {
          WgpuEffectBoxBlur.applyBoxBlurPass__wgpuEffectBoxBlur(({ final __callArgument6:Dynamic = state; __callArgument6; }), ({ final __callArgument7:Dynamic = read; __callArgument7; }), ({ final __callArgument8:Dynamic = write; __callArgument8; }), (cast radiusY : Float), (cast 0.0 : Float), (cast 1.0 : Float), (cast edgeColor : Dynamic));
          (read = cast (write : Dynamic));
          (write = cast (((cast _Runtime.strictEquals(write, temp) : Bool) ? (cast dest : Dynamic) : (cast temp : Dynamic)) : Dynamic));
        }
        pass++;
    ...
    if ((cast !_Runtime.strictEquals(read, dest) : Bool)) {
      WgpuEffectBoxBlur.applyBoxBlurPass__wgpuEffectBoxBlur(({ final __callArgument12:Dynamic = state; __callArgument12; }), ({ final __callArgument13:Dynamic = read; __callArgument13; }), ({ final __callArgument14:Dynamic = dest; __callArgument14; }), (cast 0.0 : Float), (cast 0.0 : Float), (cast 0.0 : Float), (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic));
    }
  }
  ...
  public static function applyBoxBlurPass__wgpuEffectBoxBlur(state:WgpuRenderState, source:WgpuRenderTarget, dest:WgpuRenderTarget, radius:Float, dirX:Float, dirY:Float, edgeColor:Null<BoxBlurEdgeColor__wgpuEffectBoxBlur>):Void {
    ...
    pipeline = (cast WgpuEffectBoxBlur.getBoxBlurPipeline__wgpuEffectBoxBlur(({ final __callArgument18:Dynamic = state; __callArgument18; })) : WgpuEffectPipeline);
    drawWgpuEffectPass(({ final __callArgument20:Dynamic = state; __callArgument20; }), ({ final __callArgument21:Dynamic = source; __callArgument21; }), ({ final __callArgument22:Dynamic = dest; __callArgument22; }), ({ final __callArgument23:Dynamic = pipeline; __callArgument23; }), ({ final __callArgument24:Dynamic = function(__unused1:flighthq._internal._Float32Array, __unused2:flighthq._internal._Int32Array):Void { _Runtime.callValue(function(f32:flighthq._internal._Float32Array, __unused0:flighthq._internal._Int32Array):Void {
    ...
    }, cast ([__unused1] : Array<Dynamic>)); }; __callArgument24; }));
  }
  ...
  public static function getBoxBlurPipeline__wgpuEffectBoxBlur(state:WgpuRenderState):WgpuEffectPipeline {
    ...
    if ((cast _Runtime.strictEquals(p, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) {
      (p = cast ((cast createWgpuEffectPipeline(({ final __callArgument30:Dynamic = state; __callArgument30; }), (cast WgpuEffectBoxBlur.BOX_BLUR_WGSL__wgpuEffectBoxBlur : String), ({ final __callArgument31:Dynamic = 'replace'; __callArgument31; })) : WgpuEffectPipeline) : Dynamic));
