...
class Camera {
  ...
  public static function getCamera3DInverseViewProjectionMatrix4(out:Matrix4Like, camera:Camera3D, aspect:Float):Bool {
    getCamera3DViewProjectionMatrix4(({ final __callArgument24:Dynamic = Camera.__scratchViewProjection__camera; __callArgument24; }), ({ final __callArgument25:Dynamic = camera; __callArgument25; }), (cast aspect : Float));
    return cast (cast inverseMatrix4(({ final __callArgument28:Dynamic = out; __callArgument28; }), ({ final __callArgument29:Dynamic = Camera.__scratchViewProjection__camera; __callArgument29; })) : Bool);
    return cast null;
  }
  ...
  public static function getCamera3DViewProjectionMatrix4(out:Matrix4Like, camera:Camera3D, aspect:Float):Void {
    setProjectionMatrix4(({ final __callArgument32:Dynamic = Camera.__scratchProjection__camera; __callArgument32; }), camera.projection, (cast aspect : Float), (cast camera.near : Float), (cast camera.far : Float));
    Camera.applyCamera3DProjectionJitter__camera(({ final __callArgument34:Dynamic = Camera.__scratchProjection__camera; __callArgument34; }), (cast (cast camera.jitter : { var x:Float; }).x : Float), (cast (cast camera.jitter : { var y:Float; }).y : Float));
    multiplyMatrix4(({ final __callArgument36:Dynamic = out; __callArgument36; }), ({ final __callArgument37:Dynamic = Camera.__scratchProjection__camera; __callArgument37; }), ({ final __callArgument38:Dynamic = camera.view; __callArgument38; }));
  }
  ...
  public static function setCamera3DViewMatrix4FromLookAt(camera:Camera3D, eye:Vector3Like, target:Vector3Like, up:Vector3Like):Void {
    setMatrix4LookAt(({ final __callArgument42:Dynamic = camera.view; __callArgument42; }), ({ final __callArgument43:Dynamic = eye; __callArgument43; }), ({ final __callArgument44:Dynamic = target; __callArgument44; }), ({ final __callArgument45:Dynamic = up; __callArgument45; }));
  }
  ...
  public static function updateCamera3DInverseViewProjection(camera:Camera3D, aspect:Float):Bool {
    ...
    ok = (cast getCamera3DInverseViewProjectionMatrix4(({ final __callArgument50:Dynamic = Camera.__scratchInverse__camera; __callArgument50; }), ({ final __callArgument51:Dynamic = camera; __callArgument51; }), (cast aspect : Float)) : Bool);
