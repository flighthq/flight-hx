...
class FrustumCorners {
  public static function getCamera3DFrustumCorners(out:Array<Vector3Like>, camera:Camera3D, aspect:Float):Bool {
    ...
    if ((cast !(cast (cast inverseMatrix4(({ final __callArgument4:Dynamic = FrustumCorners.__scratchInverseVP__frustumCorners; __callArgument4; }), ({ final __callArgument5:Dynamic = FrustumCorners.__scratchViewProjection__frustumCorners; __callArgument5; })) : Bool) : Bool) : Bool)) {
      return cast false;
    }
