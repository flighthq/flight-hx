    ...
    tintA = ((cast hasTint : Bool) ? (cast ((_Runtime.toInt32(tint) & 255) / 255.0) : Dynamic) : (cast 1.0 : Dynamic));
    {
      ...
      while ((cast ((cast sIdx : Float) < (cast toSpawn : Float)) : Bool)) {
        ...
        if ((cast hasColorCurve : Bool)) {
          ...
          var r0:Dynamic = _Runtime.callValue(EmitParticleBurst2D.clamp01__emitParticleBurst2D, cast ([(colorStartR + (((_Runtime.callValue(random, cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * config.colorStartVarianceR))] : Array<Dynamic>));
          var g0:Dynamic = _Runtime.callValue(EmitParticleBurst2D.clamp01__emitParticleBurst2D, cast ([(colorStartG + (((_Runtime.callValue(random, cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * config.colorStartVarianceG))] : Array<Dynamic>));
          var b0:Dynamic = _Runtime.callValue(EmitParticleBurst2D.clamp01__emitParticleBurst2D, cast ([(colorStartB + (((_Runtime.callValue(random, cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * config.colorStartVarianceB))] : Array<Dynamic>));
          var r1:Dynamic = _Runtime.callValue(EmitParticleBurst2D.clamp01__emitParticleBurst2D, cast ([(colorEndR + (((_Runtime.callValue(random, cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * config.colorEndVarianceR))] : Array<Dynamic>));
          var g1:Dynamic = _Runtime.callValue(EmitParticleBurst2D.clamp01__emitParticleBurst2D, cast ([(colorEndG + (((_Runtime.callValue(random, cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * config.colorEndVarianceG))] : Array<Dynamic>));
          var b1:Dynamic = _Runtime.callValue(EmitParticleBurst2D.clamp01__emitParticleBurst2D, cast ([(colorEndB + (((_Runtime.callValue(random, cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * config.colorEndVarianceB))] : Array<Dynamic>));
