...
class UpdateParticleEmitter2D {
  ...
  public static final TWO_PI__updateParticleEmitter2D:Dynamic = (HxMath.PI * 2.0);
  ...
  public static function updateParticleEmitter2D(emitter:ParticleEmitter2D, state:ParticleEmitterState, config:ParticleEmitterConfig, deltaTime:Float, ?callbacks:ParticleEmitterCallbacks):Void {
    ...
    while (_Runtime.truthy(_Runtime.compare(i, liveCount, '<'))) {
      ...
      if (_Runtime.truthy(_Runtime.compare(_Runtime.getIndex(lifetimes, lt), _Runtime.getIndex(lifetimes, (lt + 1.0)), '>='))) {
        ...
        if (_Runtime.truthy(_Runtime.compare(i, liveCount, '<'))) {
          ...
          var tt:Dynamic = (i * UpdateParticleEmitter2D.PARTICLE_TRANSFORM_STRIDE__updateParticleEmitter2D);
          var tt2:Dynamic = (liveCount * UpdateParticleEmitter2D.PARTICLE_TRANSFORM_STRIDE__updateParticleEmitter2D);
      ...
      var dirNz:Dynamic = _Runtime.select(_Runtime.compare(dirLen, 0.000001, '>'), function():Dynamic return cast (_Runtime.field(config, 'directionZ') / dirLen), function():Dynamic return cast 0.0);
      {
        ...
        while (_Runtime.truthy(_Runtime.compare(sIdx, toSpawn, '<'))) {
          ...
          if (_Runtime.truthy(hasColorCurve)) {
            ...
            var r0:Dynamic = _Runtime.callValue(UpdateParticleEmitter2D.clamp01__updateParticleEmitter2D, cast ([(colorStartR + (((_Runtime.callProperty(state, 'random', cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * _Runtime.field(config, 'colorStartVarianceR')))] : Array<Dynamic>));
            var g0:Dynamic = _Runtime.callValue(UpdateParticleEmitter2D.clamp01__updateParticleEmitter2D, cast ([(colorStartG + (((_Runtime.callProperty(state, 'random', cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * _Runtime.field(config, 'colorStartVarianceG')))] : Array<Dynamic>));
            var b0:Dynamic = _Runtime.callValue(UpdateParticleEmitter2D.clamp01__updateParticleEmitter2D, cast ([(colorStartB + (((_Runtime.callProperty(state, 'random', cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * _Runtime.field(config, 'colorStartVarianceB')))] : Array<Dynamic>));
            var r1:Dynamic = _Runtime.callValue(UpdateParticleEmitter2D.clamp01__updateParticleEmitter2D, cast ([(colorEndR + (((_Runtime.callProperty(state, 'random', cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * _Runtime.field(config, 'colorEndVarianceR')))] : Array<Dynamic>));
            var g1:Dynamic = _Runtime.callValue(UpdateParticleEmitter2D.clamp01__updateParticleEmitter2D, cast ([(colorEndG + (((_Runtime.callProperty(state, 'random', cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * _Runtime.field(config, 'colorEndVarianceG')))] : Array<Dynamic>));
            var b1:Dynamic = _Runtime.callValue(UpdateParticleEmitter2D.clamp01__updateParticleEmitter2D, cast ([(colorEndB + (((_Runtime.callProperty(state, 'random', cast ([] : Array<Dynamic>)) - 0.5) * 2.0) * _Runtime.field(config, 'colorEndVarianceB')))] : Array<Dynamic>));
    ...
    if (_Runtime.truthy(_Runtime.andValue(!_Runtime.strictEquals(signals, null), function():Dynamic return cast _Runtime.callValue(isParticleEmitter2DComplete, cast ([emitter, state, config] : Array<Dynamic>))))) {
  ...
  public static function rotateToDirection__updateParticleEmitter2D(lx:Float, ly:Float, lz:Float, dx:Float, dy:Float, dz:Float):Array<Float> {
    ...
    if (_Runtime.truthy(_Runtime.compare(sinAngle, 0.000001, '<'))) {
      if (_Runtime.truthy(_Runtime.compare(cosAngle, 0.0, '>'))) {
        _Runtime.setIndex(UpdateParticleEmitter2D._rot__updateParticleEmitter2D, 0.0, lx);
        _Runtime.setIndex(UpdateParticleEmitter2D._rot__updateParticleEmitter2D, 1.0, ly);
        _Runtime.setIndex(UpdateParticleEmitter2D._rot__updateParticleEmitter2D, 2.0, lz);
      } else {
        _Runtime.setIndex(UpdateParticleEmitter2D._rot__updateParticleEmitter2D, 0.0, lx);
        _Runtime.setIndex(UpdateParticleEmitter2D._rot__updateParticleEmitter2D, 1.0, -ly);
        _Runtime.setIndex(UpdateParticleEmitter2D._rot__updateParticleEmitter2D, 2.0, -lz);
    ...
    crossY = (-ax * lz);
    crossZ = ((ax * ly) - (ay * lx));
    _Runtime.setIndex(UpdateParticleEmitter2D._rot__updateParticleEmitter2D, 0.0, (((lx * cosAngle) + (crossX * sinAngle)) + ((ax * kdotv) * (1.0 - cosAngle))));
    _Runtime.setIndex(UpdateParticleEmitter2D._rot__updateParticleEmitter2D, 1.0, (((ly * cosAngle) + (crossY * sinAngle)) + ((ay * kdotv) * (1.0 - cosAngle))));
    _Runtime.setIndex(UpdateParticleEmitter2D._rot__updateParticleEmitter2D, 2.0, (((lz * cosAngle) + (crossZ * sinAngle)) + 0.0));
    return cast UpdateParticleEmitter2D._rot__updateParticleEmitter2D;
    return cast null;
  }
}
