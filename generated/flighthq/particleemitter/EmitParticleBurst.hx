  ...
  public static function emitParticleBurst(emitter:ParticleEmitter, state:ParticleEmitterState, config:ParticleEmitterConfig, count:Float, x:Float, y:Float, ?tint:Float):Float {
    ...
    tintA = ((cast hasTint : Bool) ? (cast ((_Runtime.toInt32(tint) & 255) / 255.0) : Dynamic) : (cast 1.0 : Dynamic));
    {
      ...
      while ((cast ((cast sIdx : Float) < (cast toSpawn : Float)) : Bool)) {
        ...
        flighthq._internal._StaticIndex.writeFloat32Array(_Runtime.field(state, 'velocities'), vt, (HxMath.cos(angle) * speed));
        flighthq._internal._StaticIndex.writeFloat32Array(_Runtime.field(state, 'velocities'), (vt + 1.0), (HxMath.sin(angle) * speed));
        flighthq._internal._StaticIndex.writeFloat32Array(_Runtime.field(state, 'velocities'), (vt + 2.0), 0.0);
        ...
        flighthq._internal._StaticIndex.writeFloat32Array(_Runtime.field(data, 'transforms'), (tt + 2.0), angle);
        ...
        flighthq._internal._StaticIndex.writeFloat32Array(_Runtime.field(data, 'positionsZ'), idx, 0.0);
