...
class Spring {
  ...
  public static function resetSpring(spring:flighthq.types.Spring, value:Float, velocity:Float = 0.0):Void {
    ((cast spring : flighthq.types.Spring).value = value);
    ((cast spring : flighthq.types.Spring).velocity = velocity);
  }
  ...
  public static function updateSpring(spring:flighthq.types.Spring, target:Float, config:SpringConfig, deltaTime:Float):Void {
    ...
    value = (cast spring : flighthq.types.Spring).value;
    velocity = (cast spring : flighthq.types.Spring).velocity;
    ...
    ((cast spring : flighthq.types.Spring).value = ((target + (posPosCoef * c0)) + (posVelCoef * velocity)));
    ((cast spring : flighthq.types.Spring).velocity = ((velPosCoef * c0) + (velVelCoef * velocity)));
  }
