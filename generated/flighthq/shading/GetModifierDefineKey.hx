...
class GetModifierDefineKey {
  ...
  public static function getDefineSignature__getModifierDefineKey(modifier:Modifier, ?registry:ModifierRegistry):String {
    ...
    definition = (cast resolveModifier(({ final __callArgument5:Dynamic = registry; __callArgument5; }), (cast _Runtime.field(modifier, 'kind') : String)) : Null<ModifierDefinition>);
