...
class Shading {
  ...
  public static function createModifierRegistry():ModifierRegistry {
    return cast Facade_Shading_flighthq_shading_ModifierRegistry.createModifierRegistry();
    return cast null;
  }
  ...
  public static function registerModifier(registry:ModifierRegistry, definition:ModifierDefinition):Void {
    Facade_Shading_flighthq_shading_ModifierRegistry.registerModifier(registry, definition);
  }

  public static function resolveModifier(registry:ModifierRegistry, kind:ModifierKind):Null<ModifierDefinition> {
    return cast Facade_Shading_flighthq_shading_ModifierRegistry.resolveModifier(registry, kind);
    return cast null;
  }
