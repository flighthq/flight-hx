...
class LiftGammaGainAdjustment {
  public static function createLiftGammaGainAdjustment(?options:Dynamic):LiftGammaGainAdjustment {
    ...
    transform = function(out:Dynamic, r:Dynamic, g:Dynamic, b:Dynamic) {
      _Runtime.setIndex(out, 0.0, _Runtime.callValue(LiftGammaGainAdjustment.clamp01__liftGammaGainAdjustment, cast ([_Runtime.callProperty(HxMath, 'pow', cast ([_Runtime.callProperty(HxMath, 'max', cast ([((r * _Runtime.getIndex(gain, 0.0)) + (_Runtime.getIndex(lift, 0.0) * (1.0 - r))), 0.0] : Array<Dynamic>)), _Runtime.getIndex(gammaExp, 0.0)] : Array<Dynamic>))] : Array<Dynamic>)));
      _Runtime.setIndex(out, 1.0, _Runtime.callValue(LiftGammaGainAdjustment.clamp01__liftGammaGainAdjustment, cast ([_Runtime.callProperty(HxMath, 'pow', cast ([_Runtime.callProperty(HxMath, 'max', cast ([((g * _Runtime.getIndex(gain, 1.0)) + (_Runtime.getIndex(lift, 1.0) * (1.0 - g))), 0.0] : Array<Dynamic>)), _Runtime.getIndex(gammaExp, 1.0)] : Array<Dynamic>))] : Array<Dynamic>)));
      _Runtime.setIndex(out, 2.0, _Runtime.callValue(LiftGammaGainAdjustment.clamp01__liftGammaGainAdjustment, cast ([_Runtime.callProperty(HxMath, 'pow', cast ([_Runtime.callProperty(HxMath, 'max', cast ([((b * _Runtime.getIndex(gain, 2.0)) + (_Runtime.getIndex(lift, 2.0) * (1.0 - b))), 0.0] : Array<Dynamic>)), _Runtime.getIndex(gammaExp, 2.0)] : Array<Dynamic>))] : Array<Dynamic>)));
    };
