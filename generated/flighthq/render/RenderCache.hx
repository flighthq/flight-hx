...
class RenderCache {
  ...
  public static function isRenderCache(source:Dynamic):Bool {
    return cast _Runtime.andValue(_Runtime.andValue(_Runtime.strictEquals(_Runtime.typeofValue(source), 'object'), function():Dynamic return cast !_Runtime.strictEquals(source, null)), function():Dynamic return cast _Runtime.strictEquals(_Runtime.field((cast source : RenderCache), 'kind'), RenderCacheKind));
    return cast null;
  }
