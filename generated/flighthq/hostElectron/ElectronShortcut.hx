...
class ElectronShortcut {
  public static function createElectronShortcutBackend(electron:ElectronApi):ShortcutBackend {
    ...
    return cast { getRegistered: function():Array<String> {
      ...
      ok = (cast globalShortcut : ElectronGlobalShortcut).register((cast accelerator : String), ({ final __callArgument2:Dynamic = function():Void { listener(({ final __callArgument0:Dynamic = { accelerator: accelerator }; __callArgument0; })); }; __callArgument2; }));
