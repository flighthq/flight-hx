...
class ElectronApp {
  public static function createElectronAppBackend(electron:ElectronApi):AppBackend {
    ...
    return cast { addRecentDocument: function(path:Dynamic) {
      ...
      handler = function(args:Array<Dynamic>) return _Runtime.callValue(listener, cast ([Std.string(_Runtime.coalesce(flighthq._internal._StaticIndex.readArray(args, 1.0), function():Dynamic return cast ''))] : Array<Dynamic>));
      ...
      handler = function(args:Array<Dynamic>) {
        ...
        event = (cast flighthq._internal._StaticIndex.readArray(args, 0.0) : Null<{ @:optional var preventDefault:Dynamic; }>);
      ...
      var handler:Dynamic = cast _Runtime.UNDEFINED;
      handler = function(args:Array<Dynamic>) return _Runtime.callValue(listener, cast ([_Runtime.coalesce((cast flighthq._internal._StaticIndex.readArray(args, 1.0) : Array<String>), function():Dynamic return cast cast ([] : Array<Dynamic>))] : Array<Dynamic>));
