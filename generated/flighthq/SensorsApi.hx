...
class SensorsApi {
  ...
  _Runtime.callValue(emitSignal, cast ([_Runtime.field(sensors, 'onQuaternion'), reading] : Array<Dynamic>));
    ...
    _Runtime.callProperty(SensorsApi._subscriptions__sensors, 'set', cast ([sensors, function() {
  ...
  public static function computeEulerFromQuaternion(out:OrientationReading, quaternion:QuaternionReading):Void {
    ...
    sinBeta = (2.0 * ((w * x) - (y * z)));
    beta = _Runtime.select(_Runtime.compare(_Runtime.callProperty(HxMath, 'abs', cast ([sinBeta] : Array<Dynamic>)), 1.0, '>='), function():Dynamic return cast ((_Runtime.sign(sinBeta) * HxMath.PI) / 2.0), function():Dynamic return cast _Runtime.callProperty(HxMath, 'asin', cast ([sinBeta] : Array<Dynamic>)));
    alpha = _Runtime.callProperty(HxMath, 'atan2', cast ([(2.0 * ((w * z) + (x * y))), (1.0 - (2.0 * ((x * x) + (z * z))))] : Array<Dynamic>));
    gamma = _Runtime.callProperty(HxMath, 'atan2', cast ([(2.0 * ((w * y) + (x * z))), (1.0 - (2.0 * ((x * x) + (y * y))))] : Array<Dynamic>));
  ...
  public static function computeGravityFromOrientation(out:MotionReading, orientation:OrientationReading):Void {
    ...
    G = 9.80665;
    sinG = _Runtime.callProperty(HxMath, 'sin', cast ([g] : Array<Dynamic>));
    cosG = _Runtime.callProperty(HxMath, 'cos', cast ([g] : Array<Dynamic>));
    sinB = _Runtime.callProperty(HxMath, 'sin', cast ([b] : Array<Dynamic>));
    cosB = _Runtime.callProperty(HxMath, 'cos', cast ([b] : Array<Dynamic>));
  ...
  public static function computeQuaternionFromOrientationReading(out:QuaternionReading, orientation:OrientationReading):Void {
    ...
    ca = _Runtime.callProperty(HxMath, 'cos', cast ([a] : Array<Dynamic>));
    sa = _Runtime.callProperty(HxMath, 'sin', cast ([a] : Array<Dynamic>));
    cb = _Runtime.callProperty(HxMath, 'cos', cast ([b] : Array<Dynamic>));
    sb = _Runtime.callProperty(HxMath, 'sin', cast ([b] : Array<Dynamic>));
    cg = _Runtime.callProperty(HxMath, 'cos', cast ([g] : Array<Dynamic>));
    sg = _Runtime.callProperty(HxMath, 'sin', cast ([g] : Array<Dynamic>));
  ...
  return cast _Runtime.callValue(SensorsApi.getWebSensorsPermissionState__sensors, cast ([sensor] : Array<Dynamic>));
}, isAmbientLightSupported: function() {
  return cast !_Runtime.strictEquals(_Runtime.callValue(SensorsApi.getWebGenericSensorConstructor__sensors, cast (['AmbientLightSensor'] : Array<Dynamic>)), null);
}, isBarometerSupported: function() {
  return cast false;
}, isGravitySupported: function() {
  if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.callProperty(_Runtime, 'typeofGlobal', cast (['window'] : Array<Dynamic>)), 'undefined'))) { return cast false; }
  return cast !_Runtime.strictEquals(_Runtime.callProperty(_Runtime, 'typeofGlobal', cast (['DeviceMotionEvent'] : Array<Dynamic>)), 'undefined');
  ...
  return cast !_Runtime.strictEquals(_Runtime.callValue(SensorsApi.getWebMagnetometerConstructor__sensors, cast ([] : Array<Dynamic>)), null);
}, isMotionSupported: function() {
  if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.callProperty(_Runtime, 'typeofGlobal', cast (['window'] : Array<Dynamic>)), 'undefined'))) { return cast false; }
  return cast !_Runtime.strictEquals(_Runtime.callProperty(_Runtime, 'typeofGlobal', cast (['DeviceMotionEvent'] : Array<Dynamic>)), 'undefined');
}, isOrientationSupported: function() {
  if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.callProperty(_Runtime, 'typeofGlobal', cast (['window'] : Array<Dynamic>)), 'undefined'))) { return cast false; }
  return cast !_Runtime.strictEquals(_Runtime.typeofValue(SensorsApi.DeviceOrientationEvent__sensors), 'undefined');
  ...
  request = _Runtime.callValue(SensorsApi.getWebMotionPermissionRequest__sensors, cast ([] : Array<Dynamic>));
  ...
  ctor = _Runtime.callValue(SensorsApi.getWebGenericSensorConstructor__sensors, cast (['AbsoluteOrientationSensor'] : Array<Dynamic>));
  if (_Runtime.truthy(!_Runtime.strictEquals(ctor, null))) {
  try {
  var sensorOptions:Dynamic = _Runtime.select(!_Runtime.strictEquals(_Runtime.optionalField(options, 'frequency'), _Runtime.UNDEFINED), function():Dynamic return cast { frequency: _Runtime.field(options, 'frequency') }, function():Dynamic return cast _Runtime.UNDEFINED);
  ...
  _Runtime.setField(SensorsApi._quaternionReading__sensors, 'x', _Runtime.coalesce(_Runtime.getIndex(q, 0.0), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._quaternionReading__sensors, 'y', _Runtime.coalesce(_Runtime.getIndex(q, 1.0), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._quaternionReading__sensors, 'z', _Runtime.coalesce(_Runtime.getIndex(q, 2.0), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._quaternionReading__sensors, 'w', _Runtime.coalesce(_Runtime.getIndex(q, 3.0), function():Dynamic return cast 1.0));
  _Runtime.callValue(computeEulerFromQuaternion, cast ([SensorsApi._absoluteOrientation__sensors, SensorsApi._quaternionReading__sensors] : Array<Dynamic>));
}
  _Runtime.setField(SensorsApi._absoluteOrientation__sensors, 'absolute', true);
  _Runtime.setField(SensorsApi._absoluteOrientation__sensors, 'heading', -1.0);
  _Runtime.callValue(listener, cast ([SensorsApi._absoluteOrientation__sensors] : Array<Dynamic>));
};
  ...
  _Runtime.setField(SensorsApi._absoluteOrientation__sensors, 'alpha', _Runtime.coalesce(_Runtime.field(event, 'alpha'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._absoluteOrientation__sensors, 'beta', _Runtime.coalesce(_Runtime.field(event, 'beta'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._absoluteOrientation__sensors, 'gamma', _Runtime.coalesce(_Runtime.field(event, 'gamma'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._absoluteOrientation__sensors, 'absolute', true);
  _Runtime.setField(SensorsApi._absoluteOrientation__sensors, 'heading', -1.0);
  _Runtime.setField(SensorsApi._absoluteOrientation__sensors, 'interval', -1.0);
  _Runtime.setField(SensorsApi._absoluteOrientation__sensors, 'timestamp', -1.0);
  _Runtime.callValue(listener, cast ([SensorsApi._absoluteOrientation__sensors] : Array<Dynamic>));
};
  _Runtime.callProperty(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'addEventListener', cast (['deviceorientationabsolute', (cast handler : Dynamic)] : Array<Dynamic>));
  return cast function() {
  _Runtime.callProperty(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'removeEventListener', cast (['deviceorientationabsolute', (cast handler : Dynamic)] : Array<Dynamic>));
};
}, subscribeAmbientLight: function(listener:Dynamic, ?options:SensorSubscribeOptions) {
  var ctor:Dynamic = cast _Runtime.UNDEFINED;
  ctor = _Runtime.callValue(SensorsApi.getWebGenericSensorConstructor__sensors, cast (['AmbientLightSensor'] : Array<Dynamic>));
  ...
  var handler:Dynamic = function() {
  _Runtime.setField(SensorsApi._ambientLight__sensors, 'illuminance', _Runtime.coalesce(_Runtime.field(sensor, 'illuminance'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._ambientLight__sensors, 'interval', -1.0);
  _Runtime.setField(SensorsApi._ambientLight__sensors, 'timestamp', -1.0);
  _Runtime.callValue(listener, cast ([SensorsApi._ambientLight__sensors] : Array<Dynamic>));
};
  _Runtime.callProperty(sensor, 'addEventListener', cast (['reading', handler] : Array<Dynamic>));
  _Runtime.callProperty(sensor, 'start', cast ([] : Array<Dynamic>));
  return cast function() {
  ...
  _Runtime.setField(SensorsApi._gravity__sensors, 'x', (_Runtime.coalesce(_Runtime.field(withGravity, 'x'), function():Dynamic return cast 0.0) - _Runtime.coalesce(_Runtime.optionalField(linearAccel, 'x'), function():Dynamic return cast 0.0)));
  _Runtime.setField(SensorsApi._gravity__sensors, 'y', (_Runtime.coalesce(_Runtime.field(withGravity, 'y'), function():Dynamic return cast 0.0) - _Runtime.coalesce(_Runtime.optionalField(linearAccel, 'y'), function():Dynamic return cast 0.0)));
  _Runtime.setField(SensorsApi._gravity__sensors, 'z', (_Runtime.coalesce(_Runtime.field(withGravity, 'z'), function():Dynamic return cast 0.0) - _Runtime.coalesce(_Runtime.optionalField(linearAccel, 'z'), function():Dynamic return cast 0.0)));
  _Runtime.setField(SensorsApi._gravity__sensors, 'interval', _Runtime.coalesce(_Runtime.field(event, 'interval'), function():Dynamic return cast -1.0));
  _Runtime.setField(SensorsApi._gravity__sensors, 'timestamp', -1.0);
  _Runtime.callValue(listener, cast ([SensorsApi._gravity__sensors] : Array<Dynamic>));
};
  _Runtime.callProperty(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'addEventListener', cast (['devicemotion', (cast handler : Dynamic)] : Array<Dynamic>));
  return cast function() {
  _Runtime.callProperty(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'removeEventListener', cast (['devicemotion', (cast handler : Dynamic)] : Array<Dynamic>));
};
  ...
  _Runtime.setField(SensorsApi._linearAcceleration__sensors, 'x', _Runtime.coalesce(_Runtime.field(accel, 'x'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._linearAcceleration__sensors, 'y', _Runtime.coalesce(_Runtime.field(accel, 'y'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._linearAcceleration__sensors, 'z', _Runtime.coalesce(_Runtime.field(accel, 'z'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._linearAcceleration__sensors, 'interval', _Runtime.coalesce(_Runtime.field(event, 'interval'), function():Dynamic return cast -1.0));
  _Runtime.setField(SensorsApi._linearAcceleration__sensors, 'timestamp', -1.0);
  _Runtime.callValue(listener, cast ([SensorsApi._linearAcceleration__sensors] : Array<Dynamic>));
};
  _Runtime.callProperty(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'addEventListener', cast (['devicemotion', (cast handler : Dynamic)] : Array<Dynamic>));
  return cast function() {
  _Runtime.callProperty(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'removeEventListener', cast (['devicemotion', (cast handler : Dynamic)] : Array<Dynamic>));
  ...
  var ctor:Dynamic = cast _Runtime.UNDEFINED;
  ctor = _Runtime.callValue(SensorsApi.getWebMagnetometerConstructor__sensors, cast ([] : Array<Dynamic>));
  if (_Runtime.truthy(_Runtime.strictEquals(ctor, null))) { return cast function() {
  ...
  var handler:Dynamic = function() {
  _Runtime.setField(SensorsApi._magnetometer__sensors, 'x', _Runtime.coalesce(_Runtime.field(sensor, 'x'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._magnetometer__sensors, 'y', _Runtime.coalesce(_Runtime.field(sensor, 'y'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._magnetometer__sensors, 'z', _Runtime.coalesce(_Runtime.field(sensor, 'z'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._magnetometer__sensors, 'interval', -1.0);
  _Runtime.setField(SensorsApi._magnetometer__sensors, 'timestamp', -1.0);
  _Runtime.callValue(listener, cast ([SensorsApi._magnetometer__sensors] : Array<Dynamic>));
};
  _Runtime.callProperty(sensor, 'addEventListener', cast (['reading', handler] : Array<Dynamic>));
  _Runtime.callProperty(sensor, 'start', cast ([] : Array<Dynamic>));
  return cast function() {
  ...
  _Runtime.setField(SensorsApi._motionAcceleration__sensors, 'x', _Runtime.coalesce(_Runtime.optionalField(accel, 'x'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._motionAcceleration__sensors, 'y', _Runtime.coalesce(_Runtime.optionalField(accel, 'y'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._motionAcceleration__sensors, 'z', _Runtime.coalesce(_Runtime.optionalField(accel, 'z'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._motionAcceleration__sensors, 'interval', _Runtime.coalesce(_Runtime.field(event, 'interval'), function():Dynamic return cast -1.0));
  _Runtime.setField(SensorsApi._motionAcceleration__sensors, 'timestamp', -1.0);
  rate = _Runtime.field(event, 'rotationRate');
  _Runtime.setField(SensorsApi._motionRotationRate__sensors, 'alpha', _Runtime.coalesce(_Runtime.optionalField(rate, 'alpha'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._motionRotationRate__sensors, 'beta', _Runtime.coalesce(_Runtime.optionalField(rate, 'beta'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._motionRotationRate__sensors, 'gamma', _Runtime.coalesce(_Runtime.optionalField(rate, 'gamma'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._motionRotationRate__sensors, 'interval', _Runtime.coalesce(_Runtime.field(event, 'interval'), function():Dynamic return cast -1.0));
  _Runtime.setField(SensorsApi._motionRotationRate__sensors, 'timestamp', -1.0);
  _Runtime.callValue(listener, cast ([SensorsApi._motionAcceleration__sensors, SensorsApi._motionRotationRate__sensors] : Array<Dynamic>));
};
  _Runtime.callProperty(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'addEventListener', cast (['devicemotion', (cast handler : Dynamic)] : Array<Dynamic>));
  return cast function() {
  _Runtime.callProperty(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'removeEventListener', cast (['devicemotion', (cast handler : Dynamic)] : Array<Dynamic>));
  ...
  _Runtime.setField(SensorsApi._orientation__sensors, 'alpha', _Runtime.coalesce(_Runtime.field(event, 'alpha'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._orientation__sensors, 'beta', _Runtime.coalesce(_Runtime.field(event, 'beta'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._orientation__sensors, 'gamma', _Runtime.coalesce(_Runtime.field(event, 'gamma'), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._orientation__sensors, 'absolute', _Runtime.coalesce(_Runtime.field(event, 'absolute'), function():Dynamic return cast false));
  _Runtime.setField(SensorsApi._orientation__sensors, 'interval', -1.0);
  _Runtime.setField(SensorsApi._orientation__sensors, 'timestamp', -1.0);
  heading = _Runtime.field((cast event : { @:optional var webkitCompassHeading:Float; }), 'webkitCompassHeading');
  _Runtime.setField(SensorsApi._orientation__sensors, 'heading', _Runtime.select(_Runtime.strictEquals(_Runtime.typeofValue(heading), 'number'), function():Dynamic return cast heading, function():Dynamic return cast -1.0));
  _Runtime.callValue(listener, cast ([SensorsApi._orientation__sensors] : Array<Dynamic>));
};
  _Runtime.callProperty(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'addEventListener', cast (['deviceorientation', (cast handler : Dynamic)] : Array<Dynamic>));
  return cast function() {
  _Runtime.callProperty(_Runtime.callProperty(_Runtime, 'globalValue', cast (['window'] : Array<Dynamic>)), 'removeEventListener', cast (['deviceorientation', (cast handler : Dynamic)] : Array<Dynamic>));
};
  ...
  var q:Dynamic = cast _Runtime.UNDEFINED;
  q = _Runtime.field(sensor, 'quaternion');
  _Runtime.setField(SensorsApi._quaternionReading__sensors, 'x', _Runtime.coalesce(_Runtime.optionalIndex(q, 0.0), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._quaternionReading__sensors, 'y', _Runtime.coalesce(_Runtime.optionalIndex(q, 1.0), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._quaternionReading__sensors, 'z', _Runtime.coalesce(_Runtime.optionalIndex(q, 2.0), function():Dynamic return cast 0.0));
  _Runtime.setField(SensorsApi._quaternionReading__sensors, 'w', _Runtime.coalesce(_Runtime.optionalIndex(q, 3.0), function():Dynamic return cast 1.0));
  _Runtime.setField(SensorsApi._quaternionReading__sensors, 'interval', -1.0);
  _Runtime.setField(SensorsApi._quaternionReading__sensors, 'timestamp', -1.0);
  _Runtime.callValue(listener, cast ([SensorsApi._quaternionReading__sensors] : Array<Dynamic>));
};
  _Runtime.callProperty(sensor, 'addEventListener', cast (['reading', handler] : Array<Dynamic>));
  _Runtime.callProperty(sensor, 'start', cast ([] : Array<Dynamic>));
  return cast function() {
  ...
  public static function detachSensors(sensors:Sensors):Void {
    ...
    unsubscribe = _Runtime.callProperty(SensorsApi._subscriptions__sensors, 'get', cast ([sensors] : Array<Dynamic>));
    if (_Runtime.truthy(!_Runtime.strictEquals(unsubscribe, _Runtime.UNDEFINED))) {
  _Runtime.callValue(unsubscribe, cast ([] : Array<Dynamic>));
  _Runtime.callProperty(SensorsApi._subscriptions__sensors, 'delete', cast ([sensors] : Array<Dynamic>));
}
  }
  ...
  public static function getSensorsBackend():SensorsBackend {
    if (_Runtime.truthy(_Runtime.strictEquals(SensorsApi._backend__sensors, null))) { (SensorsApi._backend__sensors = cast (_Runtime.callValue(createWebSensorsBackend, cast ([] : Array<Dynamic>)) : Dynamic)); }
  ...
  public static function getWebGenericSensorConstructor__sensors(name:String):Null<Dynamic> {
    try {
  var ctor:Dynamic = _Runtime.getIndex((cast _Runtime.callProperty(_Runtime, 'globalValue', cast (['globalThis'] : Array<Dynamic>)) : Dynamic), name);
  ...
  public static function getWebMagnetometerConstructor__sensors():Null<Dynamic> {
    if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.typeofValue(SensorsApi.Magnetometer__sensors), 'undefined'))) { return cast null; }
  ...
  public static function getWebMotionPermissionRequest__sensors():Null<Dynamic> {
    var ctor:Dynamic = cast _Runtime.UNDEFINED;
    if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.callProperty(_Runtime, 'typeofGlobal', cast (['DeviceMotionEvent'] : Array<Dynamic>)), 'undefined'))) { return cast null; }
    ctor = (cast (cast _Runtime.callProperty(_Runtime, 'globalValue', cast (['DeviceMotionEvent'] : Array<Dynamic>)) : Dynamic) : { @:optional var requestPermission:Dynamic; });
  ...
  public static function getWebSensorsPermissionState__sensors(?sensor:String):flighthq._internal._Promise<SensorsPermissionState> {
    return cast flighthq._internal._Async.make(function():flighthq._internal._Promise<SensorsPermissionState> {
      ...
      if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.callProperty(_Runtime, 'typeofGlobal', cast (['window'] : Array<Dynamic>)), 'undefined'))) { return cast 'unsupported'; }
      ...
      if (_Runtime.truthy(_Runtime.andValue(!_Runtime.strictEquals(_Runtime.callProperty(_Runtime, 'typeofGlobal', cast (['navigator'] : Array<Dynamic>)), 'undefined'), function():Dynamic return cast _Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['navigator'] : Array<Dynamic>)), 'permissions')))) {
  try {
  var status:Dynamic = flighthq._internal._Async.awaitValue(_Runtime.callProperty(_Runtime.field(_Runtime.callProperty(_Runtime, 'globalValue', cast (['navigator'] : Array<Dynamic>)), 'permissions'), 'query', cast ([{ name: (cast permissionName : PermissionName) }] : Array<Dynamic>)));
  ...
  var hasMotion:Dynamic = !_Runtime.strictEquals(_Runtime.callProperty(_Runtime, 'typeofGlobal', cast (['DeviceMotionEvent'] : Array<Dynamic>)), 'undefined');
