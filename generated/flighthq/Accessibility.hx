...
class Accessibility {
  ...
  public static function _getAccessibilityLiveRegion__accessibility(root:Dynamic, liveRegions:Dynamic, liveness:AccessibilityLiveness):Dynamic {
    ...
    if (_Runtime.truthy(_Runtime.orValue(_Runtime.strictEquals(region, _Runtime.UNDEFINED), function():Dynamic return cast _Runtime.strictEquals(_Runtime.field(region, 'parentNode'), null)))) {
  ...
  public static function _reflectAccessibilityAttribute__accessibility(element:Dynamic, attribute:String, value:Null<String>):Void {
    if (_Runtime.truthy(_Runtime.strictEquals(value, _Runtime.UNDEFINED))) {
  ...
  public static function _reparentAccessibilityElement__accessibility(element:Dynamic, parentId:Null<String>, elements:Dynamic, root:Dynamic):Void {
    ...
    parent = root;
    if (_Runtime.truthy(!_Runtime.strictEquals(parentId, _Runtime.UNDEFINED))) {
  var found:Dynamic = _Runtime.callProperty(elements, 'get', cast ([parentId] : Array<Dynamic>));
  if (_Runtime.truthy(!_Runtime.strictEquals(found, _Runtime.UNDEFINED))) { (parent = cast (found : Dynamic)); }
}
  ...
  public static function createWebAccessibilityBackend(?container:Dynamic):AccessibilityBackend {
    ...
    rootResolved = !_Runtime.strictEquals(container, _Runtime.UNDEFINED);
  ...
  if (_Runtime.truthy(_Runtime.strictEquals(element, _Runtime.UNDEFINED))) {
  ...
  element = _Runtime.callProperty(elements, 'get', cast ([id] : Array<Dynamic>));
  if (_Runtime.truthy(_Runtime.strictEquals(element, _Runtime.UNDEFINED))) { return cast false; }
