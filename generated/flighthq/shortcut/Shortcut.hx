...
class Shortcut {
  ...
  public static function registerGlobalShortcut(accelerator:String, handler:Dynamic):Bool {
    ...
    if ((cast _Runtime.strictEquals(normalized, null) : Bool)) { return cast false; }
    wrappedHandler = function(event:ShortcutEvent) {
