...
class GlRadialBlurEffect {
  ...
  public static function applyRadialBlurEffectToGl(state:GlRenderState, source:GlRenderTarget, dest:GlRenderTarget, effect:RadialBlurEffect):Void {
    ...
    program = (cast getGlEffectProgram((cast state : GlRenderState), (cast 'radialBlur' : String), (cast GlRadialBlurEffect.RADIAL_BLUR_FRAGMENT_SRC__glRadialBlurEffect : String)) : GlFullscreenProgram);
  ...
  public static final defaultGlRadialBlurEffectRunner:GlRenderEffectRunner = function(ctx:GlRenderEffectContext, effect:RenderEffect):Void {
    applyRadialBlurEffectToGl((cast _Runtime.field(ctx, 'state') : GlRenderState), (cast _Runtime.field(ctx, 'source') : GlRenderTarget), (cast _Runtime.field(ctx, 'dest') : GlRenderTarget), (cast (cast effect : RadialBlurEffect) : RadialBlurEffect));
  };

  public static function registerGlRadialBlurEffect(state:GlRenderState):Void {
    registerGlRenderEffect((cast state : GlRenderState), (cast 'RadialBlurEffect' : String), (cast defaultGlRadialBlurEffectRunner : GlRenderEffectRunner));
  }
