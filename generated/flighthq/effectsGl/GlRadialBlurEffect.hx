...
class GlRadialBlurEffect {
  ...
  public static function applyRadialBlurEffectToGl(state:GlRenderState, source:GlRenderTarget, dest:GlRenderTarget, effect:RadialBlurEffect):Void {
    ...
    program = (cast getGlEffectProgram((cast state), (cast 'radialBlur' : String), (cast GlRadialBlurEffect.RADIAL_BLUR_FRAGMENT_SRC__glRadialBlurEffect : String)) : GlFullscreenProgram);
  ...
  public static final defaultGlRadialBlurEffectRunner:GlRenderEffectRunner = (cast function(ctx:GlRenderEffectContext, effect:RenderEffect):Void {
    applyRadialBlurEffectToGl((cast _Runtime.field(ctx, 'state')), (cast _Runtime.field(ctx, 'source')), (cast _Runtime.field(ctx, 'dest')), (cast (cast effect : RadialBlurEffect)));
  });

  public static function registerGlRadialBlurEffect(state:GlRenderState):Void {
    registerGlRenderEffect((cast state), (cast 'RadialBlurEffect' : String), (cast defaultGlRadialBlurEffectRunner));
  }
