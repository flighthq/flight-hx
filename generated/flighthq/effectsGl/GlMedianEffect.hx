...
class GlMedianEffect {
  ...
  public static function registerGlMedianEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'MedianEffect' : String), ({ final __callArgument6:Dynamic = defaultGlMedianEffectRunner; __callArgument6; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
