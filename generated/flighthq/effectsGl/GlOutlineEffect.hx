...
class GlOutlineEffect {
  ...
  public static function registerGlOutlineEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'OutlineEffect' : String), ({ final __callArgument6:Dynamic = defaultGlOutlineEffectRunner; __callArgument6; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
