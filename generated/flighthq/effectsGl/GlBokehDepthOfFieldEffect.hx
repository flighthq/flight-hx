...
class GlBokehDepthOfFieldEffect {
  ...
  public static function registerGlBokehDepthOfFieldEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'BokehDepthOfFieldEffect' : String), ({ final __callArgument6:Dynamic = defaultGlBokehDepthOfFieldEffectRunner; __callArgument6; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
