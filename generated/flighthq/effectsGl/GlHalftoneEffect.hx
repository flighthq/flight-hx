...
class GlHalftoneEffect {
  ...
  public static function registerGlHalftoneEffect(state:GlRenderState):Void {
    (#if js _Runtime.callValue(registerGlRenderEffect, cast ([({ final __callArgument12:Dynamic = state; __callArgument12; }), (cast 'HalftoneEffect' : String), ({ final __callArgument13:Dynamic = defaultGlHalftoneEffectRunner; __callArgument13; })] : Array<Dynamic>)) #else registerGlRenderEffect(({ final __callArgument10:Dynamic = state; __callArgument10; }), (cast 'HalftoneEffect' : String), ({ final __callArgument11:Dynamic = defaultGlHalftoneEffectRunner; __callArgument11; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
  }
