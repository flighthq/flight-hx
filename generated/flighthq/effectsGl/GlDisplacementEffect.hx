...
class GlDisplacementEffect {
  ...
  public static function registerGlDisplacementEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'DisplacementEffect' : String), ({ final __callArgument6:Dynamic = defaultGlDisplacementEffectRunner; __callArgument6; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
