...
class GlKuwaharaEffect {
  ...
  public static function registerGlKuwaharaEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'KuwaharaEffect' : String), ({ final __callArgument6:Dynamic = defaultGlKuwaharaEffectRunner; __callArgument6; }));
  }
