...
class GlKuwaharaEffect {
  ...
  public static function applyKuwaharaEffectToGl(state:GlRenderState, source:GlRenderTarget, dest:GlRenderTarget, effect:KuwaharaEffect):Void {
    ...
    program = (cast getGlEffectProgram(({ final __callArgument0:Dynamic = state; __callArgument0; }), (cast 'stylization.kuwahara' : String), (cast GlKuwaharaEffect.KUWAHARA_FRAGMENT_SRC__glKuwaharaEffect : String)) : GlFullscreenProgram);
  ...
  public static function registerGlKuwaharaEffect(state:GlRenderState):Void {
    (#if js _Runtime.callValue(registerGlRenderEffect, cast ([({ final __callArgument12:Dynamic = state; __callArgument12; }), (cast 'KuwaharaEffect' : String), ({ final __callArgument13:Dynamic = defaultGlKuwaharaEffectRunner; __callArgument13; })] : Array<Dynamic>)) #else registerGlRenderEffect(({ final __callArgument10:Dynamic = state; __callArgument10; }), (cast 'KuwaharaEffect' : String), ({ final __callArgument11:Dynamic = defaultGlKuwaharaEffectRunner; __callArgument11; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
  }
