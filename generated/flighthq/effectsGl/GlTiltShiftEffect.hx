...
class GlTiltShiftEffect {
  ...
  public static function registerGlTiltShiftEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'TiltShiftEffect' : String), ({ final __callArgument6:Dynamic = defaultGlTiltShiftEffectRunner; __callArgument6; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
