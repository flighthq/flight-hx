...
class GlCompositeEffect {
  public static function applyCompositeEffectToGl(state:GlRenderState, source:GlRenderTarget, dest:GlRenderTarget, effect:CompositeEffect):Void {
    ...
    _Runtime.callValue(drawGlFullscreenPass, cast ([state, program, inputs, dest, function(gl:Dynamic, p:Dynamic) {
      ...
      if (_Runtime.truthy(!_Runtime.strictEquals(operatorLoc, null))) { flighthq._internal.backend.WebGl2Backend.call(gl, 'uniform1i', cast ([operatorLoc, operatorIndex] : Array<Dynamic>)); }
