...
class GlCompositeEffect {
  ...
  public static function registerGlCompositeEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument11:Dynamic = state; __callArgument11; }), (cast 'CompositeEffect' : String), ({ final __callArgument12:Dynamic = defaultGlCompositeEffectRunner; __callArgument12; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
