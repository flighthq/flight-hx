...
class GlLensFlareEffect {
  ...
  public static function registerGlLensFlareEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'LensFlareEffect' : String), ({ final __callArgument6:Dynamic = defaultGlLensFlareEffectRunner; __callArgument6; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
