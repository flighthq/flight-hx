...
class GlCameraMotionBlurEffect {
  ...
  public static function registerGlCameraMotionBlurEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'CameraMotionBlurEffect' : String), ({ final __callArgument6:Dynamic = defaultGlCameraMotionBlurEffectRunner; __callArgument6; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
