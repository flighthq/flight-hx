...
class GlConvolutionEffect {
  ...
  public static function applyConvolutionEffectToGl(state:GlRenderState, source:GlRenderTarget, dest:GlRenderTarget, effect:ConvolutionEffect):Void {
    ...
    _Runtime.callValue(drawGlFullscreenPass, cast ([state, program, cast ([_Runtime.field(source, 'texture')] : Array<Dynamic>), dest, function(gl:Dynamic, p:Dynamic) {
      ...
      flighthq._internal.backend.WebGl2Backend.uniform4f(gl, flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, _Runtime.field(p, 'program'), 'u_edgeColor'), ((Std.int((Std.int(edgeColor) >> Std.int(16.0))) & Std.int(255.0)) / 255.0), ((Std.int((Std.int(edgeColor) >> Std.int(8.0))) & Std.int(255.0)) / 255.0), ((Std.int(edgeColor) & Std.int(255.0)) / 255.0), ((Std.int(_Runtime.unsignedShiftRight(Std.int(edgeColor), Std.int(24.0))) & Std.int(255.0)) / 255.0));
    }] : Array<Dynamic>));
  }
