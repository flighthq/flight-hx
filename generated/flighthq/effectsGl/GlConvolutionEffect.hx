...
class GlConvolutionEffect {
  ...
  public static function applyConvolutionEffectToGl(state:GlRenderState, source:GlRenderTarget, dest:GlRenderTarget, effect:ConvolutionEffect):Void {
    ...
    _Runtime.callValue(drawGlFullscreenPass, cast ([state, program, cast ([_Runtime.field(source, 'texture')] : Array<Dynamic>), dest, function(gl:Dynamic, p:Dynamic) {
      ...
      flighthq._internal.backend.WebGl2Backend.uniform4f(gl, flighthq._internal.backend.WebGl2Backend.getUniformLocation(gl, _Runtime.field(p, 'program'), 'u_edgeColor'), ((_Runtime.toInt32((_Runtime.toInt32(edgeColor) >> _Runtime.toInt32(16.0))) & _Runtime.toInt32(255.0)) / 255.0), ((_Runtime.toInt32((_Runtime.toInt32(edgeColor) >> _Runtime.toInt32(8.0))) & _Runtime.toInt32(255.0)) / 255.0), ((_Runtime.toInt32(edgeColor) & _Runtime.toInt32(255.0)) / 255.0), ((_Runtime.toInt32(_Runtime.unsignedShiftRight(_Runtime.toInt32(edgeColor), _Runtime.toInt32(24.0))) & _Runtime.toInt32(255.0)) / 255.0));
    }] : Array<Dynamic>));
  }
