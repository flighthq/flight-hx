...
class GlSketchEffect {
  ...
  public static function applySketchEffectToGl(state:GlRenderState, source:GlRenderTarget, dest:GlRenderTarget, effect:SketchEffect):Void {
    ...
    program = (cast getGlEffectProgram((cast state), (cast 'stylization.sketch' : String), (cast GlSketchEffect.SKETCH_FRAGMENT_SRC__glSketchEffect : String)) : GlFullscreenProgram);
  ...
  public static final defaultGlSketchEffectRunner:GlRenderEffectRunner = (cast function(ctx:GlRenderEffectContext, effect:RenderEffect):Void {
    applySketchEffectToGl((cast _Runtime.field(ctx, 'state')), (cast _Runtime.field(ctx, 'source')), (cast _Runtime.field(ctx, 'dest')), (cast (cast effect : SketchEffect)));
  });

  public static function registerGlSketchEffect(state:GlRenderState):Void {
    registerGlRenderEffect((cast state), (cast 'SketchEffect' : String), (cast defaultGlSketchEffectRunner));
  }
