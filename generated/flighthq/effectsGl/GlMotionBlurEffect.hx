...
class GlMotionBlurEffect {
  ...
  public static function registerGlMotionBlurEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'MotionBlurEffect' : String), ({ final __callArgument6:Dynamic = defaultGlMotionBlurEffectRunner; __callArgument6; }));
  }
