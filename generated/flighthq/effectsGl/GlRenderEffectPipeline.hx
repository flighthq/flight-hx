...
class GlRenderEffectPipeline {
  ...
  public static function destroyGlRenderEffectPipeline(state:GlRenderState, pipeline:flighthq.types.GlRenderEffectPipeline):Void {
    ...
    if (_Runtime.truthy(!_Runtime.strictEquals(_Runtime.field(_Runtime.field(pipeline, 'lutTexture'), 'texture'), null))) {
      flighthq._internal.backend.WebGl2Backend.call(_Runtime.field(state, 'gl'), 'deleteTexture', cast ([_Runtime.field(_Runtime.field(pipeline, 'lutTexture'), 'texture')] : Array<Dynamic>));
