...
class GlScreenSpaceFogEffect {
  ...
  public static function registerGlScreenSpaceFogEffect(state:GlRenderState):Void {
    (#if js _Runtime.callValue(registerGlRenderEffect, cast ([({ final __callArgument12:Dynamic = state; __callArgument12; }), (cast 'ScreenSpaceFogEffect' : String), ({ final __callArgument13:Dynamic = defaultGlScreenSpaceFogEffectRunner; __callArgument13; })] : Array<Dynamic>)) #else registerGlRenderEffect(({ final __callArgument10:Dynamic = state; __callArgument10; }), (cast 'ScreenSpaceFogEffect' : String), ({ final __callArgument11:Dynamic = defaultGlScreenSpaceFogEffectRunner; __callArgument11; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
  }
