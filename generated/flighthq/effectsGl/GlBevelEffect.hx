...
class GlBevelEffect {
  ...
  public static function applyGlBevelCompositePass__glBevelEffect(state:GlRenderState, field:GlRenderTarget, source:GlRenderTarget, dest:GlRenderTarget, params:BevelCompositeParams__glBevelEffect):Void {
    ...
    _Runtime.callValue(drawGlFullscreenPass, cast ([state, loc, cast ([_Runtime.field(field, 'texture'), _Runtime.field(source, 'texture')] : Array<Dynamic>), dest, function(gl:Dynamic) {
      flighthq._internal.backend.WebGl2Backend.uniform4f(gl, _Runtime.field(loc, 'locHighlight'), ((_Runtime.toInt32((_Runtime.toInt32(_Runtime.field(params, 'highlightColor')) >> _Runtime.toInt32(16.0))) & _Runtime.toInt32(255.0)) / 255.0), ((_Runtime.toInt32((_Runtime.toInt32(_Runtime.field(params, 'highlightColor')) >> _Runtime.toInt32(8.0))) & _Runtime.toInt32(255.0)) / 255.0), ((_Runtime.toInt32(_Runtime.field(params, 'highlightColor')) & _Runtime.toInt32(255.0)) / 255.0), _Runtime.field(params, 'highlightAlpha'));
      flighthq._internal.backend.WebGl2Backend.uniform4f(gl, _Runtime.field(loc, 'locShadow'), ((_Runtime.toInt32((_Runtime.toInt32(_Runtime.field(params, 'shadowColor')) >> _Runtime.toInt32(16.0))) & _Runtime.toInt32(255.0)) / 255.0), ((_Runtime.toInt32((_Runtime.toInt32(_Runtime.field(params, 'shadowColor')) >> _Runtime.toInt32(8.0))) & _Runtime.toInt32(255.0)) / 255.0), ((_Runtime.toInt32(_Runtime.field(params, 'shadowColor')) & _Runtime.toInt32(255.0)) / 255.0), _Runtime.field(params, 'shadowAlpha'));
