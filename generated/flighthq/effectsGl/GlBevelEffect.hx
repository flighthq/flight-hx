...
class GlBevelEffect {
  ...
  public static function applyGlBevelCompositePass__glBevelEffect(state:GlRenderState, field:GlRenderTarget, source:GlRenderTarget, dest:GlRenderTarget, params:BevelCompositeParams__glBevelEffect):Void {
    ...
    _Runtime.callValue(drawGlFullscreenPass, cast ([state, loc, cast ([_Runtime.field(field, 'texture'), _Runtime.field(source, 'texture')] : Array<Dynamic>), dest, function(gl:Dynamic) {
      flighthq._internal.backend.WebGl2Backend.uniform4f(gl, _Runtime.field(loc, 'locHighlight'), ((Std.int((Std.int(_Runtime.field(params, 'highlightColor')) >> Std.int(16.0))) & Std.int(255.0)) / 255.0), ((Std.int((Std.int(_Runtime.field(params, 'highlightColor')) >> Std.int(8.0))) & Std.int(255.0)) / 255.0), ((Std.int(_Runtime.field(params, 'highlightColor')) & Std.int(255.0)) / 255.0), _Runtime.field(params, 'highlightAlpha'));
      flighthq._internal.backend.WebGl2Backend.uniform4f(gl, _Runtime.field(loc, 'locShadow'), ((Std.int((Std.int(_Runtime.field(params, 'shadowColor')) >> Std.int(16.0))) & Std.int(255.0)) / 255.0), ((Std.int((Std.int(_Runtime.field(params, 'shadowColor')) >> Std.int(8.0))) & Std.int(255.0)) / 255.0), ((Std.int(_Runtime.field(params, 'shadowColor')) & Std.int(255.0)) / 255.0), _Runtime.field(params, 'shadowAlpha'));
