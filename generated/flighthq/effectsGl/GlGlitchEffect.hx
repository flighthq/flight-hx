...
class GlGlitchEffect {
  ...
  public static function registerGlGlitchEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'GlitchEffect' : String), ({ final __callArgument6:Dynamic = defaultGlGlitchEffectRunner; __callArgument6; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
