...
class GlFxaaEffect {
  ...
  public static function registerGlFxaaEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'FxaaEffect' : String), ({ final __callArgument6:Dynamic = defaultGlFxaaEffectRunner; __callArgument6; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
