...
class GlCrtEffect {
  ...
  public static function registerGlCrtEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'CrtEffect' : String), ({ final __callArgument6:Dynamic = defaultGlCrtEffectRunner; __callArgument6; }), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end);
  }
