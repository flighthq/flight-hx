...
class GlChromaticAberrationEffect {
  ...
  public static function registerGlChromaticAberrationEffect(state:GlRenderState):Void {
    registerGlRenderEffect(({ final __callArgument5:Dynamic = state; __callArgument5; }), (cast 'ChromaticAberrationEffect' : String), ({ final __callArgument6:Dynamic = defaultGlChromaticAberrationEffectRunner; __callArgument6; }));
  }
