...
class GlBitmapText {
  public static final INSTANCE_FLOATS__glBitmapText:Dynamic = 13.0;
  ...
  public static function submitGlBitmapText__glBitmapText(state:GlRenderState, node:RenderProxy2D):Void {
    ...
    for (page in _Runtime.iterable(pages)) {
      ...
      var base:Dynamic = _Runtime.callValue(prepareGlQuadBatchWrite, cast ([state, glTexture, straightAlpha, _Runtime.field(texture, 'sampler'), _Runtime.field(node, 'blendMode'), material, materialRenderer, _Runtime.field(page, 'instanceCount')] : Array<Dynamic>));
      ...
      var drawCount:Dynamic = 0.0;
      {
        ...
        while ((cast ((cast i : Float) < (cast _Runtime.field(page, 'instanceCount') : Float)) : Bool)) {
          ...
          _Runtime.callValue(recordGlQuadBatchColorScaleBias, cast ([state, nodeColorScaleBias, (startCount + drawCount)] : Array<Dynamic>));
