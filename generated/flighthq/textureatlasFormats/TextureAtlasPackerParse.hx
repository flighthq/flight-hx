...
class TextureAtlasPackerParse {
  ...
  public static function parseTextureAtlasPackerJson(json:String, atlas:TextureAtlas, ?options:TextureAtlasPackerParseOptions):TextureAtlas {
    ...
    TextureAtlasPackerParse.applyDocument__textureAtlasPackerParse(({ final __callArgument3:Dynamic = atlas; __callArgument3; }), ({ final __callArgument4:Dynamic = doc; __callArgument4; }), ({ final __callArgument5:Dynamic = _Runtime.coalesce(options, function():Dynamic return cast {  }); __callArgument5; }));
    return cast atlas;
    return cast null;
  }
  ...
  public static function applyDocument__textureAtlasPackerParse(atlas:TextureAtlas, doc:TextureAtlasPackerDocument, options:TextureAtlasPackerParseOptions):Void {
    ...
    if ((cast _Runtime.isArray((cast doc : { var frames:flighthq._internal._Union2<Array<TextureAtlasPackerArrayFrame>, flighthq._internal._Record<String, TextureAtlasPackerHashFrame>>; }).frames) : Bool)) {
      for (entry in _Runtime.iterable((cast doc : { var frames:flighthq._internal._Union2<Array<TextureAtlasPackerArrayFrame>, flighthq._internal._Record<String, TextureAtlasPackerHashFrame>>; }).frames)) {
        TextureAtlasPackerParse.applyFrame__textureAtlasPackerParse(({ final __callArgument8:Dynamic = atlas; __callArgument8; }), (cast entry.filename : String), ({ final __callArgument9:Dynamic = entry; __callArgument9; }), ({ final __callArgument10:Dynamic = options; __callArgument10; }));
      }
    } else {
      for (__iteration0 in _Runtime.iterable(flighthq._internal.DynamicObject.entries((cast doc : { var frames:flighthq._internal._Union2<Array<TextureAtlasPackerArrayFrame>, flighthq._internal._Record<String, TextureAtlasPackerHashFrame>>; }).frames))) {
        ...
        TextureAtlasPackerParse.applyFrame__textureAtlasPackerParse(({ final __callArgument13:Dynamic = atlas; __callArgument13; }), (cast frameName : String), ({ final __callArgument14:Dynamic = entry; __callArgument14; }), ({ final __callArgument15:Dynamic = options; __callArgument15; }));
      }
    }
  }
  ...
  public static function applyFrame__textureAtlasPackerParse(atlas:TextureAtlas, name:String, entry:flighthq._internal._Union2<TextureAtlasPackerArrayFrame, TextureAtlasPackerHashFrame>, options:TextureAtlasPackerParseOptions):Void {
    ...
    region = (cast createTextureAtlasRegion(({ final __callArgument16:Dynamic = { height: ((cast (cast entry : { var rotated:Bool; }).rotated : Bool) ? (cast frame.w : Dynamic) : (cast frame.h : Dynamic)), id: _Runtime.field(atlas.regions, 'length'), name: normalized, originalHeight: ((cast ((cast trimmed : Bool) && (cast !_Runtime.strictEquals(sourceSize, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) : Bool) ? (cast sourceSize.h : Dynamic) : (cast null : Dynamic)), originalWidth: ((cast ((cast trimmed : Bool) && (cast !_Runtime.strictEquals(sourceSize, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) : Bool) ? (cast sourceSize.w : Dynamic) : (cast null : Dynamic)), pivotX: ((cast !_Runtime.strictEquals((cast entry : { @:optional var pivot:Null<TextureAtlasPackerPivot>; }).pivot, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) ? (cast (cast (cast entry : { @:optional var pivot:Null<TextureAtlasPackerPivot>; }).pivot : { var x:Float; }).x : Dynamic) : (cast null : Dynamic)), pivotY: ((cast !_Runtime.strictEquals((cast entry : { @:optional var pivot:Null<TextureAtlasPackerPivot>; }).pivot, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) ? (cast (cast (cast entry : { @:optional var pivot:Null<TextureAtlasPackerPivot>; }).pivot : { var y:Float; }).y : Dynamic) : (cast null : Dynamic)), rotated: (cast entry : { var rotated:Bool; }).rotated, sourceX: ((cast !_Runtime.strictEquals(spriteSourceSize, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) ? (cast spriteSourceSize.x : Dynamic) : (cast 0.0 : Dynamic)), sourceY: ((cast !_Runtime.strictEquals(spriteSourceSize, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) ? (cast spriteSourceSize.y : Dynamic) : (cast 0.0 : Dynamic)), trimmed: trimmed, width: ((cast (cast entry : { var rotated:Bool; }).rotated : Bool) ? (cast frame.h : Dynamic) : (cast frame.w : Dynamic)), x: frame.x, y: frame.y }; __callArgument16; })) : TextureAtlasRegion);
