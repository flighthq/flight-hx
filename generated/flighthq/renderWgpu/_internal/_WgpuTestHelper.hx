...
class _WgpuTestHelper {
  ...
  public static function makeTexture__wgpuTestHelper(?descriptor:flighthq._internal.dom.GPUTextureDescriptor):flighthq._internal.dom.GPUTexture {
    ...
    return cast (cast (cast { createView: function():flighthq._internal.dom.GPUTextureView return (cast {  } : flighthq._internal.dom.GPUTextureView), depthOrArrayLayers: depthOrArrayLayers, dimension: _Runtime.coalesce(({ final __hostType2 = descriptor; __hostType2 == null ? _Runtime.UNDEFINED : __hostType2.dimension; }), function():Dynamic return cast '2d'), destroy: function():Void {

    }, format: _Runtime.coalesce(({ final __hostType3 = descriptor; __hostType3 == null ? _Runtime.UNDEFINED : __hostType3.format; }), function():Dynamic return cast 'bgra8unorm'), height: height, mipLevelCount: _Runtime.coalesce(({ final __hostType4 = descriptor; __hostType4 == null ? _Runtime.UNDEFINED : __hostType4.mipLevelCount; }), function():Dynamic return cast 1.0), sampleCount: _Runtime.coalesce(({ final __hostType5 = descriptor; __hostType5 == null ? _Runtime.UNDEFINED : __hostType5.sampleCount; }), function():Dynamic return cast 1.0), usage: _Runtime.coalesce(({ final __hostType6 = descriptor; __hostType6 == null ? _Runtime.UNDEFINED : __hostType6.usage; }), function():Dynamic return cast flighthq._internal.backend.WebGpuConstantsBackend.value('GPUTextureUsage', 'RENDER_ATTACHMENT')), width: width } : flighthq._internal._Any) : flighthq._internal.dom.GPUTexture);
    return cast null;
  }
  ...
  public static function makeDevice__wgpuTestHelper():flighthq._internal.dom.GPUDevice {
    ...
    writeBuffer = (cast function(buffer:flighthq._internal.dom.GPUBuffer, bufferOffset:Float, data:flighthq._internal._Any, ?dataOffset:Float, ?size:Float):Void {
      _WgpuTestHelper.validateWriteBufferDestination__wgpuTestHelper(({ final __callArgument7:Dynamic = buffer; __callArgument7; }), (cast bufferOffset : Float), (cast data : flighthq._internal._Any), #if js (cast dataOffset : Float) #else (cast dataOffset : Null<Float>) #end, ({ final __callArgument8:Dynamic = size; __callArgument8; }));
    });
    writeTexture = (cast function(destination:flighthq._internal.dom.GPUTexelCopyTextureInfo, data:flighthq._internal.dom.GPUAllowSharedBufferSource, dataLayout:flighthq._internal.dom.GPUTexelCopyBufferLayout, size:flighthq._internal.dom.GPUExtent3D):Void {
      _WgpuTestHelper.validateWriteTextureSourceAllocation__wgpuTestHelper(({ final __callArgument11:Dynamic = destination; __callArgument11; }), (cast data : flighthq._internal._Any), ({ final __callArgument12:Dynamic = dataLayout; __callArgument12; }), (cast size : flighthq._internal._Any));
    });
    return cast (cast (cast { features: _Runtime.construct(flighthq._internal._HostValueLut.get('Set'), []), limits: { maxTextureDimension2D: 8192.0, minUniformBufferOffsetAlignment: 256.0 }, createBindGroup: function():flighthq._internal.dom.GPUBindGroup return (cast _WgpuTestHelper.makeBindGroup__wgpuTestHelper() : flighthq._internal.dom.GPUBindGroup), createBindGroupLayout: function():flighthq._internal.dom.GPUBindGroupLayout return (cast _WgpuTestHelper.makeBindGroupLayout__wgpuTestHelper() : flighthq._internal.dom.GPUBindGroupLayout), createBuffer: function(descriptor:flighthq._internal.dom.GPUBufferDescriptor):flighthq._internal.dom.GPUBuffer return (cast _WgpuTestHelper.makeBuffer__wgpuTestHelper(({ final __callArgument15:Dynamic = descriptor; __callArgument15; })) : flighthq._internal.dom.GPUBuffer), createCommandEncoder: function():flighthq._internal.dom.GPUCommandEncoder return (cast _WgpuTestHelper.makeCommandEncoder__wgpuTestHelper() : flighthq._internal.dom.GPUCommandEncoder), createPipelineLayout: function():flighthq._internal.dom.GPUPipelineLayout return (cast _WgpuTestHelper.makePipelineLayout__wgpuTestHelper() : flighthq._internal.dom.GPUPipelineLayout), createRenderPipeline: function(descriptor:flighthq._internal.dom.GPURenderPipelineDescriptor):flighthq._internal.dom.GPURenderPipeline return (cast _WgpuTestHelper.makePipeline__wgpuTestHelper(({ final __callArgument17:Dynamic = descriptor; __callArgument17; })) : flighthq._internal.dom.GPURenderPipeline), createSampler: function():flighthq._internal.dom.GPUSampler return (cast _WgpuTestHelper.makeSampler__wgpuTestHelper() : flighthq._internal.dom.GPUSampler), createShaderModule: function():flighthq._internal.dom.GPUShaderModule return (cast _WgpuTestHelper.makeShaderModule__wgpuTestHelper() : flighthq._internal.dom.GPUShaderModule), createTexture: function(descriptor:flighthq._internal.dom.GPUTextureDescriptor):flighthq._internal.dom.GPUTexture return (cast _WgpuTestHelper.makeTexture__wgpuTestHelper(({ final __callArgument19:Dynamic = descriptor; __callArgument19; })) : flighthq._internal.dom.GPUTexture), queue: { copyExternalImageToTexture: function():Void {
  ...
  public static function validateWriteBufferDestination__wgpuTestHelper(buffer:flighthq._internal.dom.GPUBuffer, bufferOffset:Float, data:flighthq._internal._Any, dataOffset:Float = 0.0, ?size:Float):Void {
    ...
    elementByteLength = ((cast ((cast isView : Bool) && (cast !(cast _Runtime.isInstanceOf(data, flighthq._internal._HostValueLut.get('DataView')) : Bool) : Bool)) : Bool) ? (cast (cast _WgpuTestHelper.getTypedArrayElementByteLength__wgpuTestHelper(({ final __callArgument21:Dynamic = data; __callArgument21; })) : Float) : Dynamic) : (cast 1.0 : Dynamic));
  ...
  public static function createWgpuRenderStateForTest(?options:WgpuRenderOptions):flighthq._internal._Promise<WgpuRenderState> {
    return cast flighthq._internal._Async.resolve(flighthq._internal._Async.protect(function():Dynamic {
      ...
      return flighthq._internal._Async.resolve((cast createWgpuRenderState(({ final __callArgument27:Dynamic = canvas; __callArgument27; }), ({ final __callArgument28:Dynamic = options; __callArgument28; })) : flighthq._internal._Promise<WgpuRenderState>));
    }));
  }
  ...
  public static function installWgpuMock():Void {
    ...
    ((cast (cast _Runtime.field(flighthq._internal._HostValueLut.get('HTMLCanvasElement'), 'prototype') : { var getContext:flighthq._internal._Any; }) : { var getContext:flighthq._internal._Any; }).getContext = function(contextId:String, ?options:flighthq._internal._Any):flighthq._internal._Any {
      ...
      if ((cast _Runtime.strictEquals(contextId, 'webgpu') : Bool)) {
        ...
        }, getCurrentTexture: function():flighthq._internal.dom.GPUTexture return (cast (#if js _Runtime.callValue(_WgpuTestHelper.makeTexture__wgpuTestHelper, cast ([] : Array<Dynamic>)) #else _WgpuTestHelper.makeTexture__wgpuTestHelper(#if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end) : flighthq._internal.dom.GPUTexture) } : flighthq._internal._Any) : flighthq._internal.dom.GPUCanvasContext);
      }
