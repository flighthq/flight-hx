...
class WgpuShader {
  ...
  public static function writeWgpuQuadUniforms(state:WgpuRenderState, renderProxy:{ var alpha:Float; var transform2D:{ var a:Float; var b:Float; var c:Float; var d:Float; var tx:Float; var ty:Float; }; }, colorTransform:Null<ColorTransform>, x0:Float, y0:Float, x1:Float, y1:Float, u0:Float, v0:Float, u1:Float, v1:Float):Float {
    ...
    _Runtime.setIndex(uniformData, (floatBase + 17.0), _Runtime.coalesce(({ final __typedStruct1 = colorTransform; __typedStruct1 == null ? _Runtime.UNDEFINED : __typedStruct1.greenMultiplier; }), function():Dynamic return cast 1.0));
    _Runtime.setIndex(uniformData, (floatBase + 18.0), _Runtime.coalesce(({ final __typedStruct2 = colorTransform; __typedStruct2 == null ? _Runtime.UNDEFINED : __typedStruct2.blueMultiplier; }), function():Dynamic return cast 1.0));
    _Runtime.setIndex(uniformData, (floatBase + 19.0), _Runtime.coalesce(({ final __typedStruct3 = colorTransform; __typedStruct3 == null ? _Runtime.UNDEFINED : __typedStruct3.alphaMultiplier; }), function():Dynamic return cast 1.0));
    _Runtime.setIndex(uniformData, (floatBase + 20.0), (_Runtime.coalesce(({ final __typedStruct4 = colorTransform; __typedStruct4 == null ? _Runtime.UNDEFINED : __typedStruct4.redOffset; }), function():Dynamic return cast 0.0) / 255.0));
    _Runtime.setIndex(uniformData, (floatBase + 21.0), (_Runtime.coalesce(({ final __typedStruct5 = colorTransform; __typedStruct5 == null ? _Runtime.UNDEFINED : __typedStruct5.greenOffset; }), function():Dynamic return cast 0.0) / 255.0));
    _Runtime.setIndex(uniformData, (floatBase + 22.0), (_Runtime.coalesce(({ final __typedStruct6 = colorTransform; __typedStruct6 == null ? _Runtime.UNDEFINED : __typedStruct6.blueOffset; }), function():Dynamic return cast 0.0) / 255.0));
    _Runtime.setIndex(uniformData, (floatBase + 23.0), (_Runtime.coalesce(({ final __typedStruct7 = colorTransform; __typedStruct7 == null ? _Runtime.UNDEFINED : __typedStruct7.alphaOffset; }), function():Dynamic return cast 0.0) / 255.0));
