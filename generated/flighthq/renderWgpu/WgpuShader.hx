...
class WgpuShader {
  ...
  public static function writeWgpuQuadUniforms(state:WgpuRenderState, renderProxy:{ var alpha:Float; var transform2D:{ var a:Float; var b:Float; var c:Float; var d:Float; var tx:Float; var ty:Float; }; }, colorScaleBias:Null<ColorScaleBias>, x0:Float, y0:Float, x1:Float, y1:Float, u0:Float, v0:Float, u1:Float, v1:Float, straightTextureAlpha:Bool = false):Float {
    ...
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 16.0) : Float), (cast _Runtime.coalesce(({ final __structural12 = colorScaleBias; __structural12 == null ? _Runtime.UNDEFINED : (cast __structural12 : { var redScale:Float; }).redScale; }), function():Dynamic return cast 1.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 17.0) : Float), (cast _Runtime.coalesce(({ final __structural13 = colorScaleBias; __structural13 == null ? _Runtime.UNDEFINED : (cast __structural13 : { var greenScale:Float; }).greenScale; }), function():Dynamic return cast 1.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 18.0) : Float), (cast _Runtime.coalesce(({ final __structural14 = colorScaleBias; __structural14 == null ? _Runtime.UNDEFINED : (cast __structural14 : { var blueScale:Float; }).blueScale; }), function():Dynamic return cast 1.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 19.0) : Float), (cast _Runtime.coalesce(({ final __structural15 = colorScaleBias; __structural15 == null ? _Runtime.UNDEFINED : (cast __structural15 : { var alphaScale:Float; }).alphaScale; }), function():Dynamic return cast 1.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 20.0) : Float), (cast _Runtime.coalesce(({ final __structural16 = colorScaleBias; __structural16 == null ? _Runtime.UNDEFINED : (cast __structural16 : { var redBias:Float; }).redBias; }), function():Dynamic return cast 0.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 21.0) : Float), (cast _Runtime.coalesce(({ final __structural17 = colorScaleBias; __structural17 == null ? _Runtime.UNDEFINED : (cast __structural17 : { var greenBias:Float; }).greenBias; }), function():Dynamic return cast 0.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 22.0) : Float), (cast _Runtime.coalesce(({ final __structural18 = colorScaleBias; __structural18 == null ? _Runtime.UNDEFINED : (cast __structural18 : { var blueBias:Float; }).blueBias; }), function():Dynamic return cast 0.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 23.0) : Float), (cast _Runtime.coalesce(({ final __structural19 = colorScaleBias; __structural19 == null ? _Runtime.UNDEFINED : (cast __structural19 : { var alphaBias:Float; }).alphaBias; }), function():Dynamic return cast 0.0) : Float));
