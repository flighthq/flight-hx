...
class WgpuShader {
  ...
  public static final NORMAL_BLEND__wgpuShader:flighthq._internal.dom.GPUBlendState = (cast (#if js _Runtime.callValue(WgpuShader.createWgpuBlendState__wgpuShader, cast ([(cast 'one' : String), (cast 'one-minus-src-alpha' : String)] : Array<Dynamic>)) #else WgpuShader.createWgpuBlendState__wgpuShader((cast 'one' : String), (cast 'one-minus-src-alpha' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end) : flighthq._internal.dom.GPUBlendState);
  ...
  public static function getActiveWgpuPipeline(state:WgpuRenderState):flighthq._internal.dom.GPURenderPipeline {
    ...
    return cast (cast getWgpuPipeline(({ final __callArgument2:Dynamic = state; __callArgument2; }), runtime.currentBlendMode, (cast stencilMode : Dynamic)) : flighthq._internal.dom.GPURenderPipeline);
    return cast null;
  }
  ...
  public static function getWgpuPipeline(state:WgpuRenderState, blendMode:Null<BlendMode>, stencilMode:StencilMode__wgpuShader):flighthq._internal.dom.GPURenderPipeline {
    ...
    blend = (cast getWgpuBlendState(({ final __callArgument6:Dynamic = blendMode; __callArgument6; })) : flighthq._internal.dom.GPUBlendState);
    ...
    layout = (cast createWgpuPipelineLayout(({ final __callArgument8:Dynamic = device; __callArgument8; }), runtime.uniformBindGroupLayout, runtime.textureBindGroupLayout) : flighthq._internal.dom.GPUPipelineLayout);
  ...
  public static function writeWgpuQuadUniforms(state:WgpuRenderState, renderProxy:{ var alpha:Float; var transform2D:{ var a:Float; var b:Float; var c:Float; var d:Float; var tx:Float; var ty:Float; }; }, colorScaleBias:Null<ColorScaleBias>, x0:Float, y0:Float, x1:Float, y1:Float, u0:Float, v0:Float, u1:Float, v1:Float, straightTextureAlpha:Bool = false):Float {
    ...
    setWgpuMatrixFromTransform(({ final __callArgument18:Dynamic = matrixArray; __callArgument18; }), ({ final __callArgument19:Dynamic = (cast renderProxy : { var alpha:Float; var transform2D:{ var a:Float; var b:Float; var c:Float; var d:Float; var tx:Float; var ty:Float; }; }).transform2D; __callArgument19; }), ({ final __callArgument20:Dynamic = viewport; __callArgument20; }));
    ...
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 16.0) : Float), (cast _Runtime.coalesce(({ final __typedStruct24 = colorScaleBias; __typedStruct24 == null ? _Runtime.UNDEFINED : (cast __typedStruct24 : { var redScale:Float; }).redScale; }), function():Dynamic return cast 1.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 17.0) : Float), (cast _Runtime.coalesce(({ final __typedStruct25 = colorScaleBias; __typedStruct25 == null ? _Runtime.UNDEFINED : (cast __typedStruct25 : { var greenScale:Float; }).greenScale; }), function():Dynamic return cast 1.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 18.0) : Float), (cast _Runtime.coalesce(({ final __typedStruct26 = colorScaleBias; __typedStruct26 == null ? _Runtime.UNDEFINED : (cast __typedStruct26 : { var blueScale:Float; }).blueScale; }), function():Dynamic return cast 1.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 19.0) : Float), (cast _Runtime.coalesce(({ final __typedStruct27 = colorScaleBias; __typedStruct27 == null ? _Runtime.UNDEFINED : (cast __typedStruct27 : { var alphaScale:Float; }).alphaScale; }), function():Dynamic return cast 1.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 20.0) : Float), (cast _Runtime.coalesce(({ final __typedStruct28 = colorScaleBias; __typedStruct28 == null ? _Runtime.UNDEFINED : (cast __typedStruct28 : { var redBias:Float; }).redBias; }), function():Dynamic return cast 0.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 21.0) : Float), (cast _Runtime.coalesce(({ final __typedStruct29 = colorScaleBias; __typedStruct29 == null ? _Runtime.UNDEFINED : (cast __typedStruct29 : { var greenBias:Float; }).greenBias; }), function():Dynamic return cast 0.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 22.0) : Float), (cast _Runtime.coalesce(({ final __typedStruct30 = colorScaleBias; __typedStruct30 == null ? _Runtime.UNDEFINED : (cast __typedStruct30 : { var blueBias:Float; }).blueBias; }), function():Dynamic return cast 0.0) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast uniformData : flighthq._internal._Float32Array), (cast (floatBase + 23.0) : Float), (cast _Runtime.coalesce(({ final __typedStruct31 = colorScaleBias; __typedStruct31 == null ? _Runtime.UNDEFINED : (cast __typedStruct31 : { var alphaBias:Float; }).alphaBias; }), function():Dynamic return cast 0.0) : Float));
