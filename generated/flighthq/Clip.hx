...
class Clip {
  public static function acquireClipRegion():ClipRegion {
    ...
    region = _Runtime.callProperty(Clip.clipRegionPool__clipRegion, 'pop', cast ([] : Array<Dynamic>));
  ...
  return cast region;
    ...
    return cast _Runtime.callValue(Clip.makeEmptyClipRegion__clipRegion, cast ([] : Array<Dynamic>));
    return cast null;
  }
  ...
  public static function clipRegionContainsPoint(clip:ClipRegion, x:Float, y:Float):Bool {
    ...
    return cast _Runtime.callValue(Clip.pointInContours__clipRegion, cast ([_Runtime.field(clip, 'contours'), _Runtime.field(clip, 'winding'), x, y] : Array<Dynamic>));
    return cast null;
  }
  ...
  public static function createClipRegionFromCircle(x:Float, y:Float, radius:Float, tolerance:Dynamic = 0.25):ClipRegion {
    ...
    _Runtime.callValue(Clip.appendCircleToPath__clipRegion, cast ([path, x, y, radius] : Array<Dynamic>));
  ...
  public static function createClipRegionFromContours(contours:Array<Array<Float>>, winding:PathWinding):ClipRegion {
    ...
    _Runtime.callValue(Clip.setRectangleToContoursBounds__clipRegion, cast ([rect, contours] : Array<Dynamic>));
  ...
  public static function createClipRegionFromEllipse(rectangle:RectangleLike, tolerance:Dynamic = 0.25):ClipRegion {
    var path:Dynamic = cast _Runtime.UNDEFINED;
    path = _Runtime.callValue(createPath, cast (['nonZero'] : Array<Dynamic>));
    _Runtime.callValue(Clip.appendEllipseToPath__clipRegion, cast ([path, _Runtime.field(rectangle, 'x'), _Runtime.field(rectangle, 'y'), _Runtime.field(rectangle, 'width'), _Runtime.field(rectangle, 'height')] : Array<Dynamic>));
    return cast _Runtime.callValue(createClipRegionFromPath, cast ([path, tolerance] : Array<Dynamic>));
    return cast null;
  }
  ...
  public static function createClipRegionFromRoundedRectangle(rectangle:RectangleLike, radius:Float, tolerance:Dynamic = 0.25):ClipRegion {
    ...
    path = _Runtime.callValue(createPath, cast (['nonZero'] : Array<Dynamic>));
    _Runtime.callValue(Clip.appendRoundedRectToPath__clipRegion, cast ([path, _Runtime.field(rectangle, 'x'), _Runtime.field(rectangle, 'y'), _Runtime.field(rectangle, 'width'), _Runtime.field(rectangle, 'height'), radius] : Array<Dynamic>));
    return cast _Runtime.callValue(createClipRegionFromPath, cast ([path, tolerance] : Array<Dynamic>));
    return cast null;
  }
  ...
  public static function releaseClipRegion(clip:ClipRegion):Void {
    _Runtime.callProperty(Clip.clipRegionPool__clipRegion, 'push', cast ([clip] : Array<Dynamic>));
  }
  ...
  _Runtime.setField(out, 'winding', 'nonZero');
  _Runtime.callValue(Clip.setRectangleToContoursBounds__clipRegion, cast ([_Runtime.field(out, 'rect'), cast ([quad] : Array<Dynamic>)] : Array<Dynamic>));
}
} else {
  ...
  _Runtime.setField(out, 'winding', inWinding);
  _Runtime.callValue(Clip.setRectangleToContoursBounds__clipRegion, cast ([_Runtime.field(out, 'rect'), newContours] : Array<Dynamic>));
}
    _Runtime.setField(out, 'version', _Runtime.unsignedShiftRight(Std.int((_Runtime.field(out, 'version') + 1.0)), Std.int(0.0)));
  }
