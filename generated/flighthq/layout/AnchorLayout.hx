...
class AnchorLayout {
  ...
  public static final anchorLayoutResolver__anchorLayout:LayoutResolver = (cast function(out:flighthq._internal._Float32Array, tree:LayoutTree, intrinsicSizes:flighthq._internal._ArrayLike<Float>, parentIndex:Float, childIndex:Float):Null<String> {
    ...
    left = _Runtime.coalesce(({ final __structural4 = style; __structural4 == null ? _Runtime.UNDEFINED : (cast __structural4 : { @:optional var left:Null<Float>; }).left; }), function():Dynamic return cast null);
    right = _Runtime.coalesce(({ final __structural5 = style; __structural5 == null ? _Runtime.UNDEFINED : (cast __structural5 : { @:optional var right:Null<Float>; }).right; }), function():Dynamic return cast null);
    top = _Runtime.coalesce(({ final __structural6 = style; __structural6 == null ? _Runtime.UNDEFINED : (cast __structural6 : { @:optional var top:Null<Float>; }).top; }), function():Dynamic return cast null);
    bottom = _Runtime.coalesce(({ final __structural7 = style; __structural7 == null ? _Runtime.UNDEFINED : (cast __structural7 : { @:optional var bottom:Null<Float>; }).bottom; }), function():Dynamic return cast null);
    intrinsicOffset = (childIndex * 2.0);
    width = ((cast ((cast !_Runtime.strictEquals(left, null) : Bool) && (cast !_Runtime.strictEquals(right, null) : Bool)) : Bool) ? (cast HxMath.max(0.0, ((parentWidth - left) - right)) : Dynamic) : (cast (cast AnchorLayout.finiteSize__anchorLayout((cast _Runtime.coalesce(({ final __structural8 = style; __structural8 == null ? _Runtime.UNDEFINED : (cast __structural8 : { @:optional var width:Null<Float>; }).width; }), function():Dynamic return cast _Runtime.getIndex(intrinsicSizes, intrinsicOffset)) : Float)) : Float) : Dynamic));
    height = ((cast ((cast !_Runtime.strictEquals(top, null) : Bool) && (cast !_Runtime.strictEquals(bottom, null) : Bool)) : Bool) ? (cast HxMath.max(0.0, ((parentHeight - top) - bottom)) : Dynamic) : (cast (cast AnchorLayout.finiteSize__anchorLayout((cast _Runtime.coalesce(({ final __structural9 = style; __structural9 == null ? _Runtime.UNDEFINED : (cast __structural9 : { @:optional var height:Null<Float>; }).height; }), function():Dynamic return cast _Runtime.getIndex(intrinsicSizes, (intrinsicOffset + 1.0))) : Float)) : Float) : Dynamic));
    align = _Runtime.coalesce(({ final __structural10 = style; __structural10 == null ? _Runtime.UNDEFINED : (cast __structural10 : { @:optional var align:Null<String>; }).align; }), function():Dynamic return cast 'topleft');
    childOffset = (childIndex * 4.0);
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast out : flighthq._internal._Float32Array), (cast childOffset : Float), (cast ((cast !_Runtime.strictEquals(left, null) : Bool) ? (cast (parentX + left) : Dynamic) : (cast ((cast !_Runtime.strictEquals(right, null) : Bool) ? (cast (((parentX + parentWidth) - right) - width) : Dynamic) : (cast (parentX + (cast AnchorLayout.alignX__anchorLayout((cast parentWidth : Float), (cast width : Float), ({ final __callArgument11:Dynamic = align; __callArgument11; })) : Float)) : Dynamic)) : Dynamic)) : Float));
    flighthq._internal._StaticIndex.writeFloat32ArrayTyped((cast out : flighthq._internal._Float32Array), (cast (childOffset + 1.0) : Float), (cast ((cast !_Runtime.strictEquals(top, null) : Bool) ? (cast (parentY + top) : Dynamic) : (cast ((cast !_Runtime.strictEquals(bottom, null) : Bool) ? (cast (((parentY + parentHeight) - bottom) - height) : Dynamic) : (cast (parentY + (cast AnchorLayout.alignY__anchorLayout((cast parentHeight : Float), (cast height : Float), ({ final __callArgument12:Dynamic = align; __callArgument12; })) : Float)) : Dynamic)) : Dynamic)) : Float));
