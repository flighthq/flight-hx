...
class SurfacePixel {
  ...
  public static function getSurfacePixelLuminance(source:Surface, x:Float, y:Float):Float {
    var i:Dynamic = cast _Runtime.UNDEFINED;
    i = (((y * source.width) + x) * 4.0);
    return cast HxMath.round((((flighthq._internal._StaticIndex.readUint8ClampedArray(source.data, i) * SurfacePixel.LUMA_R__surfacePixel) + (flighthq._internal._StaticIndex.readUint8ClampedArray(source.data, (i + 1.0)) * SurfacePixel.LUMA_G__surfacePixel)) + (flighthq._internal._StaticIndex.readUint8ClampedArray(source.data, (i + 2.0)) * SurfacePixel.LUMA_B__surfacePixel)));
    return cast null;
  }
