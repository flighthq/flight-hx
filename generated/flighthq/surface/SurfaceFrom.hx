...
class SurfaceFrom {
  ...
  public static function createSurfaceFromImageResource(resource:ImageResource):Surface {
    ...
    if (_Runtime.truthy(_Runtime.strictEquals(_Runtime.field(resource, 'source'), null))) {
      return cast _Runtime.callValue(createEntity, cast ([{ alphaType: _Runtime.field(resource, 'alphaType'), colorSpace: 'srgb', compressed: null, data: _Runtime.select(!_Runtime.strictEquals(_Runtime.field(resource, 'data'), null), function():Dynamic return cast new flighthq._internal._UInt8ClampedArray(_Runtime.field(resource, 'data')), function():Dynamic return cast new flighthq._internal._UInt8ClampedArray(((_Runtime.field(resource, 'width') * _Runtime.field(resource, 'height')) * 4.0))), format: _Runtime.field(resource, 'format'), height: _Runtime.field(resource, 'height'), source: null, version: 0.0, width: _Runtime.field(resource, 'width') }] : Array<Dynamic>));
    }
    ctx = flighthq._internal.backend.CanvasElementBackend.call(canvas, 'getContext', cast (['2d'] : Array<Dynamic>));
