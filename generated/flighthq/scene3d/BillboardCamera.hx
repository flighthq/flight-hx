...
class BillboardCamera {
  public static function orientBillboardToCamera(billboard:Billboard, camera:Camera3D):Bool {
    ...
    BillboardCamera.applyBillboardFacing__billboardCamera(({ final __callArgument2:Dynamic = billboard; __callArgument2; }));
    return cast true;
    return cast null;
  }

  public static function orientScene3DBillboardsToCamera(scene:Node3D, camera:Camera3D):Bool {
    if ((cast !(cast (cast BillboardCamera.setBillboardCameraBasis__billboardCamera(({ final __callArgument4:Dynamic = camera; __callArgument4; })) : Bool) : Bool) : Bool)) { return cast false; }
    BillboardCamera.orientBillboardSubtree__billboardCamera(({ final __callArgument6:Dynamic = scene; __callArgument6; }));
    return cast true;
    return cast null;
  }
  ...
  public static function applyBillboardFacing__billboardCamera(billboard:Billboard):Void {
    ...
    decomposeMatrix4(({ final __callArgument8:Dynamic = BillboardCamera._position__billboardCamera; __callArgument8; }), ({ final __callArgument9:Dynamic = BillboardCamera._rotationScratch__billboardCamera; __callArgument9; }), ({ final __callArgument10:Dynamic = BillboardCamera._scale__billboardCamera; __callArgument10; }), ({ final __callArgument11:Dynamic = world; __callArgument11; }));
    BillboardCamera.writeBillboardFacingMatrix__billboardCamera(({ final __callArgument16:Dynamic = BillboardCamera._facingWorld__billboardCamera; __callArgument16; }), billboard.mode);
    parent = (cast getNodeParent((cast (cast billboard : Node3D) : Dynamic)) : Null<Node3D>);
    if ((cast _Runtime.strictEquals(parent, null) : Bool)) {
      copyMatrix4(({ final __callArgument18:Dynamic = BillboardCamera._localScratch__billboardCamera; __callArgument18; }), ({ final __callArgument19:Dynamic = BillboardCamera._facingWorld__billboardCamera; __callArgument19; }));
    } else {
      var parentWorld:Matrix4 = (cast getNodeWorldMatrix4((cast parent : Dynamic)) : Matrix4);
      if ((cast (cast inverseMatrix4(({ final __callArgument22:Dynamic = BillboardCamera._inverseParentWorld__billboardCamera; __callArgument22; }), ({ final __callArgument23:Dynamic = parentWorld; __callArgument23; })) : Bool) : Bool)) {
        multiplyMatrix4(({ final __callArgument26:Dynamic = BillboardCamera._localScratch__billboardCamera; __callArgument26; }), ({ final __callArgument27:Dynamic = BillboardCamera._inverseParentWorld__billboardCamera; __callArgument27; }), ({ final __callArgument28:Dynamic = BillboardCamera._facingWorld__billboardCamera; __callArgument28; }));
      } else {
        copyMatrix4(({ final __callArgument32:Dynamic = BillboardCamera._localScratch__billboardCamera; __callArgument32; }), ({ final __callArgument33:Dynamic = BillboardCamera._facingWorld__billboardCamera; __callArgument33; }));
      }
    }
    setNodeLocalMatrix4((cast billboard : Dynamic), ({ final __callArgument36:Dynamic = BillboardCamera._localScratch__billboardCamera; __callArgument36; }));
  }
  ...
  public static function orientBillboardSubtree__billboardCamera(node:Node3D):Void {
    ...
    if ((cast (cast isBillboard(({ final __callArgument38:Dynamic = node; __callArgument38; })) : Bool) : Bool)) {
      BillboardCamera.applyBillboardFacing__billboardCamera(({ final __callArgument40:Dynamic = node; __callArgument40; }));
    }
    children = (cast (cast getNode3DRuntime(({ final __callArgument42:Dynamic = node; __callArgument42; })) : Node3DRuntime) : { var children:Null<Array<Node<Node3DTraits>>>; }).children;
  ...
  public static function setBillboardCameraBasis__billboardCamera(camera:Camera3D):Bool {
    ...
    if ((cast !(cast (cast inverseMatrix4(({ final __callArgument44:Dynamic = BillboardCamera._cameraWorld__billboardCamera; __callArgument44; }), ({ final __callArgument45:Dynamic = camera.view; __callArgument45; })) : Bool) : Bool) : Bool)) {
  ...
  public static final _rotationScratch__billboardCamera:Quaternion = (cast createQuaternion(({ final __callArgument48:Dynamic = 0.0; __callArgument48; }), ({ final __callArgument49:Dynamic = 0.0; __callArgument49; }), ({ final __callArgument50:Dynamic = 0.0; __callArgument50; }), ({ final __callArgument51:Dynamic = 1.0; __callArgument51; })) : Quaternion);
