...
class Platform {
  ...
  public static function getWebPlatformInfo__platform(out:PlatformInfo):PlatformInfo {
    ...
    (out.kind = cast ((cast parseUserAgentKind(out.name) : PlatformKind) : Dynamic));
    (out.version = cast ((cast parseUserAgentVersion((cast ua : String), out.name) : String) : Dynamic));
    (out.arch = cast ((cast parseUserAgentArch((cast ua : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) : String) : Dynamic));
    ...
    (out.engineVersion = cast ((cast parseUserAgentEngineVersion((cast ua : String), out.engine) : String) : Dynamic));
