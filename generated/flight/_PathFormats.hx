...
import flight._Path.appendPathArcTo;
...
import flight._Path.forEachPathSegment;
...
class _PathFormats {
  public static function appendSvgPathData(path:Path, d:String):Bool {
    ...
    readNumber = (cast function readNumber():Null<Float> {
      ...
      value = _Runtime.callProperty(flight._internal._HostValueLut.get('Number'), 'parseFloat', cast ([_Runtime.slice(d, start, pos)] : Array<Dynamic>));
      return cast ((cast _Runtime.callProperty(flight._internal._HostValueLut.get('Number'), 'isFinite', cast ([value] : Array<Dynamic>)) : Bool) ? (cast value : Dynamic) : (cast null : Dynamic));
    ...
    while ((cast true : Bool)) {
      ...
      if ((cast !(cast (cast _PathFormats.isSvgCommandLetter__svgPathData((cast commandLetter : String)) : Bool) : Bool) : Bool)) { return cast false; }
      pos++;
      ...
      while ((cast true : Bool)) {
        if ((cast !(cast first : Bool) : Bool)) {
          skipSeparators();
          if ((cast ((cast pos : Float) >= (cast length : Float)) : Bool)) { break; }
          if ((cast (cast _PathFormats.isSvgCommandLetter__svgPathData((cast _Runtime.getIndex(d, pos) : String)) : Bool) : Bool)) { break; }
        }
  ...
  public static function formatSvgPathData(path:Path, ?options:{ @:optional var precision:Float; }):String {
    ...
    forEachPathSegment(({ final __callArgument21:Dynamic = path; __callArgument21; }), (cast function(segment:PathSegment):Void {
      if ((cast _Runtime.strictEquals((cast segment : { var kind:String; }).kind, 'moveTo') : Bool)) {
        _Runtime.callProperty(parts, 'push', cast (['M' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var x:Float; var y:Float; }).x : Float), ({ final __callArgument22:Dynamic = precision; __callArgument22; })) : String)) + ' ' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var x:Float; var y:Float; }).y : Float), ({ final __callArgument24:Dynamic = precision; __callArgument24; })) : String)) + ''] : Array<Dynamic>));
      } else { if ((cast _Runtime.strictEquals((cast segment : { var kind:String; }).kind, 'lineTo') : Bool)) {
        _Runtime.callProperty(parts, 'push', cast (['L' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var x:Float; var y:Float; }).x : Float), ({ final __callArgument26:Dynamic = precision; __callArgument26; })) : String)) + ' ' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var x:Float; var y:Float; }).y : Float), ({ final __callArgument28:Dynamic = precision; __callArgument28; })) : String)) + ''] : Array<Dynamic>));
      } else { if ((cast _Runtime.strictEquals((cast segment : { var kind:String; }).kind, 'curveTo') : Bool)) {
        _Runtime.callProperty(parts, 'push', cast ([('Q' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var controlX:Float; var controlY:Float; var x:Float; var y:Float; }).controlX : Float), ({ final __callArgument30:Dynamic = precision; __callArgument30; })) : String)) + ' ' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var controlX:Float; var controlY:Float; var x:Float; var y:Float; }).controlY : Float), ({ final __callArgument32:Dynamic = precision; __callArgument32; })) : String)) + ' ' + '' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var controlX:Float; var controlY:Float; var x:Float; var y:Float; }).x : Float), ({ final __callArgument34:Dynamic = precision; __callArgument34; })) : String)) + ' ' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var controlX:Float; var controlY:Float; var x:Float; var y:Float; }).y : Float), ({ final __callArgument36:Dynamic = precision; __callArgument36; })) : String)) + '')] : Array<Dynamic>));
      } else { if ((cast _Runtime.strictEquals((cast segment : { var kind:String; }).kind, 'cubicCurveTo') : Bool)) {
        _Runtime.callProperty(parts, 'push', cast ([(('C' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var control1X:Float; var control1Y:Float; var control2X:Float; var control2Y:Float; var x:Float; var y:Float; }).control1X : Float), ({ final __callArgument38:Dynamic = precision; __callArgument38; })) : String)) + ' ' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var control1X:Float; var control1Y:Float; var control2X:Float; var control2Y:Float; var x:Float; var y:Float; }).control1Y : Float), ({ final __callArgument40:Dynamic = precision; __callArgument40; })) : String)) + ' ' + '' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var control1X:Float; var control1Y:Float; var control2X:Float; var control2Y:Float; var x:Float; var y:Float; }).control2X : Float), ({ final __callArgument42:Dynamic = precision; __callArgument42; })) : String)) + ' ' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var control1X:Float; var control1Y:Float; var control2X:Float; var control2Y:Float; var x:Float; var y:Float; }).control2Y : Float), ({ final __callArgument44:Dynamic = precision; __callArgument44; })) : String)) + ' ') + '' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var control1X:Float; var control1Y:Float; var control2X:Float; var control2Y:Float; var x:Float; var y:Float; }).x : Float), ({ final __callArgument46:Dynamic = precision; __callArgument46; })) : String)) + ' ' + Std.string((cast _PathFormats.formatSvgNumber__svgPathData((cast (cast segment : { var kind:String; var control1X:Float; var control1Y:Float; var control2X:Float; var control2Y:Float; var x:Float; var y:Float; }).y : Float), ({ final __callArgument48:Dynamic = precision; __callArgument48; })) : String)) + '')] : Array<Dynamic>));
