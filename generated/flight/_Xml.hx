...
class _Xml {
  public static function parseXmlAttributes(attrs:String):flight._internal._Record<String, String> {
    ...
    while ((cast !_Runtime.strictEquals((m = cast (_Runtime.callProperty(re, 'exec', cast ([attrs] : Array<Dynamic>)) : Dynamic)), null) : Bool)) {
      ...
      _Runtime.setIndex(result, attrName, (cast _Xml.decodeXmlEntities__xmlParse((cast value : String)) : String));
    }
    return cast result;
    return cast null;
  }
  ...
  public static function parseXmlDocument(xml:String):Null<XmlElement> {
    ...
    var entities:flight._internal._Record<String, String> = cast _Runtime.UNDEFINED;
    src = _Runtime.replace((cast _Xml.stripXmlComments__xmlParse((cast xml : String)) : String), _Runtime.regexp('\\r\\n?', 'g'), '\n', false);
    entities = (cast {  });
    (src = cast (StringTools.trim(Std.string((cast _Xml.stripXmlDoctypes__xmlParse((cast _Runtime.replace(src, _Runtime.regexp('<\\?[\\s\\S]*?\\?>', 'g'), '', false) : String), ({ final __callArgument2:Dynamic = entities; __callArgument2; })) : String))) : Dynamic));
    return cast (cast _Xml.parseElement__xmlParse((cast (cast _Xml.expandXmlEntities__xmlParse((cast src : String), ({ final __callArgument4:Dynamic = entities; __callArgument4; })) : String) : String), (cast { depth: 0.0, depthExceeded: false, pos: 0.0 } : Dynamic)) : Null<XmlElement>);
    return cast null;
  }
  ...
  public static final XML_ENTITIES__xmlParse:flight._internal._Record<String, String> = (cast { amp: '&', apos: '\'', gt: '>', lt: '<', quot: '"' });

  public static function expandXmlEntities__xmlParse(src:String, entities:flight._internal._Record<String, String>):String {
    var output:String = cast _Runtime.UNDEFINED;
    var budget:Float = cast _Runtime.UNDEFINED;
    output = src;
    budget = (_Runtime.multiplyNumbers(_Runtime.field(src, 'length'), _Xml.MAX_XML_ENTITY_GROWTH__xmlParse) + _Xml.MAX_XML_ENTITY_BUDGET__xmlParse);
    {
      var pass:Float = 0.0;
      while ((cast ((cast pass : Float) < (cast _Xml.MAX_XML_ENTITY_PASSES__xmlParse : Float)) : Bool)) {
  ...
  public static function decodeXmlEntities__xmlParse(s:String):String {
    return cast _Runtime.replace(s, _Runtime.regexp('&(?:#(\\d+)|#x([\\da-fA-F]+)|(\\w+));', 'g'), function(reference:String, dec:flight._internal._Any, hex:flight._internal._Any, name:flight._internal._Any):String {
      var numeric:flight._internal._Any = cast _Runtime.UNDEFINED;
      ...
      if ((cast !_Runtime.strictEquals(numeric, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool)) {
        var codepoint:Float = _Runtime.callValue(flight._internal._HostValueLut.get('parseInt'), cast ([numeric, ((cast !_Runtime.strictEquals(dec, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) ? (cast 10.0 : Dynamic) : (cast 16.0 : Dynamic))] : Array<Dynamic>));
      ...
      return cast _Runtime.coalesce(_Runtime.getIndex(_Xml.XML_ENTITIES__xmlParse, name), function():Dynamic return cast reference);
      return cast _Runtime.UNDEFINED;
    }, false);
    return cast null;
  }
  ...
  public static function parseElement__xmlParse(src:String, state:ParseState__xmlParse):Null<XmlElement> {
    ...
    var content:Array<flight._internal._Union2<String, XmlElement>> = cast _Runtime.UNDEFINED;
    var text:String = cast _Runtime.UNDEFINED;
    if ((cast ((cast (cast state : ParseState__xmlParse).depth : Float) >= (cast _Xml.MAX_XML_ELEMENT_DEPTH__xmlParse : Float)) : Bool)) {
      ((cast state : ParseState__xmlParse).depthExceeded = true);
      return cast null;
    }
    _Xml.skipWhitespace__xmlParse((cast src : String), (cast state : Dynamic));
    ...
    if ((cast _Runtime.strictEquals(_Runtime.getIndex(src, (cast state : ParseState__xmlParse).pos), '?') : Bool)) {
      ...
      return cast (cast _Xml.parseElement__xmlParse((cast src : String), (cast state : Dynamic)) : Null<XmlElement>);
    }
    ...
    attributes = (cast parseXmlAttributes((cast attrsStr : String)) : flight._internal._Record<String, String>);
    ...
    if ((cast !(cast selfClosing : Bool) : Bool)) {
      while ((cast ((cast (cast state : ParseState__xmlParse).pos : Float) < (cast _Runtime.field(src, 'length') : Float)) : Bool)) {
        ...
        if ((cast !_Runtime.strictEquals(_Runtime.getIndex(src, (cast state : ParseState__xmlParse).pos), '<') : Bool)) {
          ...
          var decoded:String = (cast _Xml.decodeXmlEntities__xmlParse((cast _Runtime.slice(src, textStart, (cast state : ParseState__xmlParse).pos) : String)) : String);
        ...
        var child:Null<XmlElement> = (cast _Xml.parseElement__xmlParse((cast src : String), (cast state : Dynamic)) : Null<XmlElement>);
        (cast state : ParseState__xmlParse).depth--;
  ...
  public static function stripXmlDoctypes__xmlParse(xml:String, out:flight._internal._Record<String, String>):String {
    var copyStart:Float = cast _Runtime.UNDEFINED;
    var output:String = cast _Runtime.UNDEFINED;
    var pos:Float = cast _Runtime.UNDEFINED;
    copyStart = 0.0;
    ...
    while ((cast ((cast pos : Float) < (cast _Runtime.field(xml, 'length') : Float)) : Bool)) {
      ...
      _Xml.collectXmlEntityDeclarations__xmlParse((cast _Runtime.slice(xml, doctypeStart, pos) : String), ({ final __callArgument8:Dynamic = out; __callArgument8; }));
      (copyStart = cast (pos : Dynamic));
    }
    return cast (output + _Runtime.slice(xml, copyStart, null));
    return cast null;
  ...
  public static function collectXmlEntityDeclarations__xmlParse(doctype:String, out:flight._internal._Record<String, String>):Void {
    var declaration:flight._internal._Any = cast _Runtime.UNDEFINED;
