...
class _BitmapFont {
  ...
  public static function createBitmapFontFromGlyphAtlas(atlas:GlyphAtlas):BitmapFont {
    ...
    return cast (cast createBitmapFont(({ final __callArgument10:Dynamic = { glyphs: glyphs, metrics: (#if flight_struct_typedef _Runtime.mergeObjects([runtime.metrics]) #else ({ final __structInitSource:Dynamic = _Runtime.mergeObjects([runtime.metrics]); ({ ascent: _Runtime.field(__structInitSource, 'ascent'), descent: _Runtime.field(__structInitSource, 'descent'), lineGap: _Runtime.field(__structInitSource, 'lineGap') } : GlyphMetrics); }) #end), pages: cast ([page] : Array<Dynamic>) }; __callArgument10; })) : BitmapFont);
    return cast null;
  }
  ...
  public static function explainBitmapFontGlyph(font:BitmapFont, codepoint:Float):BitmapFontGlyphExplanation {
    ...
    if ((cast _Runtime.strictEquals(pageCount, 0.0) : Bool)) { return (#if flight_struct_typedef _Runtime.mergeObjects([shared, { reason: 'no-pages' }, { renderable: false }]) #else ({ final __structInitSource:Dynamic = _Runtime.mergeObjects([shared, { reason: 'no-pages' }, { renderable: false }]); ({ glyphHeight: _Runtime.field(__structInitSource, 'glyphHeight'), glyphWidth: _Runtime.field(__structInitSource, 'glyphWidth'), page: _Runtime.field(__structInitSource, 'page'), pageCount: _Runtime.field(__structInitSource, 'pageCount'), reason: _Runtime.field(__structInitSource, 'reason'), renderable: _Runtime.field(__structInitSource, 'renderable') } : BitmapFontGlyphExplanation); }) #end); }
    if ((cast ((cast ((cast (cast glyph : { var width:Float; }).width : Float) <= (cast 0.0 : Float)) : Bool) || (cast ((cast (cast glyph : { var height:Float; }).height : Float) <= (cast 0.0 : Float)) : Bool)) : Bool)) { return (#if flight_struct_typedef _Runtime.mergeObjects([shared, { reason: 'empty-glyph' }, { renderable: false }]) #else ({ final __structInitSource:Dynamic = _Runtime.mergeObjects([shared, { reason: 'empty-glyph' }, { renderable: false }]); ({ glyphHeight: _Runtime.field(__structInitSource, 'glyphHeight'), glyphWidth: _Runtime.field(__structInitSource, 'glyphWidth'), page: _Runtime.field(__structInitSource, 'page'), pageCount: _Runtime.field(__structInitSource, 'pageCount'), reason: _Runtime.field(__structInitSource, 'reason'), renderable: _Runtime.field(__structInitSource, 'renderable') } : BitmapFontGlyphExplanation); }) #end); }
    return (#if flight_struct_typedef _Runtime.mergeObjects([shared, { reason: 'ok' }, { renderable: true }]) #else ({ final __structInitSource:Dynamic = _Runtime.mergeObjects([shared, { reason: 'ok' }, { renderable: true }]); ({ glyphHeight: _Runtime.field(__structInitSource, 'glyphHeight'), glyphWidth: _Runtime.field(__structInitSource, 'glyphWidth'), page: _Runtime.field(__structInitSource, 'page'), pageCount: _Runtime.field(__structInitSource, 'pageCount'), reason: _Runtime.field(__structInitSource, 'reason'), renderable: _Runtime.field(__structInitSource, 'renderable') } : BitmapFontGlyphExplanation); }) #end);
    return cast null;
  }
