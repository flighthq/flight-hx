...
class _TextLayout {
  ...
  public static function writeFormatRange__richTextContent(ranges:Array<TextFormatRange>, format:TextFormat, start:Float, end:Float):Void {
    ...
    if ((cast ((cast ((cast !_Runtime.strictEquals(previous, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) && (cast _Runtime.strictEquals((cast previous : TextFormatRange).end, start) : Bool)) : Bool) && (cast (cast _TextLayout.textFormatEquals__richTextContent((cast previous : TextFormatRange).format, ({ final __callArgument30:Dynamic = format; __callArgument30; })) : Bool) : Bool)) : Bool)) {
      ...
      _Runtime.callProperty(ranges, 'push', cast ([(cast createTextFormatRange(({ final __callArgument32:Dynamic = (#if flight_struct_typedef _Runtime.mergeObjects([format]) #else ({ final __structInitSource:Dynamic = _Runtime.mergeObjects([format]); ({ align: _Runtime.field(__structInitSource, 'align'), blockIndent: _Runtime.field(__structInitSource, 'blockIndent'), bold: _Runtime.field(__structInitSource, 'bold'), bullet: _Runtime.field(__structInitSource, 'bullet'), color: _Runtime.field(__structInitSource, 'color'), font: _Runtime.field(__structInitSource, 'font'), indent: _Runtime.field(__structInitSource, 'indent'), italic: _Runtime.field(__structInitSource, 'italic'), kerning: _Runtime.field(__structInitSource, 'kerning'), leading: _Runtime.field(__structInitSource, 'leading'), leftMargin: _Runtime.field(__structInitSource, 'leftMargin'), letterSpacing: _Runtime.field(__structInitSource, 'letterSpacing'), listMarker: _Runtime.field(__structInitSource, 'listMarker'), rightMargin: _Runtime.field(__structInitSource, 'rightMargin'), size: _Runtime.field(__structInitSource, 'size'), strikethrough: _Runtime.field(__structInitSource, 'strikethrough'), tabStops: _Runtime.field(__structInitSource, 'tabStops'), target: _Runtime.field(__structInitSource, 'target'), underline: _Runtime.field(__structInitSource, 'underline'), url: _Runtime.field(__structInitSource, 'url'), variations: _Runtime.field(__structInitSource, 'variations') } : TextFormat); }) #end); __callArgument32; }), (cast start : Float), (cast end : Float)) : TextFormatRange)] : Array<Dynamic>));
    }
  }
  ...
  public static function mergeTextFormat(base:TextFormat, override_:TextFormat):TextFormat {
    ...
    result = (cast (#if flight_struct_typedef _Runtime.mergeObjects([base]) #else ({ final __structInitSource:Dynamic = _Runtime.mergeObjects([base]); ({ align: _Runtime.field(__structInitSource, 'align'), blockIndent: _Runtime.field(__structInitSource, 'blockIndent'), bold: _Runtime.field(__structInitSource, 'bold'), bullet: _Runtime.field(__structInitSource, 'bullet'), color: _Runtime.field(__structInitSource, 'color'), font: _Runtime.field(__structInitSource, 'font'), indent: _Runtime.field(__structInitSource, 'indent'), italic: _Runtime.field(__structInitSource, 'italic'), kerning: _Runtime.field(__structInitSource, 'kerning'), leading: _Runtime.field(__structInitSource, 'leading'), leftMargin: _Runtime.field(__structInitSource, 'leftMargin'), letterSpacing: _Runtime.field(__structInitSource, 'letterSpacing'), listMarker: _Runtime.field(__structInitSource, 'listMarker'), rightMargin: _Runtime.field(__structInitSource, 'rightMargin'), size: _Runtime.field(__structInitSource, 'size'), strikethrough: _Runtime.field(__structInitSource, 'strikethrough'), tabStops: _Runtime.field(__structInitSource, 'tabStops'), target: _Runtime.field(__structInitSource, 'target'), underline: _Runtime.field(__structInitSource, 'underline'), url: _Runtime.field(__structInitSource, 'url'), variations: _Runtime.field(__structInitSource, 'variations') } : TextFormat); }) #end));
  ...
  public static function buildGroups__textLayout(out:Array<TextLayoutGroup>, paragraphLastLines:flight._internal._Set<Float>, text:String, formatRanges:Array<TextFormatRange>, lineBreaks:Array<Float>, containerWidth:Float, measure:TextMeasureFunction, wordWrap:Bool, multiline:Bool, maxLines:Float, truncationCharacter:String):Void {
    ...
    currentFormat = (cast (#if flight_struct_typedef _Runtime.mergeObjects([(cast formatRange : TextFormatRange).format]) #else ({ final __structInitSource:Dynamic = _Runtime.mergeObjects([(cast formatRange : TextFormatRange).format]); ({ align: _Runtime.field(__structInitSource, 'align'), blockIndent: _Runtime.field(__structInitSource, 'blockIndent'), bold: _Runtime.field(__structInitSource, 'bold'), bullet: _Runtime.field(__structInitSource, 'bullet'), color: _Runtime.field(__structInitSource, 'color'), font: _Runtime.field(__structInitSource, 'font'), indent: _Runtime.field(__structInitSource, 'indent'), italic: _Runtime.field(__structInitSource, 'italic'), kerning: _Runtime.field(__structInitSource, 'kerning'), leading: _Runtime.field(__structInitSource, 'leading'), leftMargin: _Runtime.field(__structInitSource, 'leftMargin'), letterSpacing: _Runtime.field(__structInitSource, 'letterSpacing'), listMarker: _Runtime.field(__structInitSource, 'listMarker'), rightMargin: _Runtime.field(__structInitSource, 'rightMargin'), size: _Runtime.field(__structInitSource, 'size'), strikethrough: _Runtime.field(__structInitSource, 'strikethrough'), tabStops: _Runtime.field(__structInitSource, 'tabStops'), target: _Runtime.field(__structInitSource, 'target'), underline: _Runtime.field(__structInitSource, 'underline'), url: _Runtime.field(__structInitSource, 'url'), variations: _Runtime.field(__structInitSource, 'variations') } : TextFormat); }) #end));
