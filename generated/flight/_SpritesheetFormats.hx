...
class _SpritesheetFormats {
  ...
  public static function animationFromTag__asepriteParse(tag:AsepriteFrameTag, frameNames:Array<String>, durationMap:flight._internal._Map<String, Float>):SpritesheetAnimationData {
    ...
    return cast (cast createSpritesheetAnimationData((cast { direction: _Runtime.coalesce(tag.direction, function():Dynamic return cast 'forward'), frameDuration: firstDuration, frameDurations: ((cast uniform : Bool) ? (cast null : Dynamic) : (cast durations : Dynamic)), frameNames: tagFrameNames, name: tag.name, repeatCount: -1.0 } : Dynamic)) : SpritesheetAnimationData);
    return cast null;
  }
  ...
  public static function parseAsepriteSpritesheet(json:String, ?diagnostics:Array<ImportDiagnostic>):SpritesheetData {
    ...
    try {
      ...
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument18:Dynamic = diagnostics; __callArgument18; }), ({ final __callArgument19:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument19; }), (cast 'spritesheet.aseprite.malformed-json' : String), (cast 'parseAsepriteSpritesheet' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument16:Dynamic = diagnostics; __callArgument16; }), ({ final __callArgument17:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument17; }), (cast 'spritesheet.aseprite.malformed-json' : String), (cast 'parseAsepriteSpritesheet' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    ...
    return cast (cast _SpritesheetFormats.documentToData__asepriteParse(({ final __callArgument20:Dynamic = document; __callArgument20; })) : SpritesheetData);
    return cast null;
  }
  ...
  public static function parseAsepriteSpritesheetDocument(json:String, ?diagnostics:Array<ImportDiagnostic>):AsepriteParsed {
    ...
    return cast { data: (cast _SpritesheetFormats.documentToData__asepriteParse(({ final __callArgument26:Dynamic = document; __callArgument26; })) : SpritesheetData), document: document };
    return cast null;
  }
  ...
  public static function dataToHashDocument__asepriteSerialize(data:SpritesheetData, existing:{ @:optional var frames:Null<flight._internal._Record<String, AsepriteHashFrame>>; @:optional var meta:Null<AsepriteMeta>; }):AsepriteHashDocument {
    ...
    for (frame in _Runtime.iterable(data.frames)) {
      _Runtime.setIndex(frames, frame.name, (cast _SpritesheetFormats.frameToEntry__asepriteSerialize(({ final __callArgument33:Dynamic = frame; __callArgument33; }), (cast (cast _SpritesheetFormats.resolveFrameDuration__asepriteSerialize(({ final __callArgument34:Dynamic = data; __callArgument34; }), (cast frame.name : String)) : Float) : Float)) : AsepriteBaseFrame));
    }
    return cast { frames: frames, meta: (cast _SpritesheetFormats.dataToMeta__asepriteSerialize(({ final __callArgument39:Dynamic = data; __callArgument39; }), (cast _Runtime.coalesce((cast existing : { @:optional var frames:Null<flight._internal._Record<String, AsepriteBaseFrame>>; @:optional var meta:Null<AsepriteMeta>; }).meta, function():Dynamic return cast {  }) : Dynamic)) : AsepriteMeta) };
    return cast null;
  }
  ...
  public static function dataToArrayDocument__asepriteSerialize(data:SpritesheetData, existing:{ @:optional var frames:Null<Array<AsepriteArrayFrame>>; @:optional var meta:Null<AsepriteMeta>; }):AsepriteArrayDocument {
    ...
    frames = (cast _Runtime.mapArray((cast data.frames : Array<SpritesheetFrameData>), function(frame:SpritesheetFrameData, __unused5:Float, __unused6:Array<SpritesheetFrameData>):{ var duration:Float; var frame:AsepriteRect; var rotated:Bool; var sourceSize:AsepriteSize; var spriteSourceSize:AsepriteRect; var trimmed:Bool; var filename:String; } return _Runtime.mergeObjects([{ filename: frame.name }, (cast _SpritesheetFormats.frameToEntry__asepriteSerialize(({ final __callArgument41:Dynamic = frame; __callArgument41; }), (cast (cast _SpritesheetFormats.resolveFrameDuration__asepriteSerialize(({ final __callArgument42:Dynamic = data; __callArgument42; }), (cast frame.name : String)) : Float) : Float)) : AsepriteBaseFrame)]), _Runtime.UNDEFINED));
    return cast { frames: frames, meta: (cast _SpritesheetFormats.dataToMeta__asepriteSerialize(({ final __callArgument47:Dynamic = data; __callArgument47; }), (cast _Runtime.coalesce((cast existing : { @:optional var frames:Null<Array<AsepriteArrayFrame>>; @:optional var meta:Null<AsepriteMeta>; }).meta, function():Dynamic return cast {  }) : Dynamic)) : AsepriteMeta) };
    return cast null;
  }
  ...
  public static function serializeAsepriteSpritesheet(data:SpritesheetData, ?existing:flight._internal._Partial<AsepriteDocument>, ?options:AsepriteSerializeOptions):String {
    ...
    variant = _Runtime.coalesce(({ final __typedStruct49 = options; __typedStruct49 == null ? _Runtime.UNDEFINED : __typedStruct49.variant; }), function():Dynamic return cast ((cast existingIsArray : Bool) ? (cast 'array' : Dynamic) : (cast 'hash' : Dynamic)));
    if ((cast _Runtime.strictEquals(variant, 'array') : Bool)) {
      var doc:AsepriteArrayDocument = (cast _SpritesheetFormats.dataToArrayDocument__asepriteSerialize(({ final __callArgument50:Dynamic = data; __callArgument50; }), ({ final __callArgument51:Dynamic = _Runtime.coalesce((cast existing : { @:optional var frames:Null<Array<AsepriteArrayFrame>>; @:optional var meta:Null<AsepriteMeta>; }), function():Dynamic return cast {  }); __callArgument51; })) : AsepriteArrayDocument);
      return cast _Runtime.jsonStringify(doc, null, 2.0);
    }
    doc = (cast _SpritesheetFormats.dataToHashDocument__asepriteSerialize(({ final __callArgument54:Dynamic = data; __callArgument54; }), ({ final __callArgument55:Dynamic = _Runtime.coalesce((cast existing : { @:optional var frames:Null<flight._internal._Record<String, AsepriteHashFrame>>; @:optional var meta:Null<AsepriteMeta>; }), function():Dynamic return cast {  }); __callArgument55; })) : AsepriteHashDocument);
    return cast _Runtime.jsonStringify(doc, null, 2.0);
    return cast null;
  }
  ...
  public static function dictToMap__cocosPlistParse(el:XmlElement):flight._internal._Map<String, XmlElement> {
    ...
    children = el.children;
    {
      ...
      while ((cast ((cast i : Float) < (cast _Runtime.field(children, 'length') : Float)) : Bool)) {
        ...
        if (_Runtime.truthy(_Runtime.andValue(_Runtime.strictEquals(({ final __typedStruct58 = keyEl; __typedStruct58 == null ? _Runtime.UNDEFINED : __typedStruct58.name; }), 'key'), function():Dynamic return cast valEl))) {
  ...
  public static function getTextValue__cocosPlistParse(el:Null<XmlElement>):String {
    return cast _Runtime.coalesce(({ final __typedStruct59 = el; __typedStruct59 == null ? _Runtime.UNDEFINED : (cast __typedStruct59 : { var text:String; }).text; }), function():Dynamic return cast '');
    return cast null;
  }

  public static function getBoolValue__cocosPlistParse(el:Null<XmlElement>):Bool {
    return cast _Runtime.strictEquals(({ final __typedStruct60 = el; __typedStruct60 == null ? _Runtime.UNDEFINED : (cast __typedStruct60 : { var name:String; }).name; }), 'true');
    return cast null;
  }

  public static function getIntValue__cocosPlistParse(el:Null<XmlElement>):Float {
    return cast _Runtime.callValue(flight._internal._HostValueLut.get('parseInt'), cast ([_Runtime.coalesce(({ final __typedStruct61 = el; __typedStruct61 == null ? _Runtime.UNDEFINED : (cast __typedStruct61 : { var text:String; }).text; }), function():Dynamic return cast '0'), 10.0] : Array<Dynamic>));
    return cast null;
  }
  ...
  public static function parseCocosPlistXml__cocosPlistParse(xml:String, diagnostics:Null<Array<ImportDiagnostic>>):CocosPlistDocument {
    ...
    rootDict = null;
    if ((cast _Runtime.strictEquals(({ final __typedStruct62 = root; __typedStruct62 == null ? _Runtime.UNDEFINED : (cast __typedStruct62 : { var name:String; }).name; }), 'plist') : Bool)) {
    ...
    } else { if ((cast _Runtime.strictEquals(({ final __typedStruct63 = root; __typedStruct63 == null ? _Runtime.UNDEFINED : (cast __typedStruct63 : { var name:String; }).name; }), 'dict') : Bool)) {
    ...
    rootMap = (cast _SpritesheetFormats.dictToMap__cocosPlistParse(({ final __callArgument64:Dynamic = rootDict; __callArgument64; })) : flight._internal._Map<String, XmlElement>);
    ...
    if ((cast _Runtime.strictEquals(({ final __typedStruct66 = metaEl; __typedStruct66 == null ? _Runtime.UNDEFINED : (cast __typedStruct66 : { var name:String; }).name; }), 'dict') : Bool)) {
      var metaMap:flight._internal._Map<String, XmlElement> = (cast _SpritesheetFormats.dictToMap__cocosPlistParse(({ final __callArgument67:Dynamic = metaEl; __callArgument67; })) : flight._internal._Map<String, XmlElement>);
    ...
    frames = (cast {  });
    if ((cast _Runtime.strictEquals(({ final __typedStruct69 = framesEl; __typedStruct69 == null ? _Runtime.UNDEFINED : (cast __typedStruct69 : { var name:String; }).name; }), 'dict') : Bool)) {
      var framesMap:flight._internal._Map<String, XmlElement> = (cast _SpritesheetFormats.dictToMap__cocosPlistParse(({ final __callArgument70:Dynamic = framesEl; __callArgument70; })) : flight._internal._Map<String, XmlElement>);
      for (__iteration2 in _Runtime.iterable(framesMap)) {
        ...
        var fm:flight._internal._Map<String, XmlElement> = (cast _SpritesheetFormats.dictToMap__cocosPlistParse(({ final __callArgument74:Dynamic = frameEl; __callArgument74; })) : flight._internal._Map<String, XmlElement>);
        ...
        if ((cast ((cast !(cast hasFrame : Bool) : Bool) && (cast !(cast hasSpriteFields : Bool) : Bool)) : Bool)) {
          reportImportDiagnostic(({ final __callArgument76:Dynamic = diagnostics; __callArgument76; }), ({ final __callArgument77:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Drop; __callArgument77; }), (cast 'spritesheet.cocos-plist.unrecognized-frame' : String), (cast 'parseCocosPlistXml' : String), ({ final __callArgument78:Dynamic = { frame: frameName }; __callArgument78; }));
          continue;
        }
        var rectStr:String = (cast _SpritesheetFormats.getTextValue__cocosPlistParse(({ final __callArgument82:Dynamic = _Runtime.coalesce(((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'frame'))), function():Dynamic return cast ((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'textureRect')))); __callArgument82; })) : String);
        var rotated:Bool = (cast _SpritesheetFormats.getBoolValue__cocosPlistParse(({ final __callArgument84:Dynamic = _Runtime.coalesce(((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'textureRotated'))), function():Dynamic return cast ((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'rotated')))); __callArgument84; })) : Bool);
        var offsetStr:String = (cast _SpritesheetFormats.getTextValue__cocosPlistParse(({ final __callArgument86:Dynamic = _Runtime.coalesce(((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'spriteOffset'))), function():Dynamic return cast ((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'offset')))); __callArgument86; })) : String);
        var sourceSizeStr:String = (cast _SpritesheetFormats.getTextValue__cocosPlistParse(({ final __callArgument88:Dynamic = _Runtime.coalesce(((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'spriteSourceSize'))), function():Dynamic return cast ((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'sourceSize')))); __callArgument88; })) : String);
        var sizeStr:String = (cast _SpritesheetFormats.getTextValue__cocosPlistParse(({ final __callArgument90:Dynamic = _Runtime.coalesce(((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'spriteSize'))), function():Dynamic return cast ((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'size')))); __callArgument90; })) : String);
        var trimmed:Bool = (cast _SpritesheetFormats.getBoolValue__cocosPlistParse(({ final __callArgument92:Dynamic = _Runtime.coalesce(((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'spriteTrimmed'))), function():Dynamic return cast ((cast fm : flight._internal._Map<String, XmlElement>).get((cast 'trimmed')))); __callArgument92; })) : Bool);
        ...
        if ((cast _Runtime.strictEquals(({ final __typedStruct94 = aliasEl; __typedStruct94 == null ? _Runtime.UNDEFINED : (cast __typedStruct94 : { var name:String; }).name; }), 'array') : Bool)) {
  ...
  public static function documentToData__cocosPlistParse(doc:CocosPlistDocument):SpritesheetData {
    ...
    frames = (cast _Runtime.mapArray((cast flight._internal.DynamicObject.entries(doc.frames) : Array<Array<flight._internal._Union2<String, CocosPlistFrame>>>), function(__parameter5:Array<flight._internal._Union2<String, CocosPlistFrame>>, __unused6:Float, __unused7:Array<Array<flight._internal._Union2<String, CocosPlistFrame>>>):SpritesheetFrameData {
      ...
      return cast (cast _SpritesheetFormats.plistFrameToData__cocosPlistParse((cast name : String), ({ final __callArgument97:Dynamic = pf; __callArgument97; })) : SpritesheetFrameData);
      return cast _Runtime.UNDEFINED;
    }, _Runtime.UNDEFINED));
  ...
  public static function parseCocosPlistSpritesheet(xml:String, ?diagnostics:Array<ImportDiagnostic>):SpritesheetData {
    return cast (cast _SpritesheetFormats.documentToData__cocosPlistParse((cast _SpritesheetFormats.parseCocosPlistXml__cocosPlistParse((cast xml : String), ({ final __callArgument99:Dynamic = diagnostics; __callArgument99; })) : CocosPlistDocument)) : SpritesheetData);
    return cast null;
  }
  ...
  public static function parseCocosPlistSpritesheetDocument(xml:String, ?diagnostics:Array<ImportDiagnostic>):CocosPlistParsed {
    ...
    document = (cast _SpritesheetFormats.parseCocosPlistXml__cocosPlistParse((cast xml : String), ({ final __callArgument103:Dynamic = diagnostics; __callArgument103; })) : CocosPlistDocument);
    return cast { data: (cast _SpritesheetFormats.documentToData__cocosPlistParse(({ final __callArgument105:Dynamic = document; __callArgument105; })) : SpritesheetData), document: document };
    return cast null;
  }
  ...
  public static function serializeCocosPlistSpritesheet(data:SpritesheetData, ?existing:{ @:optional var frames:Null<flight._internal._Record<String, CocosPlistFrame>>; @:optional var metadata:Null<CocosPlistMetadata>; }):String {
    ...
    frames = (cast {  });
    for (frame in _Runtime.iterable(data.frames)) {
      _Runtime.setIndex(frames, frame.name, (cast _SpritesheetFormats.frameToEntry__cocosPlistSerialize(({ final __callArgument109:Dynamic = frame; __callArgument109; })) : CocosPlistFrame));
    }
    doc = (cast { frames: frames, metadata: { format: _Runtime.coalesce(({ final __typedStruct112 = ({ final __structural111 = existing; __structural111 == null ? _Runtime.UNDEFINED : (cast __structural111 : { @:optional var metadata:Null<CocosPlistMetadata>; }).metadata; }); __typedStruct112 == null ? _Runtime.UNDEFINED : (cast __typedStruct112 : { var format:Float; }).format; }), function():Dynamic return cast 3.0), size: '{' + Std.string(data.imageWidth) + ',' + Std.string(data.imageHeight) + '}', textureFileName: _Runtime.orValue(_Runtime.orValue(data.imageFile, function():Dynamic return cast ({ final __typedStruct114 = ({ final __structural113 = existing; __structural113 == null ? _Runtime.UNDEFINED : (cast __structural113 : { @:optional var metadata:Null<CocosPlistMetadata>; }).metadata; }); __typedStruct114 == null ? _Runtime.UNDEFINED : (cast __typedStruct114 : { var textureFileName:String; }).textureFileName; })), function():Dynamic return cast '') } });
    return cast (cast _SpritesheetFormats.documentToXml__cocosPlistSerialize(({ final __callArgument115:Dynamic = doc; __callArgument115; })) : String);
    return cast null;
  }
  ...
  public static function inferAnimations__libgdxAtlasParse(frameNames:Array<String>, frameDuration:Float):Array<SpritesheetAnimationData> {
    ...
    for (__iteration6 in _Runtime.iterable(groups)) {
      ...
      _Runtime.callProperty(animations, 'push', cast ([(cast createSpritesheetAnimationData((cast { frameDuration: frameDuration, frameNames: (cast _Runtime.mapArray((cast entries : Array<{ var name:String; var index:Float; }>), function(e:{ var name:String; var index:Float; }, __unused7:Float, __unused8:Array<{ var name:String; var index:Float; }>):String return (cast e : { var name:String; var index:Float; }).name, _Runtime.UNDEFINED)), name: base, repeatCount: -1.0 } : Dynamic)) : SpritesheetAnimationData)] : Array<Dynamic>));
    }
  ...
  public static function parseLibgdxAtlasSpritesheet(text:String, ?options:LibgdxAtlasParseOptions, ?diagnostics:Array<ImportDiagnostic>):SpritesheetData {
    ...
    var frameNames:Array<String> = cast _Runtime.UNDEFINED;
    var animations:Array<SpritesheetAnimationData> = cast _Runtime.UNDEFINED;
    frameDuration = _Runtime.coalesce(({ final __typedStruct125 = options; __typedStruct125 == null ? _Runtime.UNDEFINED : __typedStruct125.frameDuration; }), function():Dynamic return cast 100.0);
    ...
    imageFile = _Runtime.coalesce(({ final __structural126 = firstPage; __structural126 == null ? _Runtime.UNDEFINED : (cast __structural126 : LibgdxPage__libgdxAtlasParse).filename; }), function():Dynamic return cast '');
    imageWidth = _Runtime.coalesce(({ final __structural127 = firstPage; __structural127 == null ? _Runtime.UNDEFINED : (cast __structural127 : LibgdxPage__libgdxAtlasParse).width; }), function():Dynamic return cast 0.0);
    imageHeight = _Runtime.coalesce(({ final __structural128 = firstPage; __structural128 == null ? _Runtime.UNDEFINED : (cast __structural128 : LibgdxPage__libgdxAtlasParse).height; }), function():Dynamic return cast 0.0);
    if ((cast ((cast !_Runtime.strictEquals(firstPage, _Runtime.field(_Runtime, 'UNDEFINED')) : Bool) && (cast _Runtime.strictEquals((cast firstPage : LibgdxPage__libgdxAtlasParse).filename, '') : Bool)) : Bool)) {
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument131:Dynamic = diagnostics; __callArgument131; }), ({ final __callArgument132:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument132; }), (cast 'spritesheet.libgdx-atlas.missing-page-header' : String), (cast 'parseLibgdxAtlasSpritesheet' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument129:Dynamic = diagnostics; __callArgument129; }), ({ final __callArgument130:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument130; }), (cast 'spritesheet.libgdx-atlas.missing-page-header' : String), (cast 'parseLibgdxAtlasSpritesheet' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    }
    ...
    animations = (cast _SpritesheetFormats.inferAnimations__libgdxAtlasParse(({ final __callArgument133:Dynamic = frameNames; __callArgument133; }), (cast frameDuration : Float)) : Array<SpritesheetAnimationData>);
    return cast (cast createSpritesheetData((cast { animations: animations, frames: frames, imageFile: imageFile, imageHeight: imageHeight, imageWidth: imageWidth, scale: 1.0 } : Dynamic)) : SpritesheetData);
    return cast null;
  }
  ...
  public static function getRegistry__spritesheetDetect():KeyedTable<RegisteredFormatEntry__spritesheetDetect> {
    ...
    (_SpritesheetFormats._registry__spritesheetDetect = cast ((cast createKeyedTable((cast 'SpritesheetFormat' : String), (cast 'Unclaimed' : String)) : { >KeyedTable<RegisteredFormatEntry__spritesheetDetect>, >Entity, }) : Dynamic));
  ...
  public static function getSpritesheetFormat(kind:SpritesheetFormatKind):Null<{ var detect:String->Bool; var parse:String->SpritesheetParseOptions->SpritesheetData; }> {
    return cast _Runtime.coalesce(({ final __structural137 = (cast getRegistryTableEntry((cast (cast _SpritesheetFormats.getRegistry__spritesheetDetect() : KeyedTable<RegisteredFormatEntry__spritesheetDetect>) : Dynamic), (cast kind : String)) : Null<RegisteredFormatEntry__spritesheetDetect>); __structural137 == null ? _Runtime.UNDEFINED : (cast __structural137 : { var entry:FormatEntry__spritesheetDetect; }).entry; }), function():Dynamic return cast null);
    return cast null;
  }
  ...
  public static function getSpritesheetFormatKinds():Array<SpritesheetFormatKind> {
    ...
    getRegistryTableKeys(({ final __callArgument138:Dynamic = kinds; __callArgument138; }), (cast (cast _SpritesheetFormats.getRegistry__spritesheetDetect() : KeyedTable<RegisteredFormatEntry__spritesheetDetect>) : Dynamic));
    return cast kinds;
    return cast null;
  }
  ...
  public static function parseSpritesheet(text:String, ?formatKind:SpritesheetFormatKind, ?options:SpritesheetParseOptions):Null<SpritesheetData> {
    ...
    return cast (cast (cast registered : RegisteredFormatEntry__spritesheetDetect).entry : FormatEntry__spritesheetDetect).parse((cast text : String), ({ final __callArgument140:Dynamic = opts; __callArgument140; }));
    return cast null;
  }
  ...
  public static function unregisterSpritesheetFormat(kind:SpritesheetFormatKind):Void {
    (_SpritesheetFormats._registry__spritesheetDetect = cast ((cast withoutRegistryTableEntry((cast (cast _SpritesheetFormats.getRegistry__spritesheetDetect() : KeyedTable<RegisteredFormatEntry__spritesheetDetect>) : Dynamic), (cast kind : String)) : { >KeyedTable<RegisteredFormatEntry__spritesheetDetect>, >Entity, }) : Dynamic));
  }
  ...
  public static function inferAnimations__starlingParse(frameNames:Array<String>, frameDuration:Float):Array<SpritesheetAnimationData> {
    ...
    for (__iteration1 in _Runtime.iterable(groups)) {
      ...
      if ((cast ((cast _Runtime.field(entries, 'length') : Float) < (cast 2.0 : Float)) : Bool)) { continue; }
      _Runtime.sortAndReturn(entries, function(a:{ var name:String; var index:Float; }, b:{ var name:String; var index:Float; }) return ((cast a : { var name:String; var index:Float; }).index - (cast b : { var name:String; var index:Float; }).index));
      _Runtime.callProperty(animations, 'push', cast ([(cast createSpritesheetAnimationData((cast { frameDuration: frameDuration, frameNames: (cast _Runtime.mapArray((cast entries : Array<{ var name:String; var index:Float; }>), function(e:{ var name:String; var index:Float; }, __unused2:Float, __unused3:Array<{ var name:String; var index:Float; }>):String return (cast e : { var name:String; var index:Float; }).name, _Runtime.UNDEFINED)), name: base, repeatCount: -1.0 } : Dynamic)) : SpritesheetAnimationData)] : Array<Dynamic>));
    }
    return cast animations;
    return cast null;
  }
  ...
  public static function documentToData__starlingParse(doc:StarlingDocument, regions:Array<TextureAtlasRegion>, frameDuration:Float, diagnostics:Null<Array<ImportDiagnostic>>):SpritesheetData {
    ...
    animations = (cast _SpritesheetFormats.inferAnimations__starlingParse(({ final __callArgument149:Dynamic = frameNames; __callArgument149; }), (cast frameDuration : Float)) : Array<SpritesheetAnimationData>);
    (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument153:Dynamic = diagnostics; __callArgument153; }), ({ final __callArgument154:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument154; }), (cast 'spritesheet.starling.missing-dimensions' : String), (cast 'documentToData' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument151:Dynamic = diagnostics; __callArgument151; }), ({ final __callArgument152:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Recover; __callArgument152; }), (cast 'spritesheet.starling.missing-dimensions' : String), (cast 'documentToData' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    return cast (cast createSpritesheetData((cast { animations: animations, frames: frames, imageFile: doc.imagePath, imageHeight: 0.0, imageWidth: 0.0, scale: 1.0 } : Dynamic)) : SpritesheetData);
    return cast null;
  }
  ...
  public static function parseStarlingSpritesheet(xml:String, ?options:StarlingParseOptions, ?diagnostics:Array<ImportDiagnostic>):SpritesheetData {
    return cast (cast _SpritesheetFormats.documentToData__starlingParse((cast _SpritesheetFormats.parseStarlingXml__starlingParse((cast xml : String)) : StarlingDocument), (cast _SpritesheetFormats.regionsFromXml__starlingParse((cast xml : String)) : Array<TextureAtlasRegion>), (cast _Runtime.coalesce(({ final __typedStruct155 = options; __typedStruct155 == null ? _Runtime.UNDEFINED : __typedStruct155.frameDuration; }), function():Dynamic return cast 100.0) : Float), ({ final __callArgument156:Dynamic = diagnostics; __callArgument156; })) : SpritesheetData);
    return cast null;
  }
  ...
  public static function parseStarlingSpritesheetDocument(xml:String, ?options:StarlingParseOptions, ?diagnostics:Array<ImportDiagnostic>):StarlingParsed {
    ...
    return cast { data: (cast _SpritesheetFormats.documentToData__starlingParse(({ final __callArgument159:Dynamic = document; __callArgument159; }), (cast _SpritesheetFormats.regionsFromXml__starlingParse((cast xml : String)) : Array<TextureAtlasRegion>), (cast _Runtime.coalesce(({ final __typedStruct160 = options; __typedStruct160 == null ? _Runtime.UNDEFINED : __typedStruct160.frameDuration; }), function():Dynamic return cast 100.0) : Float), ({ final __callArgument161:Dynamic = diagnostics; __callArgument161; })) : SpritesheetData), document: document };
    return cast null;
  }
  ...
  public static function documentToXml__starlingSerialize(doc:StarlingDocument):String {
    ...
    for (st in _Runtime.iterable(doc.subTextures)) {
      _Runtime.callProperty(lines, 'push', cast (['	<SubTexture ' + Std.string((cast _SpritesheetFormats.subTextureToAttr__starlingSerialize(({ final __callArgument167:Dynamic = st; __callArgument167; })) : String)) + '/>'] : Array<Dynamic>));
    }
  ...
  public static function serializeStarlingSpritesheet(data:SpritesheetData, ?existing:{ @:optional var imagePath:Null<String>; @:optional var subTextures:Null<Array<StarlingSubTexture>>; }):String {
    ...
    doc = (cast { imagePath: _Runtime.orValue(_Runtime.orValue(data.imageFile, function():Dynamic return cast ({ final __structural169 = existing; __structural169 == null ? _Runtime.UNDEFINED : (cast __structural169 : { @:optional var imagePath:Null<String>; }).imagePath; })), function():Dynamic return cast ''), subTextures: (cast _Runtime.mapArray((cast data.frames : Array<SpritesheetFrameData>), _SpritesheetFormats.frameToSubTexture__starlingSerialize, _Runtime.UNDEFINED)) });
    return cast (cast _SpritesheetFormats.documentToXml__starlingSerialize(({ final __callArgument170:Dynamic = doc; __callArgument170; })) : String);
    return cast null;
  }
  ...
  public static function documentToData__texturePackerParse(doc:TexturePackerDocument):SpritesheetData {
    ...
    animations = _Runtime.select(meta.frameTags, function():Dynamic return cast (cast _SpritesheetFormats.animationsFromFrameTags__texturePackerParse(meta.frameTags, ({ final __callArgument174:Dynamic = frameNames; __callArgument174; })) : Array<SpritesheetAnimationData>), function():Dynamic return cast cast ([] : Array<Dynamic>));
    return cast (cast createSpritesheetData((cast { animations: animations, frames: frames, imageFile: meta.image, imageHeight: (cast meta.size : { var h:Float; }).h, imageWidth: (cast meta.size : { var w:Float; }).w, scale: (cast _SpritesheetFormats.metaScale__texturePackerParse(({ final __callArgument176:Dynamic = meta; __callArgument176; })) : Float) } : Dynamic)) : SpritesheetData);
    return cast null;
  }
  ...
  public static function parseTexturePackerSpritesheet(json:String, ?diagnostics:Array<ImportDiagnostic>):SpritesheetData {
    ...
    try {
      ...
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument182:Dynamic = diagnostics; __callArgument182; }), ({ final __callArgument183:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument183; }), (cast 'spritesheet.texture-packer.malformed-json' : String), (cast 'parseTexturePackerSpritesheet' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument180:Dynamic = diagnostics; __callArgument180; }), ({ final __callArgument181:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument181; }), (cast 'spritesheet.texture-packer.malformed-json' : String), (cast 'parseTexturePackerSpritesheet' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
      return cast (cast (#if js _Runtime.callValue(createSpritesheetData, cast ([] : Array<Dynamic>)) #else createSpritesheetData(#if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end) : SpritesheetData);
    }
    return cast (cast _SpritesheetFormats.documentToData__texturePackerParse(({ final __callArgument184:Dynamic = document; __callArgument184; })) : SpritesheetData);
    return cast null;
  }
  ...
  public static function parseTexturePackerSpritesheetDocument(json:String, ?diagnostics:Array<ImportDiagnostic>):TexturePackerParsed {
    ...
    try {
      ...
      (#if js _Runtime.callValue(reportImportDiagnostic, cast ([({ final __callArgument188:Dynamic = diagnostics; __callArgument188; }), ({ final __callArgument189:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument189; }), (cast 'spritesheet.texture-packer.malformed-json' : String), (cast 'parseTexturePackerSpritesheetDocument' : String)] : Array<Dynamic>)) #else reportImportDiagnostic(({ final __callArgument186:Dynamic = diagnostics; __callArgument186; }), ({ final __callArgument187:Dynamic = (cast ImportDiagnosticSeverityValue : { var Drop:String; var Recover:String; var Reject:String; var Skip:String; }).Reject; __callArgument187; }), (cast 'spritesheet.texture-packer.malformed-json' : String), (cast 'parseTexturePackerSpritesheetDocument' : String), #if js (cast _Runtime.field(_Runtime, 'UNDEFINED') : Dynamic) #else (cast null : Dynamic) #end) #end);
    ...
    return cast { data: (cast _SpritesheetFormats.documentToData__texturePackerParse(({ final __callArgument190:Dynamic = document; __callArgument190; })) : SpritesheetData), document: document };
    return cast null;
  }
  ...
  public static function frameToEntry__texturePackerSerialize(frame:flight._internal._IndexedAccess<flight._internal._IndexedAccess<SpritesheetData, String>, Float>):TexturePackerHashFrame {
    var trimmed:Bool = cast _Runtime.UNDEFINED;
    trimmed = ((cast ((cast ((cast !_Runtime.strictEquals((cast frame : { var offsetX:Float; }).offsetX, 0.0) : Bool) || (cast !_Runtime.strictEquals((cast frame : { var offsetY:Float; }).offsetY, 0.0) : Bool)) : Bool) || (cast !_Runtime.strictEquals((cast frame : { var sourceWidth:Float; }).sourceWidth, (cast frame : { var width:Float; }).width) : Bool)) : Bool) || (cast !_Runtime.strictEquals((cast frame : { var sourceHeight:Float; }).sourceHeight, (cast frame : { var height:Float; }).height) : Bool));
    return (#if flight_struct_typedef _Runtime.mergeObjects([{ frame: { h: (cast frame : { var height:Float; }).height, w: (cast frame : { var width:Float; }).width, x: (cast frame : { var x:Float; }).x, y: (cast frame : { var y:Float; }).y } }, ((cast ((cast !_Runtime.strictEquals((cast frame : { var pivotX:Null<Float>; }).pivotX, null) : Bool) && (cast !_Runtime.strictEquals((cast frame : { var pivotY:Null<Float>; }).pivotY, null) : Bool)) : Bool) ? (cast { pivot: { x: (cast frame : { var pivotX:Null<Float>; }).pivotX, y: (cast frame : { var pivotY:Null<Float>; }).pivotY } } : Dynamic) : (cast {  } : Dynamic)), { rotated: (cast frame : { var rotated:Bool; }).rotated }, { sourceSize: { h: (cast frame : { var sourceHeight:Float; }).sourceHeight, w: (cast frame : { var sourceWidth:Float; }).sourceWidth } }, { spriteSourceSize: { h: (cast frame : { var height:Float; }).height, w: (cast frame : { var width:Float; }).width, x: (cast frame : { var offsetX:Float; }).offsetX, y: (cast frame : { var offsetY:Float; }).offsetY } }, { trimmed: trimmed }]) #else ({ final __structInitSource:Dynamic = _Runtime.mergeObjects([{ frame: { h: (cast frame : { var height:Float; }).height, w: (cast frame : { var width:Float; }).width, x: (cast frame : { var x:Float; }).x, y: (cast frame : { var y:Float; }).y } }, ((cast ((cast !_Runtime.strictEquals((cast frame : { var pivotX:Null<Float>; }).pivotX, null) : Bool) && (cast !_Runtime.strictEquals((cast frame : { var pivotY:Null<Float>; }).pivotY, null) : Bool)) : Bool) ? (cast { pivot: { x: (cast frame : { var pivotX:Null<Float>; }).pivotX, y: (cast frame : { var pivotY:Null<Float>; }).pivotY } } : Dynamic) : (cast {  } : Dynamic)), { rotated: (cast frame : { var rotated:Bool; }).rotated }, { sourceSize: { h: (cast frame : { var sourceHeight:Float; }).sourceHeight, w: (cast frame : { var sourceWidth:Float; }).sourceWidth } }, { spriteSourceSize: { h: (cast frame : { var height:Float; }).height, w: (cast frame : { var width:Float; }).width, x: (cast frame : { var offsetX:Float; }).offsetX, y: (cast frame : { var offsetY:Float; }).offsetY } }, { trimmed: trimmed }]); ({ frame: _Runtime.field(__structInitSource, 'frame'), pivot: _Runtime.field(__structInitSource, 'pivot'), rotated: _Runtime.field(__structInitSource, 'rotated'), sourceSize: _Runtime.field(__structInitSource, 'sourceSize'), spriteSourceSize: _Runtime.field(__structInitSource, 'spriteSourceSize'), trimmed: _Runtime.field(__structInitSource, 'trimmed') } : TexturePackerHashFrame); }) #end);
    return cast null;
  }
  ...
  public static function dataToHashDocument__texturePackerSerialize(data:SpritesheetData, existing:{ @:optional var frames:Null<flight._internal._Record<String, TexturePackerHashFrame>>; @:optional var meta:Null<TexturePackerMeta>; }):TexturePackerHashDocument {
    ...
    frames = (cast {  });
    for (frame in _Runtime.iterable(data.frames)) {
      _Runtime.setIndex(frames, frame.name, (cast _SpritesheetFormats.frameToEntry__texturePackerSerialize(({ final __callArgument194:Dynamic = frame; __callArgument194; })) : TexturePackerHashFrame));
    }
    return cast { frames: frames, meta: (cast _SpritesheetFormats.dataToMeta__texturePackerSerialize(({ final __callArgument196:Dynamic = data; __callArgument196; }), (cast _Runtime.coalesce((cast existing : { @:optional var frames:Null<flight._internal._Record<String, TexturePackerHashFrame>>; @:optional var meta:Null<TexturePackerMeta>; }).meta, function():Dynamic return cast {  }) : Dynamic)) : TexturePackerMeta) };
    return cast null;
  }
  ...
  public static function serializeTexturePackerSpritesheet(data:SpritesheetData, ?existing:flight._internal._Partial<TexturePackerDocument>, ?options:TexturePackerSerializeOptions):String {
    ...
    variant = _Runtime.coalesce(({ final __typedStruct202 = options; __typedStruct202 == null ? _Runtime.UNDEFINED : __typedStruct202.variant; }), function():Dynamic return cast ((cast existingIsArray : Bool) ? (cast 'array' : Dynamic) : (cast 'hash' : Dynamic)));
    if ((cast _Runtime.strictEquals(variant, 'array') : Bool)) {
      var doc:TexturePackerArrayDocument = (cast _SpritesheetFormats.dataToArrayDocument__texturePackerSerialize(({ final __callArgument203:Dynamic = data; __callArgument203; }), ({ final __callArgument204:Dynamic = _Runtime.coalesce((cast existing : { @:optional var frames:Null<Array<TexturePackerArrayFrame>>; @:optional var meta:Null<TexturePackerMeta>; }), function():Dynamic return cast {  }); __callArgument204; })) : TexturePackerArrayDocument);
      return cast _Runtime.jsonStringify(doc, null, 2.0);
    }
    doc = (cast _SpritesheetFormats.dataToHashDocument__texturePackerSerialize(({ final __callArgument207:Dynamic = data; __callArgument207; }), ({ final __callArgument208:Dynamic = _Runtime.coalesce((cast existing : { @:optional var frames:Null<flight._internal._Record<String, TexturePackerHashFrame>>; @:optional var meta:Null<TexturePackerMeta>; }), function():Dynamic return cast {  }); __callArgument208; })) : TexturePackerHashDocument);
    return cast _Runtime.jsonStringify(doc, null, 2.0);
    return cast null;
  }
}
