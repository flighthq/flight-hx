...
class CanvasTextureResolvers {
  ...
  public var bitmapElementCache:Null<flight._internal._WeakMap<Bitmap, { var element:flight._internal.dom.HTMLCanvasElement; var version:Float; }>>;
  public var textureWindowElementCache:Null<flight._internal._WeakMap<Texture, { var element:flight._internal.dom.HTMLCanvasElement; var surface:CanvasRenderSurface; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flight._internal.dom.CanvasImageSource; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>>;
  public var registryMiss:Null<RenderRegistry->Kind->Void>;

  private function new(surfaceCreator:CanvasRenderSurfaceCreator, ?registry:Null<flight._internal._Map<TextureSourceKind, CanvasTextureResolver>>, ?bitmapElementCache:Null<flight._internal._WeakMap<Bitmap, { var element:flight._internal.dom.HTMLCanvasElement; var version:Float; }>>, ?textureWindowElementCache:Null<flight._internal._WeakMap<Texture, { var element:flight._internal.dom.HTMLCanvasElement; var surface:CanvasRenderSurface; var flipX:Bool; var flipY:Bool; var imageVersion:Float; var source:flight._internal.dom.CanvasImageSource; var textureVersion:Float; var uvOffsetX:Float; var uvOffsetY:Float; var uvRotation:Float; var uvScaleX:Float; var uvScaleY:Float; }>>, ?registryMiss:Null<RenderRegistry->Kind->Void>):Void {
