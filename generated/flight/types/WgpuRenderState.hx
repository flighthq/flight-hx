...
class WgpuRenderState extends flight.types.RenderState {
  ...
  private function new(allowSmoothing:Bool, backgroundColor:Float, backgroundColorRgba:Array<Float>, backgroundColorString:String, currentClipDepth:Float, displayObjectClipHooks:Null<Scene2DClipHooks>, pixelRatio:Float, raster2DSurfaceProvider:Null<Raster2DSurfaceProvider>, renderAlpha:Float, renderBlendMode:Null<BlendMode>, renderTransform2D:Null<Matrix>, sceneGraphSyncPolicy:Scene3DGraphSyncPolicy, roundPixels:Bool, applyBlendMode:Null<WgpuRenderState->Null<BlendMode>->Void>, deviceState:WgpuDeviceState, device:flight._internal.dom.GPUDevice, format:flight._internal.dom.GPUTextureFormat, pipeline:WgpuPipeline):Void {
