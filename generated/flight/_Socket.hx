...
class _Socket {
  ...
  private static function createWebSocketBackend():SocketBackend {
    return cast { openSocket: function(options:SocketOptions, events:SocketEventSink):Null<SocketConnection> {
      ...
      ((cast ws : flight._internal.dom.WebSocket).onopen = function(__unused1:flight._internal.dom.Event):Void { _Runtime.callValue(function(__unused0:flight._internal.dom.Event):Void { _Runtime.callProperty(events, 'handleSocketOpen', cast ([] : Array<Dynamic>)); }, cast ([] : Array<Dynamic>)); });
      ...
      ((cast ws : flight._internal.dom.WebSocket).onerror = function(__unused3:flight._internal.dom.Event):Void { _Runtime.callValue(function(__unused2:flight._internal.dom.Event):Void { _Runtime.callProperty(events, 'handleSocketError', cast ([] : Array<Dynamic>)); }, cast ([] : Array<Dynamic>)); });
