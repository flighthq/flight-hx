...
class _TextInput {
  ...
  public static function adjustTextFormatRanges__textInputEditing(ranges:Array<TextFormatRange>, defaultFormat:flight._internal._IndexedAccess<RichTextData, String>, beginIndex:Float, endIndex:Float, insertLength:Float):Void {
    ...
    if ((cast ((cast _Runtime.strictEquals(_Runtime.field(ranges, 'length'), 0.0) : Bool) && (cast ((cast insertLength : Float) > (cast 0.0 : Float)) : Bool)) : Bool)) {
      _Runtime.callProperty(ranges, 'push', cast ([(cast createTextFormatRange(({ final __callArgument331:Dynamic = (#if flight_struct_typedef _Runtime.mergeObjects([defaultFormat]) #else ({ final __structInitSource:Dynamic = _Runtime.mergeObjects([defaultFormat]); ({ align: _Runtime.field(__structInitSource, 'align'), blockIndent: _Runtime.field(__structInitSource, 'blockIndent'), bold: _Runtime.field(__structInitSource, 'bold'), bullet: _Runtime.field(__structInitSource, 'bullet'), color: _Runtime.field(__structInitSource, 'color'), font: _Runtime.field(__structInitSource, 'font'), indent: _Runtime.field(__structInitSource, 'indent'), italic: _Runtime.field(__structInitSource, 'italic'), kerning: _Runtime.field(__structInitSource, 'kerning'), leading: _Runtime.field(__structInitSource, 'leading'), leftMargin: _Runtime.field(__structInitSource, 'leftMargin'), letterSpacing: _Runtime.field(__structInitSource, 'letterSpacing'), listMarker: _Runtime.field(__structInitSource, 'listMarker'), rightMargin: _Runtime.field(__structInitSource, 'rightMargin'), size: _Runtime.field(__structInitSource, 'size'), strikethrough: _Runtime.field(__structInitSource, 'strikethrough'), tabStops: _Runtime.field(__structInitSource, 'tabStops'), target: _Runtime.field(__structInitSource, 'target'), underline: _Runtime.field(__structInitSource, 'underline'), url: _Runtime.field(__structInitSource, 'url'), variations: _Runtime.field(__structInitSource, 'variations') } : TextFormat); }) #end); __callArgument331; }), (cast beginIndex : Float), (cast (beginIndex + insertLength) : Float)) : TextFormatRange)] : Array<Dynamic>));
    }
  }
