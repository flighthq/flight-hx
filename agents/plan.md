...
7. Confirm the Haxelib artifact installs and its clean `flighthq.sdk.Sdk.*` consumer runs.
...
- granular modules and `flighthq.sdk.Sdk` compile from consumer-style fixtures;
