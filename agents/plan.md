...
4. **Public modules and types:** root package facades paired with one `_Package` implementation module, canonical type ownership, renamed cross-package re-exports, and the broad `flight.Sdk` facade.
