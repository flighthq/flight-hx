...
- 513 schemas currently emit direct fields, covering 20,964 accesses.
- 1,023 eligible schemas remain audit-only, covering 9,702 pending accesses.
- 766 audit-only schemas have no recorded escape, covering 4,948 pending accesses.
...
- Generated `Dynamic` occurrences fell from 49,168 to 46,965 across checker-derived typed-struct assignments and the reviewed escape-free tranches.
