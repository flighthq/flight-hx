...
- 458 schemas currently emit direct fields, covering 19,061 accesses.
- 1,078 eligible schemas remain audit-only, covering 11,605 pending accesses.
- 821 audit-only schemas have no recorded escape, covering 6,851 pending accesses.
