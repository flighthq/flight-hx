...
- 468 schemas currently emit direct fields, covering 19,395 accesses.
- 1,068 eligible schemas remain audit-only, covering 11,271 pending accesses.
- 811 audit-only schemas have no recorded escape, covering 6,517 pending accesses.
