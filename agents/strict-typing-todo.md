...
- 463 schemas currently emit direct fields, covering 19,216 accesses.
- 1,073 eligible schemas remain audit-only, covering 11,450 pending accesses.
- 816 audit-only schemas have no recorded escape, covering 6,696 pending accesses.
