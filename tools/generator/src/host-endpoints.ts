...
export const hostReceiverContracts: readonly HostReceiverContract[] = [
  {
    ...
    runtimePath: 'src/flighthq/_internal/backend/Canvas2dBackend.hx',
  },
  {
    binding: 'CanvasElementBackend',
    dynamicFallback: true,
    receiverTypes: ['HTMLCanvasElement', 'OffscreenCanvas'],
    runtimePath: 'src/flighthq/_internal/backend/CanvasElementBackend.hx',
  },
  {
    binding: 'DomDocumentBackend',
    dynamicFallback: true,
    receiverTypes: ['Document'],
    runtimePath: 'src/flighthq/_internal/backend/DomDocumentBackend.hx',
  },
  {
    binding: 'DomNavigatorBackend',
    dynamicFallback: true,
    receiverTypes: ['Navigator'],
    runtimePath: 'src/flighthq/_internal/backend/DomNavigatorBackend.hx',
  },
  {
    binding: 'DomWindowBackend',
    dynamicFallback: true,
    receiverTypes: ['Window'],
    runtimePath: 'src/flighthq/_internal/backend/DomWindowBackend.hx',
  },
  {
  ...
  },
  {
    ...
    runtimePath: 'src/flighthq/_internal/backend/WebGpuCanvasContextBackend.hx',
  },
  {
    binding: 'WebGpuDeviceBackend',
    dynamicFallback: true,
    receiverTypes: ['GPUDevice'],
    runtimePath: 'src/flighthq/_internal/backend/WebGpuDeviceBackend.hx',
  },
  {
    binding: 'WebGpuLimitsBackend',
    dynamicFallback: true,
    receiverTypes: ['GPUSupportedLimits'],
    runtimePath: 'src/flighthq/_internal/backend/WebGpuLimitsBackend.hx',
  },
  {
    binding: 'WebGpuQueueBackend',
    dynamicFallback: true,
    receiverTypes: ['GPUQueue'],
    runtimePath: 'src/flighthq/_internal/backend/WebGpuQueueBackend.hx',
  },
];
