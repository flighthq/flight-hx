...
// replaced by Lime's window/render lifecycle, and Flight's Lime host capabilities are enabled with
// `HostLime.enableHostLime(this)`. The DOM `pointerdown`/`keydown` listeners become
