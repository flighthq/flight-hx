...
```sh
npm run generate       # regenerate src, bridges, and reports
...
Generated Haxe under `src/` is disposable. Change the TypeScript generator, a semantic patch, or a runtime template instead of editing generated output. See [AGENTS.md](AGENTS.md) and [agents/architecture.md](agents/architecture.md) for the durable design.
