...
class Share {
...
}, share: flighthq.internal.FlightAsync.make(function(content:Dynamic, ?_options:Dynamic):flighthq.internal.FlightPromise<Dynamic> {
  ...
  try {
  var data:Dynamic = FlightRuntime.callValue(Share.shareContentToNavigatorData__share, cast ([content] : Array<Dynamic>));
  flighthq.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(FlightRuntime.callProperty(FlightRuntime, 'globalValue', cast (['navigator'] : Array<Dynamic>)), 'share', cast ([data] : Array<Dynamic>)));
  return cast true;
} catch (__error:Dynamic) {
  return cast false;
}
  return cast null;
}), shareWithResult: flighthq.internal.FlightAsync.make(function(content:Dynamic, ?_options:Dynamic):flighthq.internal.FlightPromise<Dynamic> {
  if (FlightRuntime.truthy(FlightRuntime.orValue(FlightRuntime.orValue(FlightRuntime.strictEquals(FlightRuntime.callProperty(FlightRuntime, 'typeofGlobal', cast (['navigator'] : Array<Dynamic>)), 'undefined'), function():Dynamic return cast !FlightRuntime.truthy(FlightRuntime.hasField(FlightRuntime.callProperty(FlightRuntime, 'globalValue', cast (['navigator'] : Array<Dynamic>)), 'share'))), function():Dynamic return cast !FlightRuntime.strictEquals(FlightRuntime.typeofValue(FlightRuntime.field(FlightRuntime.callProperty(FlightRuntime, 'globalValue', cast (['navigator'] : Array<Dynamic>)), 'share')), 'function')))) {
  ...
  public static function shareContent(content:ShareContent, ?options:ShareOptions):flighthq.internal.FlightPromise<Bool> {
  ...
  public static function shareContentWithResult(content:ShareContent, ?options:ShareOptions):flighthq.internal.FlightPromise<ShareResult> {
    return cast flighthq.internal.FlightAsync.make(function():flighthq.internal.FlightPromise<ShareResult> {
  ...
  return cast { completed: false, activityType: null, dismissed: false };
      ...
      result = flighthq.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(FlightRuntime.callValue(getShareBackend, cast ([] : Array<Dynamic>)), 'shareWithResult', cast ([content, options] : Array<Dynamic>)));
  ...
  public static function shareText(text:String, ?options:ShareOptions):flighthq.internal.FlightPromise<Bool> {
    return cast FlightRuntime.callValue(shareContent, cast ([{ text: text }, options] : Array<Dynamic>));
    return cast null;
  }

  public static function shareUrl(url:String, ?options:ShareOptions):flighthq.internal.FlightPromise<Bool> {
