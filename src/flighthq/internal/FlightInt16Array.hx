...
abstract FlightInt16Array(Dynamic) {
  ...
  public function fill(value:Int, start = 0, ?end:Int):FlightInt16Array {
  ...
  public function subarray(?begin:Int, ?end:Int):FlightInt16Array {
    final start = begin == null ? 0 : begin;
    final stop = end == null ? length : end;
    #if js
    return cast js.Syntax.code('{0}.subarray({1}, {2})', this, start, stop);
    #else
    return new FlightInt16Array((cast this : Array<Int>).slice(start, stop));
    #end
  }
