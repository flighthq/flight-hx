...
class VideoApi {
  ...
  public static function loadVideoResourceFromBlob(blob:Dynamic, ?options:VideoResourceLoadOptions, ?signal:Dynamic):flighthq.internal.FlightPromise<VideoResource> {
    return cast flighthq.internal.FlightAsync.make(function():flighthq.internal.FlightPromise<VideoResource> {
      ...
      try {
        try {
  var __returnValue0:Dynamic = flighthq.internal.FlightAsync.awaitValue(FlightRuntime.callValue(loadVideoResourceFromUrl, cast ([url, options, signal] : Array<Dynamic>)));
  {
  ...
  public static function loadVideoResourceFromUrl(url:String, ?options:VideoResourceLoadOptions, ?signal:Dynamic):flighthq.internal.FlightPromise<VideoResource> {
  ...
  public static function loadVideoResourceFromUrls(sources:Array<VideoResourceUrl>, ?options:VideoResourceLoadOptions, ?signal:Dynamic):flighthq.internal.FlightPromise<VideoResource> {
