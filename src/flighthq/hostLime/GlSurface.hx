...
// counterpart of flighthq.scene2dCairo.CairoSurface, promoted from the
...
class GlSurface {
  ...
  public static function createGlSurface(window:Window):flighthq._internal.dom.HTMLCanvasElement {
