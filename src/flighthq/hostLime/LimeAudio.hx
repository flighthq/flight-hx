...
import flighthq._internal.backend.NativeAudioBuffer;
import flighthq._internal.dom.AudioBuffer;
import flighthq._internal.dom.AudioBufferSourceNode;
import flighthq._internal.dom.AudioContext;
import flighthq._internal.dom.AudioDestinationNode;
import flighthq._internal.dom.AudioNode;
import flighthq._internal.dom.AudioParam;
import flighthq._internal.dom.GainNode;
import flighthq._internal.dom.StereoPannerNode;
...
private class LimeAudioBufferSourceNode extends LimeAudioNode implements AudioBufferSourceNode {
  ...
  public function applyChain():Void {
    ...
    source.position = new lime.math.Vector4(pan, 0, -Math.sqrt(Math.max(0, 1 - pan * pan)));
