...
class LimeLoop {
  ...
  public static function createLimeLoopBackend(application:Application):flighthq.types.LoopBackend {
    var nextHandle = 1;
    ...
    return cast {
      requestFrame: function(callback:Float->Void):flighthq._internal._Any {
