...
class Storage {
  ...
  public static function getStorageQuotaEstimate():flighthq.internal.FlightPromise<Null<StorageQuota>> {
    return cast flighthq.internal.FlightAsync.make(function():flighthq.internal.FlightPromise<Null<StorageQuota>> {
