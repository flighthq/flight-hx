...
class Effects {
  ...
  public static function computeKuwaharaGaussianWeights(radius:Float, out:flighthq.internal.FlightFloat32Array):Float {
  ...
  public static function computeSsaoSampleKernel(samples:Float, out:flighthq.internal.FlightFloat32Array):Float {
  ...
  public static function createBayerMatrix(order:Float, out:flighthq.internal.FlightFloat32Array):Float {
    var size:Dynamic = cast FlightRuntime.UNDEFINED;
  ...
  public static function createGaussianKernelWeights(radius:Float, sigma:Float, out:flighthq.internal.FlightFloat32Array):Float {
    var r:Dynamic = cast FlightRuntime.UNDEFINED;
    var s:Dynamic = cast FlightRuntime.UNDEFINED;
    var twoSigmaSq:Dynamic = cast FlightRuntime.UNDEFINED;
    var sum:Dynamic = cast FlightRuntime.UNDEFINED;
  ...
  public static function getAcesInputMatrix(out:flighthq.internal.FlightFloat32Array):Void {
  ...
  public static function getAcesOutputMatrix(out:flighthq.internal.FlightFloat32Array):Void {
  ...
  public static function getSobelKernelCoefficients(out:flighthq.internal.FlightFloat32Array):Void {
    FlightRuntime.setIndex(out, 0.0, -1.0);
