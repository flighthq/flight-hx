...
class EffectsCairo {
  ...
  public static inline function createCairoRenderEffectPipeline(_state:CanvasRenderState, ?options:RenderEffectPipelineOptions):CanvasRenderEffectPipeline { return flight.EffectsCanvas.createCanvasRenderEffectPipeline(_state, options); }
