...
class ApplicationApi {
  ...
  @:keep public static function lockApplicationPointer(element:Dynamic):flight.internal.FlightPromise<flight.internal.FlightNothing> {
    ...
    return cast (cast FlightRuntime.select(FlightRuntime.isInstanceOf(result, FlightRuntime.callProperty(FlightRuntime, 'globalValue', cast (['Promise'] : Array<Dynamic>))), function():Dynamic return cast result, function():Dynamic return cast FlightRuntime.callProperty(FlightRuntime.callProperty(FlightRuntime, 'globalValue', cast (['Promise'] : Array<Dynamic>)), 'resolve', cast ([] : Array<Dynamic>))) : flight.internal.FlightPromise<flight.internal.FlightNothing>);
    return cast null;
  }
