...
class Net {
  ...
  try {
    try {
  var response:Dynamic = flight.internal.FlightAsync.awaitValue(FlightRuntime.callValue(FlightRuntime.callProperty(FlightRuntime, 'globalValue', cast (['fetch'] : Array<Dynamic>)), cast ([FlightRuntime.field(request, 'url'), FlightRuntime.callValue(Net._toNetFetchInit__net, cast ([request, FlightRuntime.field(controller, 'signal')] : Array<Dynamic>))] : Array<Dynamic>)));
  ...
  var body:Dynamic = flight.internal.FlightAsync.awaitValue(FlightRuntime.callValue(Net._readNetResponseBody__net, cast ([response, FlightRuntime.coalesce(FlightRuntime.field(request, 'responseType'), function():Dynamic return cast 'text'), FlightRuntime.optionalField(options, 'progress')] : Array<Dynamic>)));
