...
class Clipboard {
  ...
  try {
  var items:Dynamic = flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(cb, 'read', cast ([] : Array<Dynamic>)));
  ...
  var blob:Dynamic = flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(item, 'getType', cast ([format] : Array<Dynamic>)));
  ...
  try {
  var blob:Dynamic = flight.internal.FlightAsync.awaitValue(FlightRuntime.callValue(Clipboard.blobFromFormatData__clipboard, cast ([format, data] : Array<Dynamic>)));
  flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(cb, 'write', cast ([cast ([FlightRuntime.construct(FlightRuntime.callProperty(FlightRuntime, 'globalValue', cast (['ClipboardItem'] : Array<Dynamic>)), [FlightRuntime.objectFromPairs([{ key: format, value: blob }])])] : Array<Dynamic>)] : Array<Dynamic>)));
  return cast true;
} catch (__error:Dynamic) {
  return cast false;
}
  ...
  formats = flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(FlightRuntime.thisValue(), 'getFormats', cast ([] : Array<Dynamic>)));
  ...
  var entry:Dynamic = {  };
  for (item in FlightRuntime.iterable(items)) {
    FlightRuntime.setIndex(entry, FlightRuntime.field(item, 'format'), flight.internal.FlightAsync.awaitValue(FlightRuntime.callValue(Clipboard.blobFromFormatData__clipboard, cast ([FlightRuntime.field(item, 'format'), FlightRuntime.field(item, 'data')] : Array<Dynamic>))));
  }
  flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(cb, 'write', cast ([cast ([FlightRuntime.construct(FlightRuntime.callProperty(FlightRuntime, 'globalValue', cast (['ClipboardItem'] : Array<Dynamic>)), [entry])] : Array<Dynamic>)] : Array<Dynamic>)));
  return cast true;
} catch (__error:Dynamic) {
  return cast false;
}
  ...
  if (FlightRuntime.truthy(FlightRuntime.orValue(FlightRuntime.strictEquals(cb, null), function():Dynamic return cast !FlightRuntime.strictEquals(FlightRuntime.typeofValue(FlightRuntime.field(cb, 'read')), 'function')))) { return cast {  }; }
  try {
  var clipItems:Dynamic = flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(cb, 'read', cast ([] : Array<Dynamic>)));
  var result:Dynamic = {  };
  ...
  var blob:Dynamic = flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(clipItem, 'getType', cast ([format] : Array<Dynamic>)));
  FlightRuntime.setIndex(result, format, FlightRuntime.select(StringTools.startsWith(format, 'image/'), function():Dynamic return cast flight.internal.FlightAsync.awaitValue(FlightRuntime.callValue(Clipboard.readBlobAsDataUrl__clipboard, cast ([blob] : Array<Dynamic>))), function():Dynamic return cast flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(blob, 'text', cast ([] : Array<Dynamic>)))));
}
    }
  }
  return cast result;
  ...
  return cast null;
}), readText: flight.internal.FlightAsync.make(function():flight.internal.FlightPromise<Dynamic> {
  var cb:Dynamic = cast FlightRuntime.UNDEFINED;
  cb = FlightRuntime.callValue(Clipboard.getWebClipboard__clipboard, cast ([] : Array<Dynamic>));
  ...
  try {
  return cast flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(cb, 'readText', cast ([] : Array<Dynamic>)));
} catch (__error:Dynamic) {
  return cast '';
}
  return cast null;
  ...
  try {
  flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(cb, 'writeText', cast ([text] : Array<Dynamic>)));
  return cast true;
} catch (__error:Dynamic) {
  return cast false;
}
  ...
  return cast FlightRuntime.compare(FlightRuntime.field(flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(FlightRuntime.thisValue(), 'readText', cast ([] : Array<Dynamic>))), 'length'), 0.0, '>');
  return cast null;
  ...
  var blob:Dynamic = flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(item, 'getType', cast ([type] : Array<Dynamic>)));
  ...
  if (FlightRuntime.truthy(FlightRuntime.strictEquals(cb, null))) { return cast false; }
  try {
  var response:Dynamic = flight.internal.FlightAsync.awaitValue(FlightRuntime.callValue(FlightRuntime.callProperty(FlightRuntime, 'globalValue', cast (['fetch'] : Array<Dynamic>)), cast ([dataUrl] : Array<Dynamic>)));
  var blob:Dynamic = flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(response, 'blob', cast ([] : Array<Dynamic>)));
  flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(cb, 'write', cast ([cast ([FlightRuntime.construct(FlightRuntime.callProperty(FlightRuntime, 'globalValue', cast (['ClipboardItem'] : Array<Dynamic>)), [FlightRuntime.objectFromPairs([{ key: FlightRuntime.field(blob, 'type'), value: blob }])])] : Array<Dynamic>)] : Array<Dynamic>)));
  return cast true;
} catch (__error:Dynamic) {
  return cast false;
}
  ...
  return cast FlightRuntime.compare(FlightRuntime.field(flight.internal.FlightAsync.awaitValue(FlightRuntime.callProperty(FlightRuntime.thisValue(), 'readImage', cast ([] : Array<Dynamic>))), 'length'), 0.0, '>');
  return cast null;
