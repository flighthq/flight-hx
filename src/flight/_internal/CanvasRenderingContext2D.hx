...
import flight._internal.backend.Canvas2dBackend;

/**
 * Temporary compatibility shim. Generated code still names this type for Canvas 2D
 * access; the implementation now lives in `flight._internal.backend.Canvas2dBackend`.
 *
 * Builder: once the generator emits `flight._internal.backend.Canvas2dBackend`
