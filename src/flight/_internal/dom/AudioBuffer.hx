...
interface AudioBuffer {
  ...
  function getChannelData(channel:Float):flight._internal._Float32Array;
  function copyToChannel(source:flight._internal._Float32Array, channelNumber:Float, ?startInChannel:Float):Void;
}
