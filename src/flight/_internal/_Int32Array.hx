...
#if js
abstract _Int32Array(Dynamic) {
#elseif lime
abstract _Int32Array(_LimeTypedArray) {
#else
abstract _Int32Array(Array<Int>) {
#end
  ...
  public function new(source:Dynamic = 0, ?byteOffset:Int, ?length:Int) {
    ...
    this = byteOffset == null
      ? js.Syntax.code('new Int32Array({0})', source)
      : length == null
        ? js.Syntax.code('new Int32Array({0}, {1})', source, byteOffset)
        : js.Syntax.code('new Int32Array({0}, {1}, {2})', source, byteOffset, length);
    #elseif lime
    this = new _LimeTypedArray('int32', source, byteOffset, length);
    #else
    if (Std.isOfType(source, Int) || Std.isOfType(source, Float)) {
      ...
      this = [for (value in values) _Runtime.toInt32(value)];
    }
    #end
  }
   ...
   * `Type.createInstance`. */
  public static function construct(source:Dynamic = 0, ?byteOffset:Int, ?length:Int):_Int32Array {
    return new _Int32Array(source, byteOffset, length);
  }

  @:arrayAccess public inline function arrayRead(index:Int):Int {
    #if (lime && !js)
    final values:lime.utils.Int32Array = cast this.nativeView;
    return values[index];
    #else
    return this[index];
    #end
  ...
  @:arrayAccess public inline function arrayWrite(index:Int, value:Float):Int {
    #if (lime && !js)
    final values:lime.utils.Int32Array = cast this.nativeView;
    return values[index] = _Runtime.toInt32(value);
    #elseif js
    js.Syntax.code('{0}[{1}] = {2}', this, index, value);
    return this[index];
    #else
    return this[index] = _Runtime.toInt32(value);
    #end
  }

  public function fill(value:Float, start = 0, ?end:Int):_Int32Array {
    #if (lime && !js)
  ...
  public function subarray(?begin:Int, ?end:Int):_Int32Array {
    ...
    #else
    return new _Int32Array((cast this : Array<Int>).slice(start, stop));
    #end
  }
}
