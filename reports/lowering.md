...
| Packages | 151 |
| Source files | 2710 |
| Candidate declarations | 15531 |
| Lowered declarations | 15531 |
| Current diagnostics | 0 |
| Proven explicit Boolean truthiness uses | 16066 |
| Proven Boolean conditional conditions | 3428 |
| Proven Boolean logical-left truthiness uses | 6176 |
| Proven Boolean logical expressions | 5871 |
| Proven numeric relations | 7631 |
| Direct Boolean truthiness uses | 16018 |
| Direct Boolean conditional expressions | 3424 |
| Direct Boolean `&&` expressions | 2644 |
| Direct Boolean `\|\|` expressions | 3205 |
| Direct numeric relations | 7616 |
| Proven indexed expressions | 13333 |
| Proven indexed reads | 9042 |
| Proven indexed writes | 4435 |
| Parked width-sensitive mixed indexed writes | 19 |
| Direct indexed reads | 9482 |
| Direct indexed writes | 4430 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| `Array` | 7519 | 6123 | 1457 | 6563 | 1457 |
...
| `@flighthq/clipboard` | 48 | 48 | 0 | 43 | 2 | 0 | 0 |
...
| `@flighthq/connectivity` | 30 | 30 | 0 | 33 | 0 | 0 | 0 |
...
| `@flighthq/geolocation` | 28 | 28 | 0 | 32 | 0 | 0 | 0 |
| `@flighthq/geometry` | 418 | 418 | 0 | 488 | 305 | 910 | 11 |
| `@flighthq/glyphatlas` | 37 | 37 | 0 | 48 | 15 | 0 | 0 |
| `@flighthq/haptics` | 23 | 23 | 0 | 25 | 0 | 0 | 0 |
| `@flighthq/host-capacitor` | 35 | 35 | 0 | 64 | 3 | 2 | 0 |
| `@flighthq/host-electron` | 35 | 35 | 0 | 100 | 6 | 13 | 0 |
| `@flighthq/host-tauri` | 22 | 22 | 0 | 48 | 3 | 0 | 0 |
| `@flighthq/host-web` | 103 | 103 | 0 | 114 | 9 | 0 | 0 |
| `@flighthq/image` | 44 | 44 | 0 | 32 | 3 | 10 | 1 |
...
| `@flighthq/power` | 30 | 30 | 0 | 32 | 0 | 0 | 0 |
...
| `@flighthq/render` | 128 | 128 | 0 | 207 | 28 | 134 | 1 |
...
| `@flighthq/screen` | 54 | 54 | 0 | 101 | 18 | 22 | 0 |
...
| `@flighthq/shortcut` | 61 | 61 | 0 | 68 | 3 | 0 | 0 |
...
| `@flighthq/storage` | 54 | 54 | 0 | 78 | 5 | 2 | 0 |
...
| `@flighthq/types` | 2532 | 2532 | 0 | 0 | 0 | 0 | 0 |
