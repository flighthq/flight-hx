...
| Dynamic compatibility type entries | 208 |
| Global value keys | 71 |
...
| `host:AbortSignal` | `host` | `flight._internal.dom.AbortSignal` | `src/flight/_internal/dom/AbortSignal.hx` | `typed` | 157 |
...
| `host:CanvasImageSource` | `host` | `flight._internal.dom.CanvasImageSource` | `src/flight/_internal/dom/CanvasImageSource.hx` | `dynamic-stub` | 25 |
...
| `host:CanvasRenderingContext2D` | `host` | `flight._internal.dom.CanvasRenderingContext2D` | `src/flight/_internal/dom/CanvasRenderingContext2D.hx` | `dynamic-stub` | 627 |
...
| `host:Document` | `host` | `flight._internal.dom.Document` | `src/flight/_internal/dom/Document.hx` | `dynamic-stub` | 140 |
...
| `host:EventTarget` | `host` | `flight._internal.dom.EventTarget` | `src/flight/_internal/dom/EventTarget.hx` | `typed` | 35 |
...
| `host:FontFace` | `host` | `flight._internal.dom.FontFace` | `src/flight/_internal/dom/FontFace.hx` | `dynamic-stub` | 34 |
...
| `host:GPUCanvasContext` | `host` | `flight._internal.dom.GPUCanvasContext` | `src/flight/_internal/dom/GPUCanvasContext.hx` | `dynamic-stub` | 18 |
...
| `host:GPUDevice` | `host` | `flight._internal.dom.GPUDevice` | `src/flight/_internal/dom/GPUDevice.hx` | `dynamic-stub` | 409 |
...
| `host:GPUPowerPreference` | `host` | `flight._internal.dom.GPUPowerPreference` | `src/flight/_internal/dom/GPUPowerPreference.hx` | `dynamic-stub` | 2 |
...
| `host:GPUTextureFormat` | `host` | `flight._internal.dom.GPUTextureFormat` | `src/flight/_internal/dom/GPUTextureFormat.hx` | `dynamic-stub` | 61 |
...
| `host:HTMLCanvasElement` | `host` | `flight._internal.dom.HTMLCanvasElement` | `src/flight/_internal/dom/HTMLCanvasElement.hx` | `dynamic-stub` | 321 |
...
| `host:HTMLInputElement` | `host` | `flight._internal.dom.HTMLInputElement` | `src/flight/_internal/dom/HTMLInputElement.hx` | `dynamic-stub` | 37 |
...
| `host:HTMLVideoElement` | `host` | `flight._internal.dom.HTMLVideoElement` | `src/flight/_internal/dom/HTMLVideoElement.hx` | `dynamic-stub` | 153 |
...
| `host:MediaMetadata` | `host` | `flight._internal.dom.MediaMetadata` | `src/flight/_internal/dom/MediaMetadata.hx` | `dynamic-stub` | 7 |
| `host:MediaQueryList` | `host` | `flight._internal.dom.MediaQueryList` | `src/flight/_internal/dom/MediaQueryList.hx` | `dynamic-stub` | 9 |
| `host:MediaSession` | `host` | `flight._internal.dom.MediaSession` | `src/flight/_internal/dom/MediaSession.hx` | `dynamic-stub` | 28 |
| `host:MediaSource` | `host` | `flight._internal.dom.MediaSource` | `src/flight/_internal/dom/MediaSource.hx` | `dynamic-stub` | 2 |
| `host:MediaStream` | `host` | `flight._internal.dom.MediaStream` | `src/flight/_internal/dom/MediaStream.hx` | `dynamic-stub` | 9 |
...
| `host:Navigator` | `host` | `flight._internal.dom.Navigator` | `src/flight/_internal/dom/Navigator.hx` | `dynamic-stub` | 81 |
...
| `host:PermissionStatus` | `host` | `flight._internal.dom.PermissionStatus` | `src/flight/_internal/dom/PermissionStatus.hx` | `dynamic-stub` | 31 |
...
| `host:Timeout` | `host` | `flight._internal.dom.Timeout` | `src/flight/_internal/dom/Timeout.hx` | `dynamic-stub` | 52 |
...
| `host:WebGLBuffer` | `host` | `flight._internal.dom.WebGLBuffer` | `src/flight/_internal/dom/WebGLBuffer.hx` | `dynamic-stub` | 65 |
...
| `host:WebGLProgram` | `host` | `flight._internal.dom.WebGLProgram` | `src/flight/_internal/dom/WebGLProgram.hx` | `dynamic-stub` | 228 |
...
| `host:WebGLTexture` | `host` | `flight._internal.dom.WebGLTexture` | `src/flight/_internal/dom/WebGLTexture.hx` | `dynamic-stub` | 393 |
...
| `host:Window` | `host` | `flight._internal.dom.Window` | `src/flight/_internal/dom/Window.hx` | `dynamic-stub` | 136 |
...
| `global:document` | `src/flight/_internal/_HostValueLut.hx` | `js-only` | 22 |
...
| `global:Map` | `src/flight/_internal/_HostValueLut.hx` | `portable` | 343 |
...
| `global:navigator` | `src/flight/_internal/_HostValueLut.hx` | `js-only` | 39 |
| `global:Notification` | `src/flight/_internal/_HostValueLut.hx` | `js-only` | 19 |
| `global:Number` | `src/flight/_internal/_HostValueLut.hx` | `portable` | 773 |
...
| `global:Set` | `src/flight/_internal/_HostValueLut.hx` | `portable` | 139 |
...
| `global:WeakMap` | `src/flight/_internal/_HostValueLut.hx` | `portable` | 211 |
| `global:WeakSet` | `src/flight/_internal/_HostValueLut.hx` | `portable` | 15 |
