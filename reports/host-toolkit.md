...
| Dynamic compatibility type entries | 214 |
| Global value keys | 72 |
...
| `host:AbortSignal` | `host` | `flight._internal.dom.AbortSignal` | `src/flight/_internal/dom/AbortSignal.hx` | `typed` | 431 |
...
| `host:AudioBufferSourceNode` | `host` | `flight._internal.dom.AudioBufferSourceNode` | `src/flight/_internal/dom/AudioBufferSourceNode.hx` | `dynamic-stub` | 25 |
...
| `host:CanvasImageSource` | `host` | `flight._internal.dom.CanvasImageSource` | `src/flight/_internal/dom/CanvasImageSource.hx` | `dynamic-stub` | 27 |
...
| `host:CanvasRenderingContext2D` | `host` | `flight._internal.dom.CanvasRenderingContext2D` | `src/flight/_internal/dom/CanvasRenderingContext2D.hx` | `dynamic-stub` | 654 |
...
| `host:Document` | `host` | `flight._internal.dom.Document` | `src/flight/_internal/dom/Document.hx` | `dynamic-stub` | 148 |
| `host:DocumentOrShadowRoot` | `host` | `flight._internal.dom.DocumentOrShadowRoot` | `src/flight/_internal/dom/DocumentOrShadowRoot.hx` | `dynamic-stub` | 3 |
...
| `host:Element` | `host` | `flight._internal.dom.Element` | `src/flight/_internal/dom/Element.hx` | `dynamic-stub` | 23 |
| `host:Event` | `host` | `flight._internal.dom.Event` | `src/flight/_internal/dom/Event.hx` | `dynamic-stub` | 53 |
| `host:EventListener` | `host` | `flight._internal.dom.EventListener` | `src/flight/_internal/dom/EventListener.hx` | `dynamic-stub` | 19 |
...
| `host:EventTarget` | `host` | `flight._internal.dom.EventTarget` | `src/flight/_internal/dom/EventTarget.hx` | `typed` | 45 |
...
| `host:File` | `host` | `flight._internal.dom.File` | `src/flight/_internal/dom/File.hx` | `dynamic-stub` | 58 |
| `host:FileList` | `host` | `flight._internal.dom.FileList` | `src/flight/_internal/dom/FileList.hx` | `dynamic-stub` | 4 |
| `host:FileReader` | `host` | `flight._internal.dom.FileReader` | `src/flight/_internal/dom/FileReader.hx` | `dynamic-stub` | 20 |
...
| `host:FontFace` | `host` | `flight._internal.dom.FontFace` | `src/flight/_internal/dom/FontFace.hx` | `dynamic-stub` | 28 |
...
| `host:GainNode` | `host` | `flight._internal.dom.GainNode` | `src/flight/_internal/dom/GainNode.hx` | `dynamic-stub` | 46 |
...
| `host:GPUBindGroupLayout` | `host` | `flight._internal.dom.GPUBindGroupLayout` | `src/flight/_internal/dom/GPUBindGroupLayout.hx` | `dynamic-stub` | 289 |
...
| `host:GPUDevice` | `host` | `flight._internal.dom.GPUDevice` | `src/flight/_internal/dom/GPUDevice.hx` | `dynamic-stub` | 417 |
...
| `host:GPUDeviceLostInfo` | `host` | `flight._internal.dom.GPUDeviceLostInfo` | `src/flight/_internal/dom/GPUDeviceLostInfo.hx` | `dynamic-stub` | 18 |
...
| `host:GPUPipelineLayout` | `host` | `flight._internal.dom.GPUPipelineLayout` | `src/flight/_internal/dom/GPUPipelineLayout.hx` | `dynamic-stub` | 61 |
...
| `host:GPUShaderModule` | `host` | `flight._internal.dom.GPUShaderModule` | `src/flight/_internal/dom/GPUShaderModule.hx` | `dynamic-stub` | 162 |
...
| `host:GPUTextureFormat` | `host` | `flight._internal.dom.GPUTextureFormat` | `src/flight/_internal/dom/GPUTextureFormat.hx` | `dynamic-stub` | 63 |
...
| `host:GPUTextureView` | `host` | `flight._internal.dom.GPUTextureView` | `src/flight/_internal/dom/GPUTextureView.hx` | `dynamic-stub` | 300 |
| `host:GPUVertexBufferLayout` | `host` | `flight._internal.dom.GPUVertexBufferLayout` | `src/flight/_internal/dom/GPUVertexBufferLayout.hx` | `dynamic-stub` | 26 |
...
| `host:HTMLCanvasElement` | `host` | `flight._internal.dom.HTMLCanvasElement` | `src/flight/_internal/dom/HTMLCanvasElement.hx` | `dynamic-stub` | 333 |
| `host:HTMLDivElement` | `host` | `flight._internal.dom.HTMLDivElement` | `src/flight/_internal/dom/HTMLDivElement.hx` | `dynamic-stub` | 45 |
| `host:HTMLElement` | `host` | `flight._internal.dom.HTMLElement` | `src/flight/_internal/dom/HTMLElement.hx` | `dynamic-stub` | 291 |
...
| `host:HTMLImageElement` | `host` | `flight._internal.dom.HTMLImageElement` | `src/flight/_internal/dom/HTMLImageElement.hx` | `dynamic-stub` | 100 |
| `host:HTMLInputElement` | `host` | `flight._internal.dom.HTMLInputElement` | `src/flight/_internal/dom/HTMLInputElement.hx` | `dynamic-stub` | 19 |
...
| `host:HTMLVideoElement` | `host` | `flight._internal.dom.HTMLVideoElement` | `src/flight/_internal/dom/HTMLVideoElement.hx` | `dynamic-stub` | 181 |
| `host:ImageBitmap` | `host` | `flight._internal.dom.ImageBitmap` | `src/flight/_internal/dom/ImageBitmap.hx` | `dynamic-stub` | 78 |
...
| `host:MIDIAccess` | `host` | `flight._internal.dom.MIDIAccess` | `src/flight/_internal/dom/MIDIAccess.hx` | `dynamic-stub` | 11 |
...
| `host:Navigator` | `host` | `flight._internal.dom.Navigator` | `src/flight/_internal/dom/Navigator.hx` | `dynamic-stub` | 82 |
| `host:Node` | `host` | `flight._internal.dom.Node` | `src/flight/_internal/dom/Node.hx` | `dynamic-stub` | 3 |
...
| `host:OffscreenCanvas` | `host` | `flight._internal.dom.OffscreenCanvas` | `src/flight/_internal/dom/OffscreenCanvas.hx` | `dynamic-stub` | 73 |
...
| `host:Permissions` | `host` | `flight._internal.dom.Permissions` | `src/flight/_internal/dom/Permissions.hx` | `dynamic-stub` | 27 |
...
| `host:Screen` | `host` | `flight._internal.dom.Screen` | `src/flight/_internal/dom/Screen.hx` | `dynamic-stub` | 22 |
...
| `host:ShadowRoot` | `host` | `flight._internal.dom.ShadowRoot` | `src/flight/_internal/dom/ShadowRoot.hx` | `dynamic-stub` | 1 |
| `host:ShareData` | `host` | `flight._internal.dom.ShareData` | `src/flight/_internal/dom/ShareData.hx` | `dynamic-stub` | 14 |
| `host:StereoPannerNode` | `host` | `flight._internal.dom.StereoPannerNode` | `src/flight/_internal/dom/StereoPannerNode.hx` | `dynamic-stub` | 17 |
...
| `host:SVGImageElement` | `host` | `flight._internal.dom.SVGImageElement` | `src/flight/_internal/dom/SVGImageElement.hx` | `dynamic-stub` | 47 |
...
| `host:TextMetrics` | `host` | `flight._internal.dom.TextMetrics` | `src/flight/_internal/dom/TextMetrics.hx` | `dynamic-stub` | 36 |
...
| `host:VideoFrame` | `host` | `flight._internal.dom.VideoFrame` | `src/flight/_internal/dom/VideoFrame.hx` | `dynamic-stub` | 60 |
| `host:VisualViewport` | `host` | `flight._internal.dom.VisualViewport` | `src/flight/_internal/dom/VisualViewport.hx` | `dynamic-stub` | 8 |
| `host:WakeLock` | `host` | `flight._internal.dom.WakeLock` | `src/flight/_internal/dom/WakeLock.hx` | `dynamic-stub` | 4 |
...
| `host:WebGLFramebuffer` | `host` | `flight._internal.dom.WebGLFramebuffer` | `src/flight/_internal/dom/WebGLFramebuffer.hx` | `dynamic-stub` | 42 |
...
| `host:WebGLProgram` | `host` | `flight._internal.dom.WebGLProgram` | `src/flight/_internal/dom/WebGLProgram.hx` | `dynamic-stub` | 250 |
| `host:WebGLRenderbuffer` | `host` | `flight._internal.dom.WebGLRenderbuffer` | `src/flight/_internal/dom/WebGLRenderbuffer.hx` | `dynamic-stub` | 8 |
...
| `host:WebGLTexture` | `host` | `flight._internal.dom.WebGLTexture` | `src/flight/_internal/dom/WebGLTexture.hx` | `dynamic-stub` | 428 |
| `host:WebGLUniformLocation` | `host` | `flight._internal.dom.WebGLUniformLocation` | `src/flight/_internal/dom/WebGLUniformLocation.hx` | `dynamic-stub` | 379 |
...
| `host:WheelEvent` | `host` | `flight._internal.dom.WheelEvent` | `src/flight/_internal/dom/WheelEvent.hx` | `dynamic-stub` | 10 |
| `host:Window` | `host` | `flight._internal.dom.Window` | `src/flight/_internal/dom/Window.hx` | `dynamic-stub` | 144 |
...
| `global:document` | `src/flight/_internal/_HostValueLut.hx` | `js-only` | 28 |
| `global:Document` | `src/flight/_internal/_HostValueLut.hx` | `js-only` | 1 |
...
| `global:FileReader` | `src/flight/_internal/_HostValueLut.hx` | `js-only` | 5 |
...
| `global:Map` | `src/flight/_internal/_HostValueLut.hx` | `portable` | 371 |
...
| `global:Number` | `src/flight/_internal/_HostValueLut.hx` | `portable` | 801 |
...
| `global:Set` | `src/flight/_internal/_HostValueLut.hx` | `portable` | 169 |
| `global:setInterval` | `src/flight/_internal/_HostValueLut.hx` | `portable` | 1 |
| `global:ShadowRoot` | `src/flight/_internal/_HostValueLut.hx` | `js-only` | 1 |
