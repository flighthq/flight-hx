...
| `host:AbortSignal` | `host` | `flight._internal.dom.AbortSignal` | `src/flight/_internal/dom/AbortSignal.hx` | `typed` | 164 |
...
| `host:AudioBufferSourceNode` | `host` | `flight._internal.dom.AudioBufferSourceNode` | `src/flight/_internal/dom/AudioBufferSourceNode.hx` | `dynamic-stub` | 28 |
| `host:AudioContext` | `host` | `flight._internal.dom.AudioContext` | `src/flight/_internal/dom/AudioContext.hx` | `dynamic-stub` | 42 |
...
| `host:CanvasRenderingContext2D` | `host` | `flight._internal.dom.CanvasRenderingContext2D` | `src/flight/_internal/dom/CanvasRenderingContext2D.hx` | `dynamic-stub` | 628 |
| `host:CanvasRenderingContext2DSettings` | `host` | `flight._internal.dom.CanvasRenderingContext2DSettings` | `src/flight/_internal/dom/CanvasRenderingContext2DSettings.hx` | `dynamic-stub` | 14 |
...
| `host:CSSStyleDeclaration` | `host` | `flight._internal.dom.CSSStyleDeclaration` | `src/flight/_internal/dom/CSSStyleDeclaration.hx` | `dynamic-stub` | 164 |
...
| `host:Document` | `host` | `flight._internal.dom.Document` | `src/flight/_internal/dom/Document.hx` | `dynamic-stub` | 146 |
...
| `host:Element` | `host` | `flight._internal.dom.Element` | `src/flight/_internal/dom/Element.hx` | `dynamic-stub` | 21 |
| `host:Event` | `host` | `flight._internal.dom.Event` | `src/flight/_internal/dom/Event.hx` | `dynamic-stub` | 51 |
...
| `host:EventTarget` | `host` | `flight._internal.dom.EventTarget` | `src/flight/_internal/dom/EventTarget.hx` | `typed` | 41 |
...
| `host:EXT_texture_filter_anisotropic` | `host` | `flight._internal.dom.EXT_texture_filter_anisotropic` | `src/flight/_internal/dom/EXT_texture_filter_anisotropic.hx` | `dynamic-stub` | 7 |
| `host:File` | `host` | `flight._internal.dom.File` | `src/flight/_internal/dom/File.hx` | `dynamic-stub` | 35 |
...
| `host:GainNode` | `host` | `flight._internal.dom.GainNode` | `src/flight/_internal/dom/GainNode.hx` | `dynamic-stub` | 47 |
...
| `host:Geolocation` | `host` | `flight._internal.dom.Geolocation` | `src/flight/_internal/dom/Geolocation.hx` | `dynamic-stub` | 13 |
...
| `host:GPU` | `host` | `flight._internal.dom.GPU` | `src/flight/_internal/dom/GPU.hx` | `dynamic-stub` | 9 |
...
| `host:GPUBindGroup` | `host` | `flight._internal.dom.GPUBindGroup` | `src/flight/_internal/dom/GPUBindGroup.hx` | `dynamic-stub` | 202 |
...
| `host:GPUBindGroupLayout` | `host` | `flight._internal.dom.GPUBindGroupLayout` | `src/flight/_internal/dom/GPUBindGroupLayout.hx` | `dynamic-stub` | 277 |
...
| `host:GPUBuffer` | `host` | `flight._internal.dom.GPUBuffer` | `src/flight/_internal/dom/GPUBuffer.hx` | `dynamic-stub` | 300 |
...
| `host:GPUSampler` | `host` | `flight._internal.dom.GPUSampler` | `src/flight/_internal/dom/GPUSampler.hx` | `dynamic-stub` | 215 |
...
| `host:GPUShaderModule` | `host` | `flight._internal.dom.GPUShaderModule` | `src/flight/_internal/dom/GPUShaderModule.hx` | `dynamic-stub` | 155 |
...
| `host:GPUTexture` | `host` | `flight._internal.dom.GPUTexture` | `src/flight/_internal/dom/GPUTexture.hx` | `dynamic-stub` | 229 |
...
| `host:GPUTextureView` | `host` | `flight._internal.dom.GPUTextureView` | `src/flight/_internal/dom/GPUTextureView.hx` | `dynamic-stub` | 290 |
...
| `host:HTMLCanvasElement` | `host` | `flight._internal.dom.HTMLCanvasElement` | `src/flight/_internal/dom/HTMLCanvasElement.hx` | `dynamic-stub` | 312 |
| `host:HTMLDivElement` | `host` | `flight._internal.dom.HTMLDivElement` | `src/flight/_internal/dom/HTMLDivElement.hx` | `dynamic-stub` | 38 |
| `host:HTMLElement` | `host` | `flight._internal.dom.HTMLElement` | `src/flight/_internal/dom/HTMLElement.hx` | `dynamic-stub` | 277 |
...
| `host:HTMLImageElement` | `host` | `flight._internal.dom.HTMLImageElement` | `src/flight/_internal/dom/HTMLImageElement.hx` | `dynamic-stub` | 78 |
...
| `host:HTMLVideoElement` | `host` | `flight._internal.dom.HTMLVideoElement` | `src/flight/_internal/dom/HTMLVideoElement.hx` | `dynamic-stub` | 152 |
| `host:ImageBitmap` | `host` | `flight._internal.dom.ImageBitmap` | `src/flight/_internal/dom/ImageBitmap.hx` | `dynamic-stub` | 63 |
...
| `host:MediaSession` | `host` | `flight._internal.dom.MediaSession` | `src/flight/_internal/dom/MediaSession.hx` | `dynamic-stub` | 36 |
...
| `host:Navigator` | `host` | `flight._internal.dom.Navigator` | `src/flight/_internal/dom/Navigator.hx` | `dynamic-stub` | 85 |
| `host:Node` | `host` | `flight._internal.dom.Node` | `src/flight/_internal/dom/Node.hx` | `dynamic-stub` | 4 |
...
| `host:OffscreenCanvas` | `host` | `flight._internal.dom.OffscreenCanvas` | `src/flight/_internal/dom/OffscreenCanvas.hx` | `dynamic-stub` | 59 |
...
| `host:Storage` | `host` | `flight._internal.dom.Storage` | `src/flight/_internal/dom/Storage.hx` | `dynamic-stub` | 13 |
...
| `host:SVGImageElement` | `host` | `flight._internal.dom.SVGImageElement` | `src/flight/_internal/dom/SVGImageElement.hx` | `dynamic-stub` | 33 |
...
| `host:VideoFrame` | `host` | `flight._internal.dom.VideoFrame` | `src/flight/_internal/dom/VideoFrame.hx` | `dynamic-stub` | 46 |
...
| `host:WebGLProgram` | `host` | `flight._internal.dom.WebGLProgram` | `src/flight/_internal/dom/WebGLProgram.hx` | `dynamic-stub` | 239 |
...
| `host:WebGLTexture` | `host` | `flight._internal.dom.WebGLTexture` | `src/flight/_internal/dom/WebGLTexture.hx` | `dynamic-stub` | 400 |
| `host:WebGLUniformLocation` | `host` | `flight._internal.dom.WebGLUniformLocation` | `src/flight/_internal/dom/WebGLUniformLocation.hx` | `dynamic-stub` | 370 |
| `host:WebGLVertexArrayObject` | `host` | `flight._internal.dom.WebGLVertexArrayObject` | `src/flight/_internal/dom/WebGLVertexArrayObject.hx` | `dynamic-stub` | 33 |
...
| `global:globalThis` | `src/flight/_internal/_HostValueLut.hx` | `portable` | 9 |
