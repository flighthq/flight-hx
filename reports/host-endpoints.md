...
| --- | --- | --- | --- | --- | ---: | --- |
| `Canvas2dBackend` | `arc` | `call` | `arc` | `backend` | 1 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
...
| `Canvas2dBackend` | `drawImage` | `call` | `drawImage` | `backend` | 25 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
...
| `Canvas2dBackend` | `fillStyle` | `write` | `fillStyle` | `backend` | 26 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `fillText` | `call` | `fillText` | `backend` | 8 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `filter` | `write` | `filter` | `backend` | 20 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
...
| `Canvas2dBackend` | `getImageData` | `call` | `getImageData` | `backend` | 7 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
...
| `Canvas2dBackend` | `lineTo` | `call` | `lineTo` | `backend` | 11 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `lineWidth` | `write` | `lineWidth` | `backend` | 8 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `measureText` | `call` | `measureText` | `backend` | 17 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `miterLimit` | `write` | `miterLimit` | `backend` | 1 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `moveTo` | `call` | `moveTo` | `backend` | 20 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `putImageData` | `call` | `putImageData` | `backend` | 4 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `quadraticCurveTo` | `call` | `quadraticCurveTo` | `backend` | 2 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `rect` | `call` | `rect` | `backend` | 9 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `restore` | `call` | `restore` | `backend` | 28 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `roundRect` | `call` | `roundRect` | `backend` | 1 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
...
| `Canvas2dBackend` | `textAlign` | `write` | `textAlign` | `backend` | 8 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `textBaseline` | `write` | `textBaseline` | `backend` | 8 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
| `Canvas2dBackend` | `transform` | `call` | `transform` | `backend` | 2 | `src/flight/_internal/backend/Canvas2dBackend.hx` |
...
| `CanvasElementBackend` | `getContext` | `call` | `getContext` | `backend` | 36 | `src/flight/_internal/backend/CanvasElementBackend.hx` |
| `CanvasElementBackend` | `getContext` | `read` | `getContext` | `dynamic-fallback` | 1 | `src/flight/_internal/_Runtime.hx` |
| `CanvasElementBackend` | `height` | `read` | `height` | `backend` | 41 | `src/flight/_internal/backend/CanvasElementBackend.hx` |
| `CanvasElementBackend` | `height` | `write` | `height` | `backend` | 37 | `src/flight/_internal/backend/CanvasElementBackend.hx` |
...
| `CanvasElementBackend` | `width` | `read` | `width` | `backend` | 43 | `src/flight/_internal/backend/CanvasElementBackend.hx` |
| `CanvasElementBackend` | `width` | `write` | `width` | `backend` | 37 | `src/flight/_internal/backend/CanvasElementBackend.hx` |
| `DomDocumentBackend` | `activeElement` | `read` | `activeElement` | `dynamic-fallback` | 1 | `src/flight/_internal/_Runtime.hx` |
| `DomDocumentBackend` | `addEventListener` | `call` | `addEventListener` | `backend` | 7 | `src/flight/_internal/backend/DomDocumentBackend.hx` |
| `DomDocumentBackend` | `body` | `read` | `body` | `backend` | 8 | `src/flight/_internal/backend/DomDocumentBackend.hx` |
| `DomDocumentBackend` | `createElement` | `call` | `createElement` | `backend` | 62 | `src/flight/_internal/backend/DomDocumentBackend.hx` |
...
| `DomDocumentBackend` | `removeEventListener` | `call` | `removeEventListener` | `backend` | 7 | `src/flight/_internal/backend/DomDocumentBackend.hx` |
...
| `DomNavigatorBackend` | `geolocation` | `read` | `geolocation` | `backend` | 4 | `src/flight/_internal/backend/DomNavigatorBackend.hx` |
...
| `DomNavigatorBackend` | `gpu` | `read` | `gpu` | `backend` | 4 | `src/flight/_internal/backend/DomNavigatorBackend.hx` |
| `DomNavigatorBackend` | `hardwareConcurrency` | `read` | `hardwareConcurrency` | `dynamic-fallback` | 1 | `src/flight/_internal/_Runtime.hx` |
| `DomNavigatorBackend` | `language` | `read` | `language` | `backend` | 2 | `src/flight/_internal/backend/DomNavigatorBackend.hx` |
...
| `DomNavigatorBackend` | `platform` | `read` | `platform` | `backend` | 1 | `src/flight/_internal/backend/DomNavigatorBackend.hx` |
...
| `DomWindowBackend` | `close` | `read` | `close` | `backend` | 1 | `src/flight/_internal/backend/DomWindowBackend.hx` |
...
| `DomWindowBackend` | `removeEventListener` | `call` | `removeEventListener` | `backend` | 22 | `src/flight/_internal/backend/DomWindowBackend.hx` |
...
| `WebGl2Backend` | `BACK` | `read` | `BACK` | `backend` | 6 | `src/flight/_internal/backend/WebGl2Backend.hx` |
...
| `WebGl2Backend` | `bindTexture` | `call` | `bindTexture` | `backend` | 48 | `src/flight/_internal/backend/WebGl2Backend.hx` |
...
| `WebGl2Backend` | `bufferSubData` | `call` | `bufferSubData` | `backend` | 6 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `CCW` | `read` | `CCW` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `checkFramebufferStatus` | `call` | `checkFramebufferStatus` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `CLAMP_TO_EDGE` | `read` | `CLAMP_TO_EDGE` | `backend` | 22 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `clear` | `call` | `clear` | `backend` | 6 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `clearBufferfi` | `call` | `clearBufferfi` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `clearBufferfv` | `call` | `clearBufferfv` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `clearColor` | `call` | `clearColor` | `backend` | 7 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `COLOR` | `read` | `COLOR` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `COLOR_ATTACHMENT0` | `read` | `COLOR_ATTACHMENT0` | `backend` | 7 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `COLOR_BUFFER_BIT` | `read` | `COLOR_BUFFER_BIT` | `backend` | 6 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `COLOR_CLEAR_VALUE` | `read` | `COLOR_CLEAR_VALUE` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `COLOR_WRITEMASK` | `read` | `COLOR_WRITEMASK` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `colorMask` | `call` | `colorMask` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `COMPILE_STATUS` | `read` | `COMPILE_STATUS` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `compileShader` | `call` | `compileShader` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `compressedTexImage2D` | `call` | `compressedTexImage2D` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `compressedTexSubImage3D` | `call` | `compressedTexSubImage3D` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `createBuffer` | `call` | `createBuffer` | `backend` | 23 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `createFramebuffer` | `call` | `createFramebuffer` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `createProgram` | `call` | `createProgram` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `createRenderbuffer` | `call` | `createRenderbuffer` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
...
| `WebGl2Backend` | `CW` | `read` | `CW` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `DECR_WRAP` | `read` | `DECR_WRAP` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `deleteBuffer` | `call` | `deleteBuffer` | `backend` | 16 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `deleteFramebuffer` | `call` | `deleteFramebuffer` | `backend` | 4 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `deleteProgram` | `call` | `deleteProgram` | `backend` | 5 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `deleteRenderbuffer` | `call` | `deleteRenderbuffer` | `backend` | 4 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `deleteShader` | `call` | `deleteShader` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `deleteTexture` | `call` | `deleteTexture` | `backend` | 16 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `deleteVertexArray` | `call` | `deleteVertexArray` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `DEPTH_BUFFER_BIT` | `read` | `DEPTH_BUFFER_BIT` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
...
| `WebGl2Backend` | `FLOAT_MAT2` | `read` | `FLOAT_MAT2` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `FLOAT_MAT3` | `read` | `FLOAT_MAT3` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `FLOAT_MAT4` | `read` | `FLOAT_MAT4` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `FLOAT_VEC2` | `read` | `FLOAT_VEC2` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `FLOAT_VEC3` | `read` | `FLOAT_VEC3` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `FLOAT_VEC4` | `read` | `FLOAT_VEC4` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `flush` | `call` | `flush` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `FRAGMENT_SHADER` | `read` | `FRAGMENT_SHADER` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `FRAMEBUFFER` | `read` | `FRAMEBUFFER` | `backend` | 25 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `FRAMEBUFFER_BINDING` | `read` | `FRAMEBUFFER_BINDING` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `FRAMEBUFFER_COMPLETE` | `read` | `FRAMEBUFFER_COMPLETE` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `framebufferRenderbuffer` | `call` | `framebufferRenderbuffer` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `framebufferTexture2D` | `call` | `framebufferTexture2D` | `backend` | 4 | `src/flight/_internal/backend/WebGl2Backend.hx` |
...
| `WebGl2Backend` | `LINEAR` | `read` | `LINEAR` | `backend` | 20 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `LINEAR_MIPMAP_LINEAR` | `read` | `LINEAR_MIPMAP_LINEAR` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `LINEAR_MIPMAP_NEAREST` | `read` | `LINEAR_MIPMAP_NEAREST` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `LINES` | `read` | `LINES` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `LINK_STATUS` | `read` | `LINK_STATUS` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `linkProgram` | `call` | `linkProgram` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `MAX` | `read` | `MAX` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `MAX_SAMPLES` | `read` | `MAX_SAMPLES` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `MAX_TEXTURE_IMAGE_UNITS` | `read` | `MAX_TEXTURE_IMAGE_UNITS` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `MIN` | `read` | `MIN` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `MIRRORED_REPEAT` | `read` | `MIRRORED_REPEAT` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `NEAREST` | `read` | `NEAREST` | `backend` | 11 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `NEAREST_MIPMAP_LINEAR` | `read` | `NEAREST_MIPMAP_LINEAR` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
...
| `WebGl2Backend` | `READ_FRAMEBUFFER` | `read` | `READ_FRAMEBUFFER` | `backend` | 6 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `readBuffer` | `call` | `readBuffer` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `readPixels` | `call` | `readPixels` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `RENDERBUFFER` | `read` | `RENDERBUFFER` | `backend` | 8 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `renderbufferStorage` | `call` | `renderbufferStorage` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `renderbufferStorageMultisample` | `call` | `renderbufferStorageMultisample` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `REPEAT` | `read` | `REPEAT` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `RGBA` | `read` | `RGBA` | `backend` | 32 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `RGBA16F` | `read` | `RGBA16F` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `RGBA32F` | `read` | `RGBA32F` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `RGBA8` | `read` | `RGBA8` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `scissor` | `call` | `scissor` | `backend` | 5 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `SCISSOR_BOX` | `read` | `SCISSOR_BOX` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `SCISSOR_TEST` | `read` | `SCISSOR_TEST` | `backend` | 8 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `shaderSource` | `call` | `shaderSource` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `SRGB8_ALPHA8` | `read` | `SRGB8_ALPHA8` | `backend` | 6 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STATIC_DRAW` | `read` | `STATIC_DRAW` | `backend` | 11 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_BACK_FAIL` | `read` | `STENCIL_BACK_FAIL` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_BACK_FUNC` | `read` | `STENCIL_BACK_FUNC` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_BACK_PASS_DEPTH_FAIL` | `read` | `STENCIL_BACK_PASS_DEPTH_FAIL` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_BACK_PASS_DEPTH_PASS` | `read` | `STENCIL_BACK_PASS_DEPTH_PASS` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_BACK_REF` | `read` | `STENCIL_BACK_REF` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_BACK_VALUE_MASK` | `read` | `STENCIL_BACK_VALUE_MASK` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_BACK_WRITEMASK` | `read` | `STENCIL_BACK_WRITEMASK` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_BUFFER_BIT` | `read` | `STENCIL_BUFFER_BIT` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_FAIL` | `read` | `STENCIL_FAIL` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_FUNC` | `read` | `STENCIL_FUNC` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_PASS_DEPTH_FAIL` | `read` | `STENCIL_PASS_DEPTH_FAIL` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_PASS_DEPTH_PASS` | `read` | `STENCIL_PASS_DEPTH_PASS` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_REF` | `read` | `STENCIL_REF` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_TEST` | `read` | `STENCIL_TEST` | `backend` | 7 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_VALUE_MASK` | `read` | `STENCIL_VALUE_MASK` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STENCIL_WRITEMASK` | `read` | `STENCIL_WRITEMASK` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `stencilFunc` | `call` | `stencilFunc` | `backend` | 5 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `stencilFuncSeparate` | `call` | `stencilFuncSeparate` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `stencilMask` | `call` | `stencilMask` | `backend` | 5 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `stencilMaskSeparate` | `call` | `stencilMaskSeparate` | `backend` | 2 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `stencilOp` | `call` | `stencilOp` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `stencilOpSeparate` | `call` | `stencilOpSeparate` | `backend` | 4 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `STREAM_DRAW` | `read` | `STREAM_DRAW` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `texImage2D` | `call` | `texImage2D` | `backend` | 10 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `texImage2D` | `call` | `texImage2DSource` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `texImage3D` | `call` | `texImage3D` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `texParameterf` | `call` | `texParameterf` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
...
| `WebGl2Backend` | `TEXTURE_2D` | `read` | `TEXTURE_2D` | `backend` | 85 | `src/flight/_internal/backend/WebGl2Backend.hx` |
...
| `WebGl2Backend` | `TEXTURE_CUBE_MAP` | `read` | `TEXTURE_CUBE_MAP` | `backend` | 25 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `TEXTURE_CUBE_MAP_POSITIVE_X` | `read` | `TEXTURE_CUBE_MAP_POSITIVE_X` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `TEXTURE_MAG_FILTER` | `read` | `TEXTURE_MAG_FILTER` | `backend` | 13 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `TEXTURE_MAX_LEVEL` | `read` | `TEXTURE_MAX_LEVEL` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `TEXTURE_MIN_FILTER` | `read` | `TEXTURE_MIN_FILTER` | `backend` | 13 | `src/flight/_internal/backend/WebGl2Backend.hx` |
...
| `WebGl2Backend` | `TRIANGLE_FAN` | `read` | `TRIANGLE_FAN` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `TRIANGLE_STRIP` | `read` | `TRIANGLE_STRIP` | `backend` | 3 | `src/flight/_internal/backend/WebGl2Backend.hx` |
...
| `WebGl2Backend` | `uniform4f` | `call` | `uniform4f` | `backend` | 47 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `uniform4fv` | `call` | `uniform4fv` | `backend` | 5 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `uniformMatrix3fv` | `call` | `uniformMatrix3fv` | `backend` | 10 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `uniformMatrix4fv` | `call` | `uniformMatrix4fv` | `backend` | 10 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `UNPACK_PREMULTIPLY_ALPHA_WEBGL` | `read` | `UNPACK_PREMULTIPLY_ALPHA_WEBGL` | `backend` | 6 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `UNSIGNED_BYTE` | `read` | `UNSIGNED_BYTE` | `backend` | 14 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `UNSIGNED_INT` | `read` | `UNSIGNED_INT` | `backend` | 4 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `UNSIGNED_INT_24_8` | `read` | `UNSIGNED_INT_24_8` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `UNSIGNED_SHORT` | `read` | `UNSIGNED_SHORT` | `backend` | 10 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `useProgram` | `call` | `useProgram` | `backend` | 15 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `VERTEX_ARRAY_BINDING` | `read` | `VERTEX_ARRAY_BINDING` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `VERTEX_SHADER` | `read` | `VERTEX_SHADER` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `vertexAttrib4f` | `call` | `vertexAttrib4f` | `backend` | 1 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `vertexAttribDivisor` | `call` | `vertexAttribDivisor` | `backend` | 32 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `vertexAttribPointer` | `call` | `vertexAttribPointer` | `backend` | 35 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `viewport` | `call` | `viewport` | `backend` | 13 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `VIEWPORT` | `read` | `VIEWPORT` | `backend` | 4 | `src/flight/_internal/backend/WebGl2Backend.hx` |
| `WebGl2Backend` | `ZERO` | `read` | `ZERO` | `backend` | 12 | `src/flight/_internal/backend/WebGl2Backend.hx` |
