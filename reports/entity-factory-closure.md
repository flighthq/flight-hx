...
| Constructor-ready Entity calls | 128 |
| Blocked Entity calls | 231 |
| Bare Entity calls | 0 |
...
| `@flighthq/types:interface#ApplicationWindow` | 1 | 0 | 1 | `createApplicationWindow` |
| `@flighthq/types:interface#AreaLight` | 2 | 2 | 0 | `cloneAreaLight`, `createAreaLight` |
| `@flighthq/types:interface#Bitmap` | 8 | 0 | 8 | `cloneBitmap`, `createBitmap`, `createBitmapFromCanvas`, `cropBitmap`, `extendBitmap`, `makeBitmap`, `readBitmap`, `trimBitmap` |
...
| `@flighthq/types:interface#ClipboardTextBackend` | 1 | 0 | 1 | `createTauriClipboardBackend` |
| `@flighthq/types:interface#ColorScaleBias` | 1 | 0 | 1 | `createColorScaleBias` |
...
| `@flighthq/types:interface#Image` | 6 | 5 | 1 | `cloneImageResource`, `createImageResource`, `createImageResourceFromCanvas`, `createImageResourceFromImageBitmap`, `createImageResourceFromImageElement`, `createVideoImageResource` |
...
| `@flighthq/types:interface#Quaternion` | 1 | 0 | 1 | `createQuaternion` |
| `@flighthq/types:interface#Ray3D` | 1 | 1 | 0 | `createRay3D` |
| `@flighthq/types:interface#Rectangle` | 1 | 0 | 1 | `createRectangle` |
...
| `@flighthq/types:interface#RenderProxy` | 1 | 0 | 1 | `createRenderProxy` |
...
| `@flighthq/types:interface#ScreenInfo` | 2 | 0 | 2 | `createScreenInfo`, `emptyScreenInfo` |
| `@flighthq/types:interface#ScreenMode` | 1 | 0 | 1 | `createScreenMode` |
...
| `@flighthq/types:interface#Spritesheet` | 2 | 0 | 2 | `cloneSpritesheet`, `createSpritesheet` |
...
| `@flighthq/types:interface#TextureAtlasRegion` | 1 | 0 | 1 | `createTextureAtlasRegion` |
| `@flighthq/types:interface#Transform2D` | 1 | 1 | 0 | `createTransform2D` |
| `@flighthq/types:interface#Transform3D` | 1 | 0 | 1 | `createTransform3D` |
...
| `@flighthq/types:interface#Vector4` | 1 | 0 | 1 | `createVector4` |
...
| `@flighthq/types:type#TauriAppCapabilities` | 1 | 0 | 1 | `createTauriAppCapabilities` |
...
| `upstream/packages/application/src/window.ts:251:10` | `createApplicationWindow` | `@flighthq/types:interface#ApplicationWindow` | `contextual` | `object` | 36 | blocked | `field-order-mismatch` |
| `upstream/packages/bitmap/src/bitmap.ts:6:10` | `cloneBitmap` | `@flighthq/types:interface#Bitmap` | `contextual` | `object` | 8 | blocked | `field-order-mismatch` |
| `upstream/packages/bitmap/src/bitmap.ts:74:10` | `createBitmap` | `@flighthq/types:interface#Bitmap` | `contextual` | `object` | 8 | blocked | `field-order-mismatch` |
| `upstream/packages/bitmap/src/bitmapChannel.ts:136:10` | `makeBitmap` | `@flighthq/types:interface#Bitmap` | `contextual` | `object` | 8 | blocked | `field-order-mismatch` |
| `upstream/packages/bitmap/src/bitmapCrop.ts:37:10` | `cropBitmap` | `@flighthq/types:interface#Bitmap` | `contextual` | `object` | 8 | blocked | `field-order-mismatch` |
| `upstream/packages/bitmap/src/bitmapCrop.ts:110:10` | `extendBitmap` | `@flighthq/types:interface#Bitmap` | `contextual` | `object` | 8 | blocked | `field-order-mismatch` |
| `upstream/packages/bitmap/src/bitmapCrop.ts:148:12` | `trimBitmap` | `@flighthq/types:interface#Bitmap` | `contextual` | `object` | 8 | blocked | `field-order-mismatch` |
| `upstream/packages/bitmap/src/bitmapFrom.ts:27:10` | `createBitmapFromCanvas` | `@flighthq/types:interface#Bitmap` | `contextual` | `object` | 8 | blocked | `field-order-mismatch` |
...
| `upstream/packages/geometry/src/quaternion.ts:41:10` | `createQuaternion` | `@flighthq/types:interface#Quaternion` | `contextual` | `object` | 4 | blocked | `field-order-mismatch` |
| `upstream/packages/geometry/src/ray3d.ts:24:10` | `createRay3D` | `@flighthq/types:interface#Ray3D` | `contextual` | `object` | 2 | ready | — |
| `upstream/packages/geometry/src/rectangle.ts:53:10` | `createRectangle` | `@flighthq/types:interface#Rectangle` | `contextual` | `object` | 4 | blocked | `field-order-mismatch` |
...
| `upstream/packages/geometry/src/transform3d.ts:16:10` | `createTransform3D` | `@flighthq/types:interface#Transform3D` | `contextual` | `object` | 3 | blocked | `field-order-mismatch` |
...
| `upstream/packages/geometry/src/vector4.ts:89:10` | `createVector4` | `@flighthq/types:interface#Vector4` | `contextual` | `object` | 4 | blocked | `field-order-mismatch` |
...
| `upstream/packages/host-electron/src/electronScreen.ts:71:10` | `emptyScreenInfo` | `@flighthq/types:interface#ScreenInfo` | `contextual` | `object` | 25 | blocked | `field-order-mismatch` |
...
| `upstream/packages/host-tauri/src/tauriApp.ts:20:10` | `createTauriAppCapabilities` | `@flighthq/types:type#TauriAppCapabilities` | `contextual` | `object` | 7 | blocked | `field-order-mismatch` |
...
| `upstream/packages/host-web/src/webBitmapReadback.ts:33:30` | `readBitmap` | `@flighthq/types:interface#Bitmap` | `contextual` | `object` | 8 | blocked | `field-order-mismatch` |
...
| `upstream/packages/materials/src/colorScaleBias.ts:50:10` | `createColorScaleBias` | `@flighthq/types:interface#ColorScaleBias` | `contextual` | `object` | 8 | blocked | `field-order-mismatch` |
...
| `upstream/packages/render/src/renderProxy.ts:36:10` | `createRenderProxy` | `@flighthq/types:interface#RenderProxy` | `contextual` | `object` | 22 | blocked | `field-order-mismatch` |
...
| `upstream/packages/screen/src/screen.ts:37:10` | `createScreenInfo` | `@flighthq/types:interface#ScreenInfo` | `contextual` | `object` | 25 | blocked | `field-order-mismatch` |
| `upstream/packages/screen/src/screen.ts:67:10` | `createScreenMode` | `@flighthq/types:interface#ScreenMode` | `contextual` | `object` | 5 | blocked | `field-order-mismatch` |
...
| `upstream/packages/spritesheet/src/spritesheet.ts:17:10` | `cloneSpritesheet` | `@flighthq/types:interface#Spritesheet` | `contextual` | `object` | 3 | blocked | `field-order-mismatch` |
| `upstream/packages/spritesheet/src/spritesheet.ts:25:10` | `createSpritesheet` | `@flighthq/types:interface#Spritesheet` | `contextual` | `object` | 3 | blocked | `field-order-mismatch` |
