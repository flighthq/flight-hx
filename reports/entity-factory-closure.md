...
| Metric | Count |
| --- | ---: |
| Production createEntity calls | 393 |
| Exact concrete Entity calls | 198 |
| Exact concrete Entity schemas | 160 |
| Constructor-ready Entity calls | 374 |
| Blocked Entity calls | 0 |
| Bare Entity calls | 0 |
| Generic Entity calls | 0 |
| Private local Entity classes | 176 |
| Field-order-normalized calls | 28 |
| Missing-field-initialized calls | 9 |
| Spread-projected calls | 18 |
| Structural Entity calls | 0 |
| Exact non-Entity calls | 19 |
| Unresolved calls | 0 |
...
| `@flighthq/types:interface#MenuHighlightBackend` | 1 | 1 | 0 | `<module>` |
| `@flighthq/types:interface#MenuPopupBackend` | 1 | 1 | 0 | `<module>` |
...
| `@flighthq/types:interface#PowerKeepAwakeBackend` | 1 | 1 | 0 | `<module>` |
| `@flighthq/types:interface#PowerSuspensionBackend` | 1 | 1 | 0 | `<module>` |
...
| `@flighthq/types:type#ElectronPowerCapabilities` | 2 | 2 | 0 | `createElectronPowerBackends` |
| `@flighthq/types:type#ElectronProtocolCapabilities` | 1 | 1 | 0 | `createElectronProtocolCapabilities` |
| `@flighthq/types:type#GlBitmapShader` | 2 | 2 | 0 | `createDefaultGlBitmapShader`, `createGlBitmapShader` |
...
| `@flighthq/types:type#WebPowerCapabilities` | 1 | 1 | 0 | `<module>` |
...
| `upstream/packages/audio/src/audioResource.ts:9:10` | `cloneAudioResource` | `@flighthq/types:interface#AudioResource` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/audio/src/audioResource.ts:13:10` | `createAudioResource` | `@flighthq/types:interface#AudioResource` | `contextual` | `object` | 1 | ready | — | — |
...
| `upstream/packages/font/src/fontResource.ts:5:10` | `createFontResource` | `@flighthq/types:interface#FontResource` | `contextual` | `object` | 2 | ready | `field-order` | — |
...
| `upstream/packages/host-capacitor/src/capacitorRegister.ts:37:10` | `capacitorHost` | `synthetic-entity:upstream/packages/host-capacitor/src/capacitorRegister.ts:37:10` | `contextual` | `object` | 26 | ready | `synthetic-class` | — |
...
| `upstream/packages/host-electron/src/electronIpc.ts:19:10` | `createElectronIpcHandleBackend` | `@flighthq/types:interface#IpcHandleBackend` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/host-electron/src/electronIpc.ts:33:10` | `createElectronIpcInvokeBackend` | `@flighthq/types:interface#IpcInvokeBackend` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/host-electron/src/electronIpc.ts:42:10` | `createElectronIpcMessageBackend` | `@flighthq/types:interface#IpcMessageBackend` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/host-electron/src/electronIpc.ts:52:10` | `createElectronIpcSendBackend` | `@flighthq/types:interface#IpcSendBackend` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/host-electron/src/electronIpc.ts:62:10` | `createElectronIpcTargetedSendBackend` | `synthetic-entity:upstream/packages/host-electron/src/electronIpc.ts:62:10` | `contextual` | `object` | 1 | ready | `synthetic-class` | — |
| `upstream/packages/host-electron/src/electronMenu.ts:26:10` | `createElectronMenuBackends` | `@flighthq/types:type#ElectronMenuCapabilities` | `contextual` | `object` | 3 | ready | — | — |
| `upstream/packages/host-electron/src/electronMenu.ts:27:18` | `createElectronMenuBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 2 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-electron/src/electronMenu.ts:42:12` | `createElectronMenuBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 1 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-electron/src/electronMenu.ts:57:13` | `createElectronMenuBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 1 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
...
| `upstream/packages/host-electron/src/electronPower.ts:34:64` | `createElectronPowerBackends` | `@flighthq/types:type#ElectronPowerCapabilities` | `returned-variable` | `object` | 7 | ready | `missing-field-initialization` | — |
| `upstream/packages/host-electron/src/electronPower.ts:37:20` | `createElectronPowerBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 1 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-electron/src/electronPower.ts:42:13` | `createElectronPowerBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 1 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-electron/src/electronPower.ts:52:11` | `createElectronPowerBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 2 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-electron/src/electronPower.ts:62:16` | `createElectronPowerBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 4 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-electron/src/electronPower.ts:95:18` | `createElectronPowerBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 2 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-electron/src/electronPower.ts:105:13` | `createElectronPowerBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 1 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-electron/src/electronPower.ts:119:17` | `createElectronPowerBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 2 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-electron/src/electronPower.ts:137:10` | `createElectronPowerBackends` | `@flighthq/types:type#ElectronPowerCapabilities` | `contextual` | `object` | 1 | ready | `spread-projection` | — |
| `upstream/packages/host-electron/src/electronPower.ts:139:14` | `createElectronPowerBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 2 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
...
| `upstream/packages/host-electron/src/electronRegister.ts:93:10` | `registerElectronBackends` | `synthetic-entity:upstream/packages/host-electron/src/electronRegister.ts:93:10` | `contextual` | `object` | 26 | ready | `synthetic-class` | — |
...
| `upstream/packages/host-tauri/src/tauriMenu.ts:27:10` | `createTauriMenuBackends` | `@flighthq/types:type#TauriMenuCapabilities` | `contextual` | `object` | 3 | ready | — | — |
| `upstream/packages/host-tauri/src/tauriMenu.ts:28:18` | `createTauriMenuBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 2 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-tauri/src/tauriMenu.ts:49:12` | `createTauriMenuBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 1 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-tauri/src/tauriMenu.ts:60:13` | `createTauriMenuBackends` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 1 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
...
| `upstream/packages/host-tauri/src/tauriRegister.ts:49:10` | `registerTauriBackends` | `synthetic-entity:upstream/packages/host-tauri/src/tauriRegister.ts:49:10` | `contextual` | `object` | 26 | ready | `synthetic-class` | — |
...
| `upstream/packages/host-web/src/webDialog.ts:31:46` | `<module>` | `synthetic-entity:upstream/packages/host-web/src/webDialog.ts:31:46` | `variable` | `object` | 1 | ready | `synthetic-class` | — |
| `upstream/packages/host-web/src/webDialog.ts:35:41` | `<module>` | `synthetic-entity:upstream/packages/host-web/src/webDialog.ts:35:41` | `variable` | `object` | 1 | ready | `synthetic-class` | — |
| `upstream/packages/host-web/src/webDialog.ts:39:41` | `<module>` | `synthetic-entity:upstream/packages/host-web/src/webDialog.ts:39:41` | `variable` | `object` | 1 | ready | `synthetic-class` | — |
| `upstream/packages/host-web/src/webDialog.ts:43:42` | `<module>` | `synthetic-entity:upstream/packages/host-web/src/webDialog.ts:43:42` | `variable` | `object` | 1 | ready | `synthetic-class` | — |
| `upstream/packages/host-web/src/webDialog.ts:47:45` | `<module>` | `synthetic-entity:upstream/packages/host-web/src/webDialog.ts:47:45` | `variable` | `object` | 1 | ready | `synthetic-class` | — |
| `upstream/packages/host-web/src/webDialog.ts:51:45` | `<module>` | `synthetic-entity:upstream/packages/host-web/src/webDialog.ts:51:45` | `variable` | `object` | 1 | ready | `synthetic-class` | — |
...
| `upstream/packages/host-web/src/webInputTarget.ts:19:40` | `<module>` | `@flighthq/types:interface#InputDropFileBackend` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/host-web/src/webInputTarget.ts:37:37` | `<module>` | `@flighthq/types:interface#InputFocusBackend` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/host-web/src/webInputTarget.ts:50:43` | `<module>` | `@flighthq/types:interface#InputPointerLockBackend` | `contextual` | `object` | 2 | ready | — | — |
| `upstream/packages/host-web/src/webInputTarget.ts:91:38` | `<module>` | `@flighthq/types:interface#InputTargetBackend` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/host-web/src/webInputTarget.ts:103:40` | `<module>` | `@flighthq/types:interface#RenderContextBackend` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/host-web/src/webInputTarget.ts:122:40` | `<module>` | `@flighthq/types:interface#RenderSurfaceBackend` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/host-web/src/webInputTarget.ts:134:37` | `createWebInputTargetHandle` | `@flighthq/types:interface#InputTargetHandle` | `contextual` | `object` | 1 | ready | — | — |
...
| `upstream/packages/host-web/src/webMenu.ts:15:62` | `<module>` | `@flighthq/types:interface#MenuHighlightBackend` | `contextual` | `object` | 1 | ready | — | — |
| `upstream/packages/host-web/src/webMenu.ts:24:54` | `<module>` | `@flighthq/types:interface#MenuPopupBackend` | `contextual` | `object` | 1 | ready | — | — |
...
| `upstream/packages/host-web/src/webPower.ts:29:64` | `<module>` | `@flighthq/types:interface#PowerKeepAwakeBackend` | `contextual` | `object` | 4 | ready | — | — |
| `upstream/packages/host-web/src/webPower.ts:88:66` | `<module>` | `@flighthq/types:interface#PowerSuspensionBackend` | `contextual` | `object` | 2 | ready | — | — |
| `upstream/packages/host-web/src/webPower.ts:113:10` | `createWebPowerReadings` | `@flighthq/types:type#WebPowerReadingCapabilities` | `contextual` | `object` | 2 | ready | — | — |
| `upstream/packages/host-web/src/webPower.ts:114:13` | `createWebPowerReadings` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 1 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-web/src/webPower.ts:169:13` | `createWebPowerReadings` | `@flighthq/types:type#EntityWithoutRuntime` | `type-argument` | `object` | 1 | not-entity | — | `field-set-mismatch`, `parameterized-destination` |
| `upstream/packages/host-web/src/webPower.ts:188:59` | `<module>` | `@flighthq/types:type#WebPowerCapabilities` | `contextual` | `object` | 2 | ready | `spread-projection` | — |
...
| `upstream/packages/host-web/src/webScreen.ts:182:17` | `createWebScreenCapabilities` | `synthetic-entity:upstream/packages/host-web/src/webScreen.ts:182:17` | `variable` | `object` | 4 | ready | `synthetic-class` | — |
| `upstream/packages/host-web/src/webScreen.ts:225:18` | `createWebScreenCapabilities` | `synthetic-entity:upstream/packages/host-web/src/webScreen.ts:225:18` | `variable` | `object` | 1 | ready | `synthetic-class` | — |
| `upstream/packages/host-web/src/webScreen.ts:246:26` | `createWebScreenCapabilities` | `synthetic-entity:upstream/packages/host-web/src/webScreen.ts:246:26` | `variable` | `object` | 2 | ready | `synthetic-class` | — |
| `upstream/packages/host-web/src/webScreen.ts:276:28` | `createWebScreenCapabilities` | `synthetic-entity:upstream/packages/host-web/src/webScreen.ts:276:28` | `variable` | `object` | 1 | ready | `synthetic-class` | — |
...
| `upstream/packages/image/src/imageResource.ts:8:10` | `cloneImageResource` | `@flighthq/types:interface#ImageResource` | `contextual` | `object` | 7 | ready | — | — |
| `upstream/packages/image/src/imageResource.ts:22:10` | `createCompressedImageResource` | `@flighthq/types:interface#CompressedImageResource` | `contextual` | `object` | 7 | ready | — | — |
| `upstream/packages/image/src/imageResource.ts:34:35` | `createImageResource` | `@flighthq/types:interface#ImageResource` | `contextual` | `object` | 7 | ready | — | — |
| `upstream/packages/image/src/imageResourceFrom.ts:18:10` | `createImageResourceFromCanvas` | `@flighthq/types:interface#ImageResource` | `contextual` | `object` | 7 | ready | — | — |
| `upstream/packages/image/src/imageResourceFrom.ts:30:10` | `createImageResourceFromImageBitmap` | `@flighthq/types:interface#ImageResource` | `contextual` | `object` | 7 | ready | — | — |
| `upstream/packages/image/src/imageResourceFrom.ts:42:10` | `createImageResourceFromImageElement` | `@flighthq/types:interface#ImageResource` | `contextual` | `object` | 7 | ready | — | — |
...
| `upstream/packages/lighting/src/ambientLight.ts:18:10` | `createAmbientLight` | `@flighthq/types:interface#AmbientLight` | `contextual` | `object` | 5 | ready | — | — |
| `upstream/packages/lighting/src/areaLight.ts:8:10` | `cloneAreaLight` | `@flighthq/types:interface#AreaLight` | `contextual` | `object` | 19 | ready | — | — |
| `upstream/packages/lighting/src/areaLight.ts:40:10` | `createAreaLight` | `@flighthq/types:interface#AreaLight` | `contextual` | `object` | 19 | ready | — | — |
| `upstream/packages/lighting/src/directionalLight.ts:8:10` | `cloneDirectionalLight` | `@flighthq/types:interface#DirectionalLight` | `contextual` | `object` | 16 | ready | — | — |
| `upstream/packages/lighting/src/directionalLight.ts:33:35` | `createDirectionalLight` | `@flighthq/types:interface#DirectionalLight` | `contextual` | `object` | 16 | ready | — | — |
| `upstream/packages/lighting/src/environment.ts:15:10` | `createEnvironment` | `@flighthq/types:interface#Environment` | `contextual` | `object` | 4 | ready | — | — |
| `upstream/packages/lighting/src/hemisphereLight.ts:20:10` | `createHemisphereLight` | `@flighthq/types:interface#HemisphereLight` | `contextual` | `object` | 6 | ready | — | — |
| `upstream/packages/lighting/src/pointLight.ts:8:10` | `clonePointLight` | `@flighthq/types:interface#PointLight` | `contextual` | `object` | 16 | ready | — | — |
| `upstream/packages/lighting/src/pointLight.ts:33:10` | `createPointLight` | `@flighthq/types:interface#PointLight` | `contextual` | `object` | 16 | ready | — | — |
...
| `upstream/packages/lighting/src/spotLight.ts:8:10` | `cloneSpotLight` | `@flighthq/types:interface#SpotLight` | `contextual` | `object` | 20 | ready | — | — |
| `upstream/packages/lighting/src/spotLight.ts:39:28` | `createSpotLight` | `@flighthq/types:interface#SpotLight` | `contextual` | `object` | 20 | ready | — | — |
...
| `upstream/packages/render-gl/src/glShader.ts:55:10` | `createDefaultGlBitmapShader` | `@flighthq/types:type#GlBitmapShader` | `contextual` | `object` | 3 | ready | `field-order` | — |
| `upstream/packages/render-gl/src/glShader.ts:87:10` | `createGlBitmapShader` | `@flighthq/types:type#GlBitmapShader` | `contextual` | `object` | 3 | ready | `field-order` | — |
| `upstream/packages/render-gl/src/glTestHelper.ts:55:26` | `createGlState` | `synthetic-entity:upstream/packages/render-gl/src/glTestHelper.ts:55:26` | `contextual` | `object` | 3 | ready | `synthetic-class` | — |
...
| `upstream/packages/render/src/renderCache.ts:25:10` | `createRenderCache` | `@flighthq/types:interface#RenderCache` | `contextual` | `object` | 2 | ready | — | — |
| `upstream/packages/render/src/renderCache.ts:37:39` | `createRenderCacheAdapter` | `@flighthq/types:type#RenderCacheAdapter` | `contextual` | `object` | 3 | ready | `field-order` | — |
...
| `upstream/packages/scene2d/src/sprite.ts:48:10` | `createSpriteRendererData` | `@flighthq/types:interface#SpriteIdentityRendererData` | `contextual` | `object` | 2 | ready | — | — |
...
| `upstream/packages/scene3d-resources/src/sceneResourceSignals.ts:7:10` | `createScene3DResourceSignals` | `@flighthq/types:interface#Scene3DResourceSignals` | `contextual` | `object` | 2 | ready | — | — |
...
| `upstream/packages/skeleton2d/src/skeleton2d.ts:13:10` | `cloneSkeleton2D` | `@flighthq/types:interface#Skeleton2D` | `contextual` | `object` | 6 | ready | — | — |
| `upstream/packages/skeleton2d/src/skeleton2d.ts:153:10` | `createSkeleton2D` | `@flighthq/types:interface#Skeleton2D` | `contextual` | `object` | 5 | ready | `missing-field-initialization` | — |
...
| `upstream/packages/texture/src/videoTexture.ts:104:17` | `createVideoImageResource` | `@flighthq/types:interface#ImageResource` | `contextual` | `object` | 7 | ready | `field-order` | — |
...
| `upstream/packages/video/src/videoResource.ts:16:10` | `createVideoResource` | `@flighthq/types:interface#VideoResource` | `contextual` | `object` | 3 | ready | — | — |
